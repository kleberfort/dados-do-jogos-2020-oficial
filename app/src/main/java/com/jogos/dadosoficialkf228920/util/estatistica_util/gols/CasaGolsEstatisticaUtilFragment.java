...
public class CasaGolsEstatisticaUtilFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @org.jetbrains.annotations.Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (partidasCasa != null && nomeTime != null) {
            ...
            golsCasaMarcadosEstatisticaCasa(partidasCasa);
    ...
    public void golsCasaMarcadosEstatisticaCasa(List<PartidaNovoModelo> partidas){
