...
public class CasaGolsSofridoEstatisticaUtilFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @org.jetbrains.annotations.Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (partidasCasa != null && nomeTime != null) {
            ...
            golsCasaSofridoEstatisticaCasa(partidasCasa);
    ...
    public void golsCasaSofridoEstatisticaCasa(List<PartidaNovoModelo> partidas){
