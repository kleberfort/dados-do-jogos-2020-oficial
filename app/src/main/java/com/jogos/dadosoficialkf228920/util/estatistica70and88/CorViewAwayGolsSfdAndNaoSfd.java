...
public class CorViewAwayGolsSfdAndNaoSfd{

    public static SpannableStringBuilder formateTextAwayGolsNaoMarcados(String mercado, String name, long porcentagem, int repeticos, int totalJogos) {
    ...
    public static SpannableStringBuilder formateTextAwayGolsMarcou(String mercado, String name, long porcentagem, int repeticos, int totalJogos) {
        SpannableStringBuilder builder = new SpannableStringBuilder();
