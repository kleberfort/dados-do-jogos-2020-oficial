package com.jogos.dadosoficialkf228920.util.estatistica.cartoes;
...
public class CasaCartoesEstatisticaFragment extends Fragment  {
    ...
    public void cartoesEstatisticaCasa(List<PartidaNovoModelo> partidas){
