...
public class Estatistica70ou88NewModel {

    public static List<CharSequence> melhoresStatisticasCasa(List<MatchNewModelDate> listTeamHomeCompleto, String team, Integer porcentagem) {
    ...
    public static List<CharSequence> melhoresStatisticasFora(List<MatchNewModelDate> listTeamAwayCompleto, String team, Integer porcentagem) {
