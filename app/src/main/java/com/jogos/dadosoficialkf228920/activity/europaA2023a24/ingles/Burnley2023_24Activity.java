...
import com.jogos.dadosoficialkf228920.databinding.ActivityBurnley202324Binding;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.burnley.BurnleyCasaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.burnley.BurnleyForaFragment;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.resultado.estatistica.burnley.BurnleyResultadoEstatisticaFragment;
...
public class Burnley2023_24Activity extends AppCompatActivity {

    private ActivityBurnley202324Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityBurnley202324Binding.inflate(getLayoutInflater());
...
//                        .add("Casa 2023-24", BurnleyCasaFragment.class)
//                        .add("Fora 2023-24", BurnleyForaFragment.class)
//                        .create()
//        );
//
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new BurnleyCasaFragment(), "Jogos casa");
        adapter.addFragment(new BurnleyForaFragment(), "Jogos fora");
        adapter.addFragment(new BurnleyResultadoEstatisticaFragment(), "Estatística");
