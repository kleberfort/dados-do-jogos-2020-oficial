...
import com.jogos.dadosoficialkf228920.databinding.ActivityLiverpool202324Binding;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.liverpool.LiverpoolCasaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.liverpool.LiverpoolForaFragment;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.resultado.estatistica.liverpool.LiverpoolResultadoEstatisticaFragment;
...
public class Liverpool2023_24Activity extends AppCompatActivity {

    private ActivityLiverpool202324Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLiverpool202324Binding.inflate(getLayoutInflater());
...
//                        .add("Casa 2023-24", LiverpoolCasaFragment.class)
//                        .add("Fora 2023-24", LiverpoolForaFragment.class)
//                        .create()
//        );
//
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new LiverpoolCasaFragment(), "Jogos casa");
        adapter.addFragment(new LiverpoolForaFragment(), "Jogos fora");
        adapter.addFragment(new LiverpoolResultadoEstatisticaFragment(), "Estatística");
