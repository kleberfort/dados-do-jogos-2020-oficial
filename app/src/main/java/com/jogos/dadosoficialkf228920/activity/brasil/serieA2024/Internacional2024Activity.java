...
import com.jogos.dadosoficialkf228920.databinding.ActivityInternacional2024Binding;
...
import com.jogos.dadosoficialkf228920.fragments.brasil.serieA2024.internacional_ui.estatistica_ui.InternacionalEstatistica2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieA2024.internacional_ui.estatistica_ui.partidas_ui.InternacionalCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieA2024.internacional_ui.estatistica_ui.partidas_ui.InternacionalForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class Internacional2024Activity extends AppCompatActivity {

    private ActivityInternacional2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityInternacional2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new InternacionalCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new InternacionalForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new InternacionalEstatistica2024Fragment(), "Estatística");
