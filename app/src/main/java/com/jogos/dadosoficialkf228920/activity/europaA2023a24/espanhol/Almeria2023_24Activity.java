...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.resultado.estatistica.almeria.AlmeriaResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new AlmeriaCasaFragment(), "Jogos casa");
        adapter.addFragment(new AlmeriaForaFragment(), "Jogos fora");
        adapter.addFragment(new AlmeriaResultadoEstatisticaFragment(), "Estatística");
