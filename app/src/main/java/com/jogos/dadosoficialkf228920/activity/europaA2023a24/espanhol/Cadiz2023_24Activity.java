...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.resultado.estatistica.cadiz.CadizResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new CadizCasaFragment(), "Jogos casa");
        adapter.addFragment(new CadizForaFragment(), "Jogos fora");
        adapter.addFragment(new CadizResultadoEstatisticaFragment(), "Estatística");
