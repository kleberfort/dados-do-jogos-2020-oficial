...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.resultado.estatistica.mainz.MainzResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new MainzCasaFragment(), "Jogos casa");
        adapter.addFragment(new MainzForaFragment(), "Jogos fora");
        adapter.addFragment(new MainzResultadoEstatisticaFragment(), "Estatística");
