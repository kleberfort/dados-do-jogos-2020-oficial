...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.resultado.estatistica.rayovallecano.VallecanoResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new RayoVallecanoCasaFragment(), "Jogos casa");
        adapter.addFragment(new RayoVallecanoForaFragment(), "Jogos fora");
        adapter.addFragment(new VallecanoResultadoEstatisticaFragment(), "Estatística");
