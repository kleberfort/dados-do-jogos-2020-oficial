...
import com.jogos.dadosoficialkf228920.databinding.ActivityBanfield2024Binding;
...
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.banfield.estatistica_ui.BanfieldEstatisticaCasa2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.banfield.estatistica_ui.BanfieldEstatisticaFora2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.banfield.partidas_ui.BanfieldCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.banfield.partidas_ui.BanfieldForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class Banfield2024Activity extends AppCompatActivity {

    private ActivityBanfield2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityBanfield2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new BanfieldCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new BanfieldForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new BanfieldEstatisticaCasa2024Fragment(), "Estatística Casa");
        adapter.addFragment(new BanfieldEstatisticaFora2024Fragment(), "Estatística Fora");
