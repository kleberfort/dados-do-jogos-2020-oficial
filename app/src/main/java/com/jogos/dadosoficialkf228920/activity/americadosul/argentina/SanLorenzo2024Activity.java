...
import com.jogos.dadosoficialkf228920.databinding.ActivitySanLorenzo2024Binding;
import com.jogos.dadosoficialkf228920.databinding.ActivitySantos2024Binding;
...
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.san_lorenzo.estatistica_ui.SanLorenzoEstatisticaCasa2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.san_lorenzo.estatistica_ui.SanLorenzoEstatisticaFora2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.san_lorenzo.partidas_ui.SanLorenzoCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.san_lorenzo.partidas_ui.SanLorenzoForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class SanLorenzo2024Activity extends AppCompatActivity {

    private ActivitySanLorenzo2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivitySanLorenzo2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new SanLorenzoCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new SanLorenzoForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new SanLorenzoEstatisticaCasa2024Fragment(), "Estatística Casa");
        adapter.addFragment(new SanLorenzoEstatisticaFora2024Fragment(), "Estatística Fora");
