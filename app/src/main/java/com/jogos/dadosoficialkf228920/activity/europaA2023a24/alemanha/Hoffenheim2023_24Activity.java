...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.resultado.estatistica.hoffenheim.HoffenheimResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new HoffenheimCasaFragment(), "Jogos casa");
        adapter.addFragment(new HoffenheimForaFragment(), "Jogos fora");
        adapter.addFragment(new HoffenheimResultadoEstatisticaFragment(), "Estatística");
