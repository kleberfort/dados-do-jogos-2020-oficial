...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.resultado.estatistica.nantes.NantesResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new NantesCasaFragment(), "Jogos casa");
        adapter.addFragment(new NantesForaFragment(), "Jogos fora");
        adapter.addFragment(new NantesResultadoEstatisticaFragment(), "Estatística");
