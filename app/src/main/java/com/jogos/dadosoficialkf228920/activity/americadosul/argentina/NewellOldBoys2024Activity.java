...
import com.jogos.dadosoficialkf228920.databinding.ActivityNewcastle202324Binding;
import com.jogos.dadosoficialkf228920.databinding.ActivityNewellOldBoys2024Binding;
...
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.newell_old_boys.estatistica_ui.NewellOldBoysEstatisticaCasa2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.newell_old_boys.estatistica_ui.NewellOldBoysEstatisticaFora2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.newell_old_boys.partidas_ui.NewellOldBoysCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.newell_old_boys.partidas_ui.NewellOldBoysForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class NewellOldBoys2024Activity extends AppCompatActivity {

    private ActivityNewellOldBoys2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityNewellOldBoys2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new NewellOldBoysCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new NewellOldBoysForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new NewellOldBoysEstatisticaCasa2024Fragment(), "Estatística Casa");
        adapter.addFragment(new NewellOldBoysEstatisticaFora2024Fragment(), "Estatística Fora");
