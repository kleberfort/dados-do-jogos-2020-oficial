...
import com.jogos.dadosoficialkf228920.databinding.ActivityLanus2024Binding;
...
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.lanus.estatistica_ui.LanusEstatisticaCasa2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.lanus.estatistica_ui.LanusEstatisticaFora2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.lanus.partidas_ui.LanusCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.lanus.partidas_ui.LanusForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class Lanus2024Activity extends AppCompatActivity {

    private ActivityLanus2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLanus2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new LanusCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new LanusForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new LanusEstatisticaCasa2024Fragment(), "Estatística Casa");
        adapter.addFragment(new LanusEstatisticaFora2024Fragment(), "Estatística Fora");
