...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.resultado.estatistica.tottenham.TottenhamResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new TottenhamCasaFragment(), "Jogos casa");
        adapter.addFragment(new TottenhamForaFragment(), "Jogos fora");
        adapter.addFragment(new TottenhamResultadoEstatisticaFragment(), "Estatística");
