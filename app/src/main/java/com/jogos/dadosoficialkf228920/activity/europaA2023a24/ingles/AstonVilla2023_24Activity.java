...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new AstonVillaCasaFragment(), "Jogos casa");
        adapter.addFragment(new AstonVillaForaFragment(), "Jogos fora");
        adapter.addFragment(new AstonVillaResultadoEstatisticaFragment(), "Estatística");
