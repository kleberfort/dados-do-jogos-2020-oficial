...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.resultado.estatistica.leipzig.LeipzigResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new LeipzigCasaFragment(), "Jogos casa");
        adapter.addFragment(new LeipzigForaFragment(), "Jogos fora");
        adapter.addFragment(new LeipzigResultadoEstatisticaFragment(), "Estatística");
