...
import com.jogos.dadosoficialkf228920.databinding.ActivityGuarani2024Binding;
...
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.guarani_ui.estatistica_ui.GuaraniEstatistica2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.guarani_ui.estatistica_ui.partidas_ui.GuaraniCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.guarani_ui.estatistica_ui.partidas_ui.GuaraniForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class Guarani2024Activity extends AppCompatActivity {

    private ActivityGuarani2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityGuarani2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new GuaraniCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new GuaraniForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new GuaraniEstatistica2024Fragment(), "Estatística");
