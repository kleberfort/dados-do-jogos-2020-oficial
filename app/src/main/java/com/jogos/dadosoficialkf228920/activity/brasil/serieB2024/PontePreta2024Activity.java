...
import com.jogos.dadosoficialkf228920.databinding.ActivityPontePreta2024Binding;
...
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.pontepreta_ui.estatistica_ui.PontePretaEstatistica2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.pontepreta_ui.estatistica_ui.partidas_ui.PontePretaCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.pontepreta_ui.estatistica_ui.partidas_ui.PontePretaForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class PontePreta2024Activity extends AppCompatActivity {

    private ActivityPontePreta2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPontePreta2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new PontePretaCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new PontePretaForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new PontePretaEstatistica2024Fragment(), "Estatística");
