...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.resultado.estatistica.wolfsburg.WolfsburgResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new WolfsburgCasaFragment(), "Jogos casa");
        adapter.addFragment(new WolfsburgForaFragment(), "Jogos fora");
        adapter.addFragment(new WolfsburgResultadoEstatisticaFragment(), "Estatística");
