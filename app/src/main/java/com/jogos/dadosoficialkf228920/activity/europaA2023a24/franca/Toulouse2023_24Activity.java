...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.resultado.estatistica.toulouse.ToulouseResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new ToulouseCasaFragment(), "Jogos casa");
        adapter.addFragment(new ToulouseForaFragment(), "Jogos fora");
        adapter.addFragment(new ToulouseResultadoEstatisticaFragment(), "Estatística");
