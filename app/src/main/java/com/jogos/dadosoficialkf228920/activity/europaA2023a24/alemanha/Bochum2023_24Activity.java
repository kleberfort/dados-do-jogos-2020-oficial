...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.resultado.estatistica.bochum.BochumResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new BochumCasaFragment(), "Jogos casa");
        adapter.addFragment(new BochumForaFragment(), "Jogos fora");
        adapter.addFragment(new BochumResultadoEstatisticaFragment(), "Estatística");
