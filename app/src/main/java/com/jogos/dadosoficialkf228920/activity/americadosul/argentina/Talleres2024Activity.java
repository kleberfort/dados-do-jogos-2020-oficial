...
import com.jogos.dadosoficialkf228920.databinding.ActivityTalleres2024Binding;
...
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.talleres.estatistica_ui.TalleresEstatisticaCasa2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.talleres.estatistica_ui.TalleresEstatisticaFora2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.talleres.partidas_ui.TalleresCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.talleres.partidas_ui.TalleresForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class Talleres2024Activity extends AppCompatActivity {

    private ActivityTalleres2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityTalleres2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new TalleresCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new TalleresForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new TalleresEstatisticaCasa2024Fragment(), "Estatística Casa");
        adapter.addFragment(new TalleresEstatisticaFora2024Fragment(), "Estatística Fora");
