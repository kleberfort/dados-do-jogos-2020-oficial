...
import com.jogos.dadosoficialkf228920.databinding.ActivitySassuolo202324Binding;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.resultado.estatistica.sassuolo.SassuoloResultadoEstatisticaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.sassuolo.SassuoloCasaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.sassuolo.SassuoloForaFragment;
...
public class Sassuolo2023_24Activity extends AppCompatActivity {

    private ActivitySassuolo202324Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivitySassuolo202324Binding.inflate(getLayoutInflater());
...
//                        .add("Casa 2023-24", SassuoloCasaFragment.class)
//                        .add("Fora 2023-24", SassuoloForaFragment.class)
//                        .create()
//        );
//
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new SassuoloCasaFragment(), "Jogos casa");
        adapter.addFragment(new SassuoloForaFragment(), "Jogos fora");
        adapter.addFragment(new SassuoloResultadoEstatisticaFragment(), "Estatística");
