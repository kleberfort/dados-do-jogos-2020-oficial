...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.resultado.estatistica.alaves.AlavesResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new AugsburgCasaFragment(), "Jogos casa");
        adapter.addFragment(new AugsburgForaFragment(), "Jogos fora");
        adapter.addFragment(new AugsburgResultadoEstatisticaFragment(), "Estatística");
