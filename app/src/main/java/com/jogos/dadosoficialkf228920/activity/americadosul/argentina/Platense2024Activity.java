...
import com.jogos.dadosoficialkf228920.databinding.ActivityPlatense2024Binding;
...
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.platense.estatistica_ui.PlatenseEstatisticaCasa2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.platense.estatistica_ui.PlatenseEstatisticaFora2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.platense.partidas_ui.PlatenseCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.platense.partidas_ui.PlatenseForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class Platense2024Activity extends AppCompatActivity {

    private ActivityPlatense2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPlatense2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new PlatenseCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new PlatenseForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new PlatenseEstatisticaCasa2024Fragment(), "Estatística Casa");
        adapter.addFragment(new PlatenseEstatisticaFora2024Fragment(), "Estatística Fora");
