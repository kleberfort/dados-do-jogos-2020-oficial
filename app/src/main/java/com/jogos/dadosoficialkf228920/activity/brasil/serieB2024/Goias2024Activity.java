...
import com.jogos.dadosoficialkf228920.databinding.ActivityGoias2024Binding;
...
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.goias_ui.estatistica_ui.GoiasEstatistica2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.goias_ui.estatistica_ui.partidas_ui.GoiasCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.goias_ui.estatistica_ui.partidas_ui.GoiasForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class Goias2024Activity extends AppCompatActivity {

    private ActivityGoias2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityGoias2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new GoiasCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new GoiasForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new GoiasEstatistica2024Fragment(), "Estatística");
