...
import com.jogos.dadosoficialkf228920.databinding.ActivityOgcNice202324Binding;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.nice.NiceCasaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.nice.NiceForaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.resultado.estatistica.nice.NiceResultadoEstatisticaFragment;
...
public class OgcNice2023_24Activity extends AppCompatActivity {

    private ActivityOgcNice202324Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityOgcNice202324Binding.inflate(getLayoutInflater());
...
//                        .add("Casa 2023-24", NiceCasaFragment.class)
//                        .add("Fora 2023-24", NiceForaFragment.class)
//                        .create()
//        );
//
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new NiceCasaFragment(), "Jogos casa");
        adapter.addFragment(new NiceForaFragment(), "Jogos fora");
        adapter.addFragment(new NiceResultadoEstatisticaFragment(), "Estatística");
