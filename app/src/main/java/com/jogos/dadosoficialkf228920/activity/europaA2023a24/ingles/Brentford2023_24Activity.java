...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.resultado.estatistica.brentford.BrentfordResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new BrentfordCasaFragment(), "Jogos casa");
        adapter.addFragment(new BrentfordForaFragment(), "Jogos fora");
        adapter.addFragment(new BrentfordResultadoEstatisticaFragment(), "Estatística");
