...
import com.jogos.dadosoficialkf228920.databinding.ActivityCorinthians2024Binding;
...
import com.jogos.dadosoficialkf228920.fragments.brasil.serieA2024.corinthians_ui.estatistica_ui.CorinthiansEstatistica2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieA2024.corinthians_ui.estatistica_ui.partidas_ui.CorinthiansCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieA2024.corinthians_ui.estatistica_ui.partidas_ui.CorinthiansForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class Corinthians2024Activity extends AppCompatActivity {

    private ActivityCorinthians2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCorinthians2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new CorinthiansCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new CorinthiansForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new CorinthiansEstatistica2024Fragment(), "Estatística");
