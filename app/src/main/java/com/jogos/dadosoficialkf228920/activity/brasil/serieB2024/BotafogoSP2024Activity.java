...
import com.jogos.dadosoficialkf228920.databinding.ActivityBotafogoSp2024Binding;
import com.jogos.dadosoficialkf228920.databinding.ActivityCeara2024Binding;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.botafogoSP_ui.estatistica_ui.BotafogoSPEstatistica2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.botafogoSP_ui.estatistica_ui.partidas_ui.BotafogoSPCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.botafogoSP_ui.estatistica_ui.partidas_ui.BotafogoSPForaPartidas2024Fragment;
...
public class BotafogoSP2024Activity extends AppCompatActivity {

    private ActivityBotafogoSp2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityBotafogoSp2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new BotafogoSPCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new BotafogoSPForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new BotafogoSPEstatistica2024Fragment(), "Estatística");
