...
import com.jogos.dadosoficialkf228920.databinding.ActivityDefensaJusticia2024Binding;
...
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.defensa_justicia.estatistica_ui.DefensaJusticiaEstatisticaCasa2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.defensa_justicia.estatistica_ui.DefensaJusticiaEstatisticaFora2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.defensa_justicia.partidas_ui.DefensaJusticiaCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.defensa_justicia.partidas_ui.DefensaJusticiaForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class DefensaJusticia2024Activity extends AppCompatActivity {

    private ActivityDefensaJusticia2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDefensaJusticia2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new DefensaJusticiaCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new DefensaJusticiaForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new DefensaJusticiaEstatisticaCasa2024Fragment(), "Estatística Casa");
        adapter.addFragment(new DefensaJusticiaEstatisticaFora2024Fragment(), "Estatística Fora");
