...
import com.jogos.dadosoficialkf228920.databinding.ActivityLorient202324Binding;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.lorient.LorientCasaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.lorient.LorientForaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.resultado.estatistica.lorient.LorientResultadoEstatisticaFragment;
...
public class Lorient2023_24Activity extends AppCompatActivity {

    private ActivityLorient202324Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLorient202324Binding.inflate(getLayoutInflater());
...
//                        .add("Casa 2023-24", LorientCasaFragment.class)
//                        .add("Fora 2023-24", LorientForaFragment.class)
//                        .create()
//        );
//
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new LorientCasaFragment(), "Jogos casa");
        adapter.addFragment(new LorientForaFragment(), "Jogos fora");
        adapter.addFragment(new LorientResultadoEstatisticaFragment(), "Estatística");
