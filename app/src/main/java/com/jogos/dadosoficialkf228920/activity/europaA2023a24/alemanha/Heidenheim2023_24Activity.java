...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.resultado.estatistica.heidenheim.HeidenheimResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new HeidenheimCasaFragment(), "Jogos casa");
        adapter.addFragment(new HeidenheimForaFragment(), "Jogos fora");
        adapter.addFragment(new HeidenheimResultadoEstatisticaFragment(), "Estatística");
