...
import com.jogos.dadosoficialkf228920.databinding.ActivityRosarioCentral2024Binding;
...
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.rosario_central.estatistica_ui.RosarioCentralEstatisticaCasa2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.rosario_central.estatistica_ui.RosarioCentralEstatisticaFora2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.rosario_central.partidas_ui.RosarioCentralCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.rosario_central.partidas_ui.RosarioCentralForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class RosarioCentral2024Activity extends AppCompatActivity {

    private ActivityRosarioCentral2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityRosarioCentral2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new RosarioCentralCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new RosarioCentralForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new RosarioCentralEstatisticaCasa2024Fragment(), "Estatística Casa");
        adapter.addFragment(new RosarioCentralEstatisticaFora2024Fragment(), "Estatística Fora");
