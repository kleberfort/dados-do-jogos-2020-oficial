...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.resultado.estatistica.borussiadortmund.BorussiaDortmundResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new BorussiaDortmundCasaFragment(), "Jogos casa");
        adapter.addFragment(new BorussiaDortmundForaFragment(), "Jogos fora");
        adapter.addFragment(new BorussiaDortmundResultadoEstatisticaFragment(), "Estatística");
