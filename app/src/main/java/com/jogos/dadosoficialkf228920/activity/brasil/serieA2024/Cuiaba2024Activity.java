...
import com.jogos.dadosoficialkf228920.databinding.ActivityCuiaba2024Binding;
...
import com.jogos.dadosoficialkf228920.fragments.brasil.serieA2024.cuiaba_ui.estatistica_ui.CuiabaEstatistica2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieA2024.cuiaba_ui.estatistica_ui.partidas_ui.CuiabaCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieA2024.cuiaba_ui.estatistica_ui.partidas_ui.CuiabaForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieA2024.vitoria_ui.estatistica_ui.partidas_ui.VitoriaCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieA2024.vitoria_ui.estatistica_ui.partidas_ui.VitoriaForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class Cuiaba2024Activity extends AppCompatActivity {

    private ActivityCuiaba2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCuiaba2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new CuiabaCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new CuiabaForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new CuiabaEstatistica2024Fragment(), "Estatística");
