...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.resultado.estatistica.stuttgart.StuttgartResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new StuttgartCasaFragment(), "Jogos casa");
        adapter.addFragment(new StuttgartForaFragment(), "Jogos fora");
        adapter.addFragment(new StuttgartResultadoEstatisticaFragment(), "Estatística");
