...
import com.jogos.dadosoficialkf228920.databinding.ActivityCentralCordoba2024Binding;
...
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.central_cordoba.estatistica_ui.CentralCordobaEstatisticaCasa2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.central_cordoba.estatistica_ui.CentralCordobaEstatisticaFora2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.central_cordoba.partidas_ui.CentralCordobaCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.central_cordoba.partidas_ui.CentralCordobaForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class CentralCordoba2024Activity extends AppCompatActivity {

    private ActivityCentralCordoba2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCentralCordoba2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new CentralCordobaCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new CentralCordobaForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new CentralCordobaEstatisticaCasa2024Fragment(), "Estatística Casa");
        adapter.addFragment(new CentralCordobaEstatisticaFora2024Fragment(), "Estatística Fora");
