...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.resultado.estatistica.eintrachtfrankfurt.EintrachtFrankfurtResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new EintrachtFrankfurtCasaFragment(), "Jogos casa");
        adapter.addFragment(new EintrachtFrankfurtForaFragment(), "Jogos fora");
        adapter.addFragment(new EintrachtFrankfurtResultadoEstatisticaFragment(), "Estatística");
