...
import com.jogos.dadosoficialkf228920.databinding.ActivityItuano2024Binding;
...
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.ituano_ui.estatistica_ui.ItuanoEstatistica2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.ituano_ui.estatistica_ui.partidas_ui.ItuanoCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.ituano_ui.estatistica_ui.partidas_ui.ItuanoForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class Ituano2024Activity extends AppCompatActivity {

    private ActivityItuano2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityItuano2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new ItuanoCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new ItuanoForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new ItuanoEstatistica2024Fragment(), "Estatística");
