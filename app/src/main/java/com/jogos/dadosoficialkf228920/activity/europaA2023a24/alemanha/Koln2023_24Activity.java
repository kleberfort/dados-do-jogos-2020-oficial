...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.resultado.estatistica.koln.KolnResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new KolnCasaFragment(), "Jogos casa");
        adapter.addFragment(new KolnForaFragment(), "Jogos fora");
        adapter.addFragment(new KolnResultadoEstatisticaFragment(), "Estatística");
