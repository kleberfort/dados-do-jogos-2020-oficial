...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.resultado.estatistica.rennes.RennesResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new RennesCasaFragment(), "Jogos casa");
        adapter.addFragment(new RennesForaFragment(), "Jogos fora");
        adapter.addFragment(new RennesResultadoEstatisticaFragment(), "Estatística");
