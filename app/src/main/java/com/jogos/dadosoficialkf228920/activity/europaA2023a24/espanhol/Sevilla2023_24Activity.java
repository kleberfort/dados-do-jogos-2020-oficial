...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.resultado.estatistica.sevilla.SevillaResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new SevillaCasaFragment(), "Jogos casa");
        adapter.addFragment(new SevillaForaFragment(), "Jogos fora");
        adapter.addFragment(new SevillaResultadoEstatisticaFragment(), "Estatística");
