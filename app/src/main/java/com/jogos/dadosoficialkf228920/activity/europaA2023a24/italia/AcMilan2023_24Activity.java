...
import com.jogos.dadosoficialkf228920.databinding.ActivityMilan202324Binding;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.milan.MilanCasaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.milan.MilanForaFragment;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.resultado.estatistica.milan.MilanResultadoEstatisticaFragment;
...
public class AcMilan2023_24Activity extends AppCompatActivity {

    private ActivityMilan202324Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityMilan202324Binding.inflate(getLayoutInflater());
...
//                        .add("Casa 2023-24", MilanCasaFragment.class)
//                        .add("Fora 2023-24", MilanForaFragment.class)
//                        .create()
//        );
//
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new MilanCasaFragment(), "Jogos casa");
        adapter.addFragment(new MilanForaFragment(), "Jogos fora");
        adapter.addFragment(new MilanResultadoEstatisticaFragment(), "Estatística");
