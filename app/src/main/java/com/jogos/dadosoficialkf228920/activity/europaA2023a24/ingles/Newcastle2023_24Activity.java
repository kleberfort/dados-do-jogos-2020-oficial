...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.newcastle.NewcastleCasaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.newcastle.NewcastleForaFragment;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.resultado.estatistica.newcastle.NewcastleResultadoEstatisticaFragment;
...
public class Newcastle2023_24Activity extends AppCompatActivity {

    private ActivityNewcastle202324Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityNewcastle202324Binding.inflate(getLayoutInflater());
...
//                        .add("Casa 2023-24", NewcastleCasaFragment.class)
//                        .add("Fora 2023-24", NewcastleForaFragment.class)
//                        .create()
//        );
//
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new NewcastleCasaFragment(), "Jogos casa");
        adapter.addFragment(new NewcastleForaFragment(), "Jogos fora");
        adapter.addFragment(new NewcastleResultadoEstatisticaFragment(), "Estatística");
