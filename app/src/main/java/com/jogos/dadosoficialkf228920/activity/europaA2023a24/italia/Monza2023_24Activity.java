...
import com.jogos.dadosoficialkf228920.databinding.ActivityMonza202324Binding;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.monza.MonzaCasaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.monza.MonzaForaFragment;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.resultado.estatistica.monza.MonzaResultadoEstatisticaFragment;
...
public class Monza2023_24Activity extends AppCompatActivity {

    private ActivityMonza202324Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityMonza202324Binding.inflate(getLayoutInflater());
...
//                        .add("Casa 2023-24", MonzaCasaFragment.class)
//                        .add("Fora 2023-24", MonzaForaFragment.class)
//                        .create()
//        );
//
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new MonzaCasaFragment(), "Jogos casa");
        adapter.addFragment(new MonzaForaFragment(), "Jogos fora");
        adapter.addFragment(new MonzaResultadoEstatisticaFragment(), "Estatística");
