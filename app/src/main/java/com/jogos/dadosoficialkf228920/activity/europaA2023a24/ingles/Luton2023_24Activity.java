...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.resultado.estatistica.luton.LutonResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new LutonCasaFragment(), "Jogos casa");
        adapter.addFragment(new LutonForaFragment(), "Jogos fora");
        adapter.addFragment(new LutonResultadoEstatisticaFragment(), "Estatística");
