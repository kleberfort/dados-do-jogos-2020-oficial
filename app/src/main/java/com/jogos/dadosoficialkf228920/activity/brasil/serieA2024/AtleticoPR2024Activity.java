...
public class AtleticoPR2024Activity extends AppCompatActivity {

    private ActivityAtleticoPr2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAtleticoPr2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new AtleticoPRCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new AtleticoPRForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new AtleticoPREstatitisca2024Fragment(), "Estatística");
