...
import com.jogos.dadosoficialkf228920.databinding.ActivityTorino202324Binding;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.resultado.estatistica.torino.TorinoResultadoEstatisticaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.torino.TorinoCasaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.torino.TorinoForaFragment;
...
public class Torino2023_24Activity extends AppCompatActivity {

    private ActivityTorino202324Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityTorino202324Binding.inflate(getLayoutInflater());
...
//                        .add("Casa 2023-24", TorinoCasaFragment.class)
//                        .add("Fora 2023-24", TorinoForaFragment.class)
//                        .create()
//        );
//
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new TorinoCasaFragment(), "Jogos casa");
        adapter.addFragment(new TorinoForaFragment(), "Jogos fora");
        adapter.addFragment(new TorinoResultadoEstatisticaFragment(), "Estatística");
