...
import com.jogos.dadosoficialkf228920.databinding.ActivityFiorentina202324Binding;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.fiorentina.FiorentinaCasaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.fiorentina.FiorentinaForaFragment;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.resultado.estatistica.fiorentina.FiorentinaResultadoEstatisticaFragment;
...
public class Fiorentina2023_24Activity extends AppCompatActivity {

    private ActivityFiorentina202324Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityFiorentina202324Binding.inflate(getLayoutInflater());
...
//                        .add("Casa 2023-24", FiorentinaCasaFragment.class)
//                        .add("Fora 2023-24", FiorentinaForaFragment.class)
//                        .create()
//        );
//
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new FiorentinaCasaFragment(), "Jogos casa");
        adapter.addFragment(new FiorentinaForaFragment(), "Jogos fora");
        adapter.addFragment(new FiorentinaResultadoEstatisticaFragment(), "Estatística");
