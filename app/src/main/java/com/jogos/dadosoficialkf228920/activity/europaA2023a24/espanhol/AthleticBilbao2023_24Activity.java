...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.resultado.estatistica.athleticbilbao.BilbaoResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new AthleticBilbaoCasaFragment(), "Jogos casa");
        adapter.addFragment(new AthleticBilbaoForaFragment(), "Jogos fora");
        adapter.addFragment(new BilbaoResultadoEstatisticaFragment(), "Estatística");
