...
import com.jogos.dadosoficialkf228920.databinding.ActivityNapoli202324Binding;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.napoli.NapoliCasaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.napoli.NapoliForaFragment;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.resultado.estatistica.napoli.NapoliResultadoEstatisticaFragment;
...
public class Napoli2023_24Activity extends AppCompatActivity {

    private ActivityNapoli202324Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityNapoli202324Binding.inflate(getLayoutInflater());
...
//                        .add("Casa 2023-24", NapoliCasaFragment.class)
//                        .add("Fora 2023-24", NapoliForaFragment.class)
//                        .create()
//        );
//
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new NapoliCasaFragment(), "Jogos casa");
        adapter.addFragment(new NapoliForaFragment(), "Jogos fora");
        adapter.addFragment(new NapoliResultadoEstatisticaFragment(), "Estatística");
