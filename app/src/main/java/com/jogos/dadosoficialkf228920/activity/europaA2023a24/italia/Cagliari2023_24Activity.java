...
import com.jogos.dadosoficialkf228920.databinding.ActivityCagliari202324Binding;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.cagliari.CagliariCasaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.cagliari.CagliariForaFragment;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.resultado.estatistica.cagliari.CagliariResultadoEstatisticaFragment;
...
public class Cagliari2023_24Activity extends AppCompatActivity {

    private ActivityCagliari202324Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCagliari202324Binding.inflate(getLayoutInflater());
...
//                        .add("Casa 2023-24", CagliariCasaFragment.class)
//                        .add("Fora 2023-24", CagliariForaFragment.class)
//                        .create()
//        );
//
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new CagliariCasaFragment(), "Jogos casa");
        adapter.addFragment(new CagliariForaFragment(), "Jogos fora");
        adapter.addFragment(new CagliariResultadoEstatisticaFragment(), "Estatística");
