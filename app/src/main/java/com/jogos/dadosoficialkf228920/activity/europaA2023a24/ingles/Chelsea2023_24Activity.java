...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.resultado.estatistica.chelsea.ChelseaResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new ChelseaCasaFragment(), "Jogos casa");
        adapter.addFragment(new ChelseaForaFragment(), "Jogos fora");
        adapter.addFragment(new ChelseaResultadoEstatisticaFragment(), "Estatística");
