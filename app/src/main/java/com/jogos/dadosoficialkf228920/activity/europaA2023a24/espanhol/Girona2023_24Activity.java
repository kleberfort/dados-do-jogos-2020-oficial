...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.resultado.estatistica.girona.GironaResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new GironaCasaFragment(), "Jogos casa");
        adapter.addFragment(new GironaForaFragment(), "Jogos fora");
        adapter.addFragment(new GironaResultadoEstatisticaFragment(), "Estatística");
