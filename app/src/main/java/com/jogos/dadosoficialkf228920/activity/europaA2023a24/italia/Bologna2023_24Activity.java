...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.resultado.estatistica.bologna.BolognaResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new BolognaCasaFragment(), "Jogos casa");
        adapter.addFragment(new BolognaForaFragment(), "Jogos fora");
        adapter.addFragment(new BolognaResultadoEstatisticaFragment(), "Estatística");
