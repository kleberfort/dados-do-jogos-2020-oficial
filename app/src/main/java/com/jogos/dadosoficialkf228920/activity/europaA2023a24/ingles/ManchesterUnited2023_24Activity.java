...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.resultado.estatistica.manchesterunited.ManchesterUnitedResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new ManchesterUnitedCasaFragment(), "Jogos casa");
        adapter.addFragment(new ManchesterUnitedForaFragment(), "Jogos fora");
        adapter.addFragment(new ManchesterUnitedResultadoEstatisticaFragment(), "Estatística");
