...
import com.jogos.dadosoficialkf228920.databinding.ActivityClermont202324Binding;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.clermont.ClermontCasaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.clermont.ClermontForaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.resultado.estatistica.clermont.ClermontResultadoEstatisticaFragment;
...
public class Clermont2023_24Activity extends AppCompatActivity {

    private ActivityClermont202324Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityClermont202324Binding.inflate(getLayoutInflater());
...
//                        .add("Casa 2023-24", ClermontCasaFragment.class)
//                        .add("Fora 2023-24", ClermontForaFragment.class)
//                        .create()
//        );
//
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new ClermontCasaFragment(), "Jogos casa");
        adapter.addFragment(new ClermontForaFragment(), "Jogos fora");
        adapter.addFragment(new ClermontResultadoEstatisticaFragment(), "Estatística");
