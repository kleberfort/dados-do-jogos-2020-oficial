...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.resultado.estatistica.getafe.GetafeResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new GetafeCasaFragment(), "Jogos casa");
        adapter.addFragment(new GetafeForaFragment(), "Jogos fora");
        adapter.addFragment(new GetafeResultadoEstatisticaFragment(), "Estatística");
