...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.resultado.estatistica.nottinghamforest.NottinghamResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new NottinghamCasaFragment(), "Jogos casa");
        adapter.addFragment(new NottinghamForaFragment(), "Jogos fora");
        adapter.addFragment(new NottinghamResultadoEstatisticaFragment(), "Estatística");
