...
import com.jogos.dadosoficialkf228920.databinding.ActivityMetz202324Binding;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.metz.MetzCasaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.metz.MetzForaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.resultado.estatistica.metz.MetzResultadoEstatisticaFragment;
...
public class Metz2023_24Activity extends AppCompatActivity {

    private ActivityMetz202324Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityMetz202324Binding.inflate(getLayoutInflater());
...
//                        .add("Casa 2023-24", MetzCasaFragment.class)
//                        .add("Fora 2023-24", MetzForaFragment.class)
//                        .create()
//        );
//
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new MetzCasaFragment(), "Jogos casa");
        adapter.addFragment(new MetzForaFragment(), "Jogos fora");
        adapter.addFragment(new MetzResultadoEstatisticaFragment(), "Estatística");
