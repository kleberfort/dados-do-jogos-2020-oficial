...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.resultado.estatistica.frosinone.FrosinoneResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new FrosinoneCasaFragment(), "Jogos casa");
        adapter.addFragment(new FrosinoneForaFragment(), "Jogos fora");
        adapter.addFragment(new FrosinoneResultadoEstatisticaFragment(), "Estatística");
