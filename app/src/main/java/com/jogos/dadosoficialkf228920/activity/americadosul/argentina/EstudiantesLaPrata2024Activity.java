...
import com.jogos.dadosoficialkf228920.databinding.ActivityEstudiantesLaPrata2024Binding;
...
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.estudiantes_la_prata.estatistica_ui.EstudiantesLaPrataEstatisticaCasa2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.estudiantes_la_prata.estatistica_ui.EstudiantesLaPrataEstatisticaFora2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.estudiantes_la_prata.partidas_ui.EstudiantesLaPrataCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.estudiantes_la_prata.partidas_ui.EstudiantesLaPrataForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class EstudiantesLaPrata2024Activity extends AppCompatActivity {

    private ActivityEstudiantesLaPrata2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityEstudiantesLaPrata2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new EstudiantesLaPrataCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new EstudiantesLaPrataForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new EstudiantesLaPrataEstatisticaCasa2024Fragment(), "Estatística Casa");
        adapter.addFragment(new EstudiantesLaPrataEstatisticaFora2024Fragment(), "Estatística Fora");
