...
import com.jogos.dadosoficialkf228920.databinding.ActivityCrystalPalace202324Binding;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.crystalpalace.CrystalPalaceCasaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.crystalpalace.CrystalPalaceForaFragment;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.resultado.estatistica.crystalpalace.CrystalPalaceResultadoEstatisticaFragment;
...
public class CrystalPalace2023_24Activity extends AppCompatActivity {

    private ActivityCrystalPalace202324Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCrystalPalace202324Binding.inflate(getLayoutInflater());
...
//                        .add("Casa 2023-24", CrystalPalaceCasaFragment.class)
//                        .add("Fora 2023-24", CrystalPalaceForaFragment.class)
//                        .create()
//        );
//
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new CrystalPalaceCasaFragment(), "Jogos casa");
        adapter.addFragment(new CrystalPalaceForaFragment(), "Jogos fora");
        adapter.addFragment(new CrystalPalaceResultadoEstatisticaFragment(), "Estatística");
