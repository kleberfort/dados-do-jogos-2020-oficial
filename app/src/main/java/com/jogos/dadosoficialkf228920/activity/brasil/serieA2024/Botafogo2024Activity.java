...
import com.jogos.dadosoficialkf228920.fragments.brasil.serieA2024.botafogo_ui.estatistica_ui.BotafogoEstatistica2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieA2024.botafogo_ui.estatistica_ui.partidas_ui.BotafogoCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieA2024.botafogo_ui.estatistica_ui.partidas_ui.BotafogoForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class Botafogo2024Activity extends AppCompatActivity {

    private ActivityBotafogo2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityBotafogo2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new BotafogoCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new BotafogoForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new BotafogoEstatistica2024Fragment(), "Estatística");
