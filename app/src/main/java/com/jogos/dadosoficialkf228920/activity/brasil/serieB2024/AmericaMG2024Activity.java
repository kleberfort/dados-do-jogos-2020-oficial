...
import com.jogos.dadosoficialkf228920.databinding.ActivityAmericaMg2024Binding;
import com.jogos.dadosoficialkf228920.databinding.ActivityCeara2024Binding;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.americaMG_ui.estatistica_ui.AmericaMGEstatistica2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.americaMG_ui.estatistica_ui.partidas_ui.AmericaMGCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.americaMG_ui.estatistica_ui.partidas_ui.AmericaMGForaPartidas2024Fragment;
...
public class AmericaMG2024Activity extends AppCompatActivity {

    private ActivityAmericaMg2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAmericaMg2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new AmericaMGCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new AmericaMGForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new AmericaMGEstatistica2024Fragment(), "Estatística");
