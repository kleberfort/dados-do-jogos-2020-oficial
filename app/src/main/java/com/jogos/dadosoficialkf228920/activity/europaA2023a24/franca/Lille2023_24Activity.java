...
import com.jogos.dadosoficialkf228920.databinding.ActivityLille202324Binding;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.lille.LilleCasaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.lille.LilleForaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.resultado.estatistica.lille.LilleResultadoEstatisticaFragment;
...
public class Lille2023_24Activity extends AppCompatActivity {

    private ActivityLille202324Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLille202324Binding.inflate(getLayoutInflater());
...
//                        .add("Casa 2023-24", LilleCasaFragment.class)
//                        .add("Fora 2023-24", LilleForaFragment.class)
//                        .create()
//        );
//
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new LilleCasaFragment(), "Jogos casa");
        adapter.addFragment(new LilleForaFragment(), "Jogos fora");
        adapter.addFragment(new LilleResultadoEstatisticaFragment(), "Estatística");
