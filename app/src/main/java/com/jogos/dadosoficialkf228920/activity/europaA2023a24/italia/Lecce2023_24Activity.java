...
import com.jogos.dadosoficialkf228920.databinding.ActivityLecce202324Binding;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.lecce.LecceCasaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.lecce.LecceForaFragment;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.resultado.estatistica.lecce.LecceResultadoEstatisticaFragment;
...
public class Lecce2023_24Activity extends AppCompatActivity {

    private ActivityLecce202324Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLecce202324Binding.inflate(getLayoutInflater());
...
//                        .add("Casa 2023-24", LecceCasaFragment.class)
//                        .add("Fora 2023-24", LecceForaFragment.class)
//                        .create()
//        );
//
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new LecceCasaFragment(), "Jogos casa");
        adapter.addFragment(new LecceForaFragment(), "Jogos fora");
        adapter.addFragment(new LecceResultadoEstatisticaFragment(), "Estatística");
