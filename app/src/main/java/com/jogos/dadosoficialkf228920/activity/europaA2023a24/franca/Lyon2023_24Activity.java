...
import com.jogos.dadosoficialkf228920.databinding.ActivityLyon202324Binding;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.lyon.LyonCasaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.lyon.LyonForaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.resultado.estatistica.lyon.LyonResultadoEstatisticaFragment;
...
public class Lyon2023_24Activity extends AppCompatActivity {

    private ActivityLyon202324Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLyon202324Binding.inflate(getLayoutInflater());
...
//                        .add("Casa 2023-24", LyonCasaFragment.class)
//                        .add("Fora 2023-24", LyonForaFragment.class)
//                        .create()
//        );
//
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new LyonCasaFragment(), "Jogos casa");
        adapter.addFragment(new LyonForaFragment(), "Jogos fora");
        adapter.addFragment(new LyonResultadoEstatisticaFragment(), "Estatística");
