...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.resultado.estatistica.bayerleverkusen.BayerLeverkusenResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new BayerLeverkusenCasaFragment(), "Jogos casa");
        adapter.addFragment(new BayerLeverkusenForaFragment(), "Jogos fora");
        adapter.addFragment(new BayerLeverkusenResultadoEstatisticaFragment(), "Estatística");
