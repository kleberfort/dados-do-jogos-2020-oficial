...
import com.jogos.dadosoficialkf228920.databinding.ActivityLens202324Binding;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.lens.LensCasaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.lens.LensForaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.resultado.estatistica.lens.LensResultadoEstatisticaFragment;
...
public class Lens2023_24Activity extends AppCompatActivity {

    private ActivityLens202324Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLens202324Binding.inflate(getLayoutInflater());
...
//                        .add("Casa 2023-24", LensCasaFragment.class)
//                        .add("Fora 2023-24", LensForaFragment.class)
//                        .create()
//        );
//
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new LensCasaFragment(), "Jogos casa");
        adapter.addFragment(new LensForaFragment(), "Jogos fora");
        adapter.addFragment(new LensResultadoEstatisticaFragment(), "Estatística");
