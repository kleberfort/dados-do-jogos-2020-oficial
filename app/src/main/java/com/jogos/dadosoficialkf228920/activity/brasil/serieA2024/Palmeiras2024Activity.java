...
import com.jogos.dadosoficialkf228920.databinding.ActivityPalmeiras2024Binding;
...
import com.jogos.dadosoficialkf228920.fragments.brasil.serieA2024.palmeiras_ui.estatistica_ui.PalmeirasEstatistica2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieA2024.palmeiras_ui.estatistica_ui.partidas_ui.PalmeirasCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieA2024.palmeiras_ui.estatistica_ui.partidas_ui.PalmeirasForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class Palmeiras2024Activity extends AppCompatActivity {

    private ActivityPalmeiras2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPalmeiras2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new PalmeirasCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new PalmeirasForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new PalmeirasEstatistica2024Fragment(), "Estatística");
