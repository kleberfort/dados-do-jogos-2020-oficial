...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.resultado.estatistica.bayernmunique.BayernMuniqueResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new BayernMuniqueCasaFragment(), "Jogos casa");
        adapter.addFragment(new BayernMuniqueForaFragment(), "Jogos fora");
        adapter.addFragment(new BayernMuniqueResultadoEstatisticaFragment(), "Estatística");
