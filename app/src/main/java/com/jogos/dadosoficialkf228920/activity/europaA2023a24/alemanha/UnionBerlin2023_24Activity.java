...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.resultado.estatistica.unionberlin.UnionBerlinResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new UnionBerlinCasaFragment(), "Jogos casa");
        adapter.addFragment(new UnionBerlinForaFragment(), "Jogos fora");
        adapter.addFragment(new UnionBerlinResultadoEstatisticaFragment(), "Estatística");
