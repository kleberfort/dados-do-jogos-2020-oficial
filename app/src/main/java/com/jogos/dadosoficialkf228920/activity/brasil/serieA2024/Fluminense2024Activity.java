...
public class Fluminense2024Activity extends AppCompatActivity {

    private ActivityFluminense2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityFluminense2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new FluminenseCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new FluminenseForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new FluminenseEstatistica2024Fragment(), "Estatística");
