...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.resultado.estatistica.werderbremen.WerderBremenResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new WerderBremenCasaFragment(), "Jogos casa");
        adapter.addFragment(new WerderBremenForaFragment(), "Jogos fora");
        adapter.addFragment(new WerderBremenResultadoEstatisticaFragment(), "Estatística");
