...
import com.jogos.dadosoficialkf228920.databinding.ActivityAvai2024Binding;
import com.jogos.dadosoficialkf228920.databinding.ActivityCeara2024Binding;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.avai_ui.estatistica_ui.AvaiEstatistica2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.avai_ui.estatistica_ui.partidas_ui.AvaiCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.avai_ui.estatistica_ui.partidas_ui.AvaiForaPartidas2024Fragment;
...
public class Avai2024Activity extends AppCompatActivity {

    private ActivityAvai2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAvai2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new AvaiCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new AvaiForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new AvaiEstatistica2024Fragment(), "Estatística");
