...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.resultado.estatistica.barcelona.BarcelonaResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new BarcelonaCasaFragment(), "Jogos casa");
        adapter.addFragment(new BarcelonaForaFragment(), "Jogos fora");
        adapter.addFragment(new BarcelonaResultadoEstatisticaFragment(), "Estatística");
