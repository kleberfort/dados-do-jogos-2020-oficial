...
import com.jogos.dadosoficialkf228920.databinding.ActivityStrasbourg202324Binding;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.resultado.estatistica.strasbourg.StrasbourgResultadoEstatisticaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.strasbourg.StrasbourgCasaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.strasbourg.StrasbourgForaFragment;
...
public class Strasbourg2023_24Activity extends AppCompatActivity {

    private ActivityStrasbourg202324Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityStrasbourg202324Binding.inflate(getLayoutInflater());
...
//                        .add("Casa 2023-24", StrasbourgCasaFragment.class)
//                        .add("Fora 2023-24", StrasbourgForaFragment.class)
//                        .create()
//        );
//
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new StrasbourgCasaFragment(), "Jogos casa");
        adapter.addFragment(new StrasbourgForaFragment(), "Jogos fora");
        adapter.addFragment(new StrasbourgResultadoEstatisticaFragment(), "Estatística");
