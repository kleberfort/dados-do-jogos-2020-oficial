...
import com.jogos.dadosoficialkf228920.databinding.ActivityReims202324Binding;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.resultado.estatistica.reims.ReimsResultadoEstatisticaFragment;
...
public class Reims2023_24Activity extends AppCompatActivity {

    private ActivityReims202324Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityReims202324Binding.inflate(getLayoutInflater());
...
//                        .add("Casa 2023-24", ReimsCasaFragment.class)
//                        .add("Fora 2023-24", ReimsForaFragment.class)
//                        .create()
//        );
//
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new ReimsCasaFragment(), "Jogos casa");
        adapter.addFragment(new ReimsForaFragment(), "Jogos fora");
        adapter.addFragment(new ReimsResultadoEstatisticaFragment(), "Estatística");
