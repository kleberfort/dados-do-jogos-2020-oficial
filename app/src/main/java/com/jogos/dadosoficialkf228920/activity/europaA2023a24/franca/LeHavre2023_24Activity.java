...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.resultado.estatistica.lehavre.LeHavreResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new LeHavreCasaFragment(), "Jogos casa");
        adapter.addFragment(new LeHavreForaFragment(), "Jogos fora");
        adapter.addFragment(new LeHavreResultadoEstatisticaFragment(), "Estatística");
