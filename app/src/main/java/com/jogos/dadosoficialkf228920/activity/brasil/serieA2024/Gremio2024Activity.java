...
import com.jogos.dadosoficialkf228920.databinding.ActivityGremio2024Binding;
...
import com.jogos.dadosoficialkf228920.fragments.brasil.serieA2024.germio_ui.estatistica_ui.GremioEstatistica2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieA2024.germio_ui.estatistica_ui.partidas_ui.GremioCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieA2024.germio_ui.estatistica_ui.partidas_ui.GremioForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class Gremio2024Activity extends AppCompatActivity {

    private ActivityGremio2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityGremio2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new GremioCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new GremioForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new GremioEstatistica2024Fragment(), "Estatística");
