...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.resultado.estatistica.roma.RomaResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new RomaCasaFragment(), "Jogos casa");
        adapter.addFragment(new RomaForaFragment(), "Jogos fora");
        adapter.addFragment(new RomaResultadoEstatisticaFragment(), "Estatística");
