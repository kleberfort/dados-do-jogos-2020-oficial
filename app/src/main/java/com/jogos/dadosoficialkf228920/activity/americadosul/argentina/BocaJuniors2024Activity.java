...
import com.jogos.dadosoficialkf228920.databinding.ActivityBocaJuniors2024Binding;
...
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.boca_juniors.estatistica_ui.BocaJuniorsEstatisticaCasa2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.boca_juniors.estatistica_ui.BocaJuniorsEstatisticaFora2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.boca_juniors.partidas_ui.BocaJuniorsCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.boca_juniors.partidas_ui.BocaJuniorsForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class BocaJuniors2024Activity extends AppCompatActivity {

    private ActivityBocaJuniors2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityBocaJuniors2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new BocaJuniorsCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new BocaJuniorsForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new BocaJuniorsEstatisticaCasa2024Fragment(), "Estatística Casa");
        adapter.addFragment(new BocaJuniorsEstatisticaFora2024Fragment(), "Estatística Fora");
