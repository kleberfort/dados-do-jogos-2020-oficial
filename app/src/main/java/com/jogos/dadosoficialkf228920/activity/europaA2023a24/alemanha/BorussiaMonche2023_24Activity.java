...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.resultado.estatistica.borussiamonche.BorussiaMoncheResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new BorussiaMoncheCasaFragment(), "Jogos casa");
        adapter.addFragment(new BorussiaMoncheForaFragment(), "Jogos fora");
        adapter.addFragment(new BorussiaMoncheResultadoEstatisticaFragment(), "Estatística");
