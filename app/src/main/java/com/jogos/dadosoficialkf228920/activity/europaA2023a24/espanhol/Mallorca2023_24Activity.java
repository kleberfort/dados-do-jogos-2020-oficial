...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.resultado.estatistica.mallorca.MallorcaResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new MallorcaCasaFragment(), "Jogos casa");
        adapter.addFragment(new MallorcaForaFragment(), "Jogos fora");
        adapter.addFragment(new MallorcaResultadoEstatisticaFragment(), "Estatística");
