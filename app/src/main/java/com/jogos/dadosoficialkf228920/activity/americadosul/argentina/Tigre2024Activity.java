...
import com.jogos.dadosoficialkf228920.databinding.ActivityTigre2024Binding;
...
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.tigre.estatistica_ui.TigreEstatisticaCasa2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.tigre.estatistica_ui.TigreEstatisticaFora2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.tigre.partidas_ui.TigreCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.tigre.partidas_ui.TigreForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class Tigre2024Activity extends AppCompatActivity {

    private ActivityTigre2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityTigre2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new TigreCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new TigreForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new TigreEstatisticaCasa2024Fragment(), "Estatística Casa");
        adapter.addFragment(new TigreEstatisticaFora2024Fragment(), "Estatística Fora");
