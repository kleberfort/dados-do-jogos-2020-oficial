...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.resultado.estatistica.freiburg.FreiburgResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new FreiburgCasaFragment(), "Jogos casa");
        adapter.addFragment(new FreiburgForaFragment(), "Jogos fora");
        adapter.addFragment(new FreiburgResultadoEstatisticaFragment(), "Estatística");
