...
import com.jogos.dadosoficialkf228920.databinding.ActivitySalernitana202324Binding;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.resultado.estatistica.salernitana.SalernitanaResultadoEstatisticaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.salernitana.SalernitanaCasaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.salernitana.SalernitanaForaFragment;
...
public class Salernitana2023_24Activity extends AppCompatActivity {

    private ActivitySalernitana202324Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivitySalernitana202324Binding.inflate(getLayoutInflater());
...
//                        .add("Casa 2023-24", SalernitanaCasaFragment.class)
//                        .add("Fora 2023-24", SalernitanaForaFragment.class)
//                        .create()
//        );
//
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new SalernitanaCasaFragment(), "Jogos casa");
        adapter.addFragment(new SalernitanaForaFragment(), "Jogos fora");
        adapter.addFragment(new SalernitanaResultadoEstatisticaFragment(), "Estatística");
