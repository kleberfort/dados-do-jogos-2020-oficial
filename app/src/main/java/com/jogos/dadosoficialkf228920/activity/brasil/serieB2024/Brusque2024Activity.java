...
import com.jogos.dadosoficialkf228920.databinding.ActivityBrusque2024Binding;
import com.jogos.dadosoficialkf228920.databinding.ActivityCeara2024Binding;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.brusque_ui.estatistica_ui.BrusqueEstatistica2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.brusque_ui.estatistica_ui.partidas_ui.BrusqueCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.brusque_ui.estatistica_ui.partidas_ui.BrusqueForaPartidas2024Fragment;
...
public class Brusque2024Activity extends AppCompatActivity {

    private ActivityBrusque2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityBrusque2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new BrusqueCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new BrusqueForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new BrusqueEstatistica2024Fragment(), "Estatística");
