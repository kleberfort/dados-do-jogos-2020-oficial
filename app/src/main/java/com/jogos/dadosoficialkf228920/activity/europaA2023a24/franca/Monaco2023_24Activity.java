...
import com.jogos.dadosoficialkf228920.databinding.ActivityMonaco202324Binding;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.monaco.MonacoCasaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.monaco.MonacoForaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.resultado.estatistica.monaco.MonacoResultadoEstatisticaFragment;
...
public class Monaco2023_24Activity extends AppCompatActivity {

    private ActivityMonaco202324Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityMonaco202324Binding.inflate(getLayoutInflater());
...
//                        .add("Casa 2023-24", MonacoCasaFragment.class)
//                        .add("Fora 2023-24", MonacoForaFragment.class)
//                        .create()
//        );
//
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new MonacoCasaFragment(), "Jogos casa");
        adapter.addFragment(new MonacoForaFragment(), "Jogos fora");
        adapter.addFragment(new MonacoResultadoEstatisticaFragment(), "Estatística");
