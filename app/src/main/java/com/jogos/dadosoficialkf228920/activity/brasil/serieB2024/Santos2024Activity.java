...
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.santos_ui.estatistica_ui.SantosEstatistica2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.santos_ui.estatistica_ui.partidas_ui.SantosCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.santos_ui.estatistica_ui.partidas_ui.SantosForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class Santos2024Activity extends AppCompatActivity {

    private ActivitySantos2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivitySantos2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new SantosCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new SantosForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new SantosEstatistica2024Fragment(), "Estatística");
