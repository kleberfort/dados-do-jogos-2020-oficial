...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new AlavesCasaFragment(), "Jogos casa");
        adapter.addFragment(new AlavesForaFragment(), "Jogos fora");
        adapter.addFragment(new AlavesResultadoEstatisticaFragment(), "Estatística");
