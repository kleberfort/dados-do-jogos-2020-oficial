...
import com.jogos.dadosoficialkf228920.databinding.ActivityLazio202324Binding;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.lazio.LazioCasaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.lazio.LazioForaFragment;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.resultado.estatistica.lazio.LazioResultadoEstatisticaFragment;
...
public class Lazio2023_24Activity extends AppCompatActivity {

    private ActivityLazio202324Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLazio202324Binding.inflate(getLayoutInflater());
...
//                        .add("Casa 2023-24", LazioCasaFragment.class)
//                        .add("Fora 2023-24", LazioForaFragment.class)
//                        .create()
//        );
//
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new LazioCasaFragment(), "Jogos casa");
        adapter.addFragment(new LazioForaFragment(), "Jogos fora");
        adapter.addFragment(new LazioResultadoEstatisticaFragment(), "Estatística");
