...
import com.jogos.dadosoficialkf228920.databinding.ActivitySaoPaulo2024Binding;
...
import com.jogos.dadosoficialkf228920.fragments.brasil.serieA2024.sao_paulo_ui.estatistica_ui.SaoPauloEstatistica2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieA2024.sao_paulo_ui.estatistica_ui.partidas_ui.SaoPauloCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieA2024.sao_paulo_ui.estatistica_ui.partidas_ui.SaoPauloForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class SaoPaulo2024Activity extends AppCompatActivity {

    private ActivitySaoPaulo2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivitySaoPaulo2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new SaoPauloCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new SaoPauloForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new SaoPauloEstatistica2024Fragment(), "Estatística");
