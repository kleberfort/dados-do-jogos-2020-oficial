...
public class FlamengoActivity extends AppCompatActivity {
    ...
    private ActivityFlamengoA2023Binding binding;
    //private ActivityFlamengoBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityFlamengoA2023Binding.inflate(getLayoutInflater());
        ...
        FragmentPagerItemAdapter adapter = new FragmentPagerItemAdapter(
                ...
                FragmentPagerItems.with(getApplicationContext())
                        .add("Casa 2023", FlamengoCasa2023Fragment.class)
                        .add("Fora 2023", FlamengoFora2023Fragment.class)
                        .create()
        );
