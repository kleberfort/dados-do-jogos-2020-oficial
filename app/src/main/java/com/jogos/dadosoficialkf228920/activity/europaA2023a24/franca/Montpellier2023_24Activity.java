...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.resultado.estatistica.montpellier.MontpellierResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new MontpellierCasaFragment(), "Jogos casa");
        adapter.addFragment(new MontpellierForaFragment(), "Jogos fora");
        adapter.addFragment(new MontpellierResultadoEstatisticaFragment(), "Estatística");
