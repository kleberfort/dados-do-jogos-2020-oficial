...
import com.jogos.dadosoficialkf228920.databinding.ActivityUdinese202324Binding;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.resultado.estatistica.udinese.UdineseResultadoEstatisticaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.udinese.UdineseCasaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.udinese.UdineseForaFragment;
...
public class Udinese2023_24Activity extends AppCompatActivity {

    private ActivityUdinese202324Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityUdinese202324Binding.inflate(getLayoutInflater());
...
//                        .add("Casa 2023-24", UdineseCasaFragment.class)
//                        .add("Fora 2023-24", UdineseForaFragment.class)
//                        .create()
//        );
//
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new UdineseCasaFragment(), "Jogos casa");
        adapter.addFragment(new UdineseForaFragment(), "Jogos fora");
        adapter.addFragment(new UdineseResultadoEstatisticaFragment(), "Estatística");
