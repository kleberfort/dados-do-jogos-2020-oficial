...
import com.jogos.dadosoficialkf228920.databinding.ActivityAtalanta202324Binding;
...
public class Atalanta2023_24Activity extends AppCompatActivity {

    private ActivityAtalanta202324Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAtalanta202324Binding.inflate(getLayoutInflater());
...
//                        .add("Casa 2023-24", AtalantaCasaFragment.class)
//                        .add("Fora 2023-24", AtalantaForaFragment.class)
//                        .create()
//        );
//
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new AtalantaCasaFragment(), "Jogos casa");
        adapter.addFragment(new AtalantaForaFragment(), "Jogos fora");
        adapter.addFragment(new AtalantaResultadoEstatisticaFragment(), "Estatística");
