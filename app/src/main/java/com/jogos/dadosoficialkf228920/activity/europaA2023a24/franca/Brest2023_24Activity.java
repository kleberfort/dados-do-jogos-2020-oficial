...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.resultado.estatistica.brest.BrestResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new BrestCasaFragment(), "Jogos casa");
        adapter.addFragment(new BrestForaFragment(), "Jogos fora");
        adapter.addFragment(new BrestResultadoEstatisticaFragment(), "Estatística");
