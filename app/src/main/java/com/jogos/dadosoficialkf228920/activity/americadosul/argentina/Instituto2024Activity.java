...
import com.jogos.dadosoficialkf228920.databinding.ActivityInstituto2024Binding;
...
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.instituto.estatistica_ui.InstitutoEstatisticaCasa2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.instituto.estatistica_ui.InstitutoEstatisticaFora2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.instituto.partidas_ui.InstitutoCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.instituto.partidas_ui.InstitutoForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class Instituto2024Activity extends AppCompatActivity {

    private ActivityInstituto2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityInstituto2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new InstitutoCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new InstitutoForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new InstitutoEstatisticaCasa2024Fragment(), "Estatística Casa");
        adapter.addFragment(new InstitutoEstatisticaFora2024Fragment(), "Estatística Fora");
