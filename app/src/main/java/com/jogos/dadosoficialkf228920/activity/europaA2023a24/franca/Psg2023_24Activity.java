...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.resultado.estatistica.psg.PsgResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new PsgCasaFragment(), "Jogos casa");
        adapter.addFragment(new PsgForaFragment(), "Jogos fora");
        adapter.addFragment(new PsgResultadoEstatisticaFragment(), "Estatística");
