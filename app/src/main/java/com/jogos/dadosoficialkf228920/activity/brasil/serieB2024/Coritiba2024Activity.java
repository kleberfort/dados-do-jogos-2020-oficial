...
import com.jogos.dadosoficialkf228920.databinding.ActivityCoritiba2024Binding;
...
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.coritiba_ui.estatistica_ui.CoritibaEstatistica2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.coritiba_ui.estatistica_ui.partidas_ui.CoritibaCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieB2024.coritiba_ui.estatistica_ui.partidas_ui.CoritibaForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class Coritiba2024Activity extends AppCompatActivity {

    private ActivityCoritiba2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCoritiba2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new CoritibaCasaPartidas2024Fragment(), "Jogos casa");
       adapter.addFragment(new CoritibaForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new CoritibaEstatistica2024Fragment(), "Estatística");
