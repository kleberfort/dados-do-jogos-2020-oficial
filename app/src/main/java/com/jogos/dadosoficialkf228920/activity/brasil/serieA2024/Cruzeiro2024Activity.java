...
import com.jogos.dadosoficialkf228920.databinding.ActivityCruzeiro2024Binding;
...
import com.jogos.dadosoficialkf228920.fragments.brasil.serieA2024.cruzeiro_ui.estatistica_ui.CruzeiroEstatistica2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieA2024.cruzeiro_ui.estatistica_ui.partidas_ui.CruzeiroCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieA2024.cruzeiro_ui.estatistica_ui.partidas_ui.CruzeiroForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class Cruzeiro2024Activity extends AppCompatActivity {

    private ActivityCruzeiro2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCruzeiro2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new CruzeiroCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new CruzeiroForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new CruzeiroEstatistica2024Fragment(), "Estatística");
