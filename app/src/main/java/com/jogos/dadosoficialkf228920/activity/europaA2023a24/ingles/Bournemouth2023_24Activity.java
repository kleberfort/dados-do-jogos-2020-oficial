...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.resultado.estatistica.bournemouth.BounemouthResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new BournemouthCasaFragment(), "Jogos casa");
        adapter.addFragment(new BournemouthForaFragment(), "Jogos fora");
        adapter.addFragment(new BounemouthResultadoEstatisticaFragment(), "Estatística");
