...
import com.jogos.dadosoficialkf228920.databinding.ActivityBrighton202324Binding;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.brighton.BrightonCasaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.brighton.BrightonForaFragment;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.resultado.estatistica.brighton.BrightonResultadoEstatisticaFragment;
...
public class Brighton2023_24Activity extends AppCompatActivity {

    private ActivityBrighton202324Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityBrighton202324Binding.inflate(getLayoutInflater());
...
//                        .add("Casa 2023-24", BrightonCasaFragment.class)
//                        .add("Fora 2023-24", BrightonForaFragment.class)
//                        .create()
//        );
//
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new BrightonCasaFragment(), "Jogos casa");
        adapter.addFragment(new BrightonForaFragment(), "Jogos fora");
        adapter.addFragment(new BrightonResultadoEstatisticaFragment(), "Estatística");
