...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.resultado.estatistica.fulham.FulhamResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new FulhamCasaFragment(), "Jogos casa");
        adapter.addFragment(new FulhamForaFragment(), "Jogos fora");
        adapter.addFragment(new FulhamResultadoEstatisticaFragment(), "Estatística");
