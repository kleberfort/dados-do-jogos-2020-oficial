...
import com.jogos.dadosoficialkf228920.databinding.ActivityEmpoli202324Binding;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.empoli.EmpoliCasaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.empoli.EmpoliForaFragment;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.resultado.estatistica.empoli.EmpoliResultadoEstatisticaFragment;
...
public class Empoli2023_24Activity extends AppCompatActivity {

    private ActivityEmpoli202324Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityEmpoli202324Binding.inflate(getLayoutInflater());
...
//                        .add("Casa 2023-24", EmpoliCasaFragment.class)
//                        .add("Fora 2023-24", EmpoliForaFragment.class)
//                        .create()
//        );
//
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new EmpoliCasaFragment(), "Jogos casa");
        adapter.addFragment(new EmpoliForaFragment(), "Jogos fora");
        adapter.addFragment(new EmpoliResultadoEstatisticaFragment(), "Estatística");
