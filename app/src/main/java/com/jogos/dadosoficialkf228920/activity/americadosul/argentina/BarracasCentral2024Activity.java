...
import com.jogos.dadosoficialkf228920.databinding.ActivityBarracasCentral2024Binding;
...
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.barracas_central.estatistica_ui.BarracasCentralEstatisticaCasa2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.barracas_central.estatistica_ui.BarracasCentralEstatisticaFora2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.barracas_central.partidas_ui.BarracasCentralCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.barracas_central.partidas_ui.BarracasCentralForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class BarracasCentral2024Activity extends AppCompatActivity {

    private ActivityBarracasCentral2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityBarracasCentral2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new BarracasCentralCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new BarracasCentralForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new BarracasCentralEstatisticaCasa2024Fragment(), "Estatística Casa");
        adapter.addFragment(new BarracasCentralEstatisticaFora2024Fragment(), "Estatística Fora");
