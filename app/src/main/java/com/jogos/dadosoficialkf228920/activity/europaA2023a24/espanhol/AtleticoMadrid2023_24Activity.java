...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.resultado.estatistica.atleticomadrid.AtleticoResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new AtleticoMadridCasaFragment(), "Jogos casa");
        adapter.addFragment(new AtleticoMadridForaFragment(), "Jogos fora");
        adapter.addFragment(new AtleticoResultadoEstatisticaFragment(), "Estatística");
