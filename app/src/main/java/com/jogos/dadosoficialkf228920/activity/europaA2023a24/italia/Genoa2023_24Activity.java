...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.resultado.estatistica.genoa.GenoaResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new GenoaCasaFragment(), "Jogos casa");
        adapter.addFragment(new GenoaForaFragment(), "Jogos fora");
        adapter.addFragment(new GenoaResultadoEstatisticaFragment(), "Estatística");
