...
import com.jogos.dadosoficialkf228920.databinding.ActivityWestHam202324Binding;
...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.resultado.estatistica.westham.WestHamResultadoEstatisticaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.westham.WestHamCasaFragment;
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.westham.WestHamForaFragment;
...
public class WestHam2023_24Activity extends AppCompatActivity {

    private ActivityWestHam202324Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityWestHam202324Binding.inflate(getLayoutInflater());
...
//                        .add("Casa 2023-24", WestHamCasaFragment.class)
//                        .add("Fora 2023-24", WestHamForaFragment.class)
//                        .create()
//        );
//
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new WestHamCasaFragment(), "Jogos casa");
        adapter.addFragment(new WestHamForaFragment(), "Jogos fora");
        adapter.addFragment(new WestHamResultadoEstatisticaFragment(), "Estatística");
