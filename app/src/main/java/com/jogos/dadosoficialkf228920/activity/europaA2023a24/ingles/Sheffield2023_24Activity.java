...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.resultado.estatistica.sheffield.SheffieldResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new SheffieldCasaFragment(), "Jogos casa");
        adapter.addFragment(new SheffieldForaFragment(), "Jogos fora");
        adapter.addFragment(new SheffieldResultadoEstatisticaFragment(), "Estatística");
