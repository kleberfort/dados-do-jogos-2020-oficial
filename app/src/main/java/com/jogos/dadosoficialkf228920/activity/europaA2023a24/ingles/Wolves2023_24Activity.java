...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.resultado.estatistica.wolverhampton.WolvesResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new WolvesCasaFragment(), "Jogos casa");
        adapter.addFragment(new WolvesForaFragment(), "Jogos fora");
        adapter.addFragment(new WolvesResultadoEstatisticaFragment(), "Estatística");
