...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.resultado.estatistica.valencia.ValenciaResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new ValenciaCasaFragment(), "Jogos casa");
        adapter.addFragment(new ValenciaForaFragment(), "Jogos fora");
        adapter.addFragment(new ValenciaResultadoEstatisticaFragment(), "Estatística");
