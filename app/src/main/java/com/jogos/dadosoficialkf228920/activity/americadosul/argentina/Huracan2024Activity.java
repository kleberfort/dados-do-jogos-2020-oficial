...
import com.jogos.dadosoficialkf228920.databinding.ActivityHuracan2024Binding;
...
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.huracan.estatistica_ui.HuracanEstatisticaCasa2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.huracan.estatistica_ui.HuracanEstatisticaFora2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.huracan.partidas_ui.HuracanCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.huracan.partidas_ui.HuracanForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class Huracan2024Activity extends AppCompatActivity {

    private ActivityHuracan2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityHuracan2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new HuracanCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new HuracanForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new HuracanEstatisticaCasa2024Fragment(), "Estatística Casa");
        adapter.addFragment(new HuracanEstatisticaFora2024Fragment(), "Estatística Fora");
