...
import com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.resultado.estatistica.manchestercity.ManchesterCityResultadoEstatisticaFragment;
...
//        binding.viewPagerTab.setViewPager(binding.viewPager);
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new ManchesterCityCasaFragment(), "Jogos casa");
        adapter.addFragment(new ManchesterCityForaFragment(), "Jogos fora");
        adapter.addFragment(new ManchesterCityResultadoEstatisticaFragment(), "Estatística");
