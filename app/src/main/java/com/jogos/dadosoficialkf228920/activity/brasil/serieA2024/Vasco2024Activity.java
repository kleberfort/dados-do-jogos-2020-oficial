...
import com.jogos.dadosoficialkf228920.databinding.ActivityVasco2024Binding;
...
import com.jogos.dadosoficialkf228920.fragments.brasil.serieA2024.vasco_ui.estatistica_ui.VascoEstatistica2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieA2024.vasco_ui.estatistica_ui.partidas_ui.VascoCasaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.fragments.brasil.serieA2024.vasco_ui.estatistica_ui.partidas_ui.VascoForaPartidas2024Fragment;
import com.jogos.dadosoficialkf228920.model.ViewPagerAdapter;
import com.unity3d.services.banners.BannerErrorInfo;
import com.unity3d.services.banners.BannerView;
import com.unity3d.services.banners.UnityBannerSize;

public class Vasco2024Activity extends AppCompatActivity {

    private ActivityVasco2024Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityVasco2024Binding.inflate(getLayoutInflater());
    ...
    private void configTablayout(){
        ...
        adapter.addFragment(new VascoCasaPartidas2024Fragment(), "Jogos casa");
        adapter.addFragment(new VascoForaPartidas2024Fragment(), "Jogos fora");
        adapter.addFragment(new VascoEstatistica2024Fragment(), "Estatística");
