package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.marseille;
...
public class MarseilleForaAdapter extends RecyclerView.Adapter<MarseilleForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public MarseilleForaAdapter(List<Partida> augsburgFora) {
