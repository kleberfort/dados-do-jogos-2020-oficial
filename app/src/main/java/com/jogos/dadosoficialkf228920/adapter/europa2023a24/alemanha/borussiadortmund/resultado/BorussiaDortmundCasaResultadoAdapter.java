package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.borussiadortmund.resultado;
...
public class BorussiaDortmundCasaResultadoAdapter extends RecyclerView.Adapter<BorussiaDortmundCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public BorussiaDortmundCasaResultadoAdapter(List<Partida> augsburgCasa) {
