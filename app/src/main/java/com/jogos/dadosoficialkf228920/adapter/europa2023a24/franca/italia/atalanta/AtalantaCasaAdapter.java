package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.atalanta;
...
public class AtalantaCasaAdapter extends RecyclerView.Adapter<AtalantaCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public AtalantaCasaAdapter(List<Partida> augsburgCasa) {
