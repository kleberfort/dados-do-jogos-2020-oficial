...
public class FortalezaCasaA2023Adapter extends RecyclerView.Adapter<FortalezaCasaA2023Adapter.ViewHolder> {

    private List<Partida> fortalezaCasa2022;

    public FortalezaCasaA2023Adapter(List<Partida> fortalezaCasa2022) {
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaVitoriaCasa = fortalezaCasa2022.get(position);
