...
public class NottinhamForaResultadoAdapter extends RecyclerView.Adapter<NottinhamForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public NottinhamForaResultadoAdapter(List<Partida> augsburgFora) {
