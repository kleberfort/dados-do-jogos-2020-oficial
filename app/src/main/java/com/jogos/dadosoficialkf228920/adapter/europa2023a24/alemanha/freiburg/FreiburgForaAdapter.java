package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.freiburg;
...
public class FreiburgForaAdapter extends RecyclerView.Adapter<FreiburgForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public FreiburgForaAdapter(List<Partida> augsburgFora) {
