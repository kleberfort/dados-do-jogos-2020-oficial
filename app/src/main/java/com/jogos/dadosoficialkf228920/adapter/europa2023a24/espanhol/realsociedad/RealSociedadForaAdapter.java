...
public class RealSociedadForaAdapter extends RecyclerView.Adapter<RealSociedadForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public RealSociedadForaAdapter(List<Partida> augsburgFora) {
