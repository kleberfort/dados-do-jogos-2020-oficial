package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.napoli;
...
public class NapoliForaAdapter extends RecyclerView.Adapter<NapoliForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public NapoliForaAdapter(List<Partida> augsburgFora) {
