package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.intermilao.resultado;
...
public class InterMilaoCasaResultadoAdapter extends RecyclerView.Adapter<InterMilaoCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public InterMilaoCasaResultadoAdapter(List<Partida> augsburgCasa) {
