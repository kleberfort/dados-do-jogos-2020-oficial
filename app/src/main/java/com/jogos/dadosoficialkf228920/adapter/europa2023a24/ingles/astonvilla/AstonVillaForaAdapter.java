package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.astonvilla;
...
public class AstonVillaForaAdapter extends RecyclerView.Adapter<AstonVillaForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public AstonVillaForaAdapter(List<Partida> augsburgFora) {
