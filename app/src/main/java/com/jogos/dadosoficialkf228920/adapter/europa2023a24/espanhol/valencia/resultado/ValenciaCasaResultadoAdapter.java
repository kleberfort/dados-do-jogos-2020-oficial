package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.valencia.resultado;
...
public class ValenciaCasaResultadoAdapter extends RecyclerView.Adapter<ValenciaCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public ValenciaCasaResultadoAdapter(List<Partida> augsburgCasa) {
