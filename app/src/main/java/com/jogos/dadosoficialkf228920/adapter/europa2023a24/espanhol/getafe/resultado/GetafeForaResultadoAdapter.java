package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.getafe.resultado;
...
public class GetafeForaResultadoAdapter extends RecyclerView.Adapter<GetafeForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public GetafeForaResultadoAdapter(List<Partida> augsburgFora) {
