package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.genoa.resultado;
...
public class GenoaCasaResultadoAdapter extends RecyclerView.Adapter<GenoaCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public GenoaCasaResultadoAdapter(List<Partida> augsburgCasa) {
