package com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.crb.resultado;
...
public class CrbCsA2023RstdAdt extends RecyclerView.Adapter<CrbCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public CrbCsA2023RstdAdt(List<Partida> jogosCasa) {
