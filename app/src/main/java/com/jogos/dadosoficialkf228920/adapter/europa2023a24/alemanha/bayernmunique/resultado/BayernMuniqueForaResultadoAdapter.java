...
public class BayernMuniqueForaResultadoAdapter extends RecyclerView.Adapter<BayernMuniqueForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public BayernMuniqueForaResultadoAdapter(List<Partida> augsburgFora) {
