package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.liverpool.resultado;
...
public class LiverpoolForaResultadoAdapter extends RecyclerView.Adapter<LiverpoolForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public LiverpoolForaResultadoAdapter(List<Partida> augsburgFora) {
