...
public class FulhamForaResultadoAdapter extends RecyclerView.Adapter<FulhamForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public FulhamForaResultadoAdapter(List<Partida> augsburgFora) {
