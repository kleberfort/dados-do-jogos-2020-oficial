...
public class MontpellierCasaResultadoAdapter extends RecyclerView.Adapter<MontpellierCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public MontpellierCasaResultadoAdapter(List<Partida> augsburgCasa) {
