...
public class Darmstadt98CasaResultadoAdapter extends RecyclerView.Adapter<Darmstadt98CasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public Darmstadt98CasaResultadoAdapter(List<Partida> augsburgCasa) {
