...
public class HeidenheimForaAdapter extends RecyclerView.Adapter<HeidenheimForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public HeidenheimForaAdapter(List<Partida> augsburgFora) {
