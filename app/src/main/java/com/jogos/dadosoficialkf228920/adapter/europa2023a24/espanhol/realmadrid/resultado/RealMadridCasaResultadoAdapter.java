package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.realmadrid.resultado;
...
public class RealMadridCasaResultadoAdapter extends RecyclerView.Adapter<RealMadridCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public RealMadridCasaResultadoAdapter(List<Partida> augsburgCasa) {
