package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.lille.resultado;
...
public class LilleCasaResultadoAdapter extends RecyclerView.Adapter<LilleCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public LilleCasaResultadoAdapter(List<Partida> augsburgCasa) {
