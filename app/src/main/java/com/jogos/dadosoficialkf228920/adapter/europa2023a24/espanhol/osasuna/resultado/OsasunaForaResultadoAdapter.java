...
public class OsasunaForaResultadoAdapter extends RecyclerView.Adapter<OsasunaForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public OsasunaForaResultadoAdapter(List<Partida> augsburgFora) {
