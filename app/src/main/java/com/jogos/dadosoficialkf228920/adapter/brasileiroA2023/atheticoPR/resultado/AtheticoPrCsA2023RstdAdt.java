...
public class AtheticoPrCsA2023RstdAdt extends RecyclerView.Adapter<AtheticoPrCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public AtheticoPrCsA2023RstdAdt(List<Partida> jogosCasa) {
