package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.newcastle.resultado;
...
public class NewcastleCasaResultadoAdapter extends RecyclerView.Adapter<NewcastleCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public NewcastleCasaResultadoAdapter(List<Partida> augsburgCasa) {
