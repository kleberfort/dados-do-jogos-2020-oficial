package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.lens;
...
public class LensForaAdapter extends RecyclerView.Adapter<LensForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public LensForaAdapter(List<Partida> augsburgFora) {
