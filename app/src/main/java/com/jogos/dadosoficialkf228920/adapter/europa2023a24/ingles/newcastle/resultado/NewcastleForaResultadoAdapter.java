...
public class NewcastleForaResultadoAdapter extends RecyclerView.Adapter<NewcastleForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public NewcastleForaResultadoAdapter(List<Partida> augsburgFora) {
