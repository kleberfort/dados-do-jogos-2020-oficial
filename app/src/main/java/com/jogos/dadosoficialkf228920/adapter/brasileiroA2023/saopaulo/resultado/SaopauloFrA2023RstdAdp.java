...
public class SaopauloFrA2023RstdAdp extends RecyclerView.Adapter<SaopauloFrA2023RstdAdp.ViewHolder>{

    private List<Partida> jogosFora;

    public SaopauloFrA2023RstdAdp(List<Partida> jogosFora) {
