...
public class ArsenalForaResultadoAdapter extends RecyclerView.Adapter<ArsenalForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public ArsenalForaResultadoAdapter(List<Partida> augsburgFora) {
