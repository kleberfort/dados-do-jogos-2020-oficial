package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.realbetis.resultado;
...
public class RealBetisForaResultadoAdapter extends RecyclerView.Adapter<RealBetisForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public RealBetisForaResultadoAdapter(List<Partida> augsburgFora) {
