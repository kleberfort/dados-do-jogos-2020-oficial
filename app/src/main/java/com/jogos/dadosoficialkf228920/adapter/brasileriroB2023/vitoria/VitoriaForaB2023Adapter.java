...
public class VitoriaForaB2023Adapter extends RecyclerView.Adapter<VitoriaForaB2023Adapter.ViewHolder> {

    private List<Partida> vitoriaFora;

    public VitoriaForaB2023Adapter(List<Partida> vitoriaFora) {
        this.vitoriaFora = vitoriaFora;
    }
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaVitoriaFora = vitoriaFora.get(position);
