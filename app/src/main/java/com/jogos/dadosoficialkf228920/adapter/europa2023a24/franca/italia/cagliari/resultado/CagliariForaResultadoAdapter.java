...
public class CagliariForaResultadoAdapter extends RecyclerView.Adapter<CagliariForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public CagliariForaResultadoAdapter(List<Partida> augsburgFora) {
