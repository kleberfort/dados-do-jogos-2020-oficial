...
public class VillarrealForaResultadoAdapter extends RecyclerView.Adapter<VillarrealForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public VillarrealForaResultadoAdapter(List<Partida> augsburgFora) {
