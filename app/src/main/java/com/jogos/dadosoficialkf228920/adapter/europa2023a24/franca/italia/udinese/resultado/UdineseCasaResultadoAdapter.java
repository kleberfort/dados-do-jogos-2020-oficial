package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.udinese.resultado;
...
public class UdineseCasaResultadoAdapter extends RecyclerView.Adapter<UdineseCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public UdineseCasaResultadoAdapter(List<Partida> augsburgCasa) {
