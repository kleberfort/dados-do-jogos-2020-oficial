package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.barcelona.resultado;
...
public class BarcelonaCasaResultadoAdapter extends RecyclerView.Adapter<BarcelonaCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public BarcelonaCasaResultadoAdapter(List<Partida> augsburgCasa) {
