package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.milan;
...
public class MilanForaAdapter extends RecyclerView.Adapter<MilanForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public MilanForaAdapter(List<Partida> augsburgFora) {
