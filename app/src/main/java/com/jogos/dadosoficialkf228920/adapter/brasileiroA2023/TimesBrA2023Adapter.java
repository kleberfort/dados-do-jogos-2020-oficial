package com.jogos.dadosoficialkf228920.adapter.brasileiroA2023;
...
public class TimesBrA2023Adapter extends RecyclerView.Adapter<TimesBrA2023Adapter.ViewHolder> {

    private List<ClassificacaoOficial> listaTimes;

    public TimesBrA2023Adapter(List<ClassificacaoOficial> listaTimes) {
