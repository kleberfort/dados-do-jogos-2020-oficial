...
public class EmpoliCasaResultadoAdapter extends RecyclerView.Adapter<EmpoliCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public EmpoliCasaResultadoAdapter(List<Partida> augsburgCasa) {
