...
public class HellasVeronaForaResultadoAdapter extends RecyclerView.Adapter<HellasVeronaForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public HellasVeronaForaResultadoAdapter(List<Partida> augsburgFora) {
