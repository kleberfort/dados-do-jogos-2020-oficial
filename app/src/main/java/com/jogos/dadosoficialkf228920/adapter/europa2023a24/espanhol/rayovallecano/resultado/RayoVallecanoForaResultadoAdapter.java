package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.rayovallecano.resultado;
...
public class RayoVallecanoForaResultadoAdapter extends RecyclerView.Adapter<RayoVallecanoForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public RayoVallecanoForaResultadoAdapter(List<Partida> augsburgFora) {
