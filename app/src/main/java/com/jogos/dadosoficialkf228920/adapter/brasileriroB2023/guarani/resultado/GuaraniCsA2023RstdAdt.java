package com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.guarani.resultado;
...
public class GuaraniCsA2023RstdAdt extends RecyclerView.Adapter<GuaraniCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public GuaraniCsA2023RstdAdt(List<Partida> jogosCasa) {
