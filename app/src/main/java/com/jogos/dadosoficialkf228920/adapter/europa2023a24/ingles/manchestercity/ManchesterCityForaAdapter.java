package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.manchestercity;
...
public class ManchesterCityForaAdapter extends RecyclerView.Adapter<ManchesterCityForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public ManchesterCityForaAdapter(List<Partida> augsburgFora) {
