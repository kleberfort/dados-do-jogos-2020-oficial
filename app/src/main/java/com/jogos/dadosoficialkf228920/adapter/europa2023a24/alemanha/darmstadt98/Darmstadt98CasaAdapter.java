package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.darmstadt98;
...
public class Darmstadt98CasaAdapter extends RecyclerView.Adapter<Darmstadt98CasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public Darmstadt98CasaAdapter(List<Partida> augsburgCasa) {
