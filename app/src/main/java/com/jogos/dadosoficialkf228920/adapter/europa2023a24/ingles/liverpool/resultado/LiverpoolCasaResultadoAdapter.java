...
public class LiverpoolCasaResultadoAdapter extends RecyclerView.Adapter<LiverpoolCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public LiverpoolCasaResultadoAdapter(List<Partida> augsburgCasa) {
