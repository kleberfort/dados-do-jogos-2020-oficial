...
public class BorussiaDortmundForaResultadoAdapter extends RecyclerView.Adapter<BorussiaDortmundForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public BorussiaDortmundForaResultadoAdapter(List<Partida> augsburgFora) {
