package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.villarreal.resultado;
...
public class VillarrealCasaResultadoAdapter extends RecyclerView.Adapter<VillarrealCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public VillarrealCasaResultadoAdapter(List<Partida> augsburgCasa) {
