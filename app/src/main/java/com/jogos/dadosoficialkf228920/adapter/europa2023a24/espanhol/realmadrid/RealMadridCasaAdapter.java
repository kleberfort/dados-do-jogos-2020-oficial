...
public class RealMadridCasaAdapter extends RecyclerView.Adapter<RealMadridCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public RealMadridCasaAdapter(List<Partida> augsburgCasa) {
