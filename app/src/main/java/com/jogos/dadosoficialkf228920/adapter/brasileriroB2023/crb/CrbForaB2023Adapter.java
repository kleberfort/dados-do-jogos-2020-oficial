...
public class CrbForaB2023Adapter extends RecyclerView.Adapter<CrbForaB2023Adapter.ViewHolder> {

    private List<Partida> crbFora;
    
    public CrbForaB2023Adapter(List<Partida> crbFora) {
        this.crbFora = crbFora;
    }
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaCrbFora = crbFora.get(position);
