...
public class LazioForaResultadoAdapter extends RecyclerView.Adapter<LazioForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public LazioForaResultadoAdapter(List<Partida> augsburgFora) {
