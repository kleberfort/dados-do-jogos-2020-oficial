package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.athleticbilbao.resultado;
...
public class AthleticBilbaoCasaResultadoAdapter extends RecyclerView.Adapter<AthleticBilbaoCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public AthleticBilbaoCasaResultadoAdapter(List<Partida> augsburgCasa) {
