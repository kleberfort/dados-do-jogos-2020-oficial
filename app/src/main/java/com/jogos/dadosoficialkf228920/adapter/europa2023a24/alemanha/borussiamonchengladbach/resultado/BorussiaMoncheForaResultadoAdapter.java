...
public class BorussiaMoncheForaResultadoAdapter extends RecyclerView.Adapter<BorussiaMoncheForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public BorussiaMoncheForaResultadoAdapter(List<Partida> augsburgFora) {
