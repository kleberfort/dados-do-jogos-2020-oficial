...
public class UnionBerlinCasaResultadoAdapter extends RecyclerView.Adapter<UnionBerlinCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public UnionBerlinCasaResultadoAdapter(List<Partida> augsburgCasa) {
