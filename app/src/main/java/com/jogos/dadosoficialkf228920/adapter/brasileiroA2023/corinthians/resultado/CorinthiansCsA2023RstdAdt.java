...
public class CorinthiansCsA2023RstdAdt extends RecyclerView.Adapter<CorinthiansCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public CorinthiansCsA2023RstdAdt(List<Partida> jogosCasa) {
