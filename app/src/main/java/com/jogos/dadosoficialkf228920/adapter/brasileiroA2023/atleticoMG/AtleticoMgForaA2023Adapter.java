...
public class AtleticoMgForaA2023Adapter extends RecyclerView.Adapter<AtleticoMgForaA2023Adapter.ViewHolder> {

    private List<Partida> atleticoMgFora2022;

    public AtleticoMgForaA2023Adapter(List<Partida> atleticoMgFora2022) {
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaAvaiFora = atleticoMgFora2022.get(position);
