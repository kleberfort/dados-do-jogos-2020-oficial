package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.udinese;
...
public class UdineseForaAdapter extends RecyclerView.Adapter<UdineseForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public UdineseForaAdapter(List<Partida> augsburgFora) {
