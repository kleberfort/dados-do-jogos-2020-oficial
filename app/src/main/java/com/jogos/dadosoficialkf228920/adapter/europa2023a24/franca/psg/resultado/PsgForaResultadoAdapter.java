...
public class PsgForaResultadoAdapter extends RecyclerView.Adapter<PsgForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public PsgForaResultadoAdapter(List<Partida> augsburgFora) {
