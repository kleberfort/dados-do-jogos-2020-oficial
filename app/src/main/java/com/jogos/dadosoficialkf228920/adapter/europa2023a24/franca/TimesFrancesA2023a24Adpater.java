package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca;
...
public class TimesFrancesA2023a24Adpater extends RecyclerView.Adapter<TimesFrancesA2023a24Adpater.ViewHolder> {

    private List<ClassificacaoOficial> listaTimes;

    public TimesFrancesA2023a24Adpater(List<ClassificacaoOficial> listaTimes) {
