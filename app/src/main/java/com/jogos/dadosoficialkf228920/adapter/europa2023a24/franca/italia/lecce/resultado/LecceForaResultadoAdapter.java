package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.lecce.resultado;
...
public class LecceForaResultadoAdapter extends RecyclerView.Adapter<LecceForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public LecceForaResultadoAdapter(List<Partida> augsburgFora) {
