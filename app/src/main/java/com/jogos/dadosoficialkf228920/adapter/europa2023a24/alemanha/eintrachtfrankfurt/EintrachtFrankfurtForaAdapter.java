...
public class EintrachtFrankfurtForaAdapter extends RecyclerView.Adapter<EintrachtFrankfurtForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public EintrachtFrankfurtForaAdapter(List<Partida> augsburgFora) {
