package com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.fortaleza.resultado;
...
public class FortalezaFrA2023RstdAdp extends RecyclerView.Adapter<FortalezaFrA2023RstdAdp.ViewHolder>{

    private List<Partida> jogosFora;

    public FortalezaFrA2023RstdAdp(List<Partida> jogosFora) {
