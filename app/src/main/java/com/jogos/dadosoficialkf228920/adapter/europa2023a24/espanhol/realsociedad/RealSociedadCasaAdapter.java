package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.realsociedad;
...
public class RealSociedadCasaAdapter extends RecyclerView.Adapter<RealSociedadCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public RealSociedadCasaAdapter(List<Partida> augsburgCasa) {
