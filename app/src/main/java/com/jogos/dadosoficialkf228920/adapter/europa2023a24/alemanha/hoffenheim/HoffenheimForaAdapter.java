package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.hoffenheim;
...
public class HoffenheimForaAdapter extends RecyclerView.Adapter<HoffenheimForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public HoffenheimForaAdapter(List<Partida> augsburgFora) {
