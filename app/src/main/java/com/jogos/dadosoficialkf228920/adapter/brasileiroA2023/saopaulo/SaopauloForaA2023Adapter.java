...
public class SaopauloForaA2023Adapter extends RecyclerView.Adapter<SaopauloForaA2023Adapter.ViewHolder> {

    private List<Partida> saopauloFora2022;

    public SaopauloForaA2023Adapter(List<Partida> saopauloFora2022) {
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaPontePretaFora = saopauloFora2022.get(position);
