package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.nantes;
...
public class NantesCasaAdapter extends RecyclerView.Adapter<NantesCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public NantesCasaAdapter(List<Partida> augsburgCasa) {
