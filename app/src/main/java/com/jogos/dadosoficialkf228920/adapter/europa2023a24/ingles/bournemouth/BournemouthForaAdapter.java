...
public class BournemouthForaAdapter extends RecyclerView.Adapter<BournemouthForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public BournemouthForaAdapter(List<Partida> augsburgFora) {
