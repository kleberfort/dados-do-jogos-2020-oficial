...
public class FlamengoCsA2023RstdAdt extends RecyclerView.Adapter<FlamengoCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public FlamengoCsA2023RstdAdt(List<Partida> jogosCasa) {
