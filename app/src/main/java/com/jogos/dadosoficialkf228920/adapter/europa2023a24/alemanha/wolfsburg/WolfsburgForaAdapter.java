package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.wolfsburg;
...
public class WolfsburgForaAdapter extends RecyclerView.Adapter<WolfsburgForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public WolfsburgForaAdapter(List<Partida> augsburgFora) {
