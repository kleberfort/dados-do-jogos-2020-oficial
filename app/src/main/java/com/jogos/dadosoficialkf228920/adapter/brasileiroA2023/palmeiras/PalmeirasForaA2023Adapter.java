...
public class PalmeirasForaA2023Adapter extends RecyclerView.Adapter<PalmeirasForaA2023Adapter.ViewHolder> {

    private List<Partida> palmeirasFora2022;

    public PalmeirasForaA2023Adapter(List<Partida> palmeirasFora2022) {
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaSportFora = palmeirasFora2022.get(position);
