package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.westham.resultado;
...
public class WestHamForaResultadoAdapter extends RecyclerView.Adapter<WestHamForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public WestHamForaResultadoAdapter(List<Partida> augsburgFora) {
