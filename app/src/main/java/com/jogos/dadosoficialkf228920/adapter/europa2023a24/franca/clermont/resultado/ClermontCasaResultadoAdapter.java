package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.clermont.resultado;
...
public class ClermontCasaResultadoAdapter extends RecyclerView.Adapter<ClermontCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public ClermontCasaResultadoAdapter(List<Partida> augsburgCasa) {
