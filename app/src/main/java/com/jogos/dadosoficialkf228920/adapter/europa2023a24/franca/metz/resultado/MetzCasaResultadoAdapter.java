...
public class MetzCasaResultadoAdapter extends RecyclerView.Adapter<MetzCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public MetzCasaResultadoAdapter(List<Partida> augsburgCasa) {
