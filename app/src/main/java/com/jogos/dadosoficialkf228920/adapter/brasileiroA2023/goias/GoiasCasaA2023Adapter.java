...
public class GoiasCasaA2023Adapter extends RecyclerView.Adapter<GoiasCasaA2023Adapter.ViewHolder> {

    private List<Partida> goiasCasa;

    public GoiasCasaA2023Adapter(List<Partida> goiasCasa) {
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaGoiasCasa = goiasCasa.get(position);
