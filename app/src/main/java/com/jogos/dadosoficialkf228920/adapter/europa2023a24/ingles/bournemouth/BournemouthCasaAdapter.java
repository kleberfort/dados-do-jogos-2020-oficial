package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.bournemouth;
...
public class BournemouthCasaAdapter extends RecyclerView.Adapter<BournemouthCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public BournemouthCasaAdapter(List<Partida> augsburgCasa) {
