...
public class WerderBremenCasaResultadoAdapter extends RecyclerView.Adapter<WerderBremenCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public WerderBremenCasaResultadoAdapter(List<Partida> augsburgCasa) {
