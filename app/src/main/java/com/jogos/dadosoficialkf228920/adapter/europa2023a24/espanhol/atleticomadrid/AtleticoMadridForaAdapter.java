package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.atleticomadrid;
...
public class AtleticoMadridForaAdapter extends RecyclerView.Adapter<AtleticoMadridForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public AtleticoMadridForaAdapter(List<Partida> augsburgFora) {
