package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.lorient;
...
public class LorientCasaAdapter extends RecyclerView.Adapter<LorientCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public LorientCasaAdapter(List<Partida> augsburgCasa) {
