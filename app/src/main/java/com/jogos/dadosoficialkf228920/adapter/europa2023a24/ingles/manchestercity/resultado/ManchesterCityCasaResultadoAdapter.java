...
public class ManchesterCityCasaResultadoAdapter extends RecyclerView.Adapter<ManchesterCityCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public ManchesterCityCasaResultadoAdapter(List<Partida> augsburgCasa) {
