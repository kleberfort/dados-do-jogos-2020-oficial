...
public class KolnCasaResultadoAdapter extends RecyclerView.Adapter<KolnCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public KolnCasaResultadoAdapter(List<Partida> augsburgCasa) {
