...
public class TombenseForaB2023Adapter extends RecyclerView.Adapter<TombenseForaB2023Adapter.ViewHolder> {

    List<Partida> tombenseFora;

    public TombenseForaB2023Adapter(List<Partida> tombenseFora) {
        this.tombenseFora = tombenseFora;
    }
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaTombenseFora
 = tombenseFora.get(position);
