...
public class AthleticBilbaoForaAdapter extends RecyclerView.Adapter<AthleticBilbaoForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public AthleticBilbaoForaAdapter(List<Partida> augsburgFora) {
