package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.wolverhampton;
...
public class WolvesCasaAdapter extends RecyclerView.Adapter<WolvesCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public WolvesCasaAdapter(List<Partida> augsburgCasa) {
