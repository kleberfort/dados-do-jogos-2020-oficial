package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.sevilla;
...
public class SevillaForaAdapter extends RecyclerView.Adapter<SevillaForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public SevillaForaAdapter(List<Partida> augsburgFora) {
