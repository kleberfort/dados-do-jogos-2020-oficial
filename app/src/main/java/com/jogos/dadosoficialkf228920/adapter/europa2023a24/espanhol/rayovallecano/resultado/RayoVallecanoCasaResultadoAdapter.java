...
public class RayoVallecanoCasaResultadoAdapter extends RecyclerView.Adapter<RayoVallecanoCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public RayoVallecanoCasaResultadoAdapter(List<Partida> augsburgCasa) {
