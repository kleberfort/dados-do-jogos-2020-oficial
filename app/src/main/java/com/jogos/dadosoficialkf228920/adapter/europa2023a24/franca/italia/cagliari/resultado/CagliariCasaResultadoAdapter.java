package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.cagliari.resultado;
...
public class CagliariCasaResultadoAdapter extends RecyclerView.Adapter<CagliariCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public CagliariCasaResultadoAdapter(List<Partida> augsburgCasa) {
