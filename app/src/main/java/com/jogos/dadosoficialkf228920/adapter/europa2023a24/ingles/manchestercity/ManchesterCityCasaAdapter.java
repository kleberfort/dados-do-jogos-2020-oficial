...
public class ManchesterCityCasaAdapter extends RecyclerView.Adapter<ManchesterCityCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public ManchesterCityCasaAdapter(List<Partida> augsburgCasa) {
