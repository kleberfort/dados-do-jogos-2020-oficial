...
public class InterMilaoCasaAdapter extends RecyclerView.Adapter<InterMilaoCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public InterMilaoCasaAdapter(List<Partida> augsburgCasa) {
