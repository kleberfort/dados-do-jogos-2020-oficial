package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.everton;
...
public class EvertonCasaAdapter extends RecyclerView.Adapter<EvertonCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public EvertonCasaAdapter(List<Partida> augsburgCasa) {
