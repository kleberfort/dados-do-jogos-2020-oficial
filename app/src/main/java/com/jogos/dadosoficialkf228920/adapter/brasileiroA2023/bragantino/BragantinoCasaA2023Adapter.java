...
public class BragantinoCasaA2023Adapter extends RecyclerView.Adapter<BragantinoCasaA2023Adapter.ViewHolder> {

    private List<Partida> bragantinoCasa2022;

    public BragantinoCasaA2023Adapter(List<Partida> bragantinoCasa2022) {
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaChapecoenseCasa = bragantinoCasa2022.get(position);
