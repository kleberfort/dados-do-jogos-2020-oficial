package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.monaco;
...
public class MonacoCasaAdapter extends RecyclerView.Adapter<MonacoCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public MonacoCasaAdapter(List<Partida> augsburgCasa) {
