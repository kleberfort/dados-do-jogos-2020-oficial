package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.werderbremen.resultado;
...
public class WerderBremenForaResultadoAdapter extends RecyclerView.Adapter<WerderBremenForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public WerderBremenForaResultadoAdapter(List<Partida> augsburgFora) {
