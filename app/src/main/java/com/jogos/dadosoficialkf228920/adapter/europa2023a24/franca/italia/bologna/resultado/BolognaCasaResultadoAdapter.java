package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.bologna.resultado;
...
public class BolognaCasaResultadoAdapter extends RecyclerView.Adapter<BolognaCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public BolognaCasaResultadoAdapter(List<Partida> augsburgCasa) {
