...
public class ChapecoenseFrA2023RstdAdp extends RecyclerView.Adapter<ChapecoenseFrA2023RstdAdp.ViewHolder>{

    private List<Partida> jogosFora;

    public ChapecoenseFrA2023RstdAdp(List<Partida> jogosFora) {
