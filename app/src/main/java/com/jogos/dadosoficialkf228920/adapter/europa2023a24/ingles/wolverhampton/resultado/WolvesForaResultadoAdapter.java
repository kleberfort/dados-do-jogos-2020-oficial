package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.wolverhampton.resultado;
...
public class WolvesForaResultadoAdapter extends RecyclerView.Adapter<WolvesForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public WolvesForaResultadoAdapter(List<Partida> augsburgFora) {
