...
public class GenoaForaResultadoAdapter extends RecyclerView.Adapter<GenoaForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public GenoaForaResultadoAdapter(List<Partida> augsburgFora) {
