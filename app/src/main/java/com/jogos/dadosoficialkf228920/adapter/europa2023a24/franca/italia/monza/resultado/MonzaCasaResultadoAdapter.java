...
public class MonzaCasaResultadoAdapter extends RecyclerView.Adapter<MonzaCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public MonzaCasaResultadoAdapter(List<Partida> augsburgCasa) {
