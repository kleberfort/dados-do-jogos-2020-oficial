package com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.gremio.resultado;
...
public class GremioFrA2023RstdAdp extends RecyclerView.Adapter<GremioFrA2023RstdAdp.ViewHolder>{

    private List<Partida> jogosFora;

    public GremioFrA2023RstdAdp(List<Partida> jogosFora) {
