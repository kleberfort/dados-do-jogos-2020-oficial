...
public class AstonVillaForaResultadoAdapter extends RecyclerView.Adapter<AstonVillaForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public AstonVillaForaResultadoAdapter(List<Partida> augsburgFora) {
