...
public class HellasVeronaCasaAdapter extends RecyclerView.Adapter<HellasVeronaCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public HellasVeronaCasaAdapter(List<Partida> augsburgCasa) {
