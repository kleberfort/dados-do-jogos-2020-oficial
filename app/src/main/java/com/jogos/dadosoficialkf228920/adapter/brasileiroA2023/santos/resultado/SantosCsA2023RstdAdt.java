package com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.santos.resultado;
...
public class SantosCsA2023RstdAdt extends RecyclerView.Adapter<SantosCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public SantosCsA2023RstdAdt(List<Partida> jogosCasa) {
