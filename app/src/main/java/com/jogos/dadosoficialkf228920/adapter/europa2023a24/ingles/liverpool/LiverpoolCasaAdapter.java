package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.liverpool;
...
public class LiverpoolCasaAdapter extends RecyclerView.Adapter<LiverpoolCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public LiverpoolCasaAdapter(List<Partida> augsburgCasa) {
