package com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.palmeiras.resultado;
...
public class PalmeirasCsA2023RstdAdt extends RecyclerView.Adapter<PalmeirasCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public PalmeirasCsA2023RstdAdt(List<Partida> jogosCasa) {
