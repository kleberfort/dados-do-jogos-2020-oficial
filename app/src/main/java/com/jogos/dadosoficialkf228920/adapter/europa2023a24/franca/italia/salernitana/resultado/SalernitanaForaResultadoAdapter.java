...
public class SalernitanaForaResultadoAdapter extends RecyclerView.Adapter<SalernitanaForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public SalernitanaForaResultadoAdapter(List<Partida> augsburgFora) {
