package com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.cuiaba.resultado;
...
public class CuiabaCsA2023RstdAdt extends RecyclerView.Adapter<CuiabaCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public CuiabaCsA2023RstdAdt(List<Partida> jogosCasa) {
