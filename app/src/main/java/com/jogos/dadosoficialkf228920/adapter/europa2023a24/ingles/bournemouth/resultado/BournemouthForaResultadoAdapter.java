...
public class BournemouthForaResultadoAdapter extends RecyclerView.Adapter<BournemouthForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public BournemouthForaResultadoAdapter(List<Partida> augsburgFora) {
