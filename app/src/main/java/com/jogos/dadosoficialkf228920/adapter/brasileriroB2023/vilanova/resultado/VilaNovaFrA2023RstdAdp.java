...
public class VilaNovaFrA2023RstdAdp extends RecyclerView.Adapter<VilaNovaFrA2023RstdAdp.ViewHolder>{

    private List<Partida> jogosFora;

    public VilaNovaFrA2023RstdAdp(List<Partida> jogosFora) {
