package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.valencia;
...
public class ValenciaCasaAdapter extends RecyclerView.Adapter<ValenciaCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public ValenciaCasaAdapter(List<Partida> augsburgCasa) {
