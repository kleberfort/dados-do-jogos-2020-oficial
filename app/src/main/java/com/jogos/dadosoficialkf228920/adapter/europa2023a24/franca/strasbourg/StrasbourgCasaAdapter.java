...
public class StrasbourgCasaAdapter extends RecyclerView.Adapter<StrasbourgCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public StrasbourgCasaAdapter(List<Partida> augsburgCasa) {
