package com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.sampaiocorrea.resultado;
...
public class SampaioCorreaCsA2023RstdAdt extends RecyclerView.Adapter<SampaioCorreaCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public SampaioCorreaCsA2023RstdAdt(List<Partida> jogosCasa) {
