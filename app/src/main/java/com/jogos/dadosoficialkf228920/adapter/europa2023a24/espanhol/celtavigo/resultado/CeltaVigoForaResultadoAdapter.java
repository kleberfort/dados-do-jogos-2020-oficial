...
public class CeltaVigoForaResultadoAdapter extends RecyclerView.Adapter<CeltaVigoForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public CeltaVigoForaResultadoAdapter(List<Partida> augsburgFora) {
