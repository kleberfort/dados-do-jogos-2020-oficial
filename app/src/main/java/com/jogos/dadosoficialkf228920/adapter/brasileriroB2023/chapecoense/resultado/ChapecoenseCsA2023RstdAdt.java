package com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.chapecoense.resultado;
...
public class ChapecoenseCsA2023RstdAdt extends RecyclerView.Adapter<ChapecoenseCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public ChapecoenseCsA2023RstdAdt(List<Partida> jogosCasa) {
