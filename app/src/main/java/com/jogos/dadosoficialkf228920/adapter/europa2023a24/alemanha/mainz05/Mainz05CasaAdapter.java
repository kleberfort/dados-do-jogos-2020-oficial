package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.mainz05;
...
public class Mainz05CasaAdapter extends RecyclerView.Adapter<Mainz05CasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public Mainz05CasaAdapter(List<Partida> augsburgCasa) {
