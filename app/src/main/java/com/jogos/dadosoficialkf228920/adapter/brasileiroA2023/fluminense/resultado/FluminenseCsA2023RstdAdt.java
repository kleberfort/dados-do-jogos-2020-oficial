...
public class FluminenseCsA2023RstdAdt extends RecyclerView.Adapter<FluminenseCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public FluminenseCsA2023RstdAdt(List<Partida> jogosCasa) {
