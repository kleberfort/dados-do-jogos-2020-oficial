...
public class NovorizontinoCsA2023RstdAdt extends RecyclerView.Adapter<NovorizontinoCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public NovorizontinoCsA2023RstdAdt(List<Partida> jogosCasa) {
