package com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia;
...
public class ItaliaCptResultadoAdt extends RecyclerView.Adapter<ItaliaCptResultadoAdt.ViewHolder>{
    private List<Partida> augsburgCasa;

    public ItaliaCptResultadoAdt(List<Partida> augsburgCasa) {
