...
public class BarcelonaForaResultadoAdapter extends RecyclerView.Adapter<BarcelonaForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public BarcelonaForaResultadoAdapter(List<Partida> augsburgFora) {
