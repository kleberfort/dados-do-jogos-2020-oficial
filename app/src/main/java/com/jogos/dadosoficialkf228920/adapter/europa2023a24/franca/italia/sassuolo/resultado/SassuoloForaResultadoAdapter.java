package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.sassuolo.resultado;
...
public class SassuoloForaResultadoAdapter extends RecyclerView.Adapter<SassuoloForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public SassuoloForaResultadoAdapter(List<Partida> augsburgFora) {
