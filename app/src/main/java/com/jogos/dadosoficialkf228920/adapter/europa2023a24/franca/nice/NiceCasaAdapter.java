package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.nice;
...
public class NiceCasaAdapter extends RecyclerView.Adapter<NiceCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public NiceCasaAdapter(List<Partida> augsburgCasa) {
