...
public class LyonCasaResultadoAdapter extends RecyclerView.Adapter<LyonCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public LyonCasaResultadoAdapter(List<Partida> augsburgCasa) {
