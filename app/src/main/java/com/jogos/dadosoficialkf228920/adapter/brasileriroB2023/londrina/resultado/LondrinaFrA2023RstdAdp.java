...
public class LondrinaFrA2023RstdAdp extends RecyclerView.Adapter<LondrinaFrA2023RstdAdp.ViewHolder>{

    private List<Partida> jogosFora;

    public LondrinaFrA2023RstdAdp(List<Partida> jogosFora) {
