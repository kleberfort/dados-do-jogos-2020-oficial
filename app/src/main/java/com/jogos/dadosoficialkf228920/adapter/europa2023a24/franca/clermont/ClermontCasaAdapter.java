package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.clermont;
...
public class ClermontCasaAdapter extends RecyclerView.Adapter<ClermontCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public ClermontCasaAdapter(List<Partida> augsburgCasa) {
