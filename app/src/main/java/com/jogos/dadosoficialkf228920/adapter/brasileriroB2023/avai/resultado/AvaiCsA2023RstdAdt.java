package com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.avai.resultado;
...
public class AvaiCsA2023RstdAdt extends RecyclerView.Adapter<AvaiCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public AvaiCsA2023RstdAdt(List<Partida> jogosCasa) {
