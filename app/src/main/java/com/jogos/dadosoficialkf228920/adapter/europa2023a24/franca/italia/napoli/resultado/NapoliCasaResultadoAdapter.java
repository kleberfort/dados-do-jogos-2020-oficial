...
public class NapoliCasaResultadoAdapter extends RecyclerView.Adapter<NapoliCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public NapoliCasaResultadoAdapter(List<Partida> augsburgCasa) {
