package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.lehavre.resultado;
...
public class LeHavreForaResultadoAdapter extends RecyclerView.Adapter<LeHavreForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public LeHavreForaResultadoAdapter(List<Partida> augsburgFora) {
