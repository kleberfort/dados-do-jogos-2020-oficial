...
public class FreiburgForaResultadoAdapter extends RecyclerView.Adapter<FreiburgForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public FreiburgForaResultadoAdapter(List<Partida> augsburgFora) {
