package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.nottinghamforest;
...
public class NottinhamForaAdapter extends RecyclerView.Adapter<NottinhamForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public NottinhamForaAdapter(List<Partida> augsburgFora) {
