...
public class LutonForaResultadoAdapter extends RecyclerView.Adapter<LutonForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public LutonForaResultadoAdapter(List<Partida> augsburgFora) {
