...
public class FluminenseCasaA2023Adapter extends RecyclerView.Adapter<FluminenseCasaA2023Adapter.ViewHolder> {

    private List<Partida> fluminenseCasa2022;

    public FluminenseCasaA2023Adapter(List<Partida> fluminenseCasa2022) {
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaMirassolCasa = fluminenseCasa2022.get(position);
