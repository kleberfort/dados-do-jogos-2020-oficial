...
public class GranadaCasaResultadoAdapter extends RecyclerView.Adapter<GranadaCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public GranadaCasaResultadoAdapter(List<Partida> augsburgCasa) {
