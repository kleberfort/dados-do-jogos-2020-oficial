...
public class WerderBremenCasaAdapter extends RecyclerView.Adapter<WerderBremenCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public WerderBremenCasaAdapter(List<Partida> augsburgCasa) {
