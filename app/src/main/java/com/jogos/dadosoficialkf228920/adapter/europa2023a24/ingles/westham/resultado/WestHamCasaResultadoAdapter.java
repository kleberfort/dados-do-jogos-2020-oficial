...
public class WestHamCasaResultadoAdapter extends RecyclerView.Adapter<WestHamCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public WestHamCasaResultadoAdapter(List<Partida> augsburgCasa) {
