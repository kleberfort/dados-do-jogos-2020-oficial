package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.roma;
...
public class RomaCasaAdapter extends RecyclerView.Adapter<RomaCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public RomaCasaAdapter(List<Partida> augsburgCasa) {
