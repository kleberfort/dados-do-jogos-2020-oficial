...
public class NantesCasaResultadoAdapter extends RecyclerView.Adapter<NantesCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public NantesCasaResultadoAdapter(List<Partida> augsburgCasa) {
