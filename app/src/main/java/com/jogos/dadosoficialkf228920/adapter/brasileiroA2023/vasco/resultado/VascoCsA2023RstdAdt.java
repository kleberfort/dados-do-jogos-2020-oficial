package com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.vasco.resultado;
...
public class VascoCsA2023RstdAdt extends RecyclerView.Adapter<VascoCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public VascoCsA2023RstdAdt(List<Partida> jogosCasa) {
