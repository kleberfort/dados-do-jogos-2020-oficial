package com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.bahia.resultado;
...
public class BahiaCsA2023RstdAdt extends RecyclerView.Adapter<BahiaCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public BahiaCsA2023RstdAdt(List<Partida> jogosCasa) {
