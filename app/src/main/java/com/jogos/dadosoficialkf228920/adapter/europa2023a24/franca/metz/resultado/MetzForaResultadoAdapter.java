package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.metz.resultado;
...
public class MetzForaResultadoAdapter extends RecyclerView.Adapter<MetzForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public MetzForaResultadoAdapter(List<Partida> augsburgFora) {
