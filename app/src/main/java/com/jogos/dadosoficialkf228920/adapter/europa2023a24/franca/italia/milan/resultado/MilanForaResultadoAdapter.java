package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.milan.resultado;
...
public class MilanForaResultadoAdapter extends RecyclerView.Adapter<MilanForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public MilanForaResultadoAdapter(List<Partida> augsburgFora) {
