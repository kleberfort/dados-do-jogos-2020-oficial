package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.lazio;
...
public class LazioForaAdapter extends RecyclerView.Adapter<LazioForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public LazioForaAdapter(List<Partida> augsburgFora) {
