package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.salernitana.resultado;
...
public class SalernitanaCasaResultadoAdapter extends RecyclerView.Adapter<SalernitanaCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public SalernitanaCasaResultadoAdapter(List<Partida> augsburgCasa) {
