package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.hoffenheim.resultado;
...
public class HoffenheimCasaResultadoAdapter extends RecyclerView.Adapter<HoffenheimCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public HoffenheimCasaResultadoAdapter(List<Partida> augsburgCasa) {
