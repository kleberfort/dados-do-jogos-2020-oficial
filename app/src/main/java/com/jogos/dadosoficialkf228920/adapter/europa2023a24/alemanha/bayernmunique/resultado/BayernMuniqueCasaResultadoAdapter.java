package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.bayernmunique.resultado;
...
public class BayernMuniqueCasaResultadoAdapter extends RecyclerView.Adapter<BayernMuniqueCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public BayernMuniqueCasaResultadoAdapter(List<Partida> augsburgCasa) {
