...
public class InternacionalCasaA2023Adapter extends RecyclerView.Adapter<InternacionalCasaA2023Adapter.ViewHolder> {

    private List<Partida> internacionalCasa2022;

    public InternacionalCasaA2023Adapter(List<Partida> internacionalCasa2022) {
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaGuaraniCasa = internacionalCasa2022.get(position);
