...
public class BayerLeverkusenForaResultadoAdapter extends RecyclerView.Adapter<BayerLeverkusenForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public BayerLeverkusenForaResultadoAdapter(List<Partida> augsburgFora) {
