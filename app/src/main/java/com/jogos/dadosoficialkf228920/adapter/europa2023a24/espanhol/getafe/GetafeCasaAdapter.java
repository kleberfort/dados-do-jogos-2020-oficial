package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.getafe;
...
public class GetafeCasaAdapter extends RecyclerView.Adapter<GetafeCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public GetafeCasaAdapter(List<Partida> augsburgCasa) {
