package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.eintrachtfrankfurt.resultado;
...
public class EintrachtFrankfurtForaResultadoAdapter extends RecyclerView.Adapter<EintrachtFrankfurtForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public EintrachtFrankfurtForaResultadoAdapter(List<Partida> augsburgFora) {
