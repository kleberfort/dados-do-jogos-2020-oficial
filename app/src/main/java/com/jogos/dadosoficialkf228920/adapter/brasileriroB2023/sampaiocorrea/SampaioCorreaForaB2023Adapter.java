...
public class SampaioCorreaForaB2023Adapter extends RecyclerView.Adapter<SampaioCorreaForaB2023Adapter.ViewHolder> {

    private List<Partida> sampaioCorreaFora;

    public SampaioCorreaForaB2023Adapter(List<Partida> sampaioCorreaFora) {
        this.sampaioCorreaFora = sampaioCorreaFora;
    }
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaSampaioCorreaFora = sampaioCorreaFora.get(position);
