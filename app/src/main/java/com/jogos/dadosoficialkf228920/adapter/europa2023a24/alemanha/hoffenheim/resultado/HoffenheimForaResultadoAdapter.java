...
public class HoffenheimForaResultadoAdapter extends RecyclerView.Adapter<HoffenheimForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public HoffenheimForaResultadoAdapter(List<Partida> augsburgFora) {
