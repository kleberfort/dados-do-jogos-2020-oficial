package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.realmadrid;
...
public class RealMadridForaAdapter extends RecyclerView.Adapter<RealMadridForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public RealMadridForaAdapter(List<Partida> augsburgFora) {
