...
public class VillarrealCasaAdapter extends RecyclerView.Adapter<VillarrealCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public VillarrealCasaAdapter(List<Partida> augsburgCasa) {
