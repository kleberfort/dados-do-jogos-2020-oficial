package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.monaco.resultado;
...
public class MonacoForaResultadoAdapter extends RecyclerView.Adapter<MonacoForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public MonacoForaResultadoAdapter(List<Partida> augsburgFora) {
