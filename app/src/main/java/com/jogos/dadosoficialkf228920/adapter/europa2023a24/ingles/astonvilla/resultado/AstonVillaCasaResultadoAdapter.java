package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.astonvilla.resultado;
...
public class AstonVillaCasaResultadoAdapter extends RecyclerView.Adapter<AstonVillaCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public AstonVillaCasaResultadoAdapter(List<Partida> augsburgCasa) {
