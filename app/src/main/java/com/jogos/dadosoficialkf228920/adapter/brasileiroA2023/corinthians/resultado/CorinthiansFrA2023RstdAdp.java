package com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.corinthians.resultado;
...
public class CorinthiansFrA2023RstdAdp extends RecyclerView.Adapter<CorinthiansFrA2023RstdAdp.ViewHolder>{

    private List<Partida> jogosFora;

    public CorinthiansFrA2023RstdAdp(List<Partida> jogosFora) {
