package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.montpellier;
...
public class MontpellierForaAdapter extends RecyclerView.Adapter<MontpellierForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public MontpellierForaAdapter(List<Partida> augsburgFora) {
