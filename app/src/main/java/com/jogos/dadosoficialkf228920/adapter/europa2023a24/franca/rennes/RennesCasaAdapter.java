package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.rennes;
...
public class RennesCasaAdapter extends RecyclerView.Adapter<RennesCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public RennesCasaAdapter(List<Partida> augsburgCasa) {
