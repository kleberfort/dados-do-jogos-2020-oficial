...
public class LilleForaResultadoAdapter extends RecyclerView.Adapter<LilleForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public LilleForaResultadoAdapter(List<Partida> augsburgFora) {
