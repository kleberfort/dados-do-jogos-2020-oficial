...
public class ManchesterUnitedCasaResultadoAdapter extends RecyclerView.Adapter<ManchesterUnitedCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public ManchesterUnitedCasaResultadoAdapter(List<Partida> augsburgCasa) {
