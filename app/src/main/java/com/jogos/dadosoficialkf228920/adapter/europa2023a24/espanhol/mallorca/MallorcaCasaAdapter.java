package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.mallorca;
...
public class MallorcaCasaAdapter extends RecyclerView.Adapter<MallorcaCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public MallorcaCasaAdapter(List<Partida> augsburgCasa) {
