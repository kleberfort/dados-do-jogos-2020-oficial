...
public class FrancaCptResultadoAdt extends RecyclerView.Adapter<FrancaCptResultadoAdt.ViewHolder>{
    private List<Partida> augsburgCasa;

    public FrancaCptResultadoAdt(List<Partida> augsburgCasa) {
