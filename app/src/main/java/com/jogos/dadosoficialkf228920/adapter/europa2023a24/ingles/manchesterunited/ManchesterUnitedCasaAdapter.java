...
public class ManchesterUnitedCasaAdapter extends RecyclerView.Adapter<ManchesterUnitedCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public ManchesterUnitedCasaAdapter(List<Partida> augsburgCasa) {
