...
public class AtleticoMgCsA2023RstdAdt extends RecyclerView.Adapter<AtleticoMgCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public AtleticoMgCsA2023RstdAdt(List<Partida> jogosCasa) {
