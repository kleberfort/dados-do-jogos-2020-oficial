...
public class VilaNovaForaB2023Adapter extends RecyclerView.Adapter<VilaNovaForaB2023Adapter.ViewHolder> {

    private List<Partida> vilaNovaFora;

    public VilaNovaForaB2023Adapter(List<Partida> vilaNovaFora) {
        this.vilaNovaFora = vilaNovaFora;
    }
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaGoiasFora = vilaNovaFora.get(position);
