package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.montpellier.resultado;
...
public class MontpellierForaResultadoAdapter extends RecyclerView.Adapter<MontpellierForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public MontpellierForaResultadoAdapter(List<Partida> augsburgFora) {
