package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.monza.resultado;
...
public class MonzaForaResultadoAdapter extends RecyclerView.Adapter<MonzaForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public MonzaForaResultadoAdapter(List<Partida> augsburgFora) {
