package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.sheffield.resultado;
...
public class SheffieldForaResultadoAdapter extends RecyclerView.Adapter<SheffieldForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public SheffieldForaResultadoAdapter(List<Partida> augsburgFora) {
