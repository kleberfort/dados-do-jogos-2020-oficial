package com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.pontepreta.resultado;
...
public class PontePretaCsA2023RstdAdt extends RecyclerView.Adapter<PontePretaCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public PontePretaCsA2023RstdAdt(List<Partida> jogosCasa) {
