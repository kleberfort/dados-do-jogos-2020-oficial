package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.strasbourg;
...
public class StrasbourgForaAdapter extends RecyclerView.Adapter<StrasbourgForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public StrasbourgForaAdapter(List<Partida> augsburgFora) {
