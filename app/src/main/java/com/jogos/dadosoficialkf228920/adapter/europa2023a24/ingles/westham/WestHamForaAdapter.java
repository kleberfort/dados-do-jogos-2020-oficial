package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.westham;
...
public class WestHamForaAdapter extends RecyclerView.Adapter<WestHamForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public WestHamForaAdapter(List<Partida> augsburgFora) {
