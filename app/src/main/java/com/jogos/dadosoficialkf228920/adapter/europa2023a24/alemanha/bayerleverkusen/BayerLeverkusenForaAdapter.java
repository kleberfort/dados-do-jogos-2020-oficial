package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.bayerleverkusen;
...
public class BayerLeverkusenForaAdapter extends RecyclerView.Adapter<BayerLeverkusenForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public BayerLeverkusenForaAdapter(List<Partida> augsburgFora) {
