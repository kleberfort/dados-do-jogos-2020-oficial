...
public class BragantinoCsA2023RstdAdt extends RecyclerView.Adapter<BragantinoCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public BragantinoCsA2023RstdAdt(List<Partida> jogosCasa) {
