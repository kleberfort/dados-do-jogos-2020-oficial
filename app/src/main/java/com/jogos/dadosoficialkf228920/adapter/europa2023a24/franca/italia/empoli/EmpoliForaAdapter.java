package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.empoli;
...
public class EmpoliForaAdapter extends RecyclerView.Adapter<EmpoliForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public EmpoliForaAdapter(List<Partida> augsburgFora) {
