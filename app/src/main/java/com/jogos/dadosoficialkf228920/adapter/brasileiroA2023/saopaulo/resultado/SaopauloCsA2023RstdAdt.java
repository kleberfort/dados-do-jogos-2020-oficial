package com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.saopaulo.resultado;
...
public class SaopauloCsA2023RstdAdt extends RecyclerView.Adapter<SaopauloCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public SaopauloCsA2023RstdAdt(List<Partida> jogosCasa) {
