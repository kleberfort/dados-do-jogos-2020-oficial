package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol;
...
public class TimesEspanholA2023a24Adapter extends RecyclerView.Adapter<TimesEspanholA2023a24Adapter.ViewHolder> {

    private List<ClassificacaoOficial> listaTimes;

    public TimesEspanholA2023a24Adapter(List<ClassificacaoOficial> listaTimes) {
