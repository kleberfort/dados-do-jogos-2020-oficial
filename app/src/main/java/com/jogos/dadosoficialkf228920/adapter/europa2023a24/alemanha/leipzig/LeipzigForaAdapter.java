package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.leipzig;
...
public class LeipzigForaAdapter extends RecyclerView.Adapter<LeipzigForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public LeipzigForaAdapter(List<Partida> augsburgFora) {
