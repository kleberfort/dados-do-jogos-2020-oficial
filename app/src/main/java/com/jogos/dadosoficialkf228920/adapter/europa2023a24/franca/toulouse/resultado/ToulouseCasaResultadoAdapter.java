...
public class ToulouseCasaResultadoAdapter extends RecyclerView.Adapter<ToulouseCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public ToulouseCasaResultadoAdapter(List<Partida> augsburgCasa) {
