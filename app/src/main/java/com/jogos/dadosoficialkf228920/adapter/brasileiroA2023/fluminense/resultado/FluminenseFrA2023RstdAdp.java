package com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.fluminense.resultado;
...
public class FluminenseFrA2023RstdAdp extends RecyclerView.Adapter<FluminenseFrA2023RstdAdp.ViewHolder>{

    private List<Partida> jogosFora;

    public FluminenseFrA2023RstdAdp(List<Partida> jogosFora) {
