package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.tottenham;
...
public class TottenhamForaAdapter extends RecyclerView.Adapter<TottenhamForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public TottenhamForaAdapter(List<Partida> augsburgFora) {
