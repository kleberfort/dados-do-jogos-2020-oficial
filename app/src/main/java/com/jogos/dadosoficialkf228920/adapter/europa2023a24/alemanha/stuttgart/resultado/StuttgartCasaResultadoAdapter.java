...
public class StuttgartCasaResultadoAdapter extends RecyclerView.Adapter<StuttgartCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public StuttgartCasaResultadoAdapter(List<Partida> augsburgCasa) {
