...
public class PontePretaFrA2023RstdAdp extends RecyclerView.Adapter<PontePretaFrA2023RstdAdp.ViewHolder>{

    private List<Partida> jogosFora;

    public PontePretaFrA2023RstdAdp(List<Partida> jogosFora) {
