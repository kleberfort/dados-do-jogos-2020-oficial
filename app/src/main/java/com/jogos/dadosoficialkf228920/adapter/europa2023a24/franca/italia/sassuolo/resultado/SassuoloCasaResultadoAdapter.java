...
public class SassuoloCasaResultadoAdapter extends RecyclerView.Adapter<SassuoloCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public SassuoloCasaResultadoAdapter(List<Partida> augsburgCasa) {
