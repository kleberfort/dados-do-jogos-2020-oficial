package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.leipzig.resultado;
...
public class LeipzigCasaResultadoAdapter extends RecyclerView.Adapter<LeipzigCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public LeipzigCasaResultadoAdapter(List<Partida> augsburgCasa) {
