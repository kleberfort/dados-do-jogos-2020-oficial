package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.unionberlin;
...
public class UnionBerlinForaAdapter extends RecyclerView.Adapter<UnionBerlinForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public UnionBerlinForaAdapter(List<Partida> augsburgFora) {
