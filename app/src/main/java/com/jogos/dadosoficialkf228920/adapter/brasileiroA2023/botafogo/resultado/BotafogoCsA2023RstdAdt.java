package com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.botafogo.resultado;
...
public class BotafogoCsA2023RstdAdt extends RecyclerView.Adapter<BotafogoCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public BotafogoCsA2023RstdAdt(List<Partida> jogosCasa) {
