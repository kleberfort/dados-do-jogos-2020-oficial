...
public class Mainz05CasaResultadoAdapter extends RecyclerView.Adapter<Mainz05CasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public Mainz05CasaResultadoAdapter(List<Partida> augsburgCasa) {
