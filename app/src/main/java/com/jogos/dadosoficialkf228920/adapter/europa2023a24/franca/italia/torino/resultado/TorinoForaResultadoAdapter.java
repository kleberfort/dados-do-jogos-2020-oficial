...
public class TorinoForaResultadoAdapter extends RecyclerView.Adapter<TorinoForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public TorinoForaResultadoAdapter(List<Partida> augsburgFora) {
