package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.toulouse;
...
public class ToulouseForaAdapter extends RecyclerView.Adapter<ToulouseForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public ToulouseForaAdapter(List<Partida> augsburgFora) {
