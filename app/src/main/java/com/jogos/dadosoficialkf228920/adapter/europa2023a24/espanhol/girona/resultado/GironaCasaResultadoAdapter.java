package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.girona.resultado;
...
public class GironaCasaResultadoAdapter extends RecyclerView.Adapter<GironaCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public GironaCasaResultadoAdapter(List<Partida> augsburgCasa) {
