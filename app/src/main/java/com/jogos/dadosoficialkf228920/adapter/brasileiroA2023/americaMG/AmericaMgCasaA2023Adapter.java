...
public class AmericaMgCasaA2023Adapter extends RecyclerView.Adapter<AmericaMgCasaA2023Adapter.ViewHolder> {

    private List<Partida> americaMgCasa2022;

    public AmericaMgCasaA2023Adapter(List<Partida> americaMgCasa2022) {
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        /* Cartoes */
        holder.binding.cartaoAmrlCs.setText(String.valueOf(listaPartidaAmericaMgCasa.getHomeCartoes().getAmarelo()));
        holder.binding.cartaoAmrlFr.setText(String.valueOf(listaPartidaAmericaMgCasa.getAwayCartoes().getAmarelo()));
        holder.binding.cartaoVmlCs.setText(String.valueOf(listaPartidaAmericaMgCasa.getHomeCartoes().getVermelho()));
        holder.binding.cartaoVmlFr.setText(String.valueOf(listaPartidaAmericaMgCasa.getAwayCartoes().getVermelho()));
        holder.binding.cartaoTotalAmrl.setText(String.valueOf(listaPartidaAmericaMgCasa.getHomeCartoes().getAmarelo() + listaPartidaAmericaMgCasa.getAwayCartoes().getAmarelo()));
        holder.binding.cartaoTotalVml.setText(String.valueOf(listaPartidaAmericaMgCasa.getHomeCartoes().getVermelho() + listaPartidaAmericaMgCasa.getAwayCartoes().getVermelho()));
