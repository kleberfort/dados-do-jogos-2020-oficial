package com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.abc.resultado;
...
public class AbcCsA2023RstdAdt extends RecyclerView.Adapter<AbcCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public AbcCsA2023RstdAdt(List<Partida> jogosCasa) {
