...
public class AvaiCasaB2023Adapter extends RecyclerView.Adapter<AvaiCasaB2023Adapter.ViewHolder> {
    private List<Partida> avaiCasa;

    public AvaiCasaB2023Adapter(List<Partida> avaiCasa) {
        this.avaiCasa = avaiCasa;
    }
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaAvaiCasa = avaiCasa.get(position);
