package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.marseille.resultado;
...
public class MarseilleCasaResultadoAdapter extends RecyclerView.Adapter<MarseilleCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public MarseilleCasaResultadoAdapter(List<Partida> augsburgCasa) {
