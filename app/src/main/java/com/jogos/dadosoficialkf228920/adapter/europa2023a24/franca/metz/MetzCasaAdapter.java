package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.metz;
...
public class MetzCasaAdapter extends RecyclerView.Adapter<MetzCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public MetzCasaAdapter(List<Partida> augsburgCasa) {
