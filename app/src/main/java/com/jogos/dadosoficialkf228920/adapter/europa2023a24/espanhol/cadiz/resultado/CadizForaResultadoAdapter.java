...
public class CadizForaResultadoAdapter extends RecyclerView.Adapter<CadizForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public CadizForaResultadoAdapter(List<Partida> augsburgFora) {
