package com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.americaMG.resultado;
...
public class AmericaMgFrA2023RstdAdp extends RecyclerView.Adapter<AmericaMgFrA2023RstdAdp.ViewHolder>{

    private List<Partida> jogosFora;

    public AmericaMgFrA2023RstdAdp(List<Partida> jogosFora) {
