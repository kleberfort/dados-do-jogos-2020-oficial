package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.girona;
...
public class GironaForaAdapter extends RecyclerView.Adapter<GironaForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public GironaForaAdapter(List<Partida> augsburgFora) {
