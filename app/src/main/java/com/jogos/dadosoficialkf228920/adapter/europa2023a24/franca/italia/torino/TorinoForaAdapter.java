package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.torino;
...
public class TorinoForaAdapter extends RecyclerView.Adapter<TorinoForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public TorinoForaAdapter(List<Partida> augsburgFora) {
