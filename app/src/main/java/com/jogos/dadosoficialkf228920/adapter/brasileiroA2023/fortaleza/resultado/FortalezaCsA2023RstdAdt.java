...
public class FortalezaCsA2023RstdAdt extends RecyclerView.Adapter<FortalezaCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public FortalezaCsA2023RstdAdt(List<Partida> jogosCasa) {
