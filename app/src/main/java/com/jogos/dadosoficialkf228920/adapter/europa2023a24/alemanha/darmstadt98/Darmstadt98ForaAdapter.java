...
public class Darmstadt98ForaAdapter extends RecyclerView.Adapter<Darmstadt98ForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public Darmstadt98ForaAdapter(List<Partida> augsburgFora) {
