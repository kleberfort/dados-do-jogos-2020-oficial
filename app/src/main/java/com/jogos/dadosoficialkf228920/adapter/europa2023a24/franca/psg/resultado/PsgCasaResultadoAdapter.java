package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.psg.resultado;
...
public class PsgCasaResultadoAdapter extends RecyclerView.Adapter<PsgCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public PsgCasaResultadoAdapter(List<Partida> augsburgCasa) {
