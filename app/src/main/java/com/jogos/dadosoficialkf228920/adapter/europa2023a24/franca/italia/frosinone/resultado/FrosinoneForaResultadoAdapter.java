package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.frosinone.resultado;
...
public class FrosinoneForaResultadoAdapter extends RecyclerView.Adapter<FrosinoneForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public FrosinoneForaResultadoAdapter(List<Partida> augsburgFora) {
