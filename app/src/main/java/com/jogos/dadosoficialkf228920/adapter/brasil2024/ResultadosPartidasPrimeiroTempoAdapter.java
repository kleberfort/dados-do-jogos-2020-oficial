...
public class ResultadosPartidasPrimeiroTempoAdapter extends RecyclerView.Adapter<ResultadosPartidasPrimeiroTempoAdapter.ViewHolder> {
    ...
    public ResultadosPartidasPrimeiroTempoAdapter(List<MatchNewModelDate> resultados) {
    ...
    public void onBindViewHolder(@NonNull ResultadosPartidasPrimeiroTempoAdapter.ViewHolder holder, int position) {
        ...
        MatchNewModelDate result = lista.get(position);
            ...
            holder.binding.tvPlacarCasa.setText(String.valueOf(result.getHomeEstatisticaJogo().getGolsPrimeiroTempo()));
            holder.binding.tvPlacarFora.setText(String.valueOf(result.getAwayEstatisticaJogo().getGolsPrimeiroTempo()));
