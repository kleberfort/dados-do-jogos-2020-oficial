...
public class ChelseaCasaResultadoAdapter extends RecyclerView.Adapter<ChelseaCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public ChelseaCasaResultadoAdapter(List<Partida> augsburgCasa) {
