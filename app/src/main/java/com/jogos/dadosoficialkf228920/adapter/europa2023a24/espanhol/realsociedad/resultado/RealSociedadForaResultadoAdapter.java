package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.realsociedad.resultado;
...
public class RealSociedadForaResultadoAdapter extends RecyclerView.Adapter<RealSociedadForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public RealSociedadForaResultadoAdapter(List<Partida> augsburgFora) {
