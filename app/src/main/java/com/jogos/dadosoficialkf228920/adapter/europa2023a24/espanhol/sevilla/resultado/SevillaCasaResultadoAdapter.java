package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.sevilla.resultado;
...
public class SevillaCasaResultadoAdapter extends RecyclerView.Adapter<SevillaCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public SevillaCasaResultadoAdapter(List<Partida> augsburgCasa) {
