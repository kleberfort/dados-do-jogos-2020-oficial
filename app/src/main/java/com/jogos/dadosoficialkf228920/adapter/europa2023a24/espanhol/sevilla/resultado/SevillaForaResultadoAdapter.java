...
public class SevillaForaResultadoAdapter extends RecyclerView.Adapter<SevillaForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public SevillaForaResultadoAdapter(List<Partida> augsburgFora) {
