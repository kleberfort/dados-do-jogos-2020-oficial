package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.intermilao;
...
public class InterMilaoForaAdapter extends RecyclerView.Adapter<InterMilaoForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public InterMilaoForaAdapter(List<Partida> augsburgFora) {
