package com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.ceara.resultado;
...
public class CearaCsA2023RstdAdt extends RecyclerView.Adapter<CearaCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public CearaCsA2023RstdAdt(List<Partida> jogosCasa) {
