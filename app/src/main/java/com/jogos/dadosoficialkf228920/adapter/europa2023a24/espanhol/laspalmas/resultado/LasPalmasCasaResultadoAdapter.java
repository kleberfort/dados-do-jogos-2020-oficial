...
public class LasPalmasCasaResultadoAdapter extends RecyclerView.Adapter<LasPalmasCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public LasPalmasCasaResultadoAdapter(List<Partida> augsburgCasa) {
