package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles;
...
public class TimesInglesA2023a24Adapter extends RecyclerView.Adapter<TimesInglesA2023a24Adapter.ViewHolder> {
    ...
    public TimesInglesA2023a24Adapter(List<ClassificacaoOficial> listaTimes) {
        this.listaTimes = listaTimes;

    }

    public TimesInglesA2023a24Adapter() {
    }
