package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.athleticbilbao;
...
public class AthleticBilbaoCasaAdapter extends RecyclerView.Adapter<AthleticBilbaoCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public AthleticBilbaoCasaAdapter(List<Partida> augsburgCasa) {
