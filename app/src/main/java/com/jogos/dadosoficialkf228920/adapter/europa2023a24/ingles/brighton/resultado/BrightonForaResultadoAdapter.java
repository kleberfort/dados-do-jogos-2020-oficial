...
public class BrightonForaResultadoAdapter extends RecyclerView.Adapter<BrightonForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public BrightonForaResultadoAdapter(List<Partida> augsburgFora) {
