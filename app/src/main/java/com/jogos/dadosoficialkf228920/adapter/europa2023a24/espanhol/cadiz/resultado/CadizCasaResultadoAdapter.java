package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.cadiz.resultado;
...
public class CadizCasaResultadoAdapter extends RecyclerView.Adapter<CadizCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public CadizCasaResultadoAdapter(List<Partida> augsburgCasa) {
