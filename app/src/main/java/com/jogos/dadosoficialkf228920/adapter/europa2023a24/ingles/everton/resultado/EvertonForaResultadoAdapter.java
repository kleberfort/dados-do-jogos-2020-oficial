...
public class EvertonForaResultadoAdapter extends RecyclerView.Adapter<EvertonForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public EvertonForaResultadoAdapter(List<Partida> augsburgFora) {
