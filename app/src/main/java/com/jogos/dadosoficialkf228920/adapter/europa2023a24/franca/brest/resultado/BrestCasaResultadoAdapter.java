...
public class BrestCasaResultadoAdapter extends RecyclerView.Adapter<BrestCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public BrestCasaResultadoAdapter(List<Partida> augsburgCasa) {
