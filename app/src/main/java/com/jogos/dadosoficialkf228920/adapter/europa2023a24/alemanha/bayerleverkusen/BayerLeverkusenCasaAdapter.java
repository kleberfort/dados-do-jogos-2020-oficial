...
public class BayerLeverkusenCasaAdapter extends RecyclerView.Adapter<BayerLeverkusenCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public BayerLeverkusenCasaAdapter(List<Partida> augsburgCasa) {
