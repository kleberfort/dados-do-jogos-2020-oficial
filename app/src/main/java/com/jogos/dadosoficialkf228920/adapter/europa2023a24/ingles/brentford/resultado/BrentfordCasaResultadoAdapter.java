...
public class BrentfordCasaResultadoAdapter extends RecyclerView.Adapter<BrentfordCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public BrentfordCasaResultadoAdapter(List<Partida> augsburgCasa) {
