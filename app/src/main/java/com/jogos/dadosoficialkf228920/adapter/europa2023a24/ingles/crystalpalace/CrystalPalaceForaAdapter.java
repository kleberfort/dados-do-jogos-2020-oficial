...
public class CrystalPalaceForaAdapter extends RecyclerView.Adapter<CrystalPalaceForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public CrystalPalaceForaAdapter(List<Partida> augsburgFora) {
