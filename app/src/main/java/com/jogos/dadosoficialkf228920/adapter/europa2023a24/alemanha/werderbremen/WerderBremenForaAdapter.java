package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.werderbremen;
...
public class WerderBremenForaAdapter extends RecyclerView.Adapter<WerderBremenForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public WerderBremenForaAdapter(List<Partida> augsburgFora) {
