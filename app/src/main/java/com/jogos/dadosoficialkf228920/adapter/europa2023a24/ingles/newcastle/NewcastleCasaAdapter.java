package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.newcastle;
...
public class NewcastleCasaAdapter extends RecyclerView.Adapter<NewcastleCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public NewcastleCasaAdapter(List<Partida> augsburgCasa) {
