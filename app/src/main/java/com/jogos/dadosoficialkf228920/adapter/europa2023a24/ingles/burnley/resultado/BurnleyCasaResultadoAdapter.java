package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.burnley.resultado;
...
public class BurnleyCasaResultadoAdapter extends RecyclerView.Adapter<BurnleyCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public BurnleyCasaResultadoAdapter(List<Partida> augsburgCasa) {
