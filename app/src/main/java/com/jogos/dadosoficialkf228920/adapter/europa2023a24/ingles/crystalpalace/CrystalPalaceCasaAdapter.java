package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.crystalpalace;
...
public class CrystalPalaceCasaAdapter extends RecyclerView.Adapter<CrystalPalaceCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public CrystalPalaceCasaAdapter(List<Partida> augsburgCasa) {
