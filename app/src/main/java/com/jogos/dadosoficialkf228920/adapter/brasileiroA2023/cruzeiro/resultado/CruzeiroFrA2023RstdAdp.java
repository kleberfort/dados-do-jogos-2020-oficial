package com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.cruzeiro.resultado;
...
public class CruzeiroFrA2023RstdAdp extends RecyclerView.Adapter<CruzeiroFrA2023RstdAdp.ViewHolder>{

    private List<Partida> jogosFora;

    public CruzeiroFrA2023RstdAdp(List<Partida> jogosFora) {
