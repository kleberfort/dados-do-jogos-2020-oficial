package com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.vitoria.resultado;
...
public class VitoriaFrA2023RstdAdp extends RecyclerView.Adapter<VitoriaFrA2023RstdAdp.ViewHolder>{

    private List<Partida> jogosFora;

    public VitoriaFrA2023RstdAdp(List<Partida> jogosFora) {
