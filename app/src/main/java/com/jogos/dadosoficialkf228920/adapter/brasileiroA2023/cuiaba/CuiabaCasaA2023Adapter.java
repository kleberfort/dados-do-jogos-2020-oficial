package com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.cuiaba;
...
public class CuiabaCasaA2023Adapter extends RecyclerView.Adapter<CuiabaCasaA2023Adapter.ViewHolder> {
    
    private List<Partida> cuiabaCasa;

    public CuiabaCasaA2023Adapter(List<Partida> cuiabaCasa) {
        this.cuiabaCasa = cuiabaCasa;
    }
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaCuiabaCasa = cuiabaCasa.get(position);
