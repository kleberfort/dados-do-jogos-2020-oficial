...
public class RennesCasaResultadoAdapter extends RecyclerView.Adapter<RennesCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public RennesCasaResultadoAdapter(List<Partida> augsburgCasa) {
