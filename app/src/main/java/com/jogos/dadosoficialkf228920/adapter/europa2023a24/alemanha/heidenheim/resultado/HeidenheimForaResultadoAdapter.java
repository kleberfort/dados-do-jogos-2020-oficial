...
public class HeidenheimForaResultadoAdapter extends RecyclerView.Adapter<HeidenheimForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public HeidenheimForaResultadoAdapter(List<Partida> augsburgFora) {
