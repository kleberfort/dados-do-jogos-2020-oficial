...
public class AlavesCasaResultadoAdapter extends RecyclerView.Adapter<AlavesCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public AlavesCasaResultadoAdapter(List<Partida> augsburgCasa) {
