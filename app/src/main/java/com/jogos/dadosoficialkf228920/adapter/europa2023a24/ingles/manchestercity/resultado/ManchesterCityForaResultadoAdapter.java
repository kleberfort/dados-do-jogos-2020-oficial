package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.manchestercity.resultado;
...
public class ManchesterCityForaResultadoAdapter extends RecyclerView.Adapter<ManchesterCityForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public ManchesterCityForaResultadoAdapter(List<Partida> augsburgFora) {
