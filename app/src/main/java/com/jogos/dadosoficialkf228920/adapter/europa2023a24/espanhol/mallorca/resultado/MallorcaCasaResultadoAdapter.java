package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.mallorca.resultado;
...
public class MallorcaCasaResultadoAdapter extends RecyclerView.Adapter<MallorcaCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public MallorcaCasaResultadoAdapter(List<Partida> augsburgCasa) {
