package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.genoa;
...
public class GenoaForaAdapter extends RecyclerView.Adapter<GenoaForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public GenoaForaAdapter(List<Partida> augsburgFora) {
