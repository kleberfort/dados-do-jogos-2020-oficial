package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.hellasverona;
...
public class HellasVeronaForaAdapter extends RecyclerView.Adapter<HellasVeronaForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public HellasVeronaForaAdapter(List<Partida> augsburgFora) {
