...
public class CoritibaCsA2023RstdAdt extends RecyclerView.Adapter<CoritibaCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public CoritibaCsA2023RstdAdt(List<Partida> jogosCasa) {
