...
public class GironaForaResultadoAdapter extends RecyclerView.Adapter<GironaForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public GironaForaResultadoAdapter(List<Partida> augsburgFora) {
