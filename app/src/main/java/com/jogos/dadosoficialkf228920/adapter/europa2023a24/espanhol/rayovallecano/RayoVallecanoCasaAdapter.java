...
public class RayoVallecanoCasaAdapter extends RecyclerView.Adapter<RayoVallecanoCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public RayoVallecanoCasaAdapter(List<Partida> augsburgCasa) {
