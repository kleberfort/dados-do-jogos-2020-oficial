...
public class MarseilleForaResultadoAdapter extends RecyclerView.Adapter<MarseilleForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public MarseilleForaResultadoAdapter(List<Partida> augsburgFora) {
