...
public class AtheticoPrCasaA2023Adapter extends RecyclerView.Adapter<AtheticoPrCasaA2023Adapter.ViewHolder> {

    private List<Partida> atleticoGoCasa2022;

    public AtheticoPrCasaA2023Adapter(List<Partida> atleticoGoCasa2022) {
