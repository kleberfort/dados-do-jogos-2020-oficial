package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.nantes.resultado;
...
public class NantesForaResultadoAdapter extends RecyclerView.Adapter<NantesForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public NantesForaResultadoAdapter(List<Partida> augsburgFora) {
