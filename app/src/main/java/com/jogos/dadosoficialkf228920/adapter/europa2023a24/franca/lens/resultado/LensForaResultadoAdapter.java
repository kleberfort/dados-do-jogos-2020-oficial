package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.lens.resultado;
...
public class LensForaResultadoAdapter extends RecyclerView.Adapter<LensForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public LensForaResultadoAdapter(List<Partida> augsburgFora) {
