...
public class AtleticoMadridCasaAdapter extends RecyclerView.Adapter<AtleticoMadridCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public AtleticoMadridCasaAdapter(List<Partida> augsburgCasa) {
