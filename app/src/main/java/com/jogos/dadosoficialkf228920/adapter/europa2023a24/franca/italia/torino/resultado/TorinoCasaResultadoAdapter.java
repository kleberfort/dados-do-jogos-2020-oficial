package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.torino.resultado;
...
public class TorinoCasaResultadoAdapter extends RecyclerView.Adapter<TorinoCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public TorinoCasaResultadoAdapter(List<Partida> augsburgCasa) {
