package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.alaves.resultado;
...
public class AlavesForaResultadoAdapter extends RecyclerView.Adapter<AlavesForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public AlavesForaResultadoAdapter(List<Partida> augsburgFora) {
