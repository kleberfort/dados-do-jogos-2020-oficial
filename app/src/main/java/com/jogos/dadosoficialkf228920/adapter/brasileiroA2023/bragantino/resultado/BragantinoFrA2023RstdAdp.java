package com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.bragantino.resultado;
...
public class BragantinoFrA2023RstdAdp extends RecyclerView.Adapter<BragantinoFrA2023RstdAdp.ViewHolder>{

    private List<Partida> jogosFora;

    public BragantinoFrA2023RstdAdp(List<Partida> jogosFora) {
