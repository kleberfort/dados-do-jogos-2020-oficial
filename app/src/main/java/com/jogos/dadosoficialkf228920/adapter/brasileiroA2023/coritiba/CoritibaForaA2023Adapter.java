...
public class CoritibaForaA2023Adapter extends RecyclerView.Adapter<CoritibaForaA2023Adapter.ViewHolder> {
    private List<Partida> coritibaFora2022;

    public CoritibaForaA2023Adapter(List<Partida> coritibaFora2022) {
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaCriciumaFora = coritibaFora2022.get(position);
