package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.brentford;
...
public class BrentfordForaAdapter extends RecyclerView.Adapter<BrentfordForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public BrentfordForaAdapter(List<Partida> augsburgFora) {
