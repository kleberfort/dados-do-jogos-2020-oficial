package com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.atheticoPR.resultado;
...
public class AtheticoPrFrA2023RstdAdp extends RecyclerView.Adapter<AtheticoPrFrA2023RstdAdp.ViewHolder>{

    private List<Partida> jogosFora;

    public AtheticoPrFrA2023RstdAdp(List<Partida> jogosFora) {
