...
public class LensCasaResultadoAdapter extends RecyclerView.Adapter<LensCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public LensCasaResultadoAdapter(List<Partida> augsburgCasa) {
