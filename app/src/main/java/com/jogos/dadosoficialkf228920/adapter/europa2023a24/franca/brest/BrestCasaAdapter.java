package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.brest;
...
public class BrestCasaAdapter extends RecyclerView.Adapter<BrestCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public BrestCasaAdapter(List<Partida> augsburgCasa) {
