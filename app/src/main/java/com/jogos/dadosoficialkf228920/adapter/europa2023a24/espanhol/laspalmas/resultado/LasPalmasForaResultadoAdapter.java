package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.laspalmas.resultado;
...
public class LasPalmasForaResultadoAdapter extends RecyclerView.Adapter<LasPalmasForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public LasPalmasForaResultadoAdapter(List<Partida> augsburgFora) {
