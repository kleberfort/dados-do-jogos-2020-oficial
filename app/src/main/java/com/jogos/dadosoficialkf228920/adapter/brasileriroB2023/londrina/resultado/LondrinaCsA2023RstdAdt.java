package com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.londrina.resultado;
...
public class LondrinaCsA2023RstdAdt extends RecyclerView.Adapter<LondrinaCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public LondrinaCsA2023RstdAdt(List<Partida> jogosCasa) {
