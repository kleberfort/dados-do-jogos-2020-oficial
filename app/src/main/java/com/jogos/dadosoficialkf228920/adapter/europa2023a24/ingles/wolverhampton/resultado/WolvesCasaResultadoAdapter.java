...
public class WolvesCasaResultadoAdapter extends RecyclerView.Adapter<WolvesCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public WolvesCasaResultadoAdapter(List<Partida> augsburgCasa) {
