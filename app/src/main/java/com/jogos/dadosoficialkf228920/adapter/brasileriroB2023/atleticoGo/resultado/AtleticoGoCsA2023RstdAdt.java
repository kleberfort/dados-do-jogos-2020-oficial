...
public class AtleticoGoCsA2023RstdAdt extends RecyclerView.Adapter<AtleticoGoCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public AtleticoGoCsA2023RstdAdt(List<Partida> jogosCasa) {
