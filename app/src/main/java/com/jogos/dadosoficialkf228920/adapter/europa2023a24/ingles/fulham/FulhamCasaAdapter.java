package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.fulham;
...
public class FulhamCasaAdapter extends RecyclerView.Adapter<FulhamCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public FulhamCasaAdapter(List<Partida> augsburgCasa) {
