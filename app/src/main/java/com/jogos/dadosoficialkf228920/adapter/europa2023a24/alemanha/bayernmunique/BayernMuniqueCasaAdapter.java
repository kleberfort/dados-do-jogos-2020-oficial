package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.bayernmunique;
...
public class BayernMuniqueCasaAdapter extends RecyclerView.Adapter<BayernMuniqueCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public BayernMuniqueCasaAdapter(List<Partida> augsburgCasa) {
