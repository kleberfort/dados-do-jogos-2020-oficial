package com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.salernitana;
...
public class SalernitanaForaAdapter extends RecyclerView.Adapter<SalernitanaForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public SalernitanaForaAdapter(List<Partida> augsburgFora) {
