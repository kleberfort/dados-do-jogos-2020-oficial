package com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.internacional;
...
public class InternacionalForaA2023Adapter extends RecyclerView.Adapter<InternacionalForaA2023Adapter.ViewHolder> {

    private List<Partida> internacionalFora2022;

    public InternacionalForaA2023Adapter(List<Partida> internacionalFora2022) {
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaGuaraniFora = internacionalFora2022.get(position);
