package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.brentford.resultado;
...
public class BrentfordForaResultadoAdapter extends RecyclerView.Adapter<BrentfordForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public BrentfordForaResultadoAdapter(List<Partida> augsburgFora) {
