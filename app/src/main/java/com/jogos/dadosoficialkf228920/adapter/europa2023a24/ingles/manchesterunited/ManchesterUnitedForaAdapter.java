package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.manchesterunited;
...
public class ManchesterUnitedForaAdapter extends RecyclerView.Adapter<ManchesterUnitedForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public ManchesterUnitedForaAdapter(List<Partida> augsburgFora) {
