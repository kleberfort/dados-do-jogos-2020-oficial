...
public class BotafogoFrA2023RstdAdp extends RecyclerView.Adapter<BotafogoFrA2023RstdAdp.ViewHolder>{

    private List<Partida> jogosFora;

    public BotafogoFrA2023RstdAdp(List<Partida> jogosFora) {
