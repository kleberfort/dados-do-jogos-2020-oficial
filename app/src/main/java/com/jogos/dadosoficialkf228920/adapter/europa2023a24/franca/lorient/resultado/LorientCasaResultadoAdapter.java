...
public class LorientCasaResultadoAdapter extends RecyclerView.Adapter<LorientCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public LorientCasaResultadoAdapter(List<Partida> augsburgCasa) {
