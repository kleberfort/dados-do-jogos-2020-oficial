...
public class InternacionalFrA2023RstdAdp extends RecyclerView.Adapter<InternacionalFrA2023RstdAdp.ViewHolder>{

    private List<Partida> jogosFora;

    public InternacionalFrA2023RstdAdp(List<Partida> jogosFora) {
