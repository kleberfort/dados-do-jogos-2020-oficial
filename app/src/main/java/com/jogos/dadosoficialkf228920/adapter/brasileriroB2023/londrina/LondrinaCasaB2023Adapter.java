...
public class LondrinaCasaB2023Adapter extends RecyclerView.Adapter<LondrinaCasaB2023Adapter.ViewHolder> {

    private List<Partida> londrinaCasa;

    public LondrinaCasaB2023Adapter(List<Partida> londrinaCasa) {
        this.londrinaCasa = londrinaCasa;
    }
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaLondrinaCasa = londrinaCasa.get(position);
