...
public class TombenseFrA2023RstdAdp extends RecyclerView.Adapter<TombenseFrA2023RstdAdp.ViewHolder>{

    private List<Partida> jogosFora;

    public TombenseFrA2023RstdAdp(List<Partida> jogosFora) {
