...
public class CruzeiroCasaA2023Adapter extends RecyclerView.Adapter<CruzeiroCasaA2023Adapter.ViewHolder> {

    private List<Partida> cruzeiroCasa2023;

    public CruzeiroCasaA2023Adapter(List<Partida> cruzeiroCasa2023) {
        this.cruzeiroCasa2023 = cruzeiroCasa2023;
    }
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaItuanoCasa = cruzeiroCasa2023.get(position);

//DADOS DO JOGO
        holder.binding.tvNomeTime.setText(listaPartidaItuanoCasa.getName());
        holder.binding.tvRodada.setText("Rodada: " + String.valueOf(listaPartidaItuanoCasa.getRound()));
        holder.binding.tvDataJogo.setText(listaPartidaItuanoCasa.getDate());
        ...
        holder.binding.tvEscanteiosTotalPrimeiroTempo.setText(String.valueOf(listaPartidaItuanoCasa.getHomeEstatisticaJogo().getEscanteiosPrimeiroTempo() + listaPartidaItuanoCasa
