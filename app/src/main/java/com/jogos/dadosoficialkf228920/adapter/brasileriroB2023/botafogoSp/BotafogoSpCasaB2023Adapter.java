package com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.botafogoSp;
...
public class BotafogoSpCasaB2023Adapter extends RecyclerView.Adapter<BotafogoSpCasaB2023Adapter.ViewHolder> {
    private List<Partida> botafogoSpCasa;

    public BotafogoSpCasaB2023Adapter(List<Partida> botafogoSpCasa) {
        this.botafogoSpCasa = botafogoSpCasa;
    }
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaBotafogoSpCasa
 = botafogoSpCasa.get(position);
...
.getDate());
        ...
        /* Cartoes */
        holder.binding.cartaoAmrlCs.setText(String.valueOf(listaPartidaBotafogoSpCasa.getHomeCartoes().getAmarelo()));
        holder.binding.cartaoAmrlFr.setText(String.valueOf(listaPartidaBotafogoSpCasa.getAwayCartoes().getAmarelo()));
        holder.binding.cartaoVmlCs.setText(String.valueOf(listaPartidaBotafogoSpCasa.getHomeCartoes().getVermelho()));
        holder.binding.cartaoVmlFr.setText(String.valueOf(listaPartidaBotafogoSpCasa.getAwayCartoes().getVermelho()));
        holder.binding.cartaoTotalAmrl.setText(String.valueOf(listaPartidaBotafogoSpCasa.getHomeCartoes().getAmarelo() + listaPartidaBotafogoSpCasa.getAwayCartoes().getAmarelo()));
        holder.binding.cartaoTotalVml.setText(String.valueOf(listaPartidaBotafogoSpCasa.getHomeCartoes().getVermelho() + listaPartidaBotafogoSpCasa.getAwayCartoes().getVermelho()));
