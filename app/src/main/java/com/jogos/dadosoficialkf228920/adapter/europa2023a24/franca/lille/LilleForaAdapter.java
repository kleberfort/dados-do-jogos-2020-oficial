package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.lille;
...
public class LilleForaAdapter extends RecyclerView.Adapter<LilleForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public LilleForaAdapter(List<Partida> augsburgFora) {
