...
public class AtleticoMadridCasaResultadoAdapter extends RecyclerView.Adapter<AtleticoMadridCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public AtleticoMadridCasaResultadoAdapter(List<Partida> augsburgCasa) {
