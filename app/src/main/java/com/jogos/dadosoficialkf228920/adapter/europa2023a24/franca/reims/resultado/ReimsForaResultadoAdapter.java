package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.reims.resultado;
...
public class ReimsForaResultadoAdapter extends RecyclerView.Adapter<ReimsForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public ReimsForaResultadoAdapter(List<Partida> augsburgFora) {
