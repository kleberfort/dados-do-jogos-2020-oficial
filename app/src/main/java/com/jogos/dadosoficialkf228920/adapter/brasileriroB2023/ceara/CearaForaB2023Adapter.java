package com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.ceara;
...
public class CearaForaB2023Adapter extends RecyclerView.Adapter<CearaForaB2023Adapter.ViewHolder> {
    private List<Partida> cearaFora;
    
    public CearaForaB2023Adapter(List<Partida> cearaFora) {
        this.cearaFora = cearaFora;
    }
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaCearaFora = cearaFora.get(position);
