package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.koln;
...
public class KolnForaAdapter extends RecyclerView.Adapter<KolnForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public KolnForaAdapter(List<Partida> augsburgFora) {
