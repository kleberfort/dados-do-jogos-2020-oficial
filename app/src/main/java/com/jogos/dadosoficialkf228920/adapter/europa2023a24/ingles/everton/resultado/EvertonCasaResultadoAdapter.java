package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.everton.resultado;
...
public class EvertonCasaResultadoAdapter extends RecyclerView.Adapter<EvertonCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public EvertonCasaResultadoAdapter(List<Partida> augsburgCasa) {
