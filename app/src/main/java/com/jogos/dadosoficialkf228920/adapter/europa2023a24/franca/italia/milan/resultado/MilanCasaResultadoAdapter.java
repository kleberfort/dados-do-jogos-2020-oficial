...
public class MilanCasaResultadoAdapter extends RecyclerView.Adapter<MilanCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public MilanCasaResultadoAdapter(List<Partida> augsburgCasa) {
