package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.almeria.resultado;
...
public class AlmeriaCasaResultadoAdapter extends RecyclerView.Adapter<AlmeriaCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public AlmeriaCasaResultadoAdapter(List<Partida> augsburgCasa) {
