package com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.internacional.resultado;
...
public class InternacionalCsA2023RstdAdt extends RecyclerView.Adapter<InternacionalCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public InternacionalCsA2023RstdAdt(List<Partida> jogosCasa) {
