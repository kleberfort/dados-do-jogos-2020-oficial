package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.granada.resultado;
...
public class GranadaForaResultadoAdapter extends RecyclerView.Adapter<GranadaForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public GranadaForaResultadoAdapter(List<Partida> augsburgFora) {
