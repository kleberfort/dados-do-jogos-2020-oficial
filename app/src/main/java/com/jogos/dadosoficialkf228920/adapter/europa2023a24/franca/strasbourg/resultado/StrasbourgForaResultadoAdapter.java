...
public class StrasbourgForaResultadoAdapter extends RecyclerView.Adapter<StrasbourgForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public StrasbourgForaResultadoAdapter(List<Partida> augsburgFora) {
