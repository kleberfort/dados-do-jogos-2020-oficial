package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.bologna;
...
public class BolognaCasaAdapter extends RecyclerView.Adapter<BolognaCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public BolognaCasaAdapter(List<Partida> augsburgCasa) {
