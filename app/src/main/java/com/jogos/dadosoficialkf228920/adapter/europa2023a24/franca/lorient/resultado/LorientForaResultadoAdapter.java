package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.lorient.resultado;
...
public class LorientForaResultadoAdapter extends RecyclerView.Adapter<LorientForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public LorientForaResultadoAdapter(List<Partida> augsburgFora) {
