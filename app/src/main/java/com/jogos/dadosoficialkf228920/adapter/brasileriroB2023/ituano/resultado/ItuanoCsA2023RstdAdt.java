package com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.ituano.resultado;
...
public class ItuanoCsA2023RstdAdt extends RecyclerView.Adapter<ItuanoCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public ItuanoCsA2023RstdAdt(List<Partida> jogosCasa) {
