...
public class MontpellierCasaAdapter extends RecyclerView.Adapter<MontpellierCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public MontpellierCasaAdapter(List<Partida> augsburgCasa) {
