...
public class PontePretaCasaB2023Adapter extends RecyclerView.Adapter<PontePretaCasaB2023Adapter.ViewHolder> {

    private List<Partida> pontepretaCasa;

    public PontePretaCasaB2023Adapter(List<Partida> pontepretaCasa) {
        this.pontepretaCasa = pontepretaCasa;
    }
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaPontePretaCasa = pontepretaCasa.get(position);
