package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.wolfsburg.resultado;
...
public class WolfsburgForaResultadoAdapter extends RecyclerView.Adapter<WolfsburgForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public WolfsburgForaResultadoAdapter(List<Partida> augsburgFora) {
