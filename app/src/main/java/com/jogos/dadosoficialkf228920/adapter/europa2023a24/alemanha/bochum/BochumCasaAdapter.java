package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.bochum;
...
public class BochumCasaAdapter extends RecyclerView.Adapter<BochumCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public BochumCasaAdapter(List<Partida> augsburgCasa) {
