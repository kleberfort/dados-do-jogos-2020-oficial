...
public class JuventudeFrA2023RstdAdp extends RecyclerView.Adapter<JuventudeFrA2023RstdAdp.ViewHolder>{

    private List<Partida> jogosFora;

    public JuventudeFrA2023RstdAdp(List<Partida> jogosFora) {
