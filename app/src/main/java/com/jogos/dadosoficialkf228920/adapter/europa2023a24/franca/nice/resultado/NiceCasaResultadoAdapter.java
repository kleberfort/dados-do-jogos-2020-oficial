...
public class NiceCasaResultadoAdapter extends RecyclerView.Adapter<NiceCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public NiceCasaResultadoAdapter(List<Partida> augsburgCasa) {
