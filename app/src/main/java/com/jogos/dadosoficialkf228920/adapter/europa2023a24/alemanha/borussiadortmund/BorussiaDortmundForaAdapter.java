...
public class BorussiaDortmundForaAdapter extends RecyclerView.Adapter<BorussiaDortmundForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public BorussiaDortmundForaAdapter(List<Partida> augsburgFora) {
