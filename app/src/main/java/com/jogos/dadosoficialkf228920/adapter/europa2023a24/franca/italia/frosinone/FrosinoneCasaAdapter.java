package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.frosinone;
...
public class FrosinoneCasaAdapter extends RecyclerView.Adapter<FrosinoneCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public FrosinoneCasaAdapter(List<Partida> augsburgCasa) {
