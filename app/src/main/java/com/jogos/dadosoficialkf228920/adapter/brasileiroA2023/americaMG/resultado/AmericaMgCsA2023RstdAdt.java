...
public class AmericaMgCsA2023RstdAdt extends RecyclerView.Adapter<AmericaMgCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public AmericaMgCsA2023RstdAdt(List<Partida> jogosCasa) {
