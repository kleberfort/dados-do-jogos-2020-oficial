...
public class FlamengoForaA2023Adapter extends RecyclerView.Adapter<FlamengoForaA2023Adapter.ViewHolder> {
    private List<Partida> flamgengoFora2022;

    public FlamengoForaA2023Adapter(List<Partida> flamgengoFora2022) {
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaLondrinaFora = flamgengoFora2022.get(position);
