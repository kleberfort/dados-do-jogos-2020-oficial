...
public class PalmeirasFrA2023RstdAdp extends RecyclerView.Adapter<PalmeirasFrA2023RstdAdp.ViewHolder>{

    private List<Partida> jogosFora;

    public PalmeirasFrA2023RstdAdp(List<Partida> jogosFora) {
