package com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.tombense.resultado;
...
public class TombenseCsA2023RstdAdt extends RecyclerView.Adapter<TombenseCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public TombenseCsA2023RstdAdt(List<Partida> jogosCasa) {
