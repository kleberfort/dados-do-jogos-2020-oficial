package com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.juventude.resultado;
...
public class JuventudeCsA2023RstdAdt extends RecyclerView.Adapter<JuventudeCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public JuventudeCsA2023RstdAdt(List<Partida> jogosCasa) {
