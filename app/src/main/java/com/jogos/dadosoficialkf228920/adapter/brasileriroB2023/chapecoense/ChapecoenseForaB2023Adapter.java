...
public class ChapecoenseForaB2023Adapter extends RecyclerView.Adapter<ChapecoenseForaB2023Adapter.ViewHolder> {

    private List<Partida> chapecoenseFora;

    public ChapecoenseForaB2023Adapter(List<Partida> chapecoenseFora) {
        this.chapecoenseFora = chapecoenseFora;
    }
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaChapecoenseFora = chapecoenseFora.get(position);
