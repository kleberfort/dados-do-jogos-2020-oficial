...
public class AthleticBilbaoForaResultadoAdapter extends RecyclerView.Adapter<AthleticBilbaoForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public AthleticBilbaoForaResultadoAdapter(List<Partida> augsburgFora) {
