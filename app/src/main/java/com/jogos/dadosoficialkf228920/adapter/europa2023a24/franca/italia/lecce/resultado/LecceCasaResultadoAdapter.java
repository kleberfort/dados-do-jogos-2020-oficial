...
public class LecceCasaResultadoAdapter extends RecyclerView.Adapter<LecceCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public LecceCasaResultadoAdapter(List<Partida> augsburgCasa) {
