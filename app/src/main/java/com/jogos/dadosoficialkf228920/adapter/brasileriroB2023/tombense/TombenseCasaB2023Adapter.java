package com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.tombense;
...
public class TombenseCasaB2023Adapter extends RecyclerView.Adapter<TombenseCasaB2023Adapter.ViewHolder> {

    private List<Partida> tombenseCasa;

    public TombenseCasaB2023Adapter(List<Partida> tombenseCasa) {
        this.tombenseCasa = tombenseCasa;
    }
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaTombenseCasa
 = tombenseCasa.get(position);
