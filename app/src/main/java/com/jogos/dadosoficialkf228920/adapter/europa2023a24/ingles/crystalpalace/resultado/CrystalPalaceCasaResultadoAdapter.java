...
public class CrystalPalaceCasaResultadoAdapter extends RecyclerView.Adapter<CrystalPalaceCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public CrystalPalaceCasaResultadoAdapter(List<Partida> augsburgCasa) {
