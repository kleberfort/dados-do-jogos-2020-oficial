package com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.vasco;
...
public class VascoForaA2023Adapter extends RecyclerView.Adapter<VascoForaA2023Adapter.ViewHolder> {

    private List<Partida> vascoFora2023;

    public VascoForaA2023Adapter(List<Partida> vascoFora2023) {
        this.vascoFora2023 = vascoFora2023;
    }
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaNovorizontinoFora = vascoFora2023.get(position);
