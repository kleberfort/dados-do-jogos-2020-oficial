package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.augsburg;
...
public class AugsburgCasaAdapter extends RecyclerView.Adapter<AugsburgCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public AugsburgCasaAdapter(List<Partida> augsburgCasa) {
