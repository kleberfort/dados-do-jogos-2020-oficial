...
public class LeipzigForaResultadoAdapter extends RecyclerView.Adapter<LeipzigForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public LeipzigForaResultadoAdapter(List<Partida> augsburgFora) {
