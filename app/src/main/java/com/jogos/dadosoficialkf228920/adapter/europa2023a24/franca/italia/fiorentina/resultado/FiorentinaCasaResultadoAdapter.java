...
public class FiorentinaCasaResultadoAdapter extends RecyclerView.Adapter<FiorentinaCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public FiorentinaCasaResultadoAdapter(List<Partida> augsburgCasa) {
