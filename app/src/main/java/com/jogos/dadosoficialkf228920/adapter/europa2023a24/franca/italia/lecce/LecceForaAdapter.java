package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.lecce;
...
public class LecceForaAdapter extends RecyclerView.Adapter<LecceForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public LecceForaAdapter(List<Partida> augsburgFora) {
