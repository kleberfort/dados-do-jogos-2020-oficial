package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.toulouse.resultado;
...
public class ToulouseForaResultadoAdapter extends RecyclerView.Adapter<ToulouseForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public ToulouseForaResultadoAdapter(List<Partida> augsburgFora) {
