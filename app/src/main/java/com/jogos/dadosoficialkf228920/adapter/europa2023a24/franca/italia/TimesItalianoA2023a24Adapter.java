package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia;
...
public class TimesItalianoA2023a24Adapter extends RecyclerView.Adapter<TimesItalianoA2023a24Adapter.ViewHolder> {

    private List<ClassificacaoOficial> listaTimes;

    public TimesItalianoA2023a24Adapter(List<ClassificacaoOficial> listaTimes) {
