...
public class ValenciaForaResultadoAdapter extends RecyclerView.Adapter<ValenciaForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public ValenciaForaResultadoAdapter(List<Partida> augsburgFora) {
