package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.bochum.resultado;
...
public class BochumCasaResultadoAdapter extends RecyclerView.Adapter<BochumCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public BochumCasaResultadoAdapter(List<Partida> augsburgCasa) {
