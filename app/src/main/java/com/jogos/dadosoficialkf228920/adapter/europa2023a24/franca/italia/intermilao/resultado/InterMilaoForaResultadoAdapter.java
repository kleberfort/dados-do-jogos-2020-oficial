...
public class InterMilaoForaResultadoAdapter extends RecyclerView.Adapter<InterMilaoForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public InterMilaoForaResultadoAdapter(List<Partida> augsburgFora) {
