...
public class CearaCasaB2023Adapter extends RecyclerView.Adapter<CearaCasaB2023Adapter.ViewHolder> {

    private List<Partida> cearaCasa;

    public CearaCasaB2023Adapter(List<Partida> cearaCasa) {
        this.cearaCasa = cearaCasa;
    }
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaCearaCasa = cearaCasa.get(position);
