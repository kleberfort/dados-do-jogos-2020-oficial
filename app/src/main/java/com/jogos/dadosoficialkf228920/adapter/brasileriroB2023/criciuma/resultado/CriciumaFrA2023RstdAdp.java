package com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.criciuma.resultado;
...
public class CriciumaFrA2023RstdAdp extends RecyclerView.Adapter<CriciumaFrA2023RstdAdp.ViewHolder>{

    private List<Partida> jogosFora;

    public CriciumaFrA2023RstdAdp(List<Partida> jogosFora) {
