...
public class WolfsburgCasaResultadoAdapter extends RecyclerView.Adapter<WolfsburgCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public WolfsburgCasaResultadoAdapter(List<Partida> augsburgCasa) {
