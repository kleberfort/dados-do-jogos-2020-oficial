package com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.goias.resultado;
...
public class GoiasFrA2023RstdAdp extends RecyclerView.Adapter<GoiasFrA2023RstdAdp.ViewHolder>{

    private List<Partida> jogosFora;

    public GoiasFrA2023RstdAdp(List<Partida> jogosFora) {
