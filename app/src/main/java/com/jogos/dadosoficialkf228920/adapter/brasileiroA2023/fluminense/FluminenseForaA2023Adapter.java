package com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.fluminense;
...
public class FluminenseForaA2023Adapter extends RecyclerView.Adapter<FluminenseForaA2023Adapter.ViewHolder> {

    private List<Partida> fluminenseFora2022;

    public FluminenseForaA2023Adapter(List<Partida> fluminenseFora2022) {
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaMirassolFora = fluminenseFora2022.get(position);
