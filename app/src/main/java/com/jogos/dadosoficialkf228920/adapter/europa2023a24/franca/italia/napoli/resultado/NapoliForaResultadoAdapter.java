package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.napoli.resultado;
...
public class NapoliForaResultadoAdapter extends RecyclerView.Adapter<NapoliForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public NapoliForaResultadoAdapter(List<Partida> augsburgFora) {
