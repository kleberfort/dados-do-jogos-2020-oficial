package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.nottinghamforest.resultado;
...
public class NottinhamCasaResultadoAdapter extends RecyclerView.Adapter<NottinhamCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public NottinhamCasaResultadoAdapter(List<Partida> augsburgCasa) {
