package com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.novorizontino.resultado;
...
public class NovorizontinoFrA2023RstdAdp extends RecyclerView.Adapter<NovorizontinoFrA2023RstdAdp.ViewHolder>{

    private List<Partida> jogosFora;

    public NovorizontinoFrA2023RstdAdp(List<Partida> jogosFora) {
