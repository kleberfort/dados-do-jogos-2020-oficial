...
public class SheffieldCasaResultadoAdapter extends RecyclerView.Adapter<SheffieldCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public SheffieldCasaResultadoAdapter(List<Partida> augsburgCasa) {
