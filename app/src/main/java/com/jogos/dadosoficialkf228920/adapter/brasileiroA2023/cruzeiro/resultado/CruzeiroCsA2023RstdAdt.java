...
public class CruzeiroCsA2023RstdAdt extends RecyclerView.Adapter<CruzeiroCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public CruzeiroCsA2023RstdAdt(List<Partida> jogosCasa) {
