package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.empoli.resultado;
...
public class EmpoliForaResultadoAdapter extends RecyclerView.Adapter<EmpoliForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public EmpoliForaResultadoAdapter(List<Partida> augsburgFora) {
