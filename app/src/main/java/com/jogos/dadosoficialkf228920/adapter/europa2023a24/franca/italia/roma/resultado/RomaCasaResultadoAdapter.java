...
public class RomaCasaResultadoAdapter extends RecyclerView.Adapter<RomaCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public RomaCasaResultadoAdapter(List<Partida> augsburgCasa) {
