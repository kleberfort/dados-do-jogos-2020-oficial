package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.realbetis;
...
public class RealBetisCasaAdapter extends RecyclerView.Adapter<RealBetisCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public RealBetisCasaAdapter(List<Partida> augsburgCasa) {
