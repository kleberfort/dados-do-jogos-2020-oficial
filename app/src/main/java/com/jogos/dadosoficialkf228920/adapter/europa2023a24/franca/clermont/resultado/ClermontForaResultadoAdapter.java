...
public class ClermontForaResultadoAdapter extends RecyclerView.Adapter<ClermontForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public ClermontForaResultadoAdapter(List<Partida> augsburgFora) {
