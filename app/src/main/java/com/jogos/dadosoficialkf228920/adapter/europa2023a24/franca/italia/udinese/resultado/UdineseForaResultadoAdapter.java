...
public class UdineseForaResultadoAdapter extends RecyclerView.Adapter<UdineseForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public UdineseForaResultadoAdapter(List<Partida> augsburgFora) {
