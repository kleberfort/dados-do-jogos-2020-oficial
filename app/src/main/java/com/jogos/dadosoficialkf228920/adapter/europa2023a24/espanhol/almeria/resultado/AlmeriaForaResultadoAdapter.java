...
public class AlmeriaForaResultadoAdapter extends RecyclerView.Adapter<AlmeriaForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public AlmeriaForaResultadoAdapter(List<Partida> augsburgFora) {
