package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.heidenheim.resultado;
...
public class HeidenheimCasaResultadoAdapter extends RecyclerView.Adapter<HeidenheimCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public HeidenheimCasaResultadoAdapter(List<Partida> augsburgCasa) {
