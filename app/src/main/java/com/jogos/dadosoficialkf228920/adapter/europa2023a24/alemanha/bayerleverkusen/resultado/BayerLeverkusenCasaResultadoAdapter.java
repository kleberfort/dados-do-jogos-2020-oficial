package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.bayerleverkusen.resultado;
...
public class BayerLeverkusenCasaResultadoAdapter extends RecyclerView.Adapter<BayerLeverkusenCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public BayerLeverkusenCasaResultadoAdapter(List<Partida> augsburgCasa) {
