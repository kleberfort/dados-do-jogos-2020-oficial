package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.eintrachtfrankfurt;
...
public class EintrachtFrankfurtCasaAdapter extends RecyclerView.Adapter<EintrachtFrankfurtCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public EintrachtFrankfurtCasaAdapter(List<Partida> augsburgCasa) {
