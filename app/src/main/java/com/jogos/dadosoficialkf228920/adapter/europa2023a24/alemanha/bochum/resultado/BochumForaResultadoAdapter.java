...
public class BochumForaResultadoAdapter extends RecyclerView.Adapter<BochumForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public BochumForaResultadoAdapter(List<Partida> augsburgFora) {
