package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.stuttgart.resultado;
...
public class StuttgartForaResultadoAdapter extends RecyclerView.Adapter<StuttgartForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public StuttgartForaResultadoAdapter(List<Partida> augsburgFora) {
