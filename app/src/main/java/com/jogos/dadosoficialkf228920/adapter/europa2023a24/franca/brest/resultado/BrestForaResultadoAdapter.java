package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.brest.resultado;
...
public class BrestForaResultadoAdapter extends RecyclerView.Adapter<BrestForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public BrestForaResultadoAdapter(List<Partida> augsburgFora) {
