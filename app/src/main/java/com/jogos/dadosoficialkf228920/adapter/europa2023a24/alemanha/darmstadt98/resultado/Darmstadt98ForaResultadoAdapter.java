package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.darmstadt98.resultado;
...
public class Darmstadt98ForaResultadoAdapter extends RecyclerView.Adapter<Darmstadt98ForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public Darmstadt98ForaResultadoAdapter(List<Partida> augsburgFora) {
