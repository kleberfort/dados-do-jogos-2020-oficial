...
public class RealSociedadCasaResultadoAdapter extends RecyclerView.Adapter<RealSociedadCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public RealSociedadCasaResultadoAdapter(List<Partida> augsburgCasa) {
