...
public class LeHavreCasaResultadoAdapter extends RecyclerView.Adapter<LeHavreCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public LeHavreCasaResultadoAdapter(List<Partida> augsburgCasa) {
