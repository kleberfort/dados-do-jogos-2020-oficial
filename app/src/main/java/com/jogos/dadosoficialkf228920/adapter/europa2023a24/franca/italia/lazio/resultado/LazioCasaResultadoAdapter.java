package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.lazio.resultado;
...
public class LazioCasaResultadoAdapter extends RecyclerView.Adapter<LazioCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public LazioCasaResultadoAdapter(List<Partida> augsburgCasa) {
