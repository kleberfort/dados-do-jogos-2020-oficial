...
public class SampaioCorreaFrA2023RstdAdp extends RecyclerView.Adapter<SampaioCorreaFrA2023RstdAdp.ViewHolder>{

    private List<Partida> jogosFora;

    public SampaioCorreaFrA2023RstdAdp(List<Partida> jogosFora) {
