package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.burnley;
...
public class BurnleyForaAdapter extends RecyclerView.Adapter<BurnleyForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public BurnleyForaAdapter(List<Partida> augsburgFora) {
