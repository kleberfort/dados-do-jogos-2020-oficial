package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.barcelona;
...
public class BarcelonaForaAdapter extends RecyclerView.Adapter<BarcelonaForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public BarcelonaForaAdapter(List<Partida> augsburgFora) {
