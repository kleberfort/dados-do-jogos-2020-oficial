...
public class JuventusForaResultadoAdapter extends RecyclerView.Adapter<JuventusForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public JuventusForaResultadoAdapter(List<Partida> augsburgFora) {
