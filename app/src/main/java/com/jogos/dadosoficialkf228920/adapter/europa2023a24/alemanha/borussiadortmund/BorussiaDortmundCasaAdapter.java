package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.borussiadortmund;
...
public class BorussiaDortmundCasaAdapter extends RecyclerView.Adapter<BorussiaDortmundCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public BorussiaDortmundCasaAdapter(List<Partida> augsburgCasa) {
