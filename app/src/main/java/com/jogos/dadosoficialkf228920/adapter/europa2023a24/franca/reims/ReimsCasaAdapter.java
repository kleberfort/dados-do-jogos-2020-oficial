package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.reims;
...
public class ReimsCasaAdapter extends RecyclerView.Adapter<ReimsCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public ReimsCasaAdapter(List<Partida> augsburgCasa) {
