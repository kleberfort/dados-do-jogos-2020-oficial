package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.fiorentina.resultado;
...
public class FiorentinaForaResultadoAdapter extends RecyclerView.Adapter<FiorentinaForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public FiorentinaForaResultadoAdapter(List<Partida> augsburgFora) {
