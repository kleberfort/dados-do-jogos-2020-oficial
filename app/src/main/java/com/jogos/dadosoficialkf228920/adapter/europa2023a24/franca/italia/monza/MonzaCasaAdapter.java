package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.monza;
...
public class MonzaCasaAdapter extends RecyclerView.Adapter<MonzaCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public MonzaCasaAdapter(List<Partida> augsburgCasa) {
