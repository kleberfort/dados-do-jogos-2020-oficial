package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.mainz05.resultado;
...
public class Mainz05ForaResultadoAdapter extends RecyclerView.Adapter<Mainz05ForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public Mainz05ForaResultadoAdapter(List<Partida> augsburgFora) {
