package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.osasuna;
...
public class OsasunaForaAdapter extends RecyclerView.Adapter<OsasunaForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public OsasunaForaAdapter(List<Partida> augsburgFora) {
