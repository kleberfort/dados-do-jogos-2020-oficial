...
public class FrosinoneCasaResultadoAdapter extends RecyclerView.Adapter<FrosinoneCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public FrosinoneCasaResultadoAdapter(List<Partida> augsburgCasa) {
