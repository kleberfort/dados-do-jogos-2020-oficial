package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.chelsea;
...
public class ChelseaForaAdapter extends RecyclerView.Adapter<ChelseaForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public ChelseaForaAdapter(List<Partida> augsburgFora) {
