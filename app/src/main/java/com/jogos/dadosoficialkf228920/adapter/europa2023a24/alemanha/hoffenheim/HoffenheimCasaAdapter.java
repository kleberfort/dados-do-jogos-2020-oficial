...
public class HoffenheimCasaAdapter extends RecyclerView.Adapter<HoffenheimCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public HoffenheimCasaAdapter(List<Partida> augsburgCasa) {
