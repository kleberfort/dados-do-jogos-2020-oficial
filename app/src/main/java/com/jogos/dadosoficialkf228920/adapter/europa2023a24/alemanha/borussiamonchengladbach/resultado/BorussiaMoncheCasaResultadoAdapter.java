package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.borussiamonchengladbach.resultado;
...
public class BorussiaMoncheCasaResultadoAdapter extends RecyclerView.Adapter<BorussiaMoncheCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public BorussiaMoncheCasaResultadoAdapter(List<Partida> augsburgCasa) {
