package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.tottenham.resultado;
...
public class TottenhamCasaResultadoAdapter extends RecyclerView.Adapter<TottenhamCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public TottenhamCasaResultadoAdapter(List<Partida> augsburgCasa) {
