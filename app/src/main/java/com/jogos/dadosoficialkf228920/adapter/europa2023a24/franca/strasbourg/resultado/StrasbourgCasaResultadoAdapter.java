package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.strasbourg.resultado;
...
public class StrasbourgCasaResultadoAdapter extends RecyclerView.Adapter<StrasbourgCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public StrasbourgCasaResultadoAdapter(List<Partida> augsburgCasa) {
