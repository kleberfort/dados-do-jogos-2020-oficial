...
public class CuiabaForaA2023Adapter extends RecyclerView.Adapter<CuiabaForaA2023Adapter.ViewHolder> {

    private List<Partida> cuiabaFora;

    public CuiabaForaA2023Adapter(List<Partida> cuiabaFora) {
        this.cuiabaFora = cuiabaFora;
    }
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaCuiabaFora = cuiabaFora.get(position);
