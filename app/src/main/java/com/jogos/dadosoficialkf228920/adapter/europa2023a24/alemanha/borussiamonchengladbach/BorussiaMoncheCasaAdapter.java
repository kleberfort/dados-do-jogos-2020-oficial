...
public class BorussiaMoncheCasaAdapter extends RecyclerView.Adapter<BorussiaMoncheCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public BorussiaMoncheCasaAdapter(List<Partida> augsburgCasa) {
