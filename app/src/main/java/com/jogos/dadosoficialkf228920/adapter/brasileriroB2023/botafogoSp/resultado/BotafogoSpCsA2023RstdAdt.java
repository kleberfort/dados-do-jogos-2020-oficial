...
public class BotafogoSpCsA2023RstdAdt extends RecyclerView.Adapter<BotafogoSpCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public BotafogoSpCsA2023RstdAdt(List<Partida> jogosCasa) {
