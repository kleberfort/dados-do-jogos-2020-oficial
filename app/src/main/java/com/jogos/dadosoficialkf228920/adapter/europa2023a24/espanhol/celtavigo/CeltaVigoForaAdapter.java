package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.celtavigo;
...
public class CeltaVigoForaAdapter extends RecyclerView.Adapter<CeltaVigoForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public CeltaVigoForaAdapter(List<Partida> augsburgFora) {
