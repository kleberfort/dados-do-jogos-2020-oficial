package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.roma.resultado;
...
public class RomaForaResultadoAdapter extends RecyclerView.Adapter<RomaForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public RomaForaResultadoAdapter(List<Partida> augsburgFora) {
