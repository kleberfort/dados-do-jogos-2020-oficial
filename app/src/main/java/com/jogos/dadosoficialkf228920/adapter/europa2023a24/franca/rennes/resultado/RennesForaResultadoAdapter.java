package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.rennes.resultado;
...
public class RennesForaResultadoAdapter extends RecyclerView.Adapter<RennesForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public RennesForaResultadoAdapter(List<Partida> augsburgFora) {
