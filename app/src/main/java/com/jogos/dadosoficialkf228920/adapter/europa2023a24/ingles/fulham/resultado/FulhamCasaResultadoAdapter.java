package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.fulham.resultado;
...
public class FulhamCasaResultadoAdapter extends RecyclerView.Adapter<FulhamCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public FulhamCasaResultadoAdapter(List<Partida> augsburgCasa) {
