package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.luton;
...
public class LutonForaAdapter extends RecyclerView.Adapter<LutonForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public LutonForaAdapter(List<Partida> augsburgFora) {
