...
public class CorinthiansCasaA2023Adapter extends RecyclerView.Adapter<CorinthiansCasaA2023Adapter.ViewHolder> {
    private List<Partida> corinthiansCasa2022;

    public CorinthiansCasaA2023Adapter(List<Partida> corinthiansCasa2022) {
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaCrbCasa = corinthiansCasa2022.get(position);
