...
public class CriciumaCsA2023RstdAdt extends RecyclerView.Adapter<CriciumaCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public CriciumaCsA2023RstdAdt(List<Partida> jogosCasa) {
