package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.brighton;
...
public class BrightonForaAdapter extends RecyclerView.Adapter<BrightonForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public BrightonForaAdapter(List<Partida> augsburgFora) {
