...
public class AtalantaCasaResultadoAdapter extends RecyclerView.Adapter<AtalantaCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public AtalantaCasaResultadoAdapter(List<Partida> augsburgCasa) {
