package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.nice.resultado;
...
public class NiceForaResultadoAdapter extends RecyclerView.Adapter<NiceForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public NiceForaResultadoAdapter(List<Partida> augsburgFora) {
