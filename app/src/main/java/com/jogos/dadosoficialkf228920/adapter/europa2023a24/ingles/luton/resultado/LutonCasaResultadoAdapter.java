package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.luton.resultado;
...
public class LutonCasaResultadoAdapter extends RecyclerView.Adapter<LutonCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public LutonCasaResultadoAdapter(List<Partida> augsburgCasa) {
