package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.arsenal.resultado;
...
public class ArsenalCasaResultadoAdapter extends RecyclerView.Adapter<ArsenalCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public ArsenalCasaResultadoAdapter(List<Partida> augsburgCasa) {
