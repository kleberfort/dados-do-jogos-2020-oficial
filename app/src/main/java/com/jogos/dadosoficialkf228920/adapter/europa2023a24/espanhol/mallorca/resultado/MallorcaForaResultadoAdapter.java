...
public class MallorcaForaResultadoAdapter extends RecyclerView.Adapter<MallorcaForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public MallorcaForaResultadoAdapter(List<Partida> augsburgFora) {
