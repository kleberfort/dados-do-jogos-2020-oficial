package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.freiburg.resultado;
...
public class FreiburgCasaResultadoAdapter extends RecyclerView.Adapter<FreiburgCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public FreiburgCasaResultadoAdapter(List<Partida> augsburgCasa) {
