...
public class AstonVillaCasaAdapter extends RecyclerView.Adapter<AstonVillaCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public AstonVillaCasaAdapter(List<Partida> augsburgCasa) {
