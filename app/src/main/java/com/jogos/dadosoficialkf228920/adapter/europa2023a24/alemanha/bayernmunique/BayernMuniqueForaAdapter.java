...
public class BayernMuniqueForaAdapter extends RecyclerView.Adapter<BayernMuniqueForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public BayernMuniqueForaAdapter(List<Partida> augsburgFora) {
