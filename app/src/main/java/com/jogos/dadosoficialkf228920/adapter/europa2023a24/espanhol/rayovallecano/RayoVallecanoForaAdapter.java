package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.rayovallecano;
...
public class RayoVallecanoForaAdapter extends RecyclerView.Adapter<RayoVallecanoForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public RayoVallecanoForaAdapter(List<Partida> augsburgFora) {
