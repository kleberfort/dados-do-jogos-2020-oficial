package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.granada;
...
public class GranadaCasaAdapter extends RecyclerView.Adapter<GranadaCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public GranadaCasaAdapter(List<Partida> augsburgCasa) {
