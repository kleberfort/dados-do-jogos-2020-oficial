package com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.vilanova.resultado;
...
public class VilaNovaCsA2023RstdAdt extends RecyclerView.Adapter<VilaNovaCsA2023RstdAdt.ViewHolder> {

    private List<Partida> jogosCasa;


    public VilaNovaCsA2023RstdAdt(List<Partida> jogosCasa) {
