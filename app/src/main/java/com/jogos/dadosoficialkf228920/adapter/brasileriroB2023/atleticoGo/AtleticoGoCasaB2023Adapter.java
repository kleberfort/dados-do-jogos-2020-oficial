package com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.atleticoGo;
...
public class AtleticoGoCasaB2023Adapter extends RecyclerView.Adapter<AtleticoGoCasaB2023Adapter.ViewHolder> {

    private List<Partida> atleticoGoCasa2023;

    public AtleticoGoCasaB2023Adapter(List<Partida> atleticoGoCasa2023) {
        this.atleticoGoCasa2023 = atleticoGoCasa2023;
    }
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaAtleticoGoCasa = atleticoGoCasa2023.get(position);
        ...
        /* Cartoes */
        holder.binding.cartaoAmrlCs.setText(String.valueOf(listaPartidaAtleticoGoCasa.getHomeCartoes().getAmarelo()));
        holder.binding.cartaoAmrlFr.setText(String.valueOf(listaPartidaAtleticoGoCasa.getAwayCartoes().getAmarelo()));
        holder.binding.cartaoVmlCs.setText(String.valueOf(listaPartidaAtleticoGoCasa.getHomeCartoes().getVermelho()));
        holder.binding.cartaoVmlFr.setText(String.valueOf(listaPartidaAtleticoGoCasa.getAwayCartoes().getVermelho()));
        holder.binding.cartaoTotalAmrl.setText(String.valueOf(listaPartidaAtleticoGoCasa.getHomeCartoes().getAmarelo() + listaPartidaAtleticoGoCasa.getAwayCartoes().getAmarelo()));
        holder.binding.cartaoTotalVml.setText(String.valueOf(listaPartidaAtleticoGoCasa.getHomeCartoes().getVermelho() + listaPartidaAtleticoGoCasa.getAwayCartoes().getVermelho()));
    ...
    public int getItemCount() {
        return atleticoGoCasa2023.size();
    }
