...
public class UnionBerlinCasaAdapter extends RecyclerView.Adapter<UnionBerlinCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public UnionBerlinCasaAdapter(List<Partida> augsburgCasa) {
