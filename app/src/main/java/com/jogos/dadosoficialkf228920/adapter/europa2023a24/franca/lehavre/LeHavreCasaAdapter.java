package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.lehavre;
...
public class LeHavreCasaAdapter extends RecyclerView.Adapter<LeHavreCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public LeHavreCasaAdapter(List<Partida> augsburgCasa) {
