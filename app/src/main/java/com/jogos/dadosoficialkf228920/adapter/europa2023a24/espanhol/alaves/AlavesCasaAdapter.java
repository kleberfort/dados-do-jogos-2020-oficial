package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.alaves;
...
public class AlavesCasaAdapter extends RecyclerView.Adapter<AlavesCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public AlavesCasaAdapter(List<Partida> augsburgCasa) {
