...
public class RealBetisCasaResultadoAdapter extends RecyclerView.Adapter<RealBetisCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public RealBetisCasaResultadoAdapter(List<Partida> augsburgCasa) {
