...
public class ReimsCasaResultadoAdapter extends RecyclerView.Adapter<ReimsCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public ReimsCasaResultadoAdapter(List<Partida> augsburgCasa) {
