...
public class BotafogoSpForaB2023Adapter extends RecyclerView.Adapter<BotafogoSpForaB2023Adapter.ViewHolder> {

    private List<Partida> botafogoSpFora;

    public BotafogoSpForaB2023Adapter(List<Partida> botafogoSpFora) {
        this.botafogoSpFora = botafogoSpFora;
    }
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaBotafogoSpFora
 = botafogoSpFora.get(position);
...
.getDate());
        ...
        /* Cartoes */
        holder.binding.cartaoAmrlCs.setText(String.valueOf(listaPartidaBotafogoSpFora.getHomeCartoes().getAmarelo()));
        holder.binding.cartaoAmrlFr.setText(String.valueOf(listaPartidaBotafogoSpFora.getAwayCartoes().getAmarelo()));
        holder.binding.cartaoVmlCs.setText(String.valueOf(listaPartidaBotafogoSpFora.getHomeCartoes().getVermelho()));
        holder.binding.cartaoVmlFr.setText(String.valueOf(listaPartidaBotafogoSpFora.getAwayCartoes().getVermelho()));
        holder.binding.cartaoTotalAmrl.setText(String.valueOf(listaPartidaBotafogoSpFora.getHomeCartoes().getAmarelo() + listaPartidaBotafogoSpFora.getAwayCartoes().getAmarelo()));
        holder.binding.cartaoTotalVml.setText(String.valueOf(listaPartidaBotafogoSpFora.getHomeCartoes().getVermelho() + listaPartidaBotafogoSpFora.getAwayCartoes().getVermelho()));
