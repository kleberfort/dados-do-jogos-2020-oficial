package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.sheffield;
...
public class SheffieldForaAdapter extends RecyclerView.Adapter<SheffieldForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public SheffieldForaAdapter(List<Partida> augsburgFora) {
