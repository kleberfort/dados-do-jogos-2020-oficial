package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.atalanta.resultado;
...
public class AtalantaForaResultadoAdapter extends RecyclerView.Adapter<AtalantaForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public AtalantaForaResultadoAdapter(List<Partida> augsburgFora) {
