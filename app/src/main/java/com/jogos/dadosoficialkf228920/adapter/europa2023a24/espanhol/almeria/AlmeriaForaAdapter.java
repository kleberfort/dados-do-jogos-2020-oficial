package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.almeria;
...
public class AlmeriaForaAdapter extends RecyclerView.Adapter<AlmeriaForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public AlmeriaForaAdapter(List<Partida> augsburgFora) {
