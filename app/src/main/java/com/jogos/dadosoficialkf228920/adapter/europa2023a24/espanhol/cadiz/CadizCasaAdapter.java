package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.cadiz;
...
public class CadizCasaAdapter extends RecyclerView.Adapter<CadizCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public CadizCasaAdapter(List<Partida> augsburgCasa) {
