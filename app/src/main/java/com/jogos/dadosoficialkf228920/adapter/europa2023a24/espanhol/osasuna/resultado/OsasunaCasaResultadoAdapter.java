package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.osasuna.resultado;
...
public class OsasunaCasaResultadoAdapter extends RecyclerView.Adapter<OsasunaCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public OsasunaCasaResultadoAdapter(List<Partida> augsburgCasa) {
