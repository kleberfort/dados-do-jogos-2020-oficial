package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.augsburg.resultado;
...
public class AugsburgCasaResultadoAdapter extends RecyclerView.Adapter<AugsburgCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public AugsburgCasaResultadoAdapter(List<Partida> augsburgCasa) {
