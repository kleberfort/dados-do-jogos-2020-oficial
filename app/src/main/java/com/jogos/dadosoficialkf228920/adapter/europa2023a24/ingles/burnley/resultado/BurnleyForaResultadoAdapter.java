...
public class BurnleyForaResultadoAdapter extends RecyclerView.Adapter<BurnleyForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public BurnleyForaResultadoAdapter(List<Partida> augsburgFora) {
