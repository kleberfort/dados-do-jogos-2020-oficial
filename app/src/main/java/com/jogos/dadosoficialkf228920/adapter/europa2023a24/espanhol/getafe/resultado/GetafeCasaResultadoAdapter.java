...
public class GetafeCasaResultadoAdapter extends RecyclerView.Adapter<GetafeCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public GetafeCasaResultadoAdapter(List<Partida> augsburgCasa) {
