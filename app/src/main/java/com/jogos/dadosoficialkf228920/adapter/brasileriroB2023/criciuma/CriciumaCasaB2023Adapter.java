...
public class CriciumaCasaB2023Adapter extends RecyclerView.Adapter<CriciumaCasaB2023Adapter.ViewHolder> {

    private List<Partida> criciumaCasa;

    public CriciumaCasaB2023Adapter(List<Partida> criciumaCasa) {
        this.criciumaCasa = criciumaCasa;
    }
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaCriciumaCasa = criciumaCasa.get(position);
