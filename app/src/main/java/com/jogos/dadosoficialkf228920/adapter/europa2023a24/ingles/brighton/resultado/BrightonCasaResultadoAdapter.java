package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.brighton.resultado;
...
public class BrightonCasaResultadoAdapter extends RecyclerView.Adapter<BrightonCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public BrightonCasaResultadoAdapter(List<Partida> augsburgCasa) {
