package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.villarreal;
...
public class VillarrealForaAdapter extends RecyclerView.Adapter<VillarrealForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public VillarrealForaAdapter(List<Partida> augsburgFora) {
