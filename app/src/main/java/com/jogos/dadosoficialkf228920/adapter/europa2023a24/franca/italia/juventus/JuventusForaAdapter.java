package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.juventus;
...
public class JuventusForaAdapter extends RecyclerView.Adapter<JuventusForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public JuventusForaAdapter(List<Partida> augsburgFora) {
