...
public class AugsburgForaResultadoAdapter extends RecyclerView.Adapter<AugsburgForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public AugsburgForaResultadoAdapter(List<Partida> augsburgFora) {
