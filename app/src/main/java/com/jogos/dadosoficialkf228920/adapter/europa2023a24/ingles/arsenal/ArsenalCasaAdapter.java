package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.arsenal;
...
public class ArsenalCasaAdapter extends RecyclerView.Adapter<ArsenalCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public ArsenalCasaAdapter(List<Partida> augsburgCasa) {
