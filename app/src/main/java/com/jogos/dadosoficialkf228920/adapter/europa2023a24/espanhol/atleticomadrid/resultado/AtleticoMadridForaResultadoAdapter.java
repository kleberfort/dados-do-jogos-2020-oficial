package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.atleticomadrid.resultado;
...
public class AtleticoMadridForaResultadoAdapter extends RecyclerView.Adapter<AtleticoMadridForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public AtleticoMadridForaResultadoAdapter(List<Partida> augsburgFora) {
