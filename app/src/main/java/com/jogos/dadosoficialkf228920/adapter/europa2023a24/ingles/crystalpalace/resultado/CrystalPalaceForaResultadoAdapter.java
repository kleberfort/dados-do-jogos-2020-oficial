package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.crystalpalace.resultado;
...
public class CrystalPalaceForaResultadoAdapter extends RecyclerView.Adapter<CrystalPalaceForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public CrystalPalaceForaResultadoAdapter(List<Partida> augsburgFora) {
