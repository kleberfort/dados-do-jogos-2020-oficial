package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.sassuolo;
...
public class SassuoloCasaAdapter extends RecyclerView.Adapter<SassuoloCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public SassuoloCasaAdapter(List<Partida> augsburgCasa) {
