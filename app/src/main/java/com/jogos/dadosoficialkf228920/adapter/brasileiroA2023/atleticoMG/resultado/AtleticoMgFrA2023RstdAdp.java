package com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.atleticoMG.resultado;
...
public class AtleticoMgFrA2023RstdAdp extends RecyclerView.Adapter<AtleticoMgFrA2023RstdAdp.ViewHolder>{

    private List<Partida> jogosFora;

    public AtleticoMgFrA2023RstdAdp(List<Partida> jogosFora) {
