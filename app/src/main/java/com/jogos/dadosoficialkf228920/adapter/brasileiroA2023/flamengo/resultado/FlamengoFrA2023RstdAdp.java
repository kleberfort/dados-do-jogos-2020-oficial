package com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.flamengo.resultado;
...
public class FlamengoFrA2023RstdAdp extends RecyclerView.Adapter<FlamengoFrA2023RstdAdp.ViewHolder>{

    private List<Partida> jogosFora;

    public FlamengoFrA2023RstdAdp(List<Partida> jogosFora) {
