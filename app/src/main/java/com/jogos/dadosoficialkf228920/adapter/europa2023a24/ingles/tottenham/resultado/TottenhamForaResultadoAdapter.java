...
public class TottenhamForaResultadoAdapter extends RecyclerView.Adapter<TottenhamForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public TottenhamForaResultadoAdapter(List<Partida> augsburgFora) {
