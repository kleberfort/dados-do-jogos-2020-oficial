package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.celtavigo.resultado;
...
public class CeltaVigoCasaResultadoAdapter extends RecyclerView.Adapter<CeltaVigoCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public CeltaVigoCasaResultadoAdapter(List<Partida> augsburgCasa) {
