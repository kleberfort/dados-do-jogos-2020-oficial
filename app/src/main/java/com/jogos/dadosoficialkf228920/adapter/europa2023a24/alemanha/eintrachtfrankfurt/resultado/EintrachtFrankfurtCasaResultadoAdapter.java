...
public class EintrachtFrankfurtCasaResultadoAdapter extends RecyclerView.Adapter<EintrachtFrankfurtCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public EintrachtFrankfurtCasaResultadoAdapter(List<Partida> augsburgCasa) {
