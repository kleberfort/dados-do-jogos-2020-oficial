...
public class BolognaForaResultadoAdapter extends RecyclerView.Adapter<BolognaForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public BolognaForaResultadoAdapter(List<Partida> augsburgFora) {
