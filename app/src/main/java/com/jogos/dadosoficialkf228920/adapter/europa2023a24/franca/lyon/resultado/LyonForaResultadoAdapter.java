package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.lyon.resultado;
...
public class LyonForaResultadoAdapter extends RecyclerView.Adapter<LyonForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public LyonForaResultadoAdapter(List<Partida> augsburgFora) {
