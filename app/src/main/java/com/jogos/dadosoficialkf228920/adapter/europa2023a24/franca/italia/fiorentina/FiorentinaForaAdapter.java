package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.fiorentina;
...
public class FiorentinaForaAdapter extends RecyclerView.Adapter<FiorentinaForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public FiorentinaForaAdapter(List<Partida> augsburgFora) {
