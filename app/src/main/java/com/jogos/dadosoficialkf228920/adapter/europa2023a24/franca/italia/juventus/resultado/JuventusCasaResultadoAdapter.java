package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.juventus.resultado;
...
public class JuventusCasaResultadoAdapter extends RecyclerView.Adapter<JuventusCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public JuventusCasaResultadoAdapter(List<Partida> augsburgCasa) {
