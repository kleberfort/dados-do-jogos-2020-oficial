...
public class MirassolFrA2023RstdAdp extends RecyclerView.Adapter<MirassolFrA2023RstdAdp.ViewHolder>{

    private List<Partida> jogosFora;

    public MirassolFrA2023RstdAdp(List<Partida> jogosFora) {
