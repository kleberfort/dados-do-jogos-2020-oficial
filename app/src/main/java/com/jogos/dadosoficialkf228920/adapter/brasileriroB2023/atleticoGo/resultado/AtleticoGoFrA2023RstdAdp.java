package com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.atleticoGo.resultado;
...
public class AtleticoGoFrA2023RstdAdp extends RecyclerView.Adapter<AtleticoGoFrA2023RstdAdp.ViewHolder>{

    private List<Partida> jogosFora;

    public AtleticoGoFrA2023RstdAdp(List<Partida> jogosFora) {
