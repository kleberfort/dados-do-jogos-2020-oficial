...
public class AtleticoGoForaB2023Adapter extends RecyclerView.Adapter<AtleticoGoForaB2023Adapter.ViewHolder> {

    private List<Partida> atleticoGoFora2023;

    public AtleticoGoForaB2023Adapter(List<Partida> atleticoGoFora2023) {
        this.atleticoGoFora2023 = atleticoGoFora2023;
    }
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaAtleticoGoFora = atleticoGoFora2023.get(position);
...
//DADOS DO JOGO
    ...
    public int getItemCount() {
        return atleticoGoFora2023.size();
    }
