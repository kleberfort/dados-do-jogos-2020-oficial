package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.cagliari;
...
public class CagliariCasaAdapter extends RecyclerView.Adapter<CagliariCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public CagliariCasaAdapter(List<Partida> augsburgCasa) {
