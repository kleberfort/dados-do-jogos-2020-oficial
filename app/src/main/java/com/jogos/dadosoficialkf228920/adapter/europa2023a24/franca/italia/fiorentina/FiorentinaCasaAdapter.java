...
public class FiorentinaCasaAdapter extends RecyclerView.Adapter<FiorentinaCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public FiorentinaCasaAdapter(List<Partida> augsburgCasa) {
