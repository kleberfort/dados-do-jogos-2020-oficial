package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.lyon;
...
public class LyonCasaAdapter extends RecyclerView.Adapter<LyonCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public LyonCasaAdapter(List<Partida> augsburgCasa) {
