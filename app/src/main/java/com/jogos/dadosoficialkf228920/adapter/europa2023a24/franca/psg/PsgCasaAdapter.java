package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.psg;
...
public class PsgCasaAdapter extends RecyclerView.Adapter<PsgCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public PsgCasaAdapter(List<Partida> augsburgCasa) {
