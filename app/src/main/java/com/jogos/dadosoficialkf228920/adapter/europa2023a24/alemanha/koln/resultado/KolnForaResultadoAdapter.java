package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.koln.resultado;
...
public class KolnForaResultadoAdapter extends RecyclerView.Adapter<KolnForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public KolnForaResultadoAdapter(List<Partida> augsburgFora) {
