package com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.italia.hellasverona.resultado;
...
public class HellasVeronaCasaResultadoAdapter extends RecyclerView.Adapter<HellasVeronaCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public HellasVeronaCasaResultadoAdapter(List<Partida> augsburgCasa) {
