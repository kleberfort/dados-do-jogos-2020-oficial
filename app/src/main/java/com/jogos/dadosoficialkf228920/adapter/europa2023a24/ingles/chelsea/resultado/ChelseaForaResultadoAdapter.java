package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.chelsea.resultado;
...
public class ChelseaForaResultadoAdapter extends RecyclerView.Adapter<ChelseaForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public ChelseaForaResultadoAdapter(List<Partida> augsburgFora) {
