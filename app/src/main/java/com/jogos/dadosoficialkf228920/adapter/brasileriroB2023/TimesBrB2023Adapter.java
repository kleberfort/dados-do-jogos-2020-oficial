package com.jogos.dadosoficialkf228920.adapter.brasileriroB2023;
...
public class TimesBrB2023Adapter extends RecyclerView.Adapter<TimesBrB2023Adapter.ViewHolder> {

    private List<ClassificacaoOficial> listaTimes;

    public TimesBrB2023Adapter(List<ClassificacaoOficial> listaTimes) {
