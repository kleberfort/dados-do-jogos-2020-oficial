...
public class RealMadridForaResultadoAdapter extends RecyclerView.Adapter<RealMadridForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public RealMadridForaResultadoAdapter(List<Partida> augsburgFora) {
