...
public class ItuanoForaB2023Adapter extends RecyclerView.Adapter<ItuanoForaB2023Adapter.ViewHolder> {
    private List<Partida> ituanoFora;

    public ItuanoForaB2023Adapter(List<Partida> ituanoFora) {
        this.ituanoFora = ituanoFora;
    }
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaItuanoFora
 = ituanoFora.get(position);
