package com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.laspalmas;
...
public class LasPalmasForaAdapter extends RecyclerView.Adapter<LasPalmasForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public LasPalmasForaAdapter(List<Partida> augsburgFora) {
