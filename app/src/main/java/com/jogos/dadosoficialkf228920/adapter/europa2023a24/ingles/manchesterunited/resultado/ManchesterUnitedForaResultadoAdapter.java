package com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.manchesterunited.resultado;
...
public class ManchesterUnitedForaResultadoAdapter extends RecyclerView.Adapter<ManchesterUnitedForaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public ManchesterUnitedForaResultadoAdapter(List<Partida> augsburgFora) {
