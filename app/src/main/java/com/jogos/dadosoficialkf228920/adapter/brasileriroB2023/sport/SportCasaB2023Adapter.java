...
public class SportCasaB2023Adapter extends RecyclerView.Adapter<SportCasaB2023Adapter.ViewHolder> {

    private List<Partida> sportCasa;

    public SportCasaB2023Adapter(List<Partida> sportCasa) {
        this.sportCasa = sportCasa;
    }
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaSportCasa = sportCasa.get(position);
