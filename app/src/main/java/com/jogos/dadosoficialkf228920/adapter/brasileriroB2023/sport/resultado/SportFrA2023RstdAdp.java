package com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.sport.resultado;
...
public class SportFrA2023RstdAdp extends RecyclerView.Adapter<SportFrA2023RstdAdp.ViewHolder>{

    private List<Partida> jogosFora;

    public SportFrA2023RstdAdp(List<Partida> jogosFora) {
