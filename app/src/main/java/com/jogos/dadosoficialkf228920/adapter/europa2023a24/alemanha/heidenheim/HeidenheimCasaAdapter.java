package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.heidenheim;
...
public class HeidenheimCasaAdapter extends RecyclerView.Adapter<HeidenheimCasaAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public HeidenheimCasaAdapter(List<Partida> augsburgCasa) {
