...
public class MonacoCasaResultadoAdapter extends RecyclerView.Adapter<MonacoCasaResultadoAdapter.ViewHolder> {

    private List<Partida> augsburgCasa;

    public MonacoCasaResultadoAdapter(List<Partida> augsburgCasa) {
