package com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.stuttgart;
...
public class StuttgartForaAdapter extends RecyclerView.Adapter<StuttgartForaAdapter.ViewHolder> {

    private List<Partida> augsburgFora;

    public StuttgartForaAdapter(List<Partida> augsburgFora) {
