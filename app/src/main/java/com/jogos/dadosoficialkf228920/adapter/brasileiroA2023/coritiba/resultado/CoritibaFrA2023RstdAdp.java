package com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.coritiba.resultado;
...
public class CoritibaFrA2023RstdAdp extends RecyclerView.Adapter<CoritibaFrA2023RstdAdp.ViewHolder>{

    private List<Partida> jogosFora;

    public CoritibaFrA2023RstdAdp(List<Partida> jogosFora) {
