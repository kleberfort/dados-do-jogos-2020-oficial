...
public class SantosCasaA2023Adapter extends RecyclerView.Adapter<SantosCasaA2023Adapter.ViewHolder> {
    private List<Partida> santosCasa2022;

    public SantosCasaA2023Adapter(List<Partida> santosCasa2022) {
    ...
    public void onBindViewHolder( ViewHolder holder, int position) {
        ...
        Partida listaPartidaSampaioCorreaCasa = santosCasa2022.get(position);
