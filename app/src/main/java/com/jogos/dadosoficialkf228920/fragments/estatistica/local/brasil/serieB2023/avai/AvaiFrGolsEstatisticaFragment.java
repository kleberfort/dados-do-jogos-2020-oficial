...
public class AvaiFrGolsEstatisticaFragment extends Fragment {


    private TelaEstatisticaGolsBinding binding;
    private AvaiForaB2023PartidaApi avaiForaB2023PartidaApi;
    ...
    private void setupHttpClient() {
        ...
        avaiForaB2023PartidaApi = retrofit.create(AvaiForaB2023PartidaApi.class);
    }
    ...
    private void setupDadosJogos(){
        ...
        avaiForaB2023PartidaApi.getAvaiFora().enqueue(new Callback<List<Partida>>() {
            @Override
