...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.heidenheim.HeidenheimForaAdapter;
...
import com.jogos.dadosoficialkf228920.databinding.FragmentHeidenheimFora2023a24Binding;
...
public class HeidenheimForaFragment extends Fragment {

    private FragmentHeidenheimFora2023a24Binding binding;
    private HeidenheimForaPartidaApi heidenheimForaPartidaApi;
    private HeidenheimForaAdapter heidenheimForaAdapter;



    public HeidenheimForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentHeidenheimFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        heidenheimForaPartidaApi = retrofit.create(HeidenheimForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        heidenheimForaPartidaApi.getHeidenheimFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    heidenheimForaAdapter = new HeidenheimForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(heidenheimForaAdapter);
