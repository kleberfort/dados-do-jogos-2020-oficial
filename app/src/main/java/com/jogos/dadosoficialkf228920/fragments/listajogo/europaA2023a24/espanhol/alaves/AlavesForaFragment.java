...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.alaves.AlavesForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.alaves.AlavesForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAlavesFora2023a24Binding;
...
public class AlavesForaFragment extends Fragment {

    private FragmentAlavesFora2023a24Binding binding;
    private AlavesForaPartidaApi alavesForaPartidaApi;
    private AlavesForaAdapter alavesForaAdapter;



    public AlavesForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAlavesFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        alavesForaPartidaApi = retrofit.create(AlavesForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        alavesForaPartidaApi.getAlavesFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    alavesForaAdapter = new AlavesForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(alavesForaAdapter);
