...
import com.jogos.dadosoficialkf228920.adapter.inglesA2022a2023.brentford.BrentfordCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.inglesA2022a23.brentford.BrentfordCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentBrentfordCasa2022a23Binding;
...
public class BrentfordCasa2022a23Fragment extends Fragment {
    ...
    private void setupHttpClient() {
        ...
        brentfordCasaA2022a23PartidaApi = retrofit.create(BrentfordCasaA2022a23PartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        brentfordCasaA2022a23PartidaApi.getBrentfordCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    brentfordCasa2022a23Adapter = new BrentfordCasa2022a23Adapter(partidas);
                    binding.rvBrentfordCasa.setAdapter(brentfordCasa2022a23Adapter);

                    binding.rvBrentfordCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvBrentfordCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
