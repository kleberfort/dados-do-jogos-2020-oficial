...
public class ListaLaLiga_A_2024_25Fragment extends Fragment implements JogosLaLiga_A_2024_2025_Listener {
    ...
    public interface ListaLaLiga2025_OnClinkInterface{//esse é o codigo de criar a interface // entede essa primeira parte ? ele basicamente
        void listaLaLigaOnClick2025Metodo(String nome);//viu que é uma string ?sim
    }

    public interface ListaLaLiga2025_LongClickInterface{
        void listaLaLigaLongClick2025metodo();
    }

    //2 etapa criamos uma variavel da interface
    ListaLaLiga2025_OnClinkInterface listaLaLigaOnClick = null;//queremos usar o metodo listaBrasilAMetodo(String nome) mas estamos iniciando ela com o valor null
    //ou seuja null é igual a nulo ou nada
    //entende isso ?sim

    //2 etapa criamos uma variavel da interface
    ListaLaLiga2025_LongClickInterface listaLaLigaLongClick = null;
    ...
    public void onAttach(@NonNull Context context) {//
        ...
        if(context instanceof ListaLaLiga2025_OnClinkInterface){
            listaLaLigaOnClick = (ListaLaLiga2025_OnClinkInterface) context;//aqui iniciamos a nossa variavel... Esse código voce nao precisa entender, só tem que
            //compreendeu as 3 etapadas ?sim ok
        }

        if(context instanceof ListaLaLiga2025_LongClickInterface){
            listaLaLigaLongClick = (ListaLaLiga2025_LongClickInterface) context;
        }
    ...
    @Override
    public void onJogosLaLiga_A(HashMap<String, Map<String, List<PartidaNovoModelo>>> partidasPorTime) {
