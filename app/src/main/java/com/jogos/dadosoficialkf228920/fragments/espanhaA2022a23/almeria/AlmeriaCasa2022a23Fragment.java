...
import com.jogos.dadosoficialkf228920.adapter.espanhaA2022a23.almeria.AlmeriaCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.espanhaA2022a23.almeria.AlmeriaCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAlmeriaCasa2022a23Binding;
        ...
        almeriaCasaA2022a23PartidaApi.getAlmeriaCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvAlmeriaCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvAlmeriaCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
