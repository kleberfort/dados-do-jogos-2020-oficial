...
import com.jogos.dadosoficialkf228920.databinding.FragmentLiverpoolFora2023a24Binding;
...
public class LiverpoolForaFragment extends Fragment {

    private FragmentLiverpoolFora2023a24Binding binding;
    private LiverpoolForaPartidaApi liverpoolForaPartidaApi;
    private LiverpoolForaAdapter liverpoolForaAdapter;



    public LiverpoolForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLiverpoolFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupDadosJogos() {
        ...
        liverpoolForaPartidaApi.getLiverpoolFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    liverpoolForaAdapter = new LiverpoolForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(liverpoolForaAdapter);
