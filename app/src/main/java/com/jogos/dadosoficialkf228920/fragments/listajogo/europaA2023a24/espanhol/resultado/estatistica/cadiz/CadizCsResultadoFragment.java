...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.cadiz.resultado.CadizCasaResultadoAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.JogosEspanholCasaFora2023_24Api;
import com.jogos.dadosoficialkf228920.databinding.FragmentCadizCsResultadoBinding;
...
public class CadizCsResultadoFragment extends Fragment {

    private FragmentCadizCsResultadoBinding binding;
    private JogosEspanholCasaFora2023_24Api jogosEspanholCasaFora202324Api;
    private CadizCasaResultadoAdapter cadizCasaResultadoAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCadizCsResultadoBinding.inflate(inflater, container, false);
    ...
    private void setupDadosJogos() {
        ...
        jogosEspanholCasaFora202324Api.getCadizCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    cadizCasaResultadoAdapter = new CadizCasaResultadoAdapter(partidas);
                    binding.rvListaJogos.setAdapter(cadizCasaResultadoAdapter);
