...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.monaco.MonacoForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.monaco.MonacoForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAugsburgFora2023a24Binding;
import com.jogos.dadosoficialkf228920.databinding.FragmentMonacoFora2023a24Binding;
...
public class MonacoForaFragment extends Fragment {

    private FragmentMonacoFora2023a24Binding binding;
    private MonacoForaPartidaApi monacoForaPartidaApi;
    private MonacoForaAdapter monacoForaAdapter;



    public MonacoForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentMonacoFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        monacoForaPartidaApi = retrofit.create(MonacoForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        monacoForaPartidaApi.getMonacoFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    monacoForaAdapter = new MonacoForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(monacoForaAdapter);
