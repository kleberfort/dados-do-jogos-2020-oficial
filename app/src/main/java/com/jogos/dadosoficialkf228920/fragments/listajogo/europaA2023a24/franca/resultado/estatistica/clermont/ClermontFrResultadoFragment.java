package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.resultado.estatistica.clermont;
...
import com.jogos.dadosoficialkf228920.databinding.FragmentClermontFrResultadoBinding;
 ...
 * Use the {@link ClermontFrResultadoFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ClermontFrResultadoFragment extends Fragment {

    private FragmentClermontFrResultadoBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentClermontFrResultadoBinding.inflate(inflater, container, false);
    ...
    private void setupDadosJogos() {
        ...
        jogosFrancesCasaFora2023_24Api.getClermontFora().enqueue(new Callback<List<Partida>>() {
            @Override
