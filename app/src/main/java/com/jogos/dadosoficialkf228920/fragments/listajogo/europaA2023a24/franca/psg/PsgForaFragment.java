...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.psg.PsgForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.psg.PsgForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentPsgFora2023a24Binding;
...
public class PsgForaFragment extends Fragment {

    private FragmentPsgFora2023a24Binding binding;
    private PsgForaPartidaApi psgForaPartidaApi;
    private PsgForaAdapter psgForaAdapter;



    public PsgForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentPsgFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        psgForaPartidaApi = retrofit.create(PsgForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        psgForaPartidaApi.getPsgFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    psgForaAdapter = new PsgForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(psgForaAdapter);
