package com.jogos.dadosoficialkf228920.fragments.alemanhaA2022a23.bayernmunique;
...
import com.jogos.dadosoficialkf228920.adapter.alemanhaA2022a23.bayernmunique.BayernMuniqueFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.alemanhaA2022a23.bayernmunique.BayernMuniqueForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentBayernMuniqueFora2022a23Binding;
...
public class BayernMuniqueFora2022a23Fragment extends Fragment {


    private FragmentBayernMuniqueFora2022a23Binding binding;
    private BayernMuniqueForaA2022a23PartidaApi  bayernMuniqueForaA2022a23PartidaApi;
    private BayernMuniqueFora2022a23Adapter bayernMuniqueFora2022a23Adapter;


    public BayernMuniqueFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBayernMuniqueFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        bayernMuniqueForaA2022a23PartidaApi = retrofit.create(BayernMuniqueForaA2022a23PartidaApi.class);

    }

    private void setupDadosJogos() {
        binding.rvBayernMuniqueFora.setHasFixedSize(true);
        binding.rvBayernMuniqueFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvBayernMuniqueFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));
        ...
        bayernMuniqueForaA2022a23PartidaApi.getBayernMuniqueFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    bayernMuniqueFora2022a23Adapter = new BayernMuniqueFora2022a23Adapter(partidas);
                    binding.rvBayernMuniqueFora.setAdapter(bayernMuniqueFora2022a23Adapter);

                    binding.rvBayernMuniqueFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvBayernMuniqueFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
