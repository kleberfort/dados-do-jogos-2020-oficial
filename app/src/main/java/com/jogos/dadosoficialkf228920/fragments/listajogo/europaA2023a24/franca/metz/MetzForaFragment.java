package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.metz;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.metz.MetzForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.metz.MetzForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentMetzFora2023a24Binding;
...
public class MetzForaFragment extends Fragment {

    private FragmentMetzFora2023a24Binding binding;
    private MetzForaPartidaApi metzForaPartidaApi;
    private MetzForaAdapter metzForaAdapter;



    public MetzForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentMetzFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/franca/metz/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        metzForaPartidaApi = retrofit.create(MetzForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        metzForaPartidaApi.getMetzFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    metzForaAdapter = new MetzForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(metzForaAdapter);
