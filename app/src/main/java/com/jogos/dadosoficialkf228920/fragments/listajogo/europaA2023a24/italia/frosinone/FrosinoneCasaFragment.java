...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.frosinone.FrosinoneCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.frosinone.FrosinoneCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentFrosinoneCasa2023a24Binding;
...
public class FrosinoneCasaFragment extends Fragment {

    private FragmentFrosinoneCasa2023a24Binding binding;
    private FrosinoneCasaPartidaApi frosinoneCasaPartidaApi;
    private FrosinoneCasaAdapter frosinoneCasaAdapter;



    public FrosinoneCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFrosinoneCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        frosinoneCasaPartidaApi = retrofit.create(FrosinoneCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        frosinoneCasaPartidaApi.getFrosinoneCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    frosinoneCasaAdapter = new FrosinoneCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(frosinoneCasaAdapter);
