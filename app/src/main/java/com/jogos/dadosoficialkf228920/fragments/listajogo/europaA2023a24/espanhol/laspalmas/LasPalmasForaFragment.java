package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.laspalmas;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.laspalmas.LasPalmasForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.laspalmas.LasPalmasForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentLasPalmasFora2023a24Binding;
...
public class LasPalmasForaFragment extends Fragment {

    private FragmentLasPalmasFora2023a24Binding binding;
    private LasPalmasForaPartidaApi lasPalmasForaPartidaApi;
    private LasPalmasForaAdapter lasPalmasForaAdapter;



    public LasPalmasForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLasPalmasFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        lasPalmasForaPartidaApi = retrofit.create(LasPalmasForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        lasPalmasForaPartidaApi.getLasPalmasFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    lasPalmasForaAdapter = new LasPalmasForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(lasPalmasForaAdapter);
