...
import com.jogos.dadosoficialkf228920.adapter.italiaA2022a23.intermilao.InterMilaoCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.italiaA2022a23.intermilao.InterMilaoCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentInterMilaoCasa2022a23Binding;
        ...
        interMilaoCasaA2022a23PartidaApi.getInterMilaoCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvInterMilaoCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvInterMilaoCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
