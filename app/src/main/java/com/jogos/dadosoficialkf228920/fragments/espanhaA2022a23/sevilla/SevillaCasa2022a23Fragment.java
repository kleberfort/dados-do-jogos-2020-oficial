package com.jogos.dadosoficialkf228920.fragments.espanhaA2022a23.sevilla;
...
import com.jogos.dadosoficialkf228920.adapter.espanhaA2022a23.sevilla.SevillaCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.espanhaA2022a23.sevilla.SevillaCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentSevillaCasa2022a23Binding;
...
public class SevillaCasa2022a23Fragment extends Fragment {


    private FragmentSevillaCasa2022a23Binding binding;
    private SevillaCasaA2022a23PartidaApi sevillaCasaA2022a23PartidaApi;
    private SevillaCasa2022a23Adapter sevillaCasa2022a23Adapter;


    public SevillaCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSevillaCasa2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/espanhol-a-2022-23/sevilla/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        sevillaCasaA2022a23PartidaApi = retrofit.create(SevillaCasaA2022a23PartidaApi.class);

    }

    private void setupDadosJogos() {
        binding.rvSevillaCasa.setHasFixedSize(true);
        binding.rvSevillaCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvSevillaCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        sevillaCasaA2022a23PartidaApi.getSevillaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    sevillaCasa2022a23Adapter = new SevillaCasa2022a23Adapter(partidas);
                    binding.rvSevillaCasa.setAdapter(sevillaCasa2022a23Adapter);


                    binding.rvSevillaCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvSevillaCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
