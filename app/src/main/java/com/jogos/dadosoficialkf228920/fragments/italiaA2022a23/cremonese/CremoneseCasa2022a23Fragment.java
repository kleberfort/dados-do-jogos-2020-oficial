...
import com.jogos.dadosoficialkf228920.adapter.italiaA2022a23.cremonese.CremoneseCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.italiaA2022a23.cremonese.CremoneseCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentCremoneseCasa2022a23Binding;
...
public class CremoneseCasa2022a23Fragment extends Fragment {
    ...
    private void setupHttpClient() {
        ...
        cremoneseCasaA2022a23PartidaApi = retrofit.create(CremoneseCasaA2022a23PartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        cremoneseCasaA2022a23PartidaApi.getCremoneseCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    cremoneseCasa2022a23Adapter = new CremoneseCasa2022a23Adapter(partidas);
                    binding.rvCremoneseCasa.setAdapter(cremoneseCasa2022a23Adapter);

                    binding.rvCremoneseCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvCremoneseCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
