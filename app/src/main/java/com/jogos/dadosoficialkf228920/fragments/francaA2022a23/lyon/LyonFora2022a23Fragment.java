package com.jogos.dadosoficialkf228920.fragments.francaA2022a23.lyon;
...
import com.jogos.dadosoficialkf228920.adapter.francaA2022a23.lyon.LyonFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.francaA2022a23.lyon.LyonForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentLyonFora2022a23Binding;
        ...
        lyonForaA2022a23PartidaApi.getLyonFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvLyonFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvLyonFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
