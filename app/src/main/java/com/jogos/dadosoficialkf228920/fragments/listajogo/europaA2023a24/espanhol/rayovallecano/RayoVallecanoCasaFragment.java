package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.rayovallecano;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.rayovallecano.RayoVallecanoCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.rayovallecano.RayoVallecanoCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentRayoVallecanoCasa2023a24Binding;
...
public class RayoVallecanoCasaFragment extends Fragment {

    private FragmentRayoVallecanoCasa2023a24Binding binding;
    private RayoVallecanoCasaPartidaApi rayoVallecanoCasaPartidaApi;
    private RayoVallecanoCasaAdapter rayoVallecanoCasaAdapter;



    public RayoVallecanoCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentRayoVallecanoCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/espanhol/rayo-vallecano/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        rayoVallecanoCasaPartidaApi = retrofit.create(RayoVallecanoCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        rayoVallecanoCasaPartidaApi.getRayoVallecanoCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    rayoVallecanoCasaAdapter = new RayoVallecanoCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(rayoVallecanoCasaAdapter);
