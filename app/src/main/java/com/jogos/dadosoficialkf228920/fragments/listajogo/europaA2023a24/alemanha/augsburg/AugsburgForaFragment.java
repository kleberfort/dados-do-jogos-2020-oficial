package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.augsburg;
...
public class AugsburgForaFragment extends Fragment {

    private FragmentAugsburgFora2023a24Binding binding;
    private AugsburgForaPartidaApi augsburgForaPartidaApi;
    private AugsburgForaAdapter augsburgForaAdapter;



    public AugsburgForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAugsburgFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        augsburgForaPartidaApi = retrofit.create(AugsburgForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        augsburgForaPartidaApi.getAugsburgFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    augsburgForaAdapter = new AugsburgForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(augsburgForaAdapter);
