...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.crb.CrbCasaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.crb.CrbCasaB2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentCrbCasaB2023Binding;
...
public class CrbCasa2023Fragment extends Fragment {

    private FragmentCrbCasaB2023Binding binding;
    private CrbCasaB2023Adapter crbCasaB2023Adapter;
    private CrbCasaB2023PartidaApi crbCasaB2023PartidaApi;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCrbCasaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        crbCasaB2023PartidaApi = retrofit.create(CrbCasaB2023PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvCrbCasa.setHasFixedSize(true);
        binding.rvCrbCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvCrbCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        crbCasaB2023PartidaApi.getCrbCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    crbCasaB2023Adapter = new CrbCasaB2023Adapter(partidas);
                    binding.rvCrbCasa.setAdapter(crbCasaB2023Adapter);

                    binding.rvCrbCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvCrbCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
