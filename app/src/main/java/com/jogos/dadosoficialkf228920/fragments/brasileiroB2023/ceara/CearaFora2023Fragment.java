...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.ceara.CearaForaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.ceara.CearaForaB2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentCearaForaB2023Binding;
...
public class CearaFora2023Fragment extends Fragment {


    private FragmentCearaForaB2023Binding binding;
    private CearaForaB2023Adapter cearaForaB2023Adapter;
    private CearaForaB2023PartidaApi cearaForaB2023PartidaApi;





    public CearaFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCearaForaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        cearaForaB2023PartidaApi = retrofit.create(CearaForaB2023PartidaApi.class);
    ...
    private void setupListaPartidas() {
        ...
        cearaForaB2023PartidaApi.getCearaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    cearaForaB2023Adapter = new CearaForaB2023Adapter(partidas);
                    binding.rvCearaFora.setAdapter(cearaForaB2023Adapter);
