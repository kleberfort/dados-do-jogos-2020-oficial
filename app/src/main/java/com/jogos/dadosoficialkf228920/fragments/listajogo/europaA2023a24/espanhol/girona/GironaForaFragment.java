package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.girona;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.girona.GironaForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.girona.GironaForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentGironaFora2023a24Binding;
...
public class GironaForaFragment extends Fragment {

    private FragmentGironaFora2023a24Binding binding;
    private GironaForaPartidaApi gironaForaPartidaApi;
    private GironaForaAdapter gironaForaAdapter;



    public GironaForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentGironaFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/espanhol/girona/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        gironaForaPartidaApi = retrofit.create(GironaForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        gironaForaPartidaApi.getGironaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    gironaForaAdapter = new GironaForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(gironaForaAdapter);
