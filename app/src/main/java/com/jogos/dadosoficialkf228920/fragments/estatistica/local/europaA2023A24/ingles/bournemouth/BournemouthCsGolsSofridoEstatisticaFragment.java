package com.jogos.dadosoficialkf228920.fragments.estatistica.local.europaA2023A24.ingles.bournemouth;
...
public class BournemouthCsGolsSofridoEstatisticaFragment extends Fragment {


    private TelaEstatisticaGolsBinding binding;
    private BournemouthCasaPartidaApi bournemouthCasaPartidaApi; // a diferença esse treço
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //qual a diferenca de código dessas varios fragmens que voce tem ?
        //Ele recuperar dados diferente de jogos
        //seria
    ...
    private void setupHttpClient() {
        ...
        // a unica diferenca seria desse https abaixo ? ouu tem mais coisas diferentes ?
        ...
        bournemouthCasaPartidaApi = retrofit.create(BournemouthCasaPartidaApi.class); // esse q recupera lá de cima

        //esta em java nao me lembro como pegar no momento//
        //mas voce pode pegar de um unico codigo ao inves de ter um fragment e um retrofit pra cada
        //seu projeto iria diminuir pela metade

        //isso voce pode pesquisar depois// vou realizar o intersticial pra voce
    }
    ...
    private void setupDadosJogos(){
        ...
        //Esse abaixo q muda também, em 3 locais
...
//                        GOLS ACIMA -----------------------------------------------------------------------------
                    ...
                    binding.tvTitulo.setText("GOLS SOFRIDOS " + partidas.get(0).getHomeTime().getName().toUpperCase() + " CASA");
                    ...
                    SpannableStringBuilder builder = FormatarCoresTextoGolsSfdCasa.formatText(nome, totalJogos, totalGolsMcd, totalGolsMcdPct);
