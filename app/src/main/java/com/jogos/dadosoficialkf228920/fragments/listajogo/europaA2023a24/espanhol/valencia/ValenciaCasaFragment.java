...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.valencia.ValenciaCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.valencia.ValenciaCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentValenciaCasa2023a24Binding;
...
public class ValenciaCasaFragment extends Fragment {

    private FragmentValenciaCasa2023a24Binding binding;
    private ValenciaCasaPartidaApi valenciaCasaPartidaApi;
    private ValenciaCasaAdapter valenciaCasaAdapter;



    public ValenciaCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentValenciaCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        valenciaCasaPartidaApi = retrofit.create(ValenciaCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        valenciaCasaPartidaApi.getValenciaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    valenciaCasaAdapter = new ValenciaCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(valenciaCasaAdapter);
