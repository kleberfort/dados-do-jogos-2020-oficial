...
import com.jogos.dadosoficialkf228920.adapter.francaA2022a23.clermont.ClermontCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.francaA2022a23.clermont.ClermontCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentClermontCasa2022a23Binding;
        ...
        clermontCasaA2022a23PartidaApi.getClermontCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvClermontCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvClermontCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
