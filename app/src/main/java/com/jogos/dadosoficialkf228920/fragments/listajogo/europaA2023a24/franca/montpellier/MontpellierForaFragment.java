...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.montpellier.MontpellierForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.montpellier.MontpellierForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentMontpellierFora2023a24Binding;
...
public class MontpellierForaFragment extends Fragment {

    private FragmentMontpellierFora2023a24Binding binding;
    private MontpellierForaPartidaApi montpellierForaPartidaApi;
    private MontpellierForaAdapter montpellierForaAdapter;



    public MontpellierForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentMontpellierFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        montpellierForaPartidaApi = retrofit.create(MontpellierForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        montpellierForaPartidaApi.getMontpellierFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    montpellierForaAdapter = new MontpellierForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(montpellierForaAdapter);
