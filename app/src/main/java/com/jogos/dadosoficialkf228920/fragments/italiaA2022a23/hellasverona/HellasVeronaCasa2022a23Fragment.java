package com.jogos.dadosoficialkf228920.fragments.italiaA2022a23.hellasverona;
...
import com.jogos.dadosoficialkf228920.adapter.italiaA2022a23.hellasverona.HellasVeronaCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.italiaA2022a23.hellasverona.HellasVeronaCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentHellasVeronaCasa2022a23Binding;
...
public class HellasVeronaCasa2022a23Fragment extends Fragment {

    private FragmentHellasVeronaCasa2022a23Binding binding;
    private HellasVeronaCasaA2022a23PartidaApi hellasVeronaCasaA2022a23PartidaApi;
    private HellasVeronaCasa2022a23Adapter hellasVeronaCasa2022a23Adapter;

    public HellasVeronaCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentHellasVeronaCasa2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/italia-a-2022-23/hellas-verona/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        hellasVeronaCasaA2022a23PartidaApi = retrofit.create(HellasVeronaCasaA2022a23PartidaApi.class);

    }

    private void setupDadosJogos() {
        binding.rvhellasVeronaCasa.setHasFixedSize(true);
        binding.rvhellasVeronaCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvhellasVeronaCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        hellasVeronaCasaA2022a23PartidaApi.getHellasVeronaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvhellasVeronaCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvhellasVeronaCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
