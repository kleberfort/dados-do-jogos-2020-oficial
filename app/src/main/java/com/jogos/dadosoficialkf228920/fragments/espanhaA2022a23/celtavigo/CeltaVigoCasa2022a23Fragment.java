package com.jogos.dadosoficialkf228920.fragments.espanhaA2022a23.celtavigo;
...
import com.jogos.dadosoficialkf228920.adapter.espanhaA2022a23.celtavigo.CeltaVigoCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.espanhaA2022a23.celtavigo.CeltaVigoCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentCeltaVigoCasa2022a23Binding;
...
public class CeltaVigoCasa2022a23Fragment extends Fragment {
    ...
    private void setupHttpClient() {
        ...
        celtaVigoCasaA2022a23PartidaApi = retrofit.create(CeltaVigoCasaA2022a23PartidaApi.class);
    }
    ...
    private void setupDadosJogos() {
        ...
        celtaVigoCasaA2022a23PartidaApi.getCeltaVigoCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    celtaVigoCasa2022a23Adapter = new CeltaVigoCasa2022a23Adapter(partidas);
                    binding.rvCeltaVigoCasa.setAdapter(celtaVigoCasa2022a23Adapter);

                    binding.rvCeltaVigoCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvCeltaVigoCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
