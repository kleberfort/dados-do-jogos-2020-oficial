...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.vasco.resultado.VascoFrA2023RstdAdp;
...
import com.jogos.dadosoficialkf228920.databinding.FragmentVascoFr2023RstdBinding;
...
public class VascoFr2023RstdFragment extends Fragment {

    private FragmentVascoFr2023RstdBinding binding;
    private VascoForaA2023PartidaApi vascoForaA2023PartidaApi;
    private VascoFrA2023RstdAdp vascoFrA2023RstdAdp;

    public VascoFr2023RstdFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentVascoFr2023RstdBinding.inflate(inflater, container, false);
        ...
        vascoForaA2023PartidaApi.getVascoFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    vascoFrA2023RstdAdp = new VascoFrA2023RstdAdp(partidas);
                    binding.rvListaResultado.setAdapter(vascoFrA2023RstdAdp);
