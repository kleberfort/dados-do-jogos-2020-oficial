package com.jogos.dadosoficialkf228920.fragments.brasileiroB2023.chapecoense;
...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.chapecoense.ChapecoenseCasaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.chapecoense.ChapecoenseCasaB2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentChapecoenseCasaB2023Binding;
...
public class ChapecoenseCasa2023Fragment extends Fragment {

    private FragmentChapecoenseCasaB2023Binding binding;
    private ChapecoenseCasaB2023Adapter chapecoenseCasaB2023Adapter;
    private ChapecoenseCasaB2023PartidaApi chapecoenseCasaB2023PartidaApi;





    public ChapecoenseCasa2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentChapecoenseCasaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/brasileiro-b-2023/chapecoense/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        chapecoenseCasaB2023PartidaApi = retrofit.create(ChapecoenseCasaB2023PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvChapecoenseCasa.setHasFixedSize(true);
        binding.rvChapecoenseCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvChapecoenseCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        chapecoenseCasaB2023PartidaApi.getChapecoenseCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){

                    List<Partida> partidas = response.body();
                    chapecoenseCasaB2023Adapter = new ChapecoenseCasaB2023Adapter(partidas);
                    binding.rvChapecoenseCasa.setAdapter(chapecoenseCasaB2023Adapter);

                    binding.rvChapecoenseCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvChapecoenseCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
