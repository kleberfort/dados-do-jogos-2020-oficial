...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.sheffield.SheffieldForaAdapter;
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.sheffield.resultado.SheffieldForaResultadoAdapter;
...
import com.jogos.dadosoficialkf228920.databinding.FragmentSheffieldFrResultadoBinding;
...
public class SheffieldFrResultadoFragment extends Fragment {

    private FragmentSheffieldFrResultadoBinding binding;
    private SheffieldForaPartidaApi sheffieldForaPartidaApi;
    private SheffieldForaResultadoAdapter sheffieldForaResultadoAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSheffieldFrResultadoBinding.inflate(inflater, container, false);
        ...
        sheffieldForaPartidaApi.getSheffieldFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    sheffieldForaResultadoAdapter = new SheffieldForaResultadoAdapter(partidas);
                    binding.rvListaJogos.setAdapter(sheffieldForaResultadoAdapter);
