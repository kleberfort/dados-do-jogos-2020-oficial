...
import com.jogos.dadosoficialkf228920.databinding.FragmentLeHavreFrResultadoBinding;
 ...
 * Use the {@link LeHavreFrResultadoFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class LeHavreFrResultadoFragment extends Fragment {

    private FragmentLeHavreFrResultadoBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLeHavreFrResultadoBinding.inflate(inflater, container, false);
    ...
    private void setupDadosJogos() {
        ...
        jogosFrancesCasaFora2023_24Api.getLeHavreFora().enqueue(new Callback<List<Partida>>() {
            @Override
