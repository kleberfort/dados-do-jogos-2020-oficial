...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.cuiaba.CuiabaForaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.cuiaba.CuiabaForaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentCuiabaForaA2023Binding;
...
public class CuiabaFora2023Fragment extends Fragment {

    private FragmentCuiabaForaA2023Binding binding;
    private CuiabaForaA2023Adapter cuiabaForaA2023Adapter;
    private CuiabaForaA2023PartidaApi cuiabaForaA2023PartidaApi;



    public CuiabaFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCuiabaForaA2023Binding.inflate(inflater, container, false);
        ...
        cuiabaForaA2023PartidaApi.getCuiabaFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    cuiabaForaA2023Adapter = new CuiabaForaA2023Adapter(partidas);
                    binding.rvCuiabaFora.setAdapter(cuiabaForaA2023Adapter);
