...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.marseille.MarseilleCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.marseille.MarseilleCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentMarseilleCasa2023a24Binding;
...
public class MarseilleCasaFragment extends Fragment {

    private FragmentMarseilleCasa2023a24Binding binding;
    private MarseilleCasaPartidaApi marseilleCasaPartidaApi;
    private MarseilleCasaAdapter marseilleCasaAdapter;



    public MarseilleCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentMarseilleCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        marseilleCasaPartidaApi = retrofit.create(MarseilleCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        marseilleCasaPartidaApi.getMarseilleCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    marseilleCasaAdapter = new MarseilleCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(marseilleCasaAdapter);
