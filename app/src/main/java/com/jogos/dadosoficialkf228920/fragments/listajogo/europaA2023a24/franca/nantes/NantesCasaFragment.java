package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.nantes;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.nantes.NantesCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.nantes.NantesCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentNantesCasa2023a24Binding;
...
public class NantesCasaFragment extends Fragment {

    private FragmentNantesCasa2023a24Binding binding;
    private NantesCasaPartidaApi nantesCasaPartidaApi;
    private NantesCasaAdapter nantesCasaAdapter;



    public NantesCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentNantesCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/franca/nantes/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        nantesCasaPartidaApi = retrofit.create(NantesCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        nantesCasaPartidaApi.getNantesCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    nantesCasaAdapter = new NantesCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(nantesCasaAdapter);
