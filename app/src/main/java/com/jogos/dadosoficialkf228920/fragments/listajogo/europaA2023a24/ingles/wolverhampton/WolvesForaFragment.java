...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.wolverhampton.WolvesForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.ingles.wolverhampton.WolverhamptonForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentWolvesFora2023a24Binding;
...
public class WolvesForaFragment extends Fragment {

    private FragmentWolvesFora2023a24Binding binding;
    private WolverhamptonForaPartidaApi wolverhamptonForaPartidaApi;
    private WolvesForaAdapter wolvesForaAdapter;



    public WolvesForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentWolvesFora2023a24Binding.inflate(inflater, container, false);
        ...
        wolverhamptonForaPartidaApi.getWolverhamptonFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    wolvesForaAdapter = new WolvesForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(wolvesForaAdapter);
