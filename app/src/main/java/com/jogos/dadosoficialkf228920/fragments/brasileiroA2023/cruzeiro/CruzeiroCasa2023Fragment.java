package com.jogos.dadosoficialkf228920.fragments.brasileiroA2023.cruzeiro;
...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.cruzeiro.CruzeiroCasaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.cruzeiro.CruzeiroCasaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentCruzeiroCasaA2023Binding;
...
public class CruzeiroCasa2023Fragment extends Fragment {

    private FragmentCruzeiroCasaA2023Binding binding;
    private CruzeiroCasaA2023Adapter cruzeiroCasaA2023Adapter;
    private CruzeiroCasaA2023PartidaApi cruzeiroCasaA2023PartidaApi;





    public CruzeiroCasa2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCruzeiroCasaA2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        cruzeiroCasaA2023PartidaApi = retrofit.create(CruzeiroCasaA2023PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvCruzeiroCasa.setHasFixedSize(true);
        binding.rvCruzeiroCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvCruzeiroCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        cruzeiroCasaA2023PartidaApi.getCruzeiroCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    cruzeiroCasaA2023Adapter = new CruzeiroCasaA2023Adapter(partidas);
                    binding.rvCruzeiroCasa.setAdapter(cruzeiroCasaA2023Adapter);

                    binding.rvCruzeiroCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvCruzeiroCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
