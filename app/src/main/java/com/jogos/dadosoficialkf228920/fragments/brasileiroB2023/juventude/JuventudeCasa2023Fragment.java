...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.juventude.JuventudeCasaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.juventude.JuventudeCasaB2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentJuventudeCasaB2023Binding;
...
public class JuventudeCasa2023Fragment extends Fragment {

    private FragmentJuventudeCasaB2023Binding binding;
    private JuventudeCasaB2023Adapter juventudeCasaB2023Adapter;
    private JuventudeCasaB2023PartidaApi juventudeCasaB2023PartidaApi;
    ...
    public JuventudeCasa2023Fragment() {
    ...
    private void setupHttpClient() {
        ...
        juventudeCasaB2023PartidaApi = retrofit.create(JuventudeCasaB2023PartidaApi.class);
    }
    ...
    private void setupDadosJogos() {
        ...
        juventudeCasaB2023PartidaApi.getJuventudeCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    juventudeCasaB2023Adapter = new JuventudeCasaB2023Adapter(partidas);
                    binding.rvJuventudeCasa.setAdapter(juventudeCasaB2023Adapter);

                    binding.rvJuventudeCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvJuventudeCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
