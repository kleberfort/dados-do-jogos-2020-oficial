package com.jogos.dadosoficialkf228920.fragments.brasileiroA2023.gremio.resultado;
...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.gremio.resultado.GremioCsA2023RstdAdt;
...
import com.jogos.dadosoficialkf228920.databinding.FragmentGremioCs2023RstdBinding;
...
public class GremioCs2023RstdFragment extends Fragment {

    private FragmentGremioCs2023RstdBinding binding;
    private GremioCasaA2023PartidaApi gremioCasaA2023PartidaApi;
    private GremioCsA2023RstdAdt gremioCsA2023RstdAdt;

    public GremioCs2023RstdFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentGremioCs2023RstdBinding.inflate(inflater, container, false);
        ...
        gremioCasaA2023PartidaApi.getGremioCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    gremioCsA2023RstdAdt = new GremioCsA2023RstdAdt(partidas);
                    binding.rvListaResultado.setAdapter(gremioCsA2023RstdAdt);
