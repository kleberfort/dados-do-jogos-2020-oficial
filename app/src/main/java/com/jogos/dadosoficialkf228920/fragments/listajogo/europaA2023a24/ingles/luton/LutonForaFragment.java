package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.luton;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.luton.LutonForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.ingles.luton.LutonForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentLutonFora2023a24Binding;
...
public class LutonForaFragment extends Fragment {

    private FragmentLutonFora2023a24Binding binding;
    private LutonForaPartidaApi lutonForaPartidaApi;
    private LutonForaAdapter lutonForaAdapter;



    public LutonForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLutonFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        lutonForaPartidaApi = retrofit.create(LutonForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        lutonForaPartidaApi.getLutonFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    lutonForaAdapter = new LutonForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(lutonForaAdapter);
