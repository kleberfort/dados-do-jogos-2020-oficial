package com.jogos.dadosoficialkf228920.fragments.brasileiroB2023.vitoria;
...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.vitoria.VitoriaForaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.vitoria.VitoriaForaB2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentVitoriaForaB2023Binding;
...
public class VitoriaFora2023Fragment extends Fragment {

    private FragmentVitoriaForaB2023Binding binding;
    private VitoriaForaB2023Adapter vitoriaForaB2023Adapter;
    private VitoriaForaB2023PartidaApi vitoriaForaB2023PartidaApi;



    public VitoriaFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentVitoriaForaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/brasileiro-b-2023/vitoria/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        vitoriaForaB2023PartidaApi = retrofit.create(VitoriaForaB2023PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvVitoriaFora.setHasFixedSize(true);
        binding.rvVitoriaFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvVitoriaFora.addItemDecoration(new DividerItemDecoration(getContext(),LinearLayout.VERTICAL));


        vitoriaForaB2023PartidaApi.getVitoriaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    vitoriaForaB2023Adapter = new VitoriaForaB2023Adapter(partidas);
                    binding.rvVitoriaFora.setAdapter(vitoriaForaB2023Adapter);

                    binding.rvVitoriaFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvVitoriaFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
