...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.mirassol.MirassolForaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.mirassol.MirassolForaB2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentMirassolForaB2023Binding;
...
public class MirassolFora2023Fragment extends Fragment {

    private FragmentMirassolForaB2023Binding binding;
    private MirassolForaB2023Adapter mirassolForaB2023Adapter;
    private MirassolForaB2023PartidaApi mirassolForaB2023PartidaApi;





    public MirassolFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentMirassolForaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        mirassolForaB2023PartidaApi = retrofit.create(MirassolForaB2023PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvMirassolFora.setHasFixedSize(true);
        binding.rvMirassolFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvMirassolFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        mirassolForaB2023PartidaApi.getMirassolFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    mirassolForaB2023Adapter = new MirassolForaB2023Adapter(partidas);
                    binding.rvMirassolFora.setAdapter(mirassolForaB2023Adapter);

                    binding.rvMirassolFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvMirassolFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
