package com.jogos.dadosoficialkf228920.fragments.brasileiroA2023.bahia;
...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.bahia.BahiaCasaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.bahia.BahiaCasaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentBahiaCasaA2023Binding;
...
public class BahiaCasa2023Fragment extends Fragment {

    private FragmentBahiaCasaA2023Binding binding;
    private BahiaCasaA2023Adapter bahiaCasaA2023Adapter;
    private BahiaCasaA2023PartidaApi bahiaCasaA2023PartidaApi;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBahiaCasaA2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/brasileiro-a-2023/bahia/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        bahiaCasaA2023PartidaApi = retrofit.create(BahiaCasaA2023PartidaApi.class);

    }

    private void setupDadosJogos() {
        binding.rvBahiaCasa.setHasFixedSize(true);
        binding.rvBahiaCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvBahiaCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        bahiaCasaA2023PartidaApi.getBahiaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    bahiaCasaA2023Adapter = new BahiaCasaA2023Adapter(partidas);
                    binding.rvBahiaCasa.setAdapter(bahiaCasaA2023Adapter);

                    binding.rvBahiaCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvBahiaCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
