package com.jogos.dadosoficialkf228920.fragments.brasileiroB2023.londrina;
...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.londrina.LondrinaCasaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.londrina.LondrinaCasaB2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentLondrinaCasaB2023Binding;
...
public class LondrinaCasa2023Fragment extends Fragment {

    private FragmentLondrinaCasaB2023Binding binding;
    private LondrinaCasaB2023Adapter londrinaCasaB2023Adapter;
    private LondrinaCasaB2023PartidaApi londrinaCasaB2023PartidaApi;





    public LondrinaCasa2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLondrinaCasaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/brasileiro-b-2023/londrina/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        londrinaCasaB2023PartidaApi = retrofit.create(LondrinaCasaB2023PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvLondrinaCasa.setHasFixedSize(true);
        binding.rvLondrinaCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvLondrinaCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        londrinaCasaB2023PartidaApi.getLondrinaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    londrinaCasaB2023Adapter = new LondrinaCasaB2023Adapter(partidas);
                    binding.rvLondrinaCasa.setAdapter(londrinaCasaB2023Adapter);

                    binding.rvLondrinaCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvLondrinaCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
