package com.jogos.dadosoficialkf228920.fragments.inglesA2022a23.arsenal;
...
import com.jogos.dadosoficialkf228920.adapter.inglesA2022a2023.arsenal.ArsenalCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.inglesA2022a23.arsenal.ArsenalCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentArsenalCasa2022a23Binding;
...
public class ArsenalCasa2022a23Fragment extends Fragment {
    ...
    private List<Time> listaArsenalCasa;
    ...
    private void setupDadosJogos() {
        ...
        TimesInglesA2022a23Adapter timesInglesA2022a23Adapter = new TimesInglesA2022a23Adapter();
        ...
        arsenalCasaA2022a23PartidaApi.getArsenalCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvArsenalCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvArsenalCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
