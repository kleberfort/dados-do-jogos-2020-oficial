package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.juventus;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.juventus.JuventusForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.juventus.JuventusForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentJuventusFora2023a24Binding;
...
public class JuventusForaFragment extends Fragment {

    private FragmentJuventusFora2023a24Binding binding;
    private JuventusForaPartidaApi juventusForaPartidaApi;
    private JuventusForaAdapter juventusForaAdapter;



    public JuventusForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentJuventusFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/italiano/juventus/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        juventusForaPartidaApi = retrofit.create(JuventusForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        juventusForaPartidaApi.getJuventusFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    juventusForaAdapter = new JuventusForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(juventusForaAdapter);
