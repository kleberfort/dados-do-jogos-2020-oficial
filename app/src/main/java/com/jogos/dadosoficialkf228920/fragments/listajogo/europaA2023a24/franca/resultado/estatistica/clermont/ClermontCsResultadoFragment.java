...
import com.jogos.dadosoficialkf228920.databinding.FragmentClermontCsResultadoBinding;
...
public class ClermontCsResultadoFragment extends Fragment {

    private FragmentClermontCsResultadoBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentClermontCsResultadoBinding.inflate(inflater, container, false);
    ...
    private void setupDadosJogos() {
        ...
        jogosFrancesCasaFora2023_24Api.getClermontCasa().enqueue(new Callback<List<Partida>>() {
            @Override
