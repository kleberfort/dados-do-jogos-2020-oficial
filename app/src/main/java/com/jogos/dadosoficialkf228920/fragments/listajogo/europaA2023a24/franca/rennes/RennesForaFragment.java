package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.rennes;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.rennes.RennesForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.rennes.RennesForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentRennesFora2023a24Binding;
...
public class RennesForaFragment extends Fragment {

    private FragmentRennesFora2023a24Binding binding;
    private RennesForaPartidaApi rennesForaPartidaApi;
    private RennesForaAdapter rennesForaAdapter;



    public RennesForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentRennesFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/franca/rennes/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        rennesForaPartidaApi = retrofit.create(RennesForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        rennesForaPartidaApi.getRennesFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    rennesForaAdapter = new RennesForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(rennesForaAdapter);
