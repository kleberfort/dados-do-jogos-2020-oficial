package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.nice;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.nice.NiceForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.nice.NiceForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentNiceFora2023a24Binding;
...
public class NiceForaFragment extends Fragment {

    private FragmentNiceFora2023a24Binding binding;
    private NiceForaPartidaApi niceForaPartidaApi;
    private NiceForaAdapter niceForaAdapter;



    public NiceForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentNiceFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/franca/ogc-nice/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        niceForaPartidaApi = retrofit.create(NiceForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        niceForaPartidaApi.getNiceFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    niceForaAdapter = new NiceForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(niceForaAdapter);
