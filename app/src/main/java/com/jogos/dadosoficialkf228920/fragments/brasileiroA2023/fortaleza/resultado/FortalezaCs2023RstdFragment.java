...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.fortaleza.resultado.FortalezaCsA2023RstdAdt;
...
import com.jogos.dadosoficialkf228920.databinding.FragmentFortalezaCs2023RstdBinding;
...
public class FortalezaCs2023RstdFragment extends Fragment {

    private FragmentFortalezaCs2023RstdBinding binding;
    private FortalezaCasaA2023PartidaApi fortalezaCasaA2023PartidaApi;
    private FortalezaCsA2023RstdAdt fortalezaCsA2023RstdAdt;

    public FortalezaCs2023RstdFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFortalezaCs2023RstdBinding.inflate(inflater, container, false);
        ...
        fortalezaCasaA2023PartidaApi.getFortalezaCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    fortalezaCsA2023RstdAdt = new FortalezaCsA2023RstdAdt(partidas);
                    binding.rvListaResultado.setAdapter(fortalezaCsA2023RstdAdt);
