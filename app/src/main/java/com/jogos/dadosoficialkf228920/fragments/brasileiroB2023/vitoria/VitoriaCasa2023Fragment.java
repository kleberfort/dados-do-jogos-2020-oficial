...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.vitoria.VitoriaCasaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.vitoria.VitoriaCasaB2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentVitoriaCasaB2023Binding;
...
public class VitoriaCasa2023Fragment extends Fragment {

    private FragmentVitoriaCasaB2023Binding binding;
    private VitoriaCasaB2023Adapter vitoriaCasaB2023Adapter;
    private VitoriaCasaB2023PartidaApi vitoriaCasaB2023PartidaApi;
    ...
    public VitoriaCasa2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentVitoriaCasaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        vitoriaCasaB2023PartidaApi = retrofit.create(VitoriaCasaB2023PartidaApi.class);

    }

    private void setupDadosJogos() {

        binding.rvVitoriaCasa.setHasFixedSize(true);
        binding.rvVitoriaCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvVitoriaCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        vitoriaCasaB2023PartidaApi.getVitoriaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    vitoriaCasaB2023Adapter = new VitoriaCasaB2023Adapter(partidas);
                    binding.rvVitoriaCasa.setAdapter(vitoriaCasaB2023Adapter);

                    binding.rvVitoriaCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvVitoriaCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
