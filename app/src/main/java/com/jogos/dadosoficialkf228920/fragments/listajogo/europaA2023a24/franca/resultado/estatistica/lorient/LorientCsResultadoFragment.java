...
import com.jogos.dadosoficialkf228920.databinding.FragmentLorientCsResultadoBinding;
 ...
 * Use the {@link LorientCsResultadoFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class LorientCsResultadoFragment extends Fragment {

    private FragmentLorientCsResultadoBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLorientCsResultadoBinding.inflate(inflater, container, false);
    ...
    private void setupDadosJogos() {
        ...
        jogosFrancesCasaFora2023_24Api.getLorientCasa().enqueue(new Callback<List<Partida>>() {
            @Override
