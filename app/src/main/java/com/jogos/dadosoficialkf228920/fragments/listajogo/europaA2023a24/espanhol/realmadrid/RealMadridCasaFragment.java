...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.realmadrid.RealMadridCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.realmadrid.RealMadridCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentRealMadridCasa2023a24Binding;
...
public class RealMadridCasaFragment extends Fragment {

    private FragmentRealMadridCasa2023a24Binding binding;
    private RealMadridCasaPartidaApi realMadridCasaPartidaApi;
    private RealMadridCasaAdapter realMadridCasaAdapter;



    public RealMadridCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentRealMadridCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        realMadridCasaPartidaApi = retrofit.create(RealMadridCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        realMadridCasaPartidaApi.getRealMadridCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    realMadridCasaAdapter = new RealMadridCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(realMadridCasaAdapter);
