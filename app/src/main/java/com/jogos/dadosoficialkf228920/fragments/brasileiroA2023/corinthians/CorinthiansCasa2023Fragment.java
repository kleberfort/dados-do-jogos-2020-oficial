package com.jogos.dadosoficialkf228920.fragments.brasileiroA2023.corinthians;
...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.corinthians.CorinthiansCasaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.corinthians.CorinthiansCasaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentCorinthiansCasaA2023Binding;
...
public class CorinthiansCasa2023Fragment extends Fragment {

    private FragmentCorinthiansCasaA2023Binding binding;
    private CorinthiansCasaA2023Adapter corinthiansCasaA2023Adapter;
    private CorinthiansCasaA2023PartidaApi corinthiansCasaA2023PartidaApi;



    public CorinthiansCasa2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCorinthiansCasaA2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/brasileiro-a-2023/corinthians/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        corinthiansCasaA2023PartidaApi = retrofit.create(CorinthiansCasaA2023PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvCorinthiansCasa.setHasFixedSize(true);
        binding.rvCorinthiansCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvCorinthiansCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        corinthiansCasaA2023PartidaApi.getCorinthiansCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    corinthiansCasaA2023Adapter = new CorinthiansCasaA2023Adapter(partidas);
                    binding.rvCorinthiansCasa.setAdapter(corinthiansCasaA2023Adapter);

                    binding.rvCorinthiansCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvCorinthiansCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
