package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.leipzig;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.leipzig.LeipzigCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.augsburg.AugsburgCasaPartidaApi;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.leipzig.LeipzigCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAugsburgCasa2023a24Binding;
import com.jogos.dadosoficialkf228920.databinding.FragmentLeipzigCasa2023a24Binding;
...
public class LeipzigCasaFragment extends Fragment {

    private FragmentLeipzigCasa2023a24Binding binding;
    private LeipzigCasaPartidaApi leipzigCasaPartidaApi;
    private LeipzigCasaAdapter leipzigCasaAdapter;



    public LeipzigCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLeipzigCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/alemanha/leipzig/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        leipzigCasaPartidaApi = retrofit.create(LeipzigCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        leipzigCasaPartidaApi.getLeipzigCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    leipzigCasaAdapter = new LeipzigCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(leipzigCasaAdapter);
