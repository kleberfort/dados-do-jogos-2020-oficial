package com.jogos.dadosoficialkf228920.fragments.inglesA2022a23.liverpool;
...
import com.jogos.dadosoficialkf228920.adapter.inglesA2022a2023.liverpool.LiverpoolFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.inglesA2022a23.liverpool.LiverpoolForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentLiverpoolFora2022a23Binding;
        ...
        liverpoolForaA2022a23PartidaApi.getLiverpoolCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvLiverpoolFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvLiverpoolFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
