...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.bahia.BahiaForaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.bahia.BahiaForaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentBahiaForaA2023Binding;
...
public class BahiaFora2023Fragment extends Fragment {

    private FragmentBahiaForaA2023Binding binding;
    private BahiaForaA2023Adapter bahiaForaA2023Adapter;
    private BahiaForaA2023PartidaApi bahiaForaA2023PartidaApi;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBahiaForaA2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        bahiaForaA2023PartidaApi = retrofit.create(BahiaForaA2023PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvBahiaFora.setHasFixedSize(true);
        binding.rvBahiaFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvBahiaFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        bahiaForaA2023PartidaApi.getBahiaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    bahiaForaA2023Adapter = new BahiaForaA2023Adapter(partidas);
                    binding.rvBahiaFora.setAdapter(bahiaForaA2023Adapter);

                    binding.rvBahiaFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvBahiaFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
