...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.lens.LensCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.lens.LensCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentLensCasa2023a24Binding;
...
public class LensCasaFragment extends Fragment {

    private FragmentLensCasa2023a24Binding binding;
    private LensCasaPartidaApi lensCasaPartidaApi;
    private LensCasaAdapter lensCasaAdapter;



    public LensCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLensCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        lensCasaPartidaApi = retrofit.create(LensCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        lensCasaPartidaApi.getLensCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    lensCasaAdapter = new LensCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(lensCasaAdapter);
