...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.laspalmas.LasPalmasCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.laspalmas.LasPalmasCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentLasPalmasCasa2023a24Binding;
...
public class LasPalmasCasaFragment extends Fragment {

    private FragmentLasPalmasCasa2023a24Binding binding;
    private LasPalmasCasaPartidaApi lasPalmasCasaPartidaApi;
    private LasPalmasCasaAdapter lasPalmasCasaAdapter;



    public LasPalmasCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLasPalmasCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        lasPalmasCasaPartidaApi = retrofit.create(LasPalmasCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        lasPalmasCasaPartidaApi.getLasPalmasCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    lasPalmasCasaAdapter = new LasPalmasCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(lasPalmasCasaAdapter);
