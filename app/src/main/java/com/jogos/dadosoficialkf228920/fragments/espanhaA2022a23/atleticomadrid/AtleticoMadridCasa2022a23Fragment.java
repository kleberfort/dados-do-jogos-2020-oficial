package com.jogos.dadosoficialkf228920.fragments.espanhaA2022a23.atleticomadrid;
...
import com.jogos.dadosoficialkf228920.adapter.espanhaA2022a23.atleticomadrid.AtleticoMadridCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.espanhaA2022a23.atleticomadrid.AtleticoMadridCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAtleticoMadridCasa2022a23Binding;
...
public class AtleticoMadridCasa2022a23Fragment extends Fragment {

    private FragmentAtleticoMadridCasa2022a23Binding binding;
    private AtleticoMadridCasaA2022a23PartidaApi atleticoMadridCasaA2022a23PartidaApi;
    private AtleticoMadridCasa2022a23Adapter atleticoMadridCasa2022a23Adapter;


    public AtleticoMadridCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAtleticoMadridCasa2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        atleticoMadridCasaA2022a23PartidaApi = retrofit.create(AtleticoMadridCasaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvAtleticoMadridCasa.setHasFixedSize(true);
        binding.rvAtleticoMadridCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvAtleticoMadridCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        atleticoMadridCasaA2022a23PartidaApi.getAtleticoMadridCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    atleticoMadridCasa2022a23Adapter = new AtleticoMadridCasa2022a23Adapter(partidas);
                    binding.rvAtleticoMadridCasa.setAdapter(atleticoMadridCasa2022a23Adapter);

                    binding.rvAtleticoMadridCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvAtleticoMadridCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
