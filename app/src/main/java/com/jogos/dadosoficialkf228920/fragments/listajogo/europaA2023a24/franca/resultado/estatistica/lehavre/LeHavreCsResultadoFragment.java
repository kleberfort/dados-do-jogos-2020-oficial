...
import com.jogos.dadosoficialkf228920.databinding.FragmentLeHavreCsResultadoBinding;
 ...
 * Use the {@link LeHavreCsResultadoFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class LeHavreCsResultadoFragment extends Fragment {

    private FragmentLeHavreCsResultadoBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLeHavreCsResultadoBinding.inflate(inflater, container, false);
    ...
    private void setupDadosJogos() {
        ...
        jogosFrancesCasaFora2023_24Api.getLeHavreCasa().enqueue(new Callback<List<Partida>>() {
            @Override
