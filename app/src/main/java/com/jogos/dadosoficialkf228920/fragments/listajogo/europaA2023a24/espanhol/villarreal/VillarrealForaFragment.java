...
public class VillarrealForaFragment extends Fragment {

    private FragmentVillarrealFora2023a24Binding binding;
    private VillarrealForaPartidaApi villarrealForaPartidaApi;
    private VillarrealForaAdapter villarrealForaAdapter;



    public VillarrealForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentVillarrealFora2023a24Binding.inflate(inflater, container, false);
        ...
        villarrealForaPartidaApi.getVillarrealFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    villarrealForaAdapter = new VillarrealForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(villarrealForaAdapter);
