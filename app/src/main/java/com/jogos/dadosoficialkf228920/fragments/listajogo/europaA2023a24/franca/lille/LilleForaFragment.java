...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.lille.LilleForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.lille.LilleForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentLilleFora2023a24Binding;
...
public class LilleForaFragment extends Fragment {

    private FragmentLilleFora2023a24Binding binding;
    private LilleForaPartidaApi lilleForaPartidaApi;
    private LilleForaAdapter lilleForaAdapter;



    public LilleForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLilleFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        lilleForaPartidaApi = retrofit.create(LilleForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        lilleForaPartidaApi.getLilleFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    lilleForaAdapter = new LilleForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(lilleForaAdapter);
