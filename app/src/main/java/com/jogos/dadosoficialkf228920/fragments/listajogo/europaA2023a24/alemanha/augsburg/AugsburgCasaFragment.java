...
public class AugsburgCasaFragment extends Fragment {

    private FragmentAugsburgCasa2023a24Binding binding;
    private AugsburgCasaPartidaApi augsburgCasaPartidaApi;
    private AugsburgCasaAdapter augsburgCasaAdapter;



    public AugsburgCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAugsburgCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        augsburgCasaPartidaApi = retrofit.create(AugsburgCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        augsburgCasaPartidaApi.getAugsburgCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    augsburgCasaAdapter = new AugsburgCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(augsburgCasaAdapter);
