...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.atheticoPR.AtheticoPrForaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.atleticoPR.AtleticoPrForaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAtheticoPrForaA2023Binding;
...
public class AtleticoPrFora2023Fragment extends Fragment {

    private FragmentAtheticoPrForaA2023Binding binding;
    private AtheticoPrForaA2023Adapter atheticoPrForaA2023Adapter;
    ...
    public AtleticoPrFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAtheticoPrForaA2023Binding.inflate(inflater, container, false);
    ...
    private void setupDadosJogos() {
        binding.rvAtheticoPrFora.setHasFixedSize(true);
        binding.rvAtheticoPrFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvAtheticoPrFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));
        ...
        atleticoPrForaA2023PartidaApi.getAtleticoPrFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    atheticoPrForaA2023Adapter = new AtheticoPrForaA2023Adapter(partidas);
                    binding.rvAtheticoPrFora.setAdapter(atheticoPrForaA2023Adapter);

                    binding.rvAtheticoPrFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvAtheticoPrFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
