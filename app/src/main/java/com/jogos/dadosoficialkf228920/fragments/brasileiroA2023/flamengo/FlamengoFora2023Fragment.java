...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.flamengo.FlamengoForaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.flamengo.FlamengoForaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentFlamengoForaA2023Binding;
...
public class FlamengoFora2023Fragment extends Fragment {

    private FragmentFlamengoForaA2023Binding binding;
    private FlamengoForaA2023Adapter flamengoForaA2023Adapter;
    private FlamengoForaA2023PartidaApi flamengoForaA2023PartidaApi;




    public FlamengoFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFlamengoForaA2023Binding.inflate(inflater, container, false);
        ...
        flamengoForaA2023PartidaApi.getFlamengoFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    flamengoForaA2023Adapter = new FlamengoForaA2023Adapter(partidas);
                    binding.rvFlamengoFora.setAdapter(flamengoForaA2023Adapter);

                    binding.rvFlamengoFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvFlamengoFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
