...
import com.jogos.dadosoficialkf228920.databinding.FragmentLorientFrResultadoBinding;
 ...
 * Use the {@link LorientFrResultadoFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class LorientFrResultadoFragment extends Fragment {

    private FragmentLorientFrResultadoBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLorientFrResultadoBinding.inflate(inflater, container, false);
    ...
    private void setupDadosJogos() {
        ...
        jogosFrancesCasaFora2023_24Api.getLorientFora().enqueue(new Callback<List<Partida>>() {
            @Override
