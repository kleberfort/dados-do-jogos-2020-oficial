...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.cagliari.CagliariForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.cagliari.CagliariForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentCagliariFora2023a24Binding;
...
public class CagliariForaFragment extends Fragment {

    private FragmentCagliariFora2023a24Binding binding;
    private CagliariForaPartidaApi cagliariForaPartidaApi;
    private CagliariForaAdapter cagliariForaAdapter;



    public CagliariForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCagliariFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        cagliariForaPartidaApi = retrofit.create(CagliariForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        cagliariForaPartidaApi.getCagliariFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    cagliariForaAdapter = new CagliariForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(cagliariForaAdapter);
