...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.vasco.VascoCasaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.vasco.VascoCasaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentVascoCasaA2023Binding;
...
public class VascoCasa2023Fragment extends Fragment {

    private FragmentVascoCasaA2023Binding binding;
    private VascoCasaA2023Adapter vascoCasaA2023Adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentVascoCasaA2023Binding.inflate(inflater, container, false);
    ...
    private void setupDadosJogos() {
        binding.rvVascoCasa.setHasFixedSize(true);
        binding.rvVascoCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvVascoCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));
        ...
        vascoCasaA2023PartidaApi.getVascoCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    vascoCasaA2023Adapter = new VascoCasaA2023Adapter(partidas);
                    binding.rvVascoCasa.setAdapter(vascoCasaA2023Adapter);

                    binding.rvVascoCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvVascoCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
