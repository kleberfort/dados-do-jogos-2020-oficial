package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.liverpool;
...
import com.jogos.dadosoficialkf228920.databinding.FragmentLiverpoolCasa2023a24Binding;
...
public class LiverpoolCasaFragment extends Fragment {

    private FragmentLiverpoolCasa2023a24Binding binding;
    private LiverpoolCasaPartidaApi liverpoolCasaPartidaApi;
    private LiverpoolCasaAdapter liverpoolCasaAdapter;



    public LiverpoolCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLiverpoolCasa2023a24Binding.inflate(inflater, container, false);
        ...
        liverpoolCasaPartidaApi.getLiverpoolCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    liverpoolCasaAdapter = new LiverpoolCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(liverpoolCasaAdapter);
