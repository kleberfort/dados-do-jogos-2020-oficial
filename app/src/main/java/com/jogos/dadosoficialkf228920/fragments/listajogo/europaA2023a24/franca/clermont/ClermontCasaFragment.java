package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.clermont;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.clermont.ClermontCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.clermont.ClermontCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentClermontCasa2023a24Binding;
...
public class ClermontCasaFragment extends Fragment {

    private FragmentClermontCasa2023a24Binding binding;
    private ClermontCasaPartidaApi clermontCasaPartidaApi;
    private ClermontCasaAdapter clermontCasaAdapter;



    public ClermontCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentClermontCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/franca/clermont/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        clermontCasaPartidaApi = retrofit.create(ClermontCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        clermontCasaPartidaApi.getClermontCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    clermontCasaAdapter = new ClermontCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(clermontCasaAdapter);
