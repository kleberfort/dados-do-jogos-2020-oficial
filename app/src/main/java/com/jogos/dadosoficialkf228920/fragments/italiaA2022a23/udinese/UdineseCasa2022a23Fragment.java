...
import com.jogos.dadosoficialkf228920.adapter.italiaA2022a23.udinese.UdineseCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.italiaA2022a23.udinese.UdineseCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentUdineseCasa2022a23Binding;
...
public class UdineseCasa2022a23Fragment extends Fragment {
    ...
    private void setupHttpClient() {
        ...
        udineseCasaA2022a23PartidaApi = retrofit.create(UdineseCasaA2022a23PartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        udineseCasaA2022a23PartidaApi.getUdineseCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    udineseCasa2022a23Adapter = new UdineseCasa2022a23Adapter(partidas);
                    binding.rvUdineseCasa.setAdapter(udineseCasa2022a23Adapter);

                    binding.rvUdineseCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvUdineseCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
