package com.jogos.dadosoficialkf228920.fragments.italiaA2022a23.empoli;
...
import com.jogos.dadosoficialkf228920.adapter.italiaA2022a23.empoli.EmpoliCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.italiaA2022a23.empoli.EmpoliCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentEmpoliCasa2022a23Binding;
...
public class EmpoliCasa2022a23Fragment extends Fragment {
    ...
    private void setupHttpClient() {
        ...
        empoliCasaA2022a23PartidaApi = retrofit.create(EmpoliCasaA2022a23PartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        empoliCasaA2022a23PartidaApi.getEmpoliCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    empoliCasa2022a23Adapter = new EmpoliCasa2022a23Adapter(partidas);
                    binding.rvEmpoliCasa.setAdapter(empoliCasa2022a23Adapter);

                    binding.rvEmpoliCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvEmpoliCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
