package com.jogos.dadosoficialkf228920.fragments.brasileiroA2023.goias;
...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.goias.GoiasForaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.goias.GoiasForaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentGoiasForaA2023Binding;
...
public class GoiasFora2023Fragment extends Fragment {

    private FragmentGoiasForaA2023Binding binding;
    private GoiasForaA2023Adapter goiasForaA2023Adapter;
    private GoiasForaA2023PartidaApi goiasForaA2023PartidaApi;



    public GoiasFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentGoiasForaA2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/brasileiro-a-2023/goias/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        goiasForaA2023PartidaApi = retrofit.create(GoiasForaA2023PartidaApi.class);
    }
    ...
    private void setupDadosJogos() {
        ...
        goiasForaA2023PartidaApi.getGoiasFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    goiasForaA2023Adapter = new GoiasForaA2023Adapter(partidas);
                    binding.rvGoiasFora.setAdapter(goiasForaA2023Adapter);

                    binding.rvGoiasFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvGoiasFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
