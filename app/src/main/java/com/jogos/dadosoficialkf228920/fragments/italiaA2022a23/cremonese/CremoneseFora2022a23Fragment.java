package com.jogos.dadosoficialkf228920.fragments.italiaA2022a23.cremonese;
...
import com.jogos.dadosoficialkf228920.adapter.italiaA2022a23.cremonese.CremoneseFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.italiaA2022a23.cremonese.CremoneseForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentCremoneseFora2022a23Binding;
...
public class CremoneseFora2022a23Fragment extends Fragment {

    private FragmentCremoneseFora2022a23Binding binding;
    private CremoneseForaA2022a23PartidaApi cremoneseForaA2022a23PartidaApi;
    private CremoneseFora2022a23Adapter cremoneseFora2022a23Adapter;


    public CremoneseFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCremoneseFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/italia-a-2022-23/cremonese/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        cremoneseForaA2022a23PartidaApi = retrofit.create(CremoneseForaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvCremoneseFora.setHasFixedSize(true);
        binding.rvCremoneseFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvCremoneseFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        cremoneseForaA2022a23PartidaApi.getCremoneseFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    cremoneseFora2022a23Adapter = new CremoneseFora2022a23Adapter(partidas);
                    binding.rvCremoneseFora.setAdapter(cremoneseFora2022a23Adapter);

                    binding.rvCremoneseFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvCremoneseFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
