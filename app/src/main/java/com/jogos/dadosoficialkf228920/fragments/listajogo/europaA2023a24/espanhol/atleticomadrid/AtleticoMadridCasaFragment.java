...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.atleticomadrid.AtleticoMadridCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.atleticomadrid.AtleticoMadridCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAtleticoMadridCasa2023a24Binding;
...
public class AtleticoMadridCasaFragment extends Fragment {

    private FragmentAtleticoMadridCasa2023a24Binding binding;
    private AtleticoMadridCasaPartidaApi atleticoMadridCasaPartidaApi;
    private AtleticoMadridCasaAdapter atleticoMadridCasaAdapter;



    public AtleticoMadridCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAtleticoMadridCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        atleticoMadridCasaPartidaApi = retrofit.create(AtleticoMadridCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        atleticoMadridCasaPartidaApi.getAtleticoMadridCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    atleticoMadridCasaAdapter = new AtleticoMadridCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(atleticoMadridCasaAdapter);
