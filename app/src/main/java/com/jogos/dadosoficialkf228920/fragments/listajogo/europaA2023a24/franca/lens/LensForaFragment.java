package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.lens;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.lens.LensForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.lens.LensForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentLensFora2023a24Binding;
...
public class LensForaFragment extends Fragment {

    private FragmentLensFora2023a24Binding binding;
    private LensForaPartidaApi lensForaPartidaApi;
    private LensForaAdapter lensForaAdapter;



    public LensForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLensFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/franca/lens/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        lensForaPartidaApi = retrofit.create(LensForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        lensForaPartidaApi.getLensFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    lensForaAdapter = new LensForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(lensForaAdapter);
