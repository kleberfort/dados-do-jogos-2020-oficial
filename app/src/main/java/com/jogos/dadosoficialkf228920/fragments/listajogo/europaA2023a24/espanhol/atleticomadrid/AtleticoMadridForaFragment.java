package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.atleticomadrid;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.atleticomadrid.AtleticoMadridForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.atleticomadrid.AtleticoMadridForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAtleticoMadridFora2023a24Binding;
...
public class AtleticoMadridForaFragment extends Fragment {

    private FragmentAtleticoMadridFora2023a24Binding binding;
    private AtleticoMadridForaPartidaApi atleticoMadridForaPartidaApi;
    private AtleticoMadridForaAdapter atleticoMadridForaAdapter;



    public AtleticoMadridForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAtleticoMadridFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/espanhol/atletico-de-madrid/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        atleticoMadridForaPartidaApi = retrofit.create(AtleticoMadridForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        atleticoMadridForaPartidaApi.getAtleticoMadridFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    atleticoMadridForaAdapter = new AtleticoMadridForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(atleticoMadridForaAdapter);
