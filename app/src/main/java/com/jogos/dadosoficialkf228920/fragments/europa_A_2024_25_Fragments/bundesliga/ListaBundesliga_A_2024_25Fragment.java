...
import static com.appodeal.ads.y0.m;
...
import com.jogos.dadosoficialkf228920.databinding.FragmentListaBundesligaA202425Binding;
import com.jogos.dadosoficialkf228920.fragments.europa_A_2024_25_Fragments.bundesliga.util.JogosBundesliga_A_2024_25;
import com.jogos.dadosoficialkf228920.fragments.europa_A_2024_25_Fragments.bundesliga.util.JogosBundesliga_A_2024_25_Listener;
...
public class ListaBundesliga_A_2024_25Fragment extends Fragment implements JogosBundesliga_A_2024_25_Listener {

   private FragmentListaBundesligaA202425Binding binding;
   private JogosBundesliga_A_2024_25 bundesligaA202425;
   private TimesClasificacaoBrasilA2024Adapter timesClasificacaoBrasilA2024Adapter;
    ...
    public interface ListaBundesliga2025_OnClinkInterface{//esse é o codigo de criar a interface // entede essa primeira parte ? ele basicamente
        void listaBundesligaOnClick2025Metodo(String nome);//viu que é uma string ?sim
    }

    public interface ListaBundesliga2025_LongClickInterface{
        void listaBundesligaLongClick2025metodo();
    }

    //2 etapa criamos uma variavel da interface
    ListaBundesliga2025_OnClinkInterface listaBundesligaOnClick = null;//queremos usar o metodo listaBrasilAMetodo(String nome) mas estamos iniciando ela com o valor null
    //ou seuja null é igual a nulo ou nada
    //entende isso ?sim

    //2 etapa criamos uma variavel da interface
   ListaBundesliga2025_LongClickInterface listaBundesligaLongClick = null;
    ...
    public void onAttach(@NonNull Context context) {//
        ...
        if(context instanceof ListaBundesliga2025_OnClinkInterface){
            listaBundesligaOnClick = (ListaBundesliga2025_OnClinkInterface) context;//aqui iniciamos a nossa variavel... Esse código voce nao precisa entender, só tem que
            //compreendeu as 3 etapadas ?sim ok
        }

        if(context instanceof ListaBundesliga2025_LongClickInterface){
            listaBundesligaLongClick = (ListaBundesliga2025_LongClickInterface) context;
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentListaBundesligaA202425Binding.inflate(inflater, container, false);
        View view = binding.getRoot();

        bundesligaA202425 = new JogosBundesliga_A_2024_25();
        bundesligaA202425.setupHttpClient();
        bundesligaA202425.setupDadosJogos();
        bundesligaA202425.setListener(this);
        ...
        binding.rvLista.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvLista, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                if (acessos >= 3) {
                    listaBundesligaOnClick.listaBundesligaOnClick2025Metodo(name);
            ...
            public void onLongItemClick(View view, int position) {
                listaBundesligaLongClick.listaBundesligaLongClick2025metodo();
    ...
    @Override
    public void onJogosBundesliga_A(HashMap<String, Map<String, List<MatchNewModelDate>>> partidasPorTime) {
