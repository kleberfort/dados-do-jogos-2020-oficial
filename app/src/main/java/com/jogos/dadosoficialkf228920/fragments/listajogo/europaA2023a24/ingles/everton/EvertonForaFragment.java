...
import com.jogos.dadosoficialkf228920.databinding.FragmentEvertonFora2023a24Binding;
...
public class EvertonForaFragment extends Fragment {

    private FragmentEvertonFora2023a24Binding binding;
    private EvertonForaPartidaApi evertonForaPartidaApi;
    private EvertonForaAdapter evertonForaAdapter;



    public EvertonForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentEvertonFora2023a24Binding.inflate(inflater, container, false);
        ...
        evertonForaPartidaApi.getEvertonFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    evertonForaAdapter = new EvertonForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(evertonForaAdapter);
