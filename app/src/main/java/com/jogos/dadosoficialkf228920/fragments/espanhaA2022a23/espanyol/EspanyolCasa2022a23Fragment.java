...
import com.jogos.dadosoficialkf228920.adapter.espanhaA2022a23.espanyol.EspanyolCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.espanhaA2022a23.espanyol.EspanyolCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentEspanyolCasa2022a23Binding;
...
public class EspanyolCasa2022a23Fragment extends Fragment {
    ...
    private void setupHttpClient() {
        ...
        espanyolCasaA2022a23PartidaApi = retrofit.create(EspanyolCasaA2022a23PartidaApi.class);
    }
    ...
    private void setupDadosJogos() {
        ...
        espanyolCasaA2022a23PartidaApi.getEspanyolCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    espanyolCasa2022a23Adapter = new EspanyolCasa2022a23Adapter(partidas);
                    binding.rvEspanyolCasa.setAdapter(espanyolCasa2022a23Adapter);

                    binding.rvEspanyolCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvEspanyolCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
