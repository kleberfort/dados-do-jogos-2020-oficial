package com.jogos.dadosoficialkf228920.fragments.brasileiroB2023.avai;
...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.avai.AvaiCasaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.avai.AvaiCasaB2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAvaiCasaB2023Binding;
...
public class AvaiCasa2023Fragment extends Fragment {

    private FragmentAvaiCasaB2023Binding binding;
    private AvaiCasaB2023Adapter avaiCasaB2023Adapter;
    private AvaiCasaB2023PartidaApi avaiCasaB2023PartidaApi;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAvaiCasaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/brasileiro-b-2023/avai/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        avaiCasaB2023PartidaApi = retrofit.create(AvaiCasaB2023PartidaApi.class);
    }
    ...
    private void setupDadosJogos() {
        ...
        avaiCasaB2023PartidaApi.getAvaiCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    avaiCasaB2023Adapter = new AvaiCasaB2023Adapter(partidas);
                    binding.rvAvaiCasa.setAdapter(avaiCasaB2023Adapter);

                    binding.rvAvaiCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvAvaiCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
