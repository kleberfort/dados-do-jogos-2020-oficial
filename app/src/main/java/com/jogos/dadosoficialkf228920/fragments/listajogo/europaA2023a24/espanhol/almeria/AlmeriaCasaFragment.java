package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.almeria;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.almeria.AlmeriaCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.almeria.AlmeriaCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAlmeriaCasa2023a24Binding;
...
public class AlmeriaCasaFragment extends Fragment {

    private FragmentAlmeriaCasa2023a24Binding binding;
    private AlmeriaCasaPartidaApi almeriaCasaPartidaApi;
    private AlmeriaCasaAdapter almeriaCasaAdapter;



    public AlmeriaCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAlmeriaCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/espanhol/almeria/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        almeriaCasaPartidaApi = retrofit.create(AlmeriaCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        almeriaCasaPartidaApi.getAlmeriaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    almeriaCasaAdapter = new AlmeriaCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(almeriaCasaAdapter);
