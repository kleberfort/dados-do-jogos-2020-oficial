package com.jogos.dadosoficialkf228920.fragments.inglesA2022a23.brentford;
...
import com.jogos.dadosoficialkf228920.adapter.inglesA2022a2023.brentford.BrentfordFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.inglesA2022a23.brentford.BrentfordForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentBrentfordFora2022a23Binding;
...
public class BrentfordFora2022a23Fragment extends Fragment {

    private FragmentBrentfordFora2022a23Binding binding;
    private BrentfordForaA2022a23PartidaApi brentfordForaA2022a23PartidaApi;
    private BrentfordFora2022a23Adapter brentfordFora2022a23Adapter;


    public BrentfordFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBrentfordFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/ingles-a-2022-23/brentford/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        brentfordForaA2022a23PartidaApi = retrofit.create(BrentfordForaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvBrentfordFora.setHasFixedSize(true);
        binding.rvBrentfordFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvBrentfordFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        brentfordForaA2022a23PartidaApi.getBrentfordCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    brentfordFora2022a23Adapter = new BrentfordFora2022a23Adapter(partidas);
                    binding.rvBrentfordFora.setAdapter(brentfordFora2022a23Adapter);

                    binding.rvBrentfordFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvBrentfordFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
