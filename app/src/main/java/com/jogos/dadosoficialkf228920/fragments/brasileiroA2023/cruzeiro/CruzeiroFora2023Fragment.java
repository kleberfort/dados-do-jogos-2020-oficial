...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.cruzeiro.CruzeiroForaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.cruzeiro.CruzeiroForaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentCruzeiroForaA2023Binding;
...
public class CruzeiroFora2023Fragment extends Fragment {

    private FragmentCruzeiroForaA2023Binding binding;
    private CruzeiroForaA2023Adapter cruzeiroForaA2023Adapter;
    ...
    public CruzeiroFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCruzeiroForaA2023Binding.inflate(inflater, container, false);
    ...
    private void setupDadosJogos() {
        binding.rvCruzeiroFora.setHasFixedSize(true);
        binding.rvCruzeiroFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvCruzeiroFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));
        ...
        cruzeiroForaA2023PartidaApi.getCruzeiroFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    cruzeiroForaA2023Adapter = new CruzeiroForaA2023Adapter(partidas);
                    binding.rvCruzeiroFora.setAdapter(cruzeiroForaA2023Adapter);

                    binding.rvCruzeiroFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvCruzeiroFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
