package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.milan;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.milan.MilanCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.milan.MilanCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentMilanCasa2023a24Binding;
...
public class MilanCasaFragment extends Fragment {

    private FragmentMilanCasa2023a24Binding binding;
    private MilanCasaPartidaApi milanCasaPartidaApi;
    private MilanCasaAdapter milanCasaAdapter;



    public MilanCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentMilanCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/italiano/ac-milan/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        milanCasaPartidaApi = retrofit.create(MilanCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        milanCasaPartidaApi.getMilanCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    milanCasaAdapter = new MilanCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(milanCasaAdapter);
