...
import com.jogos.dadosoficialkf228920.adapter.francaA2022a23.montpellier.MontpellierFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.francaA2022a23.montpellier.MontpellierForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentMontpellierFora2022a23Binding;
        ...
        montpellierForaA2022a23PartidaApi.getMontpellierFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvMontepellierFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvMontepellierFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
