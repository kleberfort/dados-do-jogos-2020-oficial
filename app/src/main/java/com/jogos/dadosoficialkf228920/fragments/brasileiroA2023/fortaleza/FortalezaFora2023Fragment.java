...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.fortaleza.FortalezaForaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.fortaleza.FortalezaForaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentFortalezaForaA2023Binding;
...
public class FortalezaFora2023Fragment extends Fragment {

    private FragmentFortalezaForaA2023Binding binding;
    private FortalezaForaA2023Adapter fortalezaForaA2023Adapter;
    private FortalezaForaA2023PartidaApi fortalezaForaA2023PartidaApi;





    public FortalezaFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFortalezaForaA2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        fortalezaForaA2023PartidaApi = retrofit.create(FortalezaForaA2023PartidaApi.class);
    }
    ...
    private void setupDadosJogos() {
        ...
        fortalezaForaA2023PartidaApi.getFortalezaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    fortalezaForaA2023Adapter = new FortalezaForaA2023Adapter(partidas);
                    binding.rvFortalezaFora.setAdapter(fortalezaForaA2023Adapter);

                    binding.rvFortalezaFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvFortalezaFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
