package com.jogos.dadosoficialkf228920.fragments.inglesA2022a23.everton;
...
import com.jogos.dadosoficialkf228920.adapter.inglesA2022a2023.everton.EvertonCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.inglesA2022a23.everton.EvertonCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentEvertonCasa2022a23Binding;
        ...
        evertonCasaA2022a23PartidaApi.getEvertonCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvEvertonCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvEvertonCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
