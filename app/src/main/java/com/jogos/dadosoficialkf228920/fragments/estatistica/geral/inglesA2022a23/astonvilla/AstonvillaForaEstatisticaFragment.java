package com.jogos.dadosoficialkf228920.fragments.estatistica.geral.inglesA2022a23.astonvilla;
...
public class AstonvillaForaEstatisticaFragment extends Fragment {
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/ingles-a-2022-23/aston-villa/")                .addConverterFactory(GsonConverterFactory.create())
                .build();
