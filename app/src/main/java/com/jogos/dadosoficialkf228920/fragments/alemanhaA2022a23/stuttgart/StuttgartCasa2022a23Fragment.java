package com.jogos.dadosoficialkf228920.fragments.alemanhaA2022a23.stuttgart;
...
import com.jogos.dadosoficialkf228920.adapter.alemanhaA2022a23.stuttgart.StuttgartCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.alemanhaA2022a23.stuttgart.StuttgartCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentStuttgartCasa2022a23Binding;
        ...
        stuttgartCasaA2022a23PartidaApi.getStuttgartCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvStuttgartCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvStuttgartCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
