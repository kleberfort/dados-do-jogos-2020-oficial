package com.jogos.dadosoficialkf228920.fragments.brasileiroB2023.crb;
...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.crb.CrbForaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.crb.CrbForaB2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentCrbForaB2023Binding;
...
public class CrbFora2023Fragment extends Fragment {


    private FragmentCrbForaB2023Binding binding;
    private CrbForaB2023Adapter crbForaB2023Adapter;
    private CrbForaB2023PartidaApi crbForaB2023PartidaApi;




    public CrbFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCrbForaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/brasileiro-b-2023/crb/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        crbForaB2023PartidaApi = retrofit.create(CrbForaB2023PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvCrbFora.setHasFixedSize(true);
        binding.rvCrbFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvCrbFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        crbForaB2023PartidaApi.getCrbFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    crbForaB2023Adapter = new CrbForaB2023Adapter(partidas);
                    binding.rvCrbFora.setAdapter(crbForaB2023Adapter);

                    binding.rvCrbFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvCrbFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
