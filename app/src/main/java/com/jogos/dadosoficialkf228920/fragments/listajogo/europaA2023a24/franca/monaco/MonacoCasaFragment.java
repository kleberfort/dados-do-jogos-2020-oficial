package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.monaco;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.monaco.MonacoCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.monaco.MonacoCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentMonacoCasa2023a24Binding;
...
public class MonacoCasaFragment extends Fragment {

    private FragmentMonacoCasa2023a24Binding binding;
    private MonacoCasaPartidaApi monacoCasaPartidaApi;
    private MonacoCasaAdapter monacoCasaAdapter;



    public MonacoCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentMonacoCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/franca/monaco/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        monacoCasaPartidaApi = retrofit.create(MonacoCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        monacoCasaPartidaApi.getMonacoCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    monacoCasaAdapter = new MonacoCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(monacoCasaAdapter);
