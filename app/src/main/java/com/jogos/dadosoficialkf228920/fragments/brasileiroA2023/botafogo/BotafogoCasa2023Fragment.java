...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.botafogo.BotafogoCasaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.botafogo.BotafogoCasaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentBotafogoCasaA2023Binding;
...
public class BotafogoCasa2023Fragment extends Fragment {

    private FragmentBotafogoCasaA2023Binding binding;
    private BotafogoCasaA2023Adapter botafogoCasaA2023Adapter;
    private BotafogoCasaA2023PartidaApi botafogoCasaA2023PartidaApi;



    public BotafogoCasa2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBotafogoCasaA2023Binding.inflate(inflater, container, false);
        ...
        botafogoCasaA2023PartidaApi.getBotafogoCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    botafogoCasaA2023Adapter = new BotafogoCasaA2023Adapter(partidas);
                    binding.rvBotafogoCasa.setAdapter(botafogoCasaA2023Adapter);
