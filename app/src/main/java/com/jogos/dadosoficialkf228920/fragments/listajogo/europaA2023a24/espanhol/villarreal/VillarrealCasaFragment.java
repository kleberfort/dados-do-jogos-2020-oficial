package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.villarreal;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.villarreal.VillarrealCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.villarreal.VillarrealCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentVillarrealCasa2023a24Binding;
...
public class VillarrealCasaFragment extends Fragment {

    private FragmentVillarrealCasa2023a24Binding binding;
    private VillarrealCasaPartidaApi villarrealCasaPartidaApi;
    private VillarrealCasaAdapter villarrealCasaAdapter;



    public VillarrealCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentVillarrealCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        villarrealCasaPartidaApi = retrofit.create(VillarrealCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        villarrealCasaPartidaApi.getVillarrealCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    villarrealCasaAdapter = new VillarrealCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(villarrealCasaAdapter);
