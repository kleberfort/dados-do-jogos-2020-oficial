package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.sassuolo;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.sassuolo.SassuoloCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.sassuolo.SassuoloCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentSassuoloCasa2023a24Binding;
...
public class SassuoloCasaFragment extends Fragment {

    private FragmentSassuoloCasa2023a24Binding binding;
    private SassuoloCasaPartidaApi sassuoloCasaPartidaApi;
    private SassuoloCasaAdapter sassuoloCasaAdapter;



    public SassuoloCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSassuoloCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/italiano/sassuolo/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        sassuoloCasaPartidaApi = retrofit.create(SassuoloCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        sassuoloCasaPartidaApi.getSassuoloCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    sassuoloCasaAdapter = new SassuoloCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(sassuoloCasaAdapter);
