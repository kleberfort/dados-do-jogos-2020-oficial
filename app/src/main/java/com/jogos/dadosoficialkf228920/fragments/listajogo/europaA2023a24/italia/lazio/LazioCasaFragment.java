package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.lazio;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.lazio.LazioCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.lazio.LazioCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentLazioCasa2023a24Binding;
...
public class LazioCasaFragment extends Fragment {

    private FragmentLazioCasa2023a24Binding binding;
    private LazioCasaPartidaApi lazioCasaPartidaApi;
    private LazioCasaAdapter lazioCasaAdapter;



    public LazioCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLazioCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/italiano/lazio/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        lazioCasaPartidaApi = retrofit.create(LazioCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        lazioCasaPartidaApi.getLazioCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    lazioCasaAdapter = new LazioCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(lazioCasaAdapter);
