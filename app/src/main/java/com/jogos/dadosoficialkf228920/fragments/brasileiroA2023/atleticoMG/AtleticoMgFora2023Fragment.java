package com.jogos.dadosoficialkf228920.fragments.brasileiroA2023.atleticoMG;
...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.atleticoMG.AtleticoMgForaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.atleticoMG.AtleticoMgForaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAtleticoMgForaA2023Binding;
...
public class AtleticoMgFora2023Fragment extends Fragment {

    private FragmentAtleticoMgForaA2023Binding binding;
    private AtleticoMgForaA2023Adapter atleticoMgForaA2023Adapter;
    private AtleticoMgForaA2023PartidaApi atleticoMgForaA2023PartidaApi;




    public AtleticoMgFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAtleticoMgForaA2023Binding.inflate(inflater, container, false);
        ...
        atleticoMgForaA2023PartidaApi.getAtleticoMgFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    atleticoMgForaA2023Adapter = new AtleticoMgForaA2023Adapter(partidas);
                    binding.rvAtleticoMgFora.setAdapter(atleticoMgForaA2023Adapter);

                    binding.rvAtleticoMgFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvAtleticoMgFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
