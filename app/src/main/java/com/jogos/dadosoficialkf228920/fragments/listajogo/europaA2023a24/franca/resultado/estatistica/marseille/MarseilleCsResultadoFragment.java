...
import com.jogos.dadosoficialkf228920.databinding.FragmentMarseilleCsResultadoBinding;
 ...
 * Use the {@link MarseilleCsResultadoFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MarseilleCsResultadoFragment extends Fragment {

    private FragmentMarseilleCsResultadoBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentMarseilleCsResultadoBinding.inflate(inflater, container, false);
    ...
    private void setupDadosJogos() {
        ...
        jogosFrancesCasaFora2023_24Api.getMarseilleCasa().enqueue(new Callback<List<Partida>>() {
            @Override
