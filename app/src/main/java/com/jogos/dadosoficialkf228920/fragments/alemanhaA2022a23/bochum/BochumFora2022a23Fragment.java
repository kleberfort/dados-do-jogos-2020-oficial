...
import com.jogos.dadosoficialkf228920.adapter.alemanhaA2022a23.bochum.BochumFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.alemanhaA2022a23.bochum.BochumForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentBochumFora2022a23Binding;
        ...
        bochumForaA2022a23PartidaApi.getBochumFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvBochumFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvBochumFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
