package com.jogos.dadosoficialkf228920.fragments.alemanhaA2022a23.freiburg;
...
import com.jogos.dadosoficialkf228920.adapter.alemanhaA2022a23.freiburg.FreiburgCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.alemanhaA2022a23.freiburg.FreiburgCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentFreiburgCasa2022a23Binding;
...
public class FreiburgCasa2022a23Fragment extends Fragment {


    private FragmentFreiburgCasa2022a23Binding binding;
    private FreiburgCasaA2022a23PartidaApi freiburgCasaA2022a23PartidaApi;
    private FreiburgCasa2022a23Adapter freiburgCasa2022a23Adapter;


    public FreiburgCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFreiburgCasa2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        freiburgCasaA2022a23PartidaApi = retrofit.create(FreiburgCasaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvFreiburgCasa.setHasFixedSize(true);
        binding.rvFreiburgCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvFreiburgCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        freiburgCasaA2022a23PartidaApi.getFreiburgCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    freiburgCasa2022a23Adapter = new FreiburgCasa2022a23Adapter(partidas);
                    binding.rvFreiburgCasa.setAdapter(freiburgCasa2022a23Adapter);

                    binding.rvFreiburgCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvFreiburgCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
