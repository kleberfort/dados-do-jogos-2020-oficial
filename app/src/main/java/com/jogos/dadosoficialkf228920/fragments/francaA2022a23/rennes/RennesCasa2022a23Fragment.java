package com.jogos.dadosoficialkf228920.fragments.francaA2022a23.rennes;
...
import com.jogos.dadosoficialkf228920.adapter.francaA2022a23.rennes.RennesCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.francaA2022a23.rennes.RennesCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentRennesCasa2022a23Binding;
...
public class RennesCasa2022a23Fragment extends Fragment {

    private FragmentRennesCasa2022a23Binding binding;
    private RennesCasaA2022a23PartidaApi rennesCasaA2022a23PartidaApi;
    private RennesCasa2022a23Adapter rennesCasa2022a23Adapter;


    public RennesCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentRennesCasa2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/franca-a-2022-23/rennes/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        rennesCasaA2022a23PartidaApi = retrofit.create(RennesCasaA2022a23PartidaApi.class);

    }

    private void setupDadosJogos() {
        binding.rvRennesCasa.setHasFixedSize(true);
        binding.rvRennesCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvRennesCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        rennesCasaA2022a23PartidaApi.getRennesCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    rennesCasa2022a23Adapter = new RennesCasa2022a23Adapter(partidas);
                    binding.rvRennesCasa.setAdapter(rennesCasa2022a23Adapter);

                    binding.rvRennesCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvRennesCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
