package com.jogos.dadosoficialkf228920.fragments.espanhaA2022a23.realvalladolid;
...
import com.jogos.dadosoficialkf228920.adapter.espanhaA2022a23.realvalladolid.RealValladolidCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.espanhaA2022a23.realvalladolid.RealValladolidCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentRealValladolidCasa2022a23Binding;
...
public class RealValladolidCasa2022a23Fragment extends Fragment {


    private FragmentRealValladolidCasa2022a23Binding binding;
    private RealValladolidCasaA2022a23PartidaApi realValladolidCasaA2022a23PartidaApi;
    private RealValladolidCasa2022a23Adapter realValladolidCasa2022a23Adapter;

    public RealValladolidCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentRealValladolidCasa2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        realValladolidCasaA2022a23PartidaApi = retrofit.create(RealValladolidCasaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvRealValladolidCasa.setHasFixedSize(true);
        binding.rvRealValladolidCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvRealValladolidCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        realValladolidCasaA2022a23PartidaApi.getRealValladolidCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    realValladolidCasa2022a23Adapter = new RealValladolidCasa2022a23Adapter(partidas);
                    binding.rvRealValladolidCasa.setAdapter(realValladolidCasa2022a23Adapter);

                    binding.rvRealValladolidCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvRealValladolidCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
