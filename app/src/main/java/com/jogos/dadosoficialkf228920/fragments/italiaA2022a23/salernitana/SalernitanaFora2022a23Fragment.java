...
import com.jogos.dadosoficialkf228920.adapter.italiaA2022a23.salernitana.SalernitanaFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.italiaA2022a23.salernitana.SalernitanaForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentSalernitanaFora2022a23Binding;
        ...
        salernitanaForaA2022a23PartidaApi.getSalernitanaFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    salernitanaFora2022a23Adapter = new SalernitanaFora2022a23Adapter(partidas);
                    binding.rvSalernitanaFora.setAdapter(salernitanaFora2022a23Adapter);

                    binding.rvSalernitanaFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvSalernitanaFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
