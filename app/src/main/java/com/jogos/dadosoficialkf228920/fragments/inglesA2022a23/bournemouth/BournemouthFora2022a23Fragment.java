package com.jogos.dadosoficialkf228920.fragments.inglesA2022a23.bournemouth;
...
import com.jogos.dadosoficialkf228920.adapter.inglesA2022a2023.bournemouth.BournemouthFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.inglesA2022a23.bournemouth.BournemouthForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentBournemouthFora2022a23Binding;
...
public class BournemouthFora2022a23Fragment extends Fragment {

    private FragmentBournemouthFora2022a23Binding binding;
    private BournemouthForaA2022a23PartidaApi bournemouthForaA2022a23PartidaApi;
    private BournemouthFora2022a23Adapter bournemouthFora2022a23Adapter;


    public BournemouthFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBournemouthFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        bournemouthForaA2022a23PartidaApi = retrofit.create(BournemouthForaA2022a23PartidaApi.class);


    }

    private void setupDadosJogos() {
        binding.rvBournemouthFora.setHasFixedSize(true);
        binding.rvBournemouthFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvBournemouthFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        bournemouthForaA2022a23PartidaApi.getBournemouthCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    bournemouthFora2022a23Adapter = new BournemouthFora2022a23Adapter(partidas);
                    binding.rvBournemouthFora.setAdapter(bournemouthFora2022a23Adapter);

                    binding.rvBournemouthFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvBournemouthFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
