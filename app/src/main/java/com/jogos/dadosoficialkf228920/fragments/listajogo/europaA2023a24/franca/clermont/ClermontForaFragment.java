...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.clermont.ClermontForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.clermont.ClermontForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentClermontFora2023a24Binding;
...
public class ClermontForaFragment extends Fragment {

    private FragmentClermontFora2023a24Binding binding;
    private ClermontForaPartidaApi clermontForaPartidaApi;
    private ClermontForaAdapter clermontForaAdapter;



    public ClermontForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentClermontFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        clermontForaPartidaApi = retrofit.create(ClermontForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        clermontForaPartidaApi.getClermontFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    clermontForaAdapter = new ClermontForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(clermontForaAdapter);
