...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.palmeiras.PalmeirasForaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.palmeiras.PalmeirasForaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentPalmeirasForaA2023Binding;
...
public class PalmeirasFora2023Fragment extends Fragment {

    private FragmentPalmeirasForaA2023Binding binding;
    private PalmeirasForaA2023Adapter palmeirasForaA2023Adapter;
    private PalmeirasForaA2023PartidaApi palmeirasForaA2023PartidaApi;




    public PalmeirasFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentPalmeirasForaA2023Binding.inflate(inflater, container, false);
        ...
        palmeirasForaA2023PartidaApi.getPalmeirasFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    palmeirasForaA2023Adapter = new PalmeirasForaA2023Adapter(partidas);
                    binding.rvPalmeirasFora.setAdapter(palmeirasForaA2023Adapter);
