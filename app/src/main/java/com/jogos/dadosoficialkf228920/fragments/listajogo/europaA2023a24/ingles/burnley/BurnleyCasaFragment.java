...
import com.jogos.dadosoficialkf228920.databinding.FragmentBurnleyCasa2023a24Binding;
...
public class BurnleyCasaFragment extends Fragment {

    private FragmentBurnleyCasa2023a24Binding binding;
    private BurnleyCasaPartidaApi burnleyCasaPartidaApi;
    private BurnleyCasaAdapter burnleyCasaAdapter;



    public BurnleyCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBurnleyCasa2023a24Binding.inflate(inflater, container, false);
        ...
        burnleyCasaPartidaApi.getBurnleyCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    burnleyCasaAdapter = new BurnleyCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(burnleyCasaAdapter);
