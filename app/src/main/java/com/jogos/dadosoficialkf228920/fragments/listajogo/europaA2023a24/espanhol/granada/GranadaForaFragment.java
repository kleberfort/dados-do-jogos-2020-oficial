package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.granada;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.granada.GranadaForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.granada.GranadaForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentGranadaFora2023a24Binding;
...
public class GranadaForaFragment extends Fragment {

    private FragmentGranadaFora2023a24Binding binding;
    private GranadaForaPartidaApi granadaForaPartidaApi;
    private GranadaForaAdapter granadaForaAdapter;



    public GranadaForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentGranadaFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/espanhol/granada/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        granadaForaPartidaApi = retrofit.create(GranadaForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        granadaForaPartidaApi.getGranadaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    granadaForaAdapter = new GranadaForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(granadaForaAdapter);
