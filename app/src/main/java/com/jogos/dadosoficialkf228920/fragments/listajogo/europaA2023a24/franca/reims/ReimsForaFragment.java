...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.reims.ReimsForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.reims.ReimsForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentReimsFora2023a24Binding;
...
public class ReimsForaFragment extends Fragment {

    private FragmentReimsFora2023a24Binding binding;
    private ReimsForaPartidaApi reimsForaPartidaApi;
    private ReimsForaAdapter reimsForaAdapter;



    public ReimsForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentReimsFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        reimsForaPartidaApi = retrofit.create(ReimsForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        reimsForaPartidaApi.getReimsFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    reimsForaAdapter = new ReimsForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(reimsForaAdapter);
