...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.unionberlin.UnionBerlinForaAdapter;
...
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.unionberlin.UnionBerlinForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAugsburgFora2023a24Binding;
import com.jogos.dadosoficialkf228920.databinding.FragmentUnionBerlinFora2023a24Binding;
...
public class UnionBerlinForaFragment extends Fragment {

    private FragmentUnionBerlinFora2023a24Binding binding;
    private UnionBerlinForaPartidaApi unionBerlinForaPartidaApi;
    private UnionBerlinForaAdapter unionBerlinForaAdapter;



    public UnionBerlinForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentUnionBerlinFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        unionBerlinForaPartidaApi = retrofit.create(UnionBerlinForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        unionBerlinForaPartidaApi.getUnionBerlinFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    unionBerlinForaAdapter = new UnionBerlinForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(unionBerlinForaAdapter);
