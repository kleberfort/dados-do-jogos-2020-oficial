...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.chapecoense.ChapecoenseForaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.chapecoense.ChapecoenseForaB2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentChapecoenseForaB2023Binding;
...
public class ChapecoenseFora2023Fragment extends Fragment {

    private FragmentChapecoenseForaB2023Binding binding;
    private ChapecoenseForaB2023Adapter chapecoenseForaB2023Adapter;
    private ChapecoenseForaB2023PartidaApi chapecoenseForaB2023PartidaApi;





    public ChapecoenseFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentChapecoenseForaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        chapecoenseForaB2023PartidaApi = retrofit.create(ChapecoenseForaB2023PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvChapecoenseFora.setHasFixedSize(true);
        binding.rvChapecoenseFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvChapecoenseFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        chapecoenseForaB2023PartidaApi.getChapecoenseFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    chapecoenseForaB2023Adapter = new ChapecoenseForaB2023Adapter(partidas);
                    binding.rvChapecoenseFora.setAdapter(chapecoenseForaB2023Adapter);

                    binding.rvChapecoenseFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvChapecoenseFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
