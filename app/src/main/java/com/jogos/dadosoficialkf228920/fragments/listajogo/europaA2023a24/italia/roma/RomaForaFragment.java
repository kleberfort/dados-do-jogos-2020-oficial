...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.roma.RomaForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.roma.RomaForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentRomaFora2023a24Binding;
...
public class RomaForaFragment extends Fragment {

    private FragmentRomaFora2023a24Binding binding;
    private RomaForaPartidaApi romaForaPartidaApi;
    private RomaForaAdapter romaForaAdapter;



    public RomaForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentRomaFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        romaForaPartidaApi = retrofit.create(RomaForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        romaForaPartidaApi.getRomaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    romaForaAdapter = new RomaForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(romaForaAdapter);
