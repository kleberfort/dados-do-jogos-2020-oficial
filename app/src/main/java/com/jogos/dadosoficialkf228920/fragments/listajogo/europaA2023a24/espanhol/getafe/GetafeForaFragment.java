package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.getafe;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.getafe.GetafeForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.getafe.GetafeForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentGetafeFora2023a24Binding;
...
public class GetafeForaFragment extends Fragment {

    private FragmentGetafeFora2023a24Binding binding;
    private GetafeForaPartidaApi getafeForaPartidaApi;
    private GetafeForaAdapter getafeForaAdapter;



    public GetafeForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentGetafeFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/espanhol/getafe/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        getafeForaPartidaApi = retrofit.create(GetafeForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        getafeForaPartidaApi.getGetafeFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    getafeForaAdapter = new GetafeForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(getafeForaAdapter);
