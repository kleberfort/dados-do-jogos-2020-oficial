package com.jogos.dadosoficialkf228920.fragments.espanhaA2022a23.valencia;
...
import com.jogos.dadosoficialkf228920.adapter.espanhaA2022a23.valencia.ValenciaCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.espanhaA2022a23.valencia.ValenciaCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentValenciaCasa2022a23Binding;
...
public class ValenciaCasa2022a23Fragment extends Fragment {


    private FragmentValenciaCasa2022a23Binding binding;
    private ValenciaCasaA2022a23PartidaApi valenciaCasaA2022a23PartidaApi;
    private ValenciaCasa2022a23Adapter valenciaCasa2022a23Adapter;

    public ValenciaCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentValenciaCasa2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/espanhol-a-2022-23/valencia/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        valenciaCasaA2022a23PartidaApi = retrofit.create(ValenciaCasaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvValenciaCasa.setHasFixedSize(true);
        binding.rvValenciaCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvValenciaCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        valenciaCasaA2022a23PartidaApi.getValenciaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    valenciaCasa2022a23Adapter = new ValenciaCasa2022a23Adapter(partidas);
                    binding.rvValenciaCasa.setAdapter(valenciaCasa2022a23Adapter);

                    binding.rvValenciaCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvValenciaCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
