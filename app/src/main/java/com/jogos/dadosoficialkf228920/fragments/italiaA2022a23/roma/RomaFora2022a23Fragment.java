package com.jogos.dadosoficialkf228920.fragments.italiaA2022a23.roma;
...
import com.jogos.dadosoficialkf228920.adapter.italiaA2022a23.roma.RomaFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.italiaA2022a23.roma.RomaForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentRomaFora2022a23Binding;
        ...
        romaForaA2022a23PartidaApi.getRomaFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvRomaFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvRomaFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
