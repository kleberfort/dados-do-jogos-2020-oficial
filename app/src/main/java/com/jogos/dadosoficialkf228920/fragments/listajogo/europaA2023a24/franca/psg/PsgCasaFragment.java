package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.psg;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.psg.PsgCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.psg.PsgCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentPsgCasa2023a24Binding;
...
public class PsgCasaFragment extends Fragment {

    private FragmentPsgCasa2023a24Binding binding;
    private PsgCasaPartidaApi psgCasaPartidaApi;
    private PsgCasaAdapter psgCasaAdapter;



    public PsgCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentPsgCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/franca/psg/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        psgCasaPartidaApi = retrofit.create(PsgCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        psgCasaPartidaApi.getPsgCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    psgCasaAdapter = new PsgCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(psgCasaAdapter);
