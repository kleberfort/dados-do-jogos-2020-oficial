...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.botafogo.resultado.BotafogoFrA2023RstdAdp;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.botafogo.BotafogoForaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentBotafogoFr2023RstdBinding;
...
public class BotafogoFr2023RstdFragment extends Fragment {

    private FragmentBotafogoFr2023RstdBinding binding;
    private BotafogoForaA2023PartidaApi botafogoForaA2023PartidaApi;
    private BotafogoFrA2023RstdAdp botafogoFrA2023RstdAdp;

    public BotafogoFr2023RstdFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBotafogoFr2023RstdBinding.inflate(inflater, container, false);
        ...
        botafogoForaA2023PartidaApi.getBotafogoFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    botafogoFrA2023RstdAdp = new BotafogoFrA2023RstdAdp(partidas);
                    binding.rvListaResultado.setAdapter(botafogoFrA2023RstdAdp);
