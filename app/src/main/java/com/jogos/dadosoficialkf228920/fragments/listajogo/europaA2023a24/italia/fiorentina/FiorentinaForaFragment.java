...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.fiorentina.FiorentinaForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.fiorentina.FiorentinaForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentFiorentinaFora2023a24Binding;
...
public class FiorentinaForaFragment extends Fragment {

    private FragmentFiorentinaFora2023a24Binding binding;
    private FiorentinaForaPartidaApi fiorentinaForaPartidaApi;
    private FiorentinaForaAdapter  fiorentinaForaAdapter;



    public FiorentinaForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFiorentinaFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        fiorentinaForaPartidaApi = retrofit.create(FiorentinaForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        fiorentinaForaPartidaApi.getFiorentinaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    fiorentinaForaAdapter = new FiorentinaForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(fiorentinaForaAdapter);
