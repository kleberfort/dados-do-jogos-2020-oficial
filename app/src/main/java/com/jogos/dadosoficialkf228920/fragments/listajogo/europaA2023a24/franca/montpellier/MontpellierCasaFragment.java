package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.montpellier;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.montpellier.MontpellierCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.montpellier.MontpellierCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentMontpellierCasa2023a24Binding;
...
public class MontpellierCasaFragment extends Fragment {

    private FragmentMontpellierCasa2023a24Binding binding;
    private MontpellierCasaPartidaApi montpellierCasaPartidaApi;
    private MontpellierCasaAdapter montpellierCasaAdapter;



    public MontpellierCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentMontpellierCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/franca/montpellier/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        montpellierCasaPartidaApi = retrofit.create(MontpellierCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        montpellierCasaPartidaApi.getMontpellierCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    montpellierCasaAdapter = new MontpellierCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(montpellierCasaAdapter);
