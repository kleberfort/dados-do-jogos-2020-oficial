package com.jogos.dadosoficialkf228920.fragments.alemanhaA2022a23.leipzig;
...
import com.jogos.dadosoficialkf228920.adapter.alemanhaA2022a23.leipzig.LeipzigFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.alemanhaA2022a23.leipzig.LeipzigForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentLeipzigFora2022a23Binding;
...
public class LeipzigFora2022a23Fragment extends Fragment {

    private FragmentLeipzigFora2022a23Binding binding;
    private LeipzigForaA2022a23PartidaApi leipzigForaA2022a23PartidaApi;
    private LeipzigFora2022a23Adapter leipzigFora2022a23Adapter;


    public LeipzigFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLeipzigFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        leipzigForaA2022a23PartidaApi = retrofit.create(LeipzigForaA2022a23PartidaApi.class);

    }

    private void setupDadosJogos() {
        binding.rvLeipzigFora.setHasFixedSize(true);
        binding.rvLeipzigFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvLeipzigFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        leipzigForaA2022a23PartidaApi.getLeipzigFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    leipzigFora2022a23Adapter = new LeipzigFora2022a23Adapter(partidas);
                    binding.rvLeipzigFora.setAdapter(leipzigFora2022a23Adapter);

                    binding.rvLeipzigFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvLeipzigFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
