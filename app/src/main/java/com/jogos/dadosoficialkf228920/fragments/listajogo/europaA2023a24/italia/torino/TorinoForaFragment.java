...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.torino.TorinoForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.torino.TorinoForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentTorinoFora2023a24Binding;
...
public class TorinoForaFragment extends Fragment {

    private FragmentTorinoFora2023a24Binding binding;
    private TorinoForaPartidaApi torinoForaPartidaApi;
    private TorinoForaAdapter torinoForaAdapter;



    public TorinoForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentTorinoFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        torinoForaPartidaApi = retrofit.create(TorinoForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        torinoForaPartidaApi.getTorinoFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    torinoForaAdapter = new TorinoForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(torinoForaAdapter);
