...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.getafe.GetafeCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.getafe.GetafeCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentGetafeCasa2023a24Binding;
...
public class GetafeCasaFragment extends Fragment {

    private FragmentGetafeCasa2023a24Binding binding;
    private GetafeCasaPartidaApi getafeCasaPartidaApi;
    private GetafeCasaAdapter getafeCasaAdapter;



    public GetafeCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentGetafeCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        getafeCasaPartidaApi = retrofit.create(GetafeCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        getafeCasaPartidaApi.getGetafeCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    getafeCasaAdapter = new GetafeCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(getafeCasaAdapter);
