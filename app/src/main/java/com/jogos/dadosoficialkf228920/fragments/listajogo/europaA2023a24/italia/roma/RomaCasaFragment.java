package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.roma;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.roma.RomaCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.roma.RomaCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentRomaCasa2023a24Binding;
...
public class RomaCasaFragment extends Fragment {

    private FragmentRomaCasa2023a24Binding binding;
    private RomaCasaPartidaApi romaCasaPartidaApi;
    private RomaCasaAdapter romaCasaAdapter;



    public RomaCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentRomaCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/italiano/roma/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        romaCasaPartidaApi = retrofit.create(RomaCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        romaCasaPartidaApi.getRomaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    romaCasaAdapter = new RomaCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(romaCasaAdapter);
