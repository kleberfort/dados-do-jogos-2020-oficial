...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.mallorca.MallorcaCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.mallorca.MallorcaCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentMallorcaCasa2023a24Binding;
...
public class MallorcaCasaFragment extends Fragment {

    private FragmentMallorcaCasa2023a24Binding binding;
    private MallorcaCasaPartidaApi mallorcaCasaPartidaApi;
    private MallorcaCasaAdapter mallorcaCasaAdapter;



    public MallorcaCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentMallorcaCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        mallorcaCasaPartidaApi = retrofit.create(MallorcaCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        mallorcaCasaPartidaApi.getMallorcaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    mallorcaCasaAdapter = new MallorcaCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(mallorcaCasaAdapter);
