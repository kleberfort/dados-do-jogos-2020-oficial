...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.sevilla.SevillaCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.sevilla.SevillaCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentSevillaCasa2023a24Binding;
...
public class SevillaCasaFragment extends Fragment {

    private FragmentSevillaCasa2023a24Binding binding;
    private SevillaCasaPartidaApi sevillaCasaPartidaApi;
    private SevillaCasaAdapter sevillaCasaAdapter;



    public SevillaCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSevillaCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        sevillaCasaPartidaApi = retrofit.create(SevillaCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        sevillaCasaPartidaApi.getSevillaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    sevillaCasaAdapter = new SevillaCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(sevillaCasaAdapter);
