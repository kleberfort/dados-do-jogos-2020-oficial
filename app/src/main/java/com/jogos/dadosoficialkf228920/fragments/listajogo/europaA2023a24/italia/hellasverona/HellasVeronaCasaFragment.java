...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.hellasverona.HellasVeronaCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.hellasverona.HellasVeronaCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentHellasVeronaCasa2023a24Binding;
...
public class HellasVeronaCasaFragment extends Fragment {

    private FragmentHellasVeronaCasa2023a24Binding binding;
    private HellasVeronaCasaPartidaApi hellasVeronaCasaPartidaApi;
    private HellasVeronaCasaAdapter hellasVeronaCasaAdapter;



    public HellasVeronaCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentHellasVeronaCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        hellasVeronaCasaPartidaApi = retrofit.create(HellasVeronaCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        hellasVeronaCasaPartidaApi.getHellasVeronaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    hellasVeronaCasaAdapter = new HellasVeronaCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(hellasVeronaCasaAdapter);
