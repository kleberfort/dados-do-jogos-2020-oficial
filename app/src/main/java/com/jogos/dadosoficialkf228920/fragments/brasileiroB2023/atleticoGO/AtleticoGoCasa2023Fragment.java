package com.jogos.dadosoficialkf228920.fragments.brasileiroB2023.atleticoGO;
...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.atleticoGo.AtleticoGoCasaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.atleticoGO.AtleticoGoCasaB2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAtleticoGoCasaB2023Binding;
...
public class AtleticoGoCasa2023Fragment extends Fragment {

    private FragmentAtleticoGoCasaB2023Binding binding;
    private AtleticoGoCasaB2023Adapter atleticoGoCasaB2023Adapter;
    private AtleticoGoCasaB2023PartidaApi atleticoGoCasaB2023PartidaApi;




    public AtleticoGoCasa2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAtleticoGoCasaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/brasileiro-b-2023/atletico-go/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        atleticoGoCasaB2023PartidaApi = retrofit.create(AtleticoGoCasaB2023PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvAtleticoGoCasa.setHasFixedSize(true);
        binding.rvAtleticoGoCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvAtleticoGoCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        atleticoGoCasaB2023PartidaApi.getAtleticoGoCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    atleticoGoCasaB2023Adapter = new AtleticoGoCasaB2023Adapter(partidas);
                    binding.rvAtleticoGoCasa.setAdapter(atleticoGoCasaB2023Adapter);

                    binding.rvAtleticoGoCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvAtleticoGoCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
