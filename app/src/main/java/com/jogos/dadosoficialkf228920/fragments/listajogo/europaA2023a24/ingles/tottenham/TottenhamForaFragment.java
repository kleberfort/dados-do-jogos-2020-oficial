package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.tottenham;
...
import com.jogos.dadosoficialkf228920.databinding.FragmentTottenhamFora2023a24Binding;
...
public class TottenhamForaFragment extends Fragment {

    private FragmentTottenhamFora2023a24Binding binding;
    private TottenhamForaPartidaApi tottenhamForaPartidaApi;
    private TottenhamForaAdapter tottenhamForaAdapter;



    public TottenhamForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentTottenhamFora2023a24Binding.inflate(inflater, container, false);
        ...
        tottenhamForaPartidaApi.getTottenhamFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    tottenhamForaAdapter = new TottenhamForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(tottenhamForaAdapter);
