package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.cadiz;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.cadiz.CadizCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.cadiz.CadizCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentCadizCasa2023a24Binding;
...
public class CadizCasaFragment extends Fragment {

    private FragmentCadizCasa2023a24Binding binding;
    private CadizCasaPartidaApi cadizCasaPartidaApi;
    private CadizCasaAdapter cadizCasaAdapter;



    public CadizCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCadizCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        cadizCasaPartidaApi = retrofit.create(CadizCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        cadizCasaPartidaApi.getCadizCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    cadizCasaAdapter = new CadizCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(cadizCasaAdapter);
