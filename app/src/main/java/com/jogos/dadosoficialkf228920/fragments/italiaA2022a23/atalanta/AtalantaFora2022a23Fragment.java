package com.jogos.dadosoficialkf228920.fragments.italiaA2022a23.atalanta;
...
import com.jogos.dadosoficialkf228920.adapter.italiaA2022a23.atalanta.AtalantaFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.italiaA2022a23.atalanta.AtalantaForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAtalantaFora2022a23Binding;
        ...
        atalantaForaA2022a23PartidaApi.getAtalantaFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    atalantaFora2022a23Adapter = new AtalantaFora2022a23Adapter(partidas);
                    binding.rvAtalantaFora.setAdapter(atalantaFora2022a23Adapter);

                    binding.rvAtalantaFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvAtalantaFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
