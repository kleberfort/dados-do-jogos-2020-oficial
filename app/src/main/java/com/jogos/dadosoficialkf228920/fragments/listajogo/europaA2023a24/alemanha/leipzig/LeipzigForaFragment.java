...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.leipzig.LeipzigForaAdapter;
...
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.leipzig.LeipzigForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAugsburgFora2023a24Binding;
import com.jogos.dadosoficialkf228920.databinding.FragmentLeipzigFora2023a24Binding;
...
public class LeipzigForaFragment extends Fragment {

    private FragmentLeipzigFora2023a24Binding binding;
    private LeipzigForaPartidaApi leipzigForaPartidaApi;
    private LeipzigForaAdapter leipzigForaAdapter;



    public LeipzigForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLeipzigFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        leipzigForaPartidaApi = retrofit.create(LeipzigForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        leipzigForaPartidaApi.getLeipzigFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    leipzigForaAdapter = new LeipzigForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(leipzigForaAdapter);
