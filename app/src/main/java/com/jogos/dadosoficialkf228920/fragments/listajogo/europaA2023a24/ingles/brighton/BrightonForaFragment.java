...
import com.jogos.dadosoficialkf228920.databinding.FragmentBrightonFora2023a24Binding;
...
public class BrightonForaFragment extends Fragment {

    private FragmentBrightonFora2023a24Binding binding;
    private BrightonForaPartidaApi brightonForaPartidaApi;
    private BrightonForaAdapter brightonForaAdapter;



    public BrightonForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBrightonFora2023a24Binding.inflate(inflater, container, false);
        ...
        brightonForaPartidaApi.getBrightonFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    brightonForaAdapter = new BrightonForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(brightonForaAdapter);
