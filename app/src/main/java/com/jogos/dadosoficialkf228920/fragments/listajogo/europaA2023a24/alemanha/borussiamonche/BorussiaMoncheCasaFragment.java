...
import com.jogos.dadosoficialkf228920.adapter.alemanhaA2022a23.augsburg.AugsburgCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.adapter.alemanhaA2022a23.borussiamonchengladbach.BorussiaMonchengladbachCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.borussiamonchengladbach.BorussiaMoncheCasaAdapter;
...
import com.jogos.dadosoficialkf228920.databinding.FragmentBorussiaMonchegladbachCasa2023a24Binding;
...
public class BorussiaMoncheCasaFragment extends Fragment {

    private FragmentBorussiaMonchegladbachCasa2023a24Binding binding;
    private BorussiaMonchengladbachCasaPartidaApi borussiaMonchengladbachCasaPartidaApi;
    private BorussiaMoncheCasaAdapter borussiaMoncheCasaAdapter;



    public BorussiaMoncheCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBorussiaMonchegladbachCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        borussiaMonchengladbachCasaPartidaApi = retrofit.create(BorussiaMonchengladbachCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        borussiaMonchengladbachCasaPartidaApi.getBorussiaMonchengladbachCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    borussiaMoncheCasaAdapter = new BorussiaMoncheCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(borussiaMoncheCasaAdapter);
