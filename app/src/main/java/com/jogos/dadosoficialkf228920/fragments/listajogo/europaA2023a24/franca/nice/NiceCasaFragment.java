...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.nice.NiceCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.nice.NiceCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentNiceCasa2023a24Binding;
...
public class NiceCasaFragment extends Fragment {

    private FragmentNiceCasa2023a24Binding binding;
    private NiceCasaPartidaApi niceCasaPartidaApi;
    private NiceCasaAdapter niceCasaAdapter;



    public NiceCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentNiceCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        niceCasaPartidaApi = retrofit.create(NiceCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        niceCasaPartidaApi.getNiceCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    niceCasaAdapter = new NiceCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(niceCasaAdapter);
