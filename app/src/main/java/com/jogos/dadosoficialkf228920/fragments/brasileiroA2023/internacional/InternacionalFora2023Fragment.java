...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.internacional.InternacionalForaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.internacional.InternacionalForaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentInternacionalForaA2023Binding;
...
public class InternacionalFora2023Fragment extends Fragment {

    private FragmentInternacionalForaA2023Binding binding;
    private InternacionalForaA2023Adapter internacionalForaA2023Adapter;
    private InternacionalForaA2023PartidaApi internacionalForaA2023PartidaApi;



    public InternacionalFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentInternacionalForaA2023Binding.inflate(inflater, container, false);
        ...
        internacionalForaA2023PartidaApi.getInternacionalFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    internacionalForaA2023Adapter = new InternacionalForaA2023Adapter(partidas);
                    binding.rvInternacionalFora.setAdapter(internacionalForaA2023Adapter);
