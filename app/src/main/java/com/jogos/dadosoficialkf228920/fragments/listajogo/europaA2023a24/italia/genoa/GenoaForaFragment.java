package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.genoa;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.genoa.GenoaForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.genoa.GenoaForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentGenoaFora2023a24Binding;
...
public class GenoaForaFragment extends Fragment {

    private FragmentGenoaFora2023a24Binding binding;
    private GenoaForaPartidaApi genoaForaPartidaApi;
    private GenoaForaAdapter genoaForaAdapter;



    public GenoaForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentGenoaFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/italiano/genoa/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        genoaForaPartidaApi = retrofit.create(GenoaForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        genoaForaPartidaApi.getGenoaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    genoaForaAdapter = new GenoaForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(genoaForaAdapter);
