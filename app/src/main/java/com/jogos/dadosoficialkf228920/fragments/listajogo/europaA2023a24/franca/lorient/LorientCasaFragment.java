package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.lorient;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.lorient.LorientCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.lorient.LorientCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentLorientCasa2023a24Binding;
...
public class LorientCasaFragment extends Fragment {

    private FragmentLorientCasa2023a24Binding binding;
    private LorientCasaPartidaApi lorientCasaPartidaApi;
    private LorientCasaAdapter lorientCasaAdapter;



    public LorientCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLorientCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/franca/lorient/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        lorientCasaPartidaApi = retrofit.create(LorientCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        lorientCasaPartidaApi.getLorientCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    lorientCasaAdapter = new LorientCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(lorientCasaAdapter);
