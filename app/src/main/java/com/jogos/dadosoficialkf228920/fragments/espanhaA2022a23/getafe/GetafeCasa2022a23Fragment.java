...
import com.jogos.dadosoficialkf228920.adapter.espanhaA2022a23.getafe.GetafeCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.espanhaA2022a23.getafe.GetafeCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentGetafeCasa2022a23Binding;
...
public class GetafeCasa2022a23Fragment extends Fragment {
    ...
    private void setupHttpClient() {
        ...
        getafeCasaA2022a23PartidaApi = retrofit.create(GetafeCasaA2022a23PartidaApi.class);
    }
    ...
    private void setupDadosJogos() {
        ...
        getafeCasaA2022a23PartidaApi.getGetafeCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    getafeCasa2022a23Adapter = new GetafeCasa2022a23Adapter(partidas);
                    binding.rvGetafeCasa.setAdapter(getafeCasa2022a23Adapter);

                    binding.rvGetafeCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvGetafeCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
