...
import com.jogos.dadosoficialkf228920.adapter.inglesA2022a2023.brighton.BrightonCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.inglesA2022a23.brighton.BrightonCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentBrightonCasa2022a23Binding;
        ...
        brightonCasaA2022a23PartidaApi.getBrightonCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvBrigtonCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvBrigtonCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
