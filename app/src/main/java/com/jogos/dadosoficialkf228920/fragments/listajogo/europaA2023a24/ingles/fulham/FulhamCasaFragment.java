package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.fulham;
...
import com.jogos.dadosoficialkf228920.databinding.FragmentFulhamCasa2023a24Binding;
...
public class FulhamCasaFragment extends Fragment {

    private FragmentFulhamCasa2023a24Binding binding;
    private FulhamCasaPartidaApi fulhamCasaPartidaApi;
    private FulhamCasaAdapter fulhamCasaAdapter;



    public FulhamCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFulhamCasa2023a24Binding.inflate(inflater, container, false);
        ...
        fulhamCasaPartidaApi.getFulhamCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    fulhamCasaAdapter = new FulhamCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(fulhamCasaAdapter);
