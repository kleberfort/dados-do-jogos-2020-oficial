...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.lorient.LorientForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.lorient.LorientForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentLorientFora2023a24Binding;
...
public class LorientForaFragment extends Fragment {

    private FragmentLorientFora2023a24Binding binding;
    private LorientForaPartidaApi lorientForaPartidaApi;
    private LorientForaAdapter lorientForaAdapter;



    public LorientForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLorientFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        lorientForaPartidaApi = retrofit.create(LorientForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        lorientForaPartidaApi.getLorientFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    lorientForaAdapter = new LorientForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(lorientForaAdapter);
