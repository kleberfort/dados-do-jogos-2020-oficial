...
import com.jogos.dadosoficialkf228920.adapter.francaA2022a23.strasbourg.StrasbourgFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.francaA2022a23.strasbourg.StrasbourgForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentStrasbourgFora2022a23Binding;
        ...
        strasbourgForaA2022a23PartidaApi.getStrasbourgFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvStrasbourgFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvStrasbourgFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
