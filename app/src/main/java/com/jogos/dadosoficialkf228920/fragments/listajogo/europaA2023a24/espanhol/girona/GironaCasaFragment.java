...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.girona.GironaCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.girona.GironaCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentGironaCasa2023a24Binding;
...
public class GironaCasaFragment extends Fragment {

    private FragmentGironaCasa2023a24Binding binding;
    private GironaCasaPartidaApi gironaCasaPartidaApi;
    private GironaCasaAdapter gironaCasaAdapter;



    public GironaCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentGironaCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        gironaCasaPartidaApi = retrofit.create(GironaCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        gironaCasaPartidaApi.getGironaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    gironaCasaAdapter = new GironaCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(gironaCasaAdapter);
