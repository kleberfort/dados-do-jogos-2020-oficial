...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.athleticbilbao.AthleticBilbaoCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.athleticbilbao.AthleticBilbaoCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAthleticBilbaoCasa2023a24Binding;
...
public class AthleticBilbaoCasaFragment extends Fragment {

    private FragmentAthleticBilbaoCasa2023a24Binding binding;
    private AthleticBilbaoCasaPartidaApi athleticBilbaoCasaPartidaApi;
    private AthleticBilbaoCasaAdapter athleticBilbaoCasaAdapter;



    public AthleticBilbaoCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAthleticBilbaoCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        athleticBilbaoCasaPartidaApi = retrofit.create(AthleticBilbaoCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        athleticBilbaoCasaPartidaApi.getAthleticBilbaoCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    athleticBilbaoCasaAdapter = new AthleticBilbaoCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(athleticBilbaoCasaAdapter);
