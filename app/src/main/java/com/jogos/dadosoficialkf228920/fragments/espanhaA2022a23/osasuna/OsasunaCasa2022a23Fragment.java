...
import com.jogos.dadosoficialkf228920.adapter.espanhaA2022a23.osasuna.OsasunaCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.espanhaA2022a23.osasuna.OsasunaCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentOsasunaCasa2022a23Binding;
...
public class OsasunaCasa2022a23Fragment extends Fragment {
    ...
    private void setupHttpClient() {
        ...
        osasunaCasaA2022a23PartidaApi = retrofit.create(OsasunaCasaA2022a23PartidaApi.class);
    }
    ...
    private void setupDadosJogos() {
        ...
        osasunaCasaA2022a23PartidaApi.getOsasunaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    osasunaCasa2022a23Adapter = new OsasunaCasa2022a23Adapter(partidas);
                    binding.rvOsasunaCasa.setAdapter(osasunaCasa2022a23Adapter);


                    binding.rvOsasunaCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvOsasunaCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
