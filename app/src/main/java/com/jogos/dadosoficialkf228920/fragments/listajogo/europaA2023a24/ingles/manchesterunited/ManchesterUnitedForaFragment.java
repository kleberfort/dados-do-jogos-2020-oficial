...
import com.jogos.dadosoficialkf228920.databinding.FragmentManchesterUnitedFora2023a24Binding;
...
public class ManchesterUnitedForaFragment extends Fragment {

    private FragmentManchesterUnitedFora2023a24Binding binding;
    private ManchesterUnitedForaPartidaApi manchesterUnitedForaPartidaApi;
    private ManchesterUnitedForaAdapter manchesterUnitedForaAdapter;



    public ManchesterUnitedForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentManchesterUnitedFora2023a24Binding.inflate(inflater, container, false);
        ...
        manchesterUnitedForaPartidaApi.getManchesterUnitedFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    manchesterUnitedForaAdapter = new ManchesterUnitedForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(manchesterUnitedForaAdapter);
