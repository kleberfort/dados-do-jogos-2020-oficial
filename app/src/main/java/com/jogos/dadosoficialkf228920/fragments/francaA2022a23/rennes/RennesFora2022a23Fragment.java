...
import com.jogos.dadosoficialkf228920.adapter.francaA2022a23.rennes.RennesFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.francaA2022a23.rennes.RennesForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentRennesFora2022a23Binding;
        ...
        rennesForaA2022a23PartidaApi.getRennesFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    rennesFora2022a23Adapter = new RennesFora2022a23Adapter(partidas);
                    binding.rvRennesFora.setAdapter(rennesFora2022a23Adapter);

                    binding.rvRennesFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvRennesFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
