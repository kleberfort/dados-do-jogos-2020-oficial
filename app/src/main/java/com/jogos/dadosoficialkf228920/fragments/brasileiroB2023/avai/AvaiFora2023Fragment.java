...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.avai.AvaiForaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.avai.AvaiForaB2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAvaiForaB2023Binding;
...
public class AvaiFora2023Fragment extends Fragment {

    private FragmentAvaiForaB2023Binding binding;
    private AvaiForaB2023Adapter avaiCasaB2023Adapter;
    private AvaiForaB2023PartidaApi avaiCasaB2023PartidaApi;


    public AvaiFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAvaiForaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        avaiCasaB2023PartidaApi = retrofit.create(AvaiForaB2023PartidaApi.class);
    }
    ...
    private void setupDadosJogos() {
        ...
        avaiCasaB2023PartidaApi.getAvaiFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    avaiCasaB2023Adapter = new AvaiForaB2023Adapter(partidas);
                    binding.rvAvaiFora.setAdapter(avaiCasaB2023Adapter);

                    binding.rvAvaiFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvAvaiFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
