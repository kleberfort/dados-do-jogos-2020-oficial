package com.jogos.dadosoficialkf228920.fragments.italiaA2022a23.spezia;
...
import com.jogos.dadosoficialkf228920.adapter.italiaA2022a23.spezia.SpeziaCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.italiaA2022a23.spezia.SpeziaCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentSpeziaCasa2022a23Binding;
        ...
        speziaCasaA2022a23PartidaApi.getSpeziaCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvSpeziaCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvSpeziaCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
