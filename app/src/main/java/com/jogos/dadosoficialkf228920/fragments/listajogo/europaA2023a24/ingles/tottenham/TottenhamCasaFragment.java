...
import com.jogos.dadosoficialkf228920.databinding.FragmentTottenhamCasa2023a24Binding;
...
public class TottenhamCasaFragment extends Fragment {

    private FragmentTottenhamCasa2023a24Binding binding;
    private TottenhamCasaPartidaApi tottenhamCasaPartidaApi;
    private TottenhamCasaAdapter tottenhamCasaAdapter;



    public TottenhamCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentTottenhamCasa2023a24Binding.inflate(inflater, container, false);
        ...
        tottenhamCasaPartidaApi.getTottenhamCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    tottenhamCasaAdapter = new TottenhamCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(tottenhamCasaAdapter);
