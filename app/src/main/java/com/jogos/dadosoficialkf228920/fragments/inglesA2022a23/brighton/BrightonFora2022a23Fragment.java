package com.jogos.dadosoficialkf228920.fragments.inglesA2022a23.brighton;
...
import com.jogos.dadosoficialkf228920.adapter.inglesA2022a2023.brighton.BrightonFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.inglesA2022a23.brighton.BrightonForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentBrightonFora2022a23Binding;
...
public class BrightonFora2022a23Fragment extends Fragment {

    private FragmentBrightonFora2022a23Binding binding;
    private BrightonForaA2022a23PartidaApi brightonForaA2022a23PartidaApi;
    private BrightonFora2022a23Adapter brightonFora2022a23Adapter;


    public BrightonFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBrightonFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        brightonForaA2022a23PartidaApi = retrofit.create(BrightonForaA2022a23PartidaApi.class);


    }

    private void setupDadosJogos() {
        binding.rvBrigtonFora.setHasFixedSize(true);
        binding.rvBrigtonFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvBrigtonFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        brightonForaA2022a23PartidaApi.getBrightonCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    brightonFora2022a23Adapter = new BrightonFora2022a23Adapter(partidas);
                    binding.rvBrigtonFora.setAdapter(brightonFora2022a23Adapter);

                    binding.rvBrigtonFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvBrigtonFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
