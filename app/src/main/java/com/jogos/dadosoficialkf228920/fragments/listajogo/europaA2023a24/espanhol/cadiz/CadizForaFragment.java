...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.cadiz.CadizForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.cadiz.CadizForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentCadizFora2023a24Binding;
...
public class CadizForaFragment extends Fragment {

    private FragmentCadizFora2023a24Binding binding;
    private CadizForaPartidaApi cadizForaPartidaApi;
    private CadizForaAdapter cadizForaAdapter;



    public CadizForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCadizFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        cadizForaPartidaApi = retrofit.create(CadizForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        cadizForaPartidaApi.getCadizFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    cadizForaAdapter = new CadizForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(cadizForaAdapter);
