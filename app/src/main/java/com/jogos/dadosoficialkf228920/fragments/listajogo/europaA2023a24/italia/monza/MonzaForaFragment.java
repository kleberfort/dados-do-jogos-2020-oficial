...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.monza.MonzaForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.monza.MonzaForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentMonzaFora2023a24Binding;
...
public class MonzaForaFragment extends Fragment {

    private FragmentMonzaFora2023a24Binding binding;
    private MonzaForaPartidaApi monzaForaPartidaApi;
    private MonzaForaAdapter monzaForaAdapter;



    public MonzaForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentMonzaFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        monzaForaPartidaApi = retrofit.create(MonzaForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        monzaForaPartidaApi.getMonzaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    monzaForaAdapter = new MonzaForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(monzaForaAdapter);
