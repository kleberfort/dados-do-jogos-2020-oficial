...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.udinese.UdineseForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.udinese.UdineseForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentUdineseFora2023a24Binding;
...
public class UdineseForaFragment extends Fragment {

    private FragmentUdineseFora2023a24Binding binding;
    private UdineseForaPartidaApi udineseForaPartidaApi;
    private UdineseForaAdapter udineseForaAdapter;



    public UdineseForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentUdineseFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        udineseForaPartidaApi = retrofit.create(UdineseForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        udineseForaPartidaApi.getUdineseFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    udineseForaAdapter = new UdineseForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(udineseForaAdapter);
