...
import com.jogos.dadosoficialkf228920.databinding.FragmentBrentfordCasa2023a24Binding;
...
public class BrentfordCasaFragment extends Fragment {

    private FragmentBrentfordCasa2023a24Binding binding;
    private BrentfordCasaPartidaApi brentfordCasaPartidaApi;
    private BrentfordCasaAdapter brentfordCasaAdapter;



    public BrentfordCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBrentfordCasa2023a24Binding.inflate(inflater, container, false);
        ...
        brentfordCasaPartidaApi.getBrentfordCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    brentfordCasaAdapter = new BrentfordCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(brentfordCasaAdapter);
