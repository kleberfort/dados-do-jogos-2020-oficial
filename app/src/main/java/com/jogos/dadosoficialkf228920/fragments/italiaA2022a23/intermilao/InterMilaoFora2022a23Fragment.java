package com.jogos.dadosoficialkf228920.fragments.italiaA2022a23.intermilao;
...
import com.jogos.dadosoficialkf228920.adapter.italiaA2022a23.intermilao.InterMilaoFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.italiaA2022a23.intermilao.InterMilaoForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentInterMilaoFora2022a23Binding;
        ...
        interMilaoForaA2022a23PartidaApi.getInterMilaoFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvInterMilaoFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvInterMilaoFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
