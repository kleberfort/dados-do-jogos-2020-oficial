package com.jogos.dadosoficialkf228920.fragments.estatistica.local.brasil.seriaA2023.atleticoPr;
...
public class AtleticoPrCsEscanteiosEstatisticaFragment extends Fragment {

    private TelaEstatisticaEscanteiosBinding binding;
    private AtleticoPrCasaA2023PartidaApi atleticoPrCasaA2023PartidaApi;
    ...
    private void setupHttpClient() {
        ...
        atleticoPrCasaA2023PartidaApi = retrofit.create(AtleticoPrCasaA2023PartidaApi.class);
    }
    ...
    private void setupDadosJogos(){
        ...
        atleticoPrCasaA2023PartidaApi.getAtleticoPrCasa().enqueue(new Callback<List<Partida>>() {
            @Override
