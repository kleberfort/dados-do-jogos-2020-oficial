package com.jogos.dadosoficialkf228920.fragments.brasileiroA2023.flamengo;
...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.flamengo.FlamengoCasaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.flamengo.FlamengoCasaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentFlamengoCasaA2023Binding;
...
public class FlamengoCasa2023Fragment extends Fragment {

    private FragmentFlamengoCasaA2023Binding binding;
    private FlamengoCasaA2023Adapter flamengoCasaA2023Adapter;
    private FlamengoCasaA2023PartidaApi flamengoCasaA2023PartidaApi;


    public FlamengoCasa2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFlamengoCasaA2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        flamengoCasaA2023PartidaApi = retrofit.create(FlamengoCasaA2023PartidaApi.class);
    }
    ...
    private void setupDadosJogos() {
        ...
        flamengoCasaA2023PartidaApi.getFlamengoCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    flamengoCasaA2023Adapter = new FlamengoCasaA2023Adapter(partidas);
                    binding.rvFlamengoCasa.setAdapter(flamengoCasaA2023Adapter);
