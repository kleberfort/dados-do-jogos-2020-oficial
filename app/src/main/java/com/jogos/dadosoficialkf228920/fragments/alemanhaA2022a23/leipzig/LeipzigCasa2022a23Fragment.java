...
import com.jogos.dadosoficialkf228920.adapter.alemanhaA2022a23.leipzig.LeipzigCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.alemanhaA2022a23.leipzig.LeipzigCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentLeipzigCasa2022a23Binding;
        ...
        leipzigCasaA2022a23PartidaApi.getLeipzigCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvLeipzigCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvLeipzigCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
