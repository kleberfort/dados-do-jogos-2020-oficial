package com.jogos.dadosoficialkf228920.fragments.francaA2022a23.marseille;
...
import com.jogos.dadosoficialkf228920.adapter.francaA2022a23.marseille.MarseilleFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.francaA2022a23.marseille.MarseilleForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentMarseilleFora2022a23Binding;
...
public class MarseilleFora2022a23Fragment extends Fragment {
    ...
    private void setupHttpClient() {
        ...
        marseilleForaA2022a23PartidaApi = retrofit.create(MarseilleForaA2022a23PartidaApi.class);
    }
    ...
    private void setupDadosJogos() {
        ...
        marseilleForaA2022a23PartidaApi.getMarseilleFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    marseilleFora2022a23Adapter = new MarseilleFora2022a23Adapter(partidas);
                    binding.rvMarseilleFora.setAdapter(marseilleFora2022a23Adapter);

                    binding.rvMarseilleFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvMarseilleFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
