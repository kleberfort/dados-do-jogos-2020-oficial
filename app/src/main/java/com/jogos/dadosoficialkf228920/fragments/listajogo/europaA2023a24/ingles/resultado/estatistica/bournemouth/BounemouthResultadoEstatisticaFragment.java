...
public class BounemouthResultadoEstatisticaFragment extends Fragment {

    private FragmentBounemouthResultadoEstatisticaBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBounemouthResultadoEstatisticaBinding.inflate(inflater, container, false);
        ...
        FragmentPagerItemAdapter adapter = new FragmentPagerItemAdapter(
                ...
                FragmentPagerItems.with(getApplicationContext())
                        .add("Casa 2023-24", BournemouthCsResultadoFragment.class)
                        .add("Fora 2023-24", BournemouthFrResultadoFragment.class)
