package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.chelsea;
...
import com.jogos.dadosoficialkf228920.databinding.FragmentChelseaFora2023a24Binding;
...
public class ChelseaForaFragment extends Fragment {

    private FragmentChelseaFora2023a24Binding binding;
    private ChelseaForaPartidaApi chelseaForaPartidaApi;
    private ChelseaForaAdapter chelseaForaAdapter;



    public ChelseaForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentChelseaFora2023a24Binding.inflate(inflater, container, false);
        ...
        chelseaForaPartidaApi.getChelseaFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    chelseaForaAdapter = new ChelseaForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(chelseaForaAdapter);
