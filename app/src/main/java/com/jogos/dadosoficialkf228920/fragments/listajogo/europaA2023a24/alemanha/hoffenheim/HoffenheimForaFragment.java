package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.hoffenheim;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.hoffenheim.HoffenheimCasaAdapter;
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.hoffenheim.HoffenheimForaAdapter;
...
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.hoffenheim.HoffenheimForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAugsburgFora2023a24Binding;
import com.jogos.dadosoficialkf228920.databinding.FragmentHoffenheimFora2023a24Binding;
...
public class HoffenheimForaFragment extends Fragment {

    private FragmentHoffenheimFora2023a24Binding binding;
    private HoffenheimForaPartidaApi hoffenheimForaPartidaApi;
    private HoffenheimForaAdapter hoffenheimForaAdapter;



    public HoffenheimForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentHoffenheimFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/alemanha/hoffenheim/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        hoffenheimForaPartidaApi = retrofit.create(HoffenheimForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        hoffenheimForaPartidaApi.getHoffenheimFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    hoffenheimForaAdapter = new HoffenheimForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(hoffenheimForaAdapter);
