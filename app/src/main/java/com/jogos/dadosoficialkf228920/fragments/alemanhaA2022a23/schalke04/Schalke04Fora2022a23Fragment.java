package com.jogos.dadosoficialkf228920.fragments.alemanhaA2022a23.schalke04;
...
import com.jogos.dadosoficialkf228920.adapter.alemanhaA2022a23.schalke04.Schalke04Fora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.alemanhaA2022a23.schalke04.Schalke04ForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentSchalke04Fora2022a23Binding;
        ...
        schalke04ForaA2022a23PartidaApi.getSchalke04Fora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    schalke04Fora2022a23Adapter = new Schalke04Fora2022a23Adapter(partidas);
                    binding.rvSchalke04Fora.setAdapter(schalke04Fora2022a23Adapter);

                    binding.rvSchalke04Fora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvSchalke04Fora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
