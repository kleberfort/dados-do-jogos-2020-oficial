...
import com.jogos.dadosoficialkf228920.adapter.inglesA2022a2023.crystalpalace.CrystalPalaceCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.inglesA2022a23.crystalpalace.CrystalPalaceCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentCrystalPalaceCasa2022a23Binding;
        ...
        crystalPalaceCasaA2022a23PartidaApi.getCrystalPalaceCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvCrystalPalaceCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvCrystalPalaceCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
