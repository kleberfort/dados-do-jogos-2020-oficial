...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.lecce.LecceCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.lecce.LecceCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentLecceCasa2023a24Binding;
...
public class LecceCasaFragment extends Fragment {

    private FragmentLecceCasa2023a24Binding binding;
    private LecceCasaPartidaApi lecceCasaPartidaApi;
    private LecceCasaAdapter lecceCasaAdapter;



    public LecceCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLecceCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        lecceCasaPartidaApi = retrofit.create(LecceCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        lecceCasaPartidaApi.getLecceCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    lecceCasaAdapter = new LecceCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(lecceCasaAdapter);
