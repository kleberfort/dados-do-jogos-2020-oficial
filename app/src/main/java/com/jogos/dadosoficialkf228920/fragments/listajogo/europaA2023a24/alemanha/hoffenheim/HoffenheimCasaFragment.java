...
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.hoffenheim.HoffenheimCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAugsburgCasa2023a24Binding;
import com.jogos.dadosoficialkf228920.databinding.FragmentHoffenheimCasa2023a24Binding;
...
public class HoffenheimCasaFragment extends Fragment {

    private FragmentHoffenheimCasa2023a24Binding binding;
    private HoffenheimCasaPartidaApi hoffenheimCasaPartidaApi;
    private HoffenheimCasaAdapter hoffenheimCasaAdapter;



    public HoffenheimCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentHoffenheimCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        hoffenheimCasaPartidaApi = retrofit.create(HoffenheimCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        hoffenheimCasaPartidaApi.getHoffenheimCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    hoffenheimCasaAdapter = new HoffenheimCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(hoffenheimCasaAdapter);
