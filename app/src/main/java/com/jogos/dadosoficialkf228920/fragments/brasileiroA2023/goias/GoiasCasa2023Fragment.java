...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.goias.GoiasCasaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.goias.GoiasCasaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentGoiasCasaA2023Binding;
...
public class GoiasCasa2023Fragment extends Fragment {

    private FragmentGoiasCasaA2023Binding binding;
    private GoiasCasaA2023Adapter goiasCasaA2023Adapter;
    private GoiasCasaA2023PartidaApi goiasCasaA2023PartidaApi;



    public GoiasCasa2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentGoiasCasaA2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        goiasCasaA2023PartidaApi = retrofit.create(GoiasCasaA2023PartidaApi.class);
    }
    ...
    private void setupDadosJogos() {
        ...
        goiasCasaA2023PartidaApi.getGoiasCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    goiasCasaA2023Adapter = new GoiasCasaA2023Adapter(partidas);
                    binding.rvGoiasCasa.setAdapter(goiasCasaA2023Adapter);
