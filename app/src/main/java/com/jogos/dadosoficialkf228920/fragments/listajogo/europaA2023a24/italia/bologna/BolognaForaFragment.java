package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.bologna;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.bologna.BolognaForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.bologna.BolognaForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentBolognaFora2023a24Binding;
...
public class BolognaForaFragment extends Fragment {

    private FragmentBolognaFora2023a24Binding binding;
    private BolognaForaPartidaApi bolognaForaPartidaApi;
    private BolognaForaAdapter bolognaForaAdapter;



    public BolognaForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBolognaFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/italiano/bologna/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        bolognaForaPartidaApi = retrofit.create(BolognaForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        bolognaForaPartidaApi.getBolognaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    bolognaForaAdapter = new BolognaForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(bolognaForaAdapter);
