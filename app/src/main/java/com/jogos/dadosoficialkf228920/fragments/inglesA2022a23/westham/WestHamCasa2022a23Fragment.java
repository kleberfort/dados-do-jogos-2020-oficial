package com.jogos.dadosoficialkf228920.fragments.inglesA2022a23.westham;
...
import com.jogos.dadosoficialkf228920.adapter.inglesA2022a2023.westham.WesthamCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.inglesA2022a23.westham.WestHamCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentWestHamCasa2022a23Binding;
...
public class WestHamCasa2022a23Fragment extends Fragment {
    ...
    private void setupHttpClient() {
        ...
        westHamCasaA2022a23PartidaApi = retrofit.create(WestHamCasaA2022a23PartidaApi.class);
    }
    ...
    private void setupDadosJogos() {
        ...
        westHamCasaA2022a23PartidaApi.getWestHamCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    westhamCasa2022a23Adapter = new WesthamCasa2022a23Adapter(partidas);
                    binding.rvWesthamCasa.setAdapter(westhamCasa2022a23Adapter);

                    binding.rvWesthamCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvWesthamCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
