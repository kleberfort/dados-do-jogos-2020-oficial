...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.intermilao.InterMilaoForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.intermilao.InterMilaoForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentInterMilaoFora2023a24Binding;
...
public class InterMilaoForaFragment extends Fragment {

    private FragmentInterMilaoFora2023a24Binding binding;
    private InterMilaoForaPartidaApi interMilaoForaPartidaApi;
    private InterMilaoForaAdapter interMilaoForaAdapter;



    public InterMilaoForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentInterMilaoFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        interMilaoForaPartidaApi = retrofit.create(InterMilaoForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        interMilaoForaPartidaApi.getInterMilaoFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    interMilaoForaAdapter = new InterMilaoForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(interMilaoForaAdapter);
