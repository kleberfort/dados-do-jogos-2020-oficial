...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.rayovallecano.RayoVallecanoForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.rayovallecano.RayoVallecanoForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentRayoVallecanoFora2023a24Binding;
...
public class RayoVallecanoForaFragment extends Fragment {

    private FragmentRayoVallecanoFora2023a24Binding binding;
    private RayoVallecanoForaPartidaApi rayoVallecanoForaPartidaApi;
    private RayoVallecanoForaAdapter rayoVallecanoForaAdapter;



    public RayoVallecanoForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentRayoVallecanoFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        rayoVallecanoForaPartidaApi = retrofit.create(RayoVallecanoForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        rayoVallecanoForaPartidaApi.getRayoVallecanoFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    rayoVallecanoForaAdapter = new RayoVallecanoForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(rayoVallecanoForaAdapter);
