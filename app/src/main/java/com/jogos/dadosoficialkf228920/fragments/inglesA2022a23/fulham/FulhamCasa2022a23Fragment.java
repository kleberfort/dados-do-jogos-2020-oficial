package com.jogos.dadosoficialkf228920.fragments.inglesA2022a23.fulham;
...
import com.jogos.dadosoficialkf228920.adapter.inglesA2022a2023.fulham.FulhamCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.inglesA2022a23.fulham.FulhamCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentFulhamCasa2022a23Binding;
...
public class FulhamCasa2022a23Fragment extends Fragment {

    private FragmentFulhamCasa2022a23Binding binding;
    private FulhamCasaA2022a23PartidaApi fulhamCasaA2022a23PartidaApi;
    private FulhamCasa2022a23Adapter fulhamCasa2022a23Adapter;


    public FulhamCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFulhamCasa2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        fulhamCasaA2022a23PartidaApi = retrofit.create(FulhamCasaA2022a23PartidaApi.class);


    }

    private void setupDadosJogos() {
        binding.rvFulhamCasa.setHasFixedSize(true);
        binding.rvFulhamCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvFulhamCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        fulhamCasaA2022a23PartidaApi.getFulhamCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    fulhamCasa2022a23Adapter = new FulhamCasa2022a23Adapter(partidas);
                    binding.rvFulhamCasa.setAdapter(fulhamCasa2022a23Adapter);

                    binding.rvFulhamCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvFulhamCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
