package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.valencia;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.valencia.ValenciaForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.valencia.ValenciaForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentValenciaFora2023a24Binding;
...
public class ValenciaForaFragment extends Fragment {

    private FragmentValenciaFora2023a24Binding binding;
    private ValenciaForaPartidaApi valenciaForaPartidaApi;
    private ValenciaForaAdapter valenciaForaAdapter;



    public ValenciaForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentValenciaFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/espanhol/valencia/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        valenciaForaPartidaApi = retrofit.create(ValenciaForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        valenciaForaPartidaApi.getValenciaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    valenciaForaAdapter = new ValenciaForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(valenciaForaAdapter);
