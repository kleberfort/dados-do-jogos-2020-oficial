...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.ituano.ItuanoForaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.ituano.ItuanoForaB2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentItuanoForaB2023Binding;
...
public class ItuanoFora2023Fragment extends Fragment {

    private FragmentItuanoForaB2023Binding binding;
    private ItuanoForaB2023Adapter ituanoForaB2023Adapter;
    private ItuanoForaB2023PartidaApi ituanoForaB2023PartidaApi;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentItuanoForaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        ituanoForaB2023PartidaApi = retrofit.create(ItuanoForaB2023PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvItuanoFora.setHasFixedSize(true);
        binding.rvItuanoFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvItuanoFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        ituanoForaB2023PartidaApi.getItuanoFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    ituanoForaB2023Adapter = new ItuanoForaB2023Adapter(partidas);
                    binding.rvItuanoFora.setAdapter(ituanoForaB2023Adapter);

                    binding.rvItuanoFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvItuanoFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
