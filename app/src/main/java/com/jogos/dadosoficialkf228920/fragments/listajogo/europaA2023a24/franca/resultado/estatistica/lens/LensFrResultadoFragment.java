...
import com.jogos.dadosoficialkf228920.databinding.FragmentLensFrResultadoBinding;
 ...
 * Use the {@link LensFrResultadoFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class LensFrResultadoFragment extends Fragment {

    private FragmentLensFrResultadoBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLensFrResultadoBinding.inflate(inflater, container, false);
    ...
    private void setupDadosJogos() {
        ...
        jogosFrancesCasaFora2023_24Api.getLensFora().enqueue(new Callback<List<Partida>>() {
            @Override
