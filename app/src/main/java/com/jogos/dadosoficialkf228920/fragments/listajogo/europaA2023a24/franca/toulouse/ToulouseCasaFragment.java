...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.toulouse.ToulouseCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.toulouse.ToulouseCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentToulouseCasa2023a24Binding;
...
public class ToulouseCasaFragment extends Fragment {

    private FragmentToulouseCasa2023a24Binding binding;
    private ToulouseCasaPartidaApi toulouseCasaPartidaApi;
    private ToulouseCasaAdapter toulouseCasaAdapter;



    public ToulouseCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentToulouseCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        toulouseCasaPartidaApi = retrofit.create(ToulouseCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        toulouseCasaPartidaApi.getToulouseCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    toulouseCasaAdapter = new ToulouseCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(toulouseCasaAdapter);
