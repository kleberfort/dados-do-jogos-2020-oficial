...
import com.jogos.dadosoficialkf228920.databinding.FragmentLutonCasa2023a24Binding;
...
public class LutonCasaFragment extends Fragment {

    private FragmentLutonCasa2023a24Binding binding;
    private LutonCasaPartidaApi lutonCasaPartidaApi;
    private LutonCasaAdapter lutonCasaAdapter;



    public LutonCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLutonCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupDadosJogos() {
        ...
        lutonCasaPartidaApi.getLutonCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    lutonCasaAdapter = new LutonCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(lutonCasaAdapter);
