package com.jogos.dadosoficialkf228920.fragments.inglesA2022a23.crystalpalace;
...
import com.jogos.dadosoficialkf228920.adapter.inglesA2022a2023.crystalpalace.CrystalPalaceFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.inglesA2022a23.crystalpalace.CrystalPalaceForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentCrystalPalaceFora2022a23Binding;
...
public class CrystalPalaceFora2022a23Fragment extends Fragment {

    private FragmentCrystalPalaceFora2022a23Binding binding;
    private CrystalPalaceForaA2022a23PartidaApi crystalPalaceForaA2022a23PartidaApi;
    private CrystalPalaceFora2022a23Adapter crystalPalaceFora2022a23Adapter;


    public CrystalPalaceFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCrystalPalaceFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        crystalPalaceForaA2022a23PartidaApi = retrofit.create(CrystalPalaceForaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvCrystalPalaceFora.setHasFixedSize(true);
        binding.rvCrystalPalaceFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvCrystalPalaceFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        crystalPalaceForaA2022a23PartidaApi.getCrystalPalaceCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvCrystalPalaceFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvCrystalPalaceFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
