...
import com.jogos.dadosoficialkf228920.adapter.francaA2022a23.marseille.MarseilleCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.francaA2022a23.marseille.MarseilleCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentMarseilleCasa2022a23Binding;
        ...
        marseilleCasaA2022a23PartidaApi.getMarseilleCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvMarseilleCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvMarseilleCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
