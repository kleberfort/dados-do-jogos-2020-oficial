package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.sevilla;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.sevilla.SevillaForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.sevilla.SevillaForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentSevillaFora2023a24Binding;
...
public class SevillaForaFragment extends Fragment {

    private FragmentSevillaFora2023a24Binding binding;
    private SevillaForaPartidaApi sevillaForaPartidaApi;
    private SevillaForaAdapter sevillaForaAdapter;



    public SevillaForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSevillaFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        sevillaForaPartidaApi = retrofit.create(SevillaForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        sevillaForaPartidaApi.getSevillaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    sevillaForaAdapter = new SevillaForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(sevillaForaAdapter);
