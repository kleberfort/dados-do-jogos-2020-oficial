package com.jogos.dadosoficialkf228920.fragments.espanhaA2022a23.getafe;
...
import com.jogos.dadosoficialkf228920.adapter.espanhaA2022a23.getafe.GetafeFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.espanhaA2022a23.getafe.GetafeForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentGetafeFora2022a23Binding;
...
public class GetafeFora2022a23Fragment extends Fragment {

    private FragmentGetafeFora2022a23Binding binding;
    private GetafeForaA2022a23PartidaApi getafeForaA2022a23PartidaApi;
    private GetafeFora2022a23Adapter getafeFora2022a23Adapter;

    public GetafeFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentGetafeFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/espanhol-a-2022-23/getafe/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        getafeForaA2022a23PartidaApi = retrofit.create(GetafeForaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvGetafeFora.setHasFixedSize(true);
        binding.rvGetafeFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvGetafeFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        getafeForaA2022a23PartidaApi.getGetafeFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    getafeFora2022a23Adapter = new GetafeFora2022a23Adapter(partidas);
                    binding.rvGetafeFora.setAdapter(getafeFora2022a23Adapter);

                    binding.rvGetafeFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvGetafeFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
