package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.bournemouth;
...
import com.jogos.dadosoficialkf228920.databinding.FragmentBournemouthFora2023a24Binding;
...
public class BournemouthForaFragment extends Fragment {

    private FragmentBournemouthFora2023a24Binding binding;
    private BournemouthForaPartidaApi bournemouthForaPartidaApi;
    private BournemouthForaAdapter bournemouthForaAdapter;



    public BournemouthForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBournemouthFora2023a24Binding.inflate(inflater, container, false);
        ...
        bournemouthForaPartidaApi.getBournemouthFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    bournemouthForaAdapter = new BournemouthForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(bournemouthForaAdapter);
