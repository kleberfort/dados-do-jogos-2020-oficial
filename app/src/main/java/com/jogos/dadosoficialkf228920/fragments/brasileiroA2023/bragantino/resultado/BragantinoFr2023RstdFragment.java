...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.bragantino.resultado.BragantinoFrA2023RstdAdp;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.bragantino.BragantinoForaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentBragantinoFr2023RstdBinding;
...
public class BragantinoFr2023RstdFragment extends Fragment {

    private FragmentBragantinoFr2023RstdBinding binding;
    private BragantinoForaA2023PartidaApi bragantinoForaA2023PartidaApi;
    private BragantinoFrA2023RstdAdp bragantinoFrA2023RstdAdp;

    public BragantinoFr2023RstdFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBragantinoFr2023RstdBinding.inflate(inflater, container, false);
        ...
        bragantinoForaA2023PartidaApi.getBragantinoFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    bragantinoFrA2023RstdAdp = new BragantinoFrA2023RstdAdp(partidas);
                    binding.rvListaResultado.setAdapter(bragantinoFrA2023RstdAdp);
