package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.koln;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.koln.KolnCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.augsburg.AugsburgCasaPartidaApi;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.koln.KolnCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAugsburgCasa2023a24Binding;
import com.jogos.dadosoficialkf228920.databinding.FragmentKolnCasa2023a24Binding;
...
public class KolnCasaFragment extends Fragment {

    private FragmentKolnCasa2023a24Binding binding;
    private KolnCasaPartidaApi kolnCasaPartidaApi;
    private KolnCasaAdapter kolnCasaAdapter;



    public KolnCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentKolnCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/alemanha/koln/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        kolnCasaPartidaApi = retrofit.create(KolnCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        kolnCasaPartidaApi.getKolnCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    kolnCasaAdapter = new KolnCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(kolnCasaAdapter);
