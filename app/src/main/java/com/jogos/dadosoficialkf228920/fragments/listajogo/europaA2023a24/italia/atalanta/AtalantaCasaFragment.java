package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.atalanta;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.atalanta.AtalantaCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.atalanta.AtalantaCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAtalantaCasa2023a24Binding;
...
public class AtalantaCasaFragment extends Fragment {

    private FragmentAtalantaCasa2023a24Binding binding;
    private AtalantaCasaPartidaApi atalantaCasaPartidaApi;
    private AtalantaCasaAdapter atalantaCasaAdapter;



    public AtalantaCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAtalantaCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/italiano/atalanta/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        atalantaCasaPartidaApi = retrofit.create(AtalantaCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        atalantaCasaPartidaApi.getAtalantaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    atalantaCasaAdapter = new AtalantaCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(atalantaCasaAdapter);
