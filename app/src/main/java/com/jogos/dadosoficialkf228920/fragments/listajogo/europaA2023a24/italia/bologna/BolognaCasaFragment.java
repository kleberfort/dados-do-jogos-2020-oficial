...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.bologna.BolognaCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.bologna.BolognaCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentBolognaCasa2023a24Binding;
...
public class BolognaCasaFragment extends Fragment {

    private FragmentBolognaCasa2023a24Binding binding;
    private BolognaCasaPartidaApi bolognaCasaPartidaApi;
    private BolognaCasaAdapter bolognaCasaAdapter;



    public BolognaCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBolognaCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        bolognaCasaPartidaApi = retrofit.create(BolognaCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        bolognaCasaPartidaApi.getBolognaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    bolognaCasaAdapter = new BolognaCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(bolognaCasaAdapter);
