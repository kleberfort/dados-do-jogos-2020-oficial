...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.criciuma.CriciumaForaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.criciuma.CriciumaForaB2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentCriciumaForaB2023Binding;
...
public class CriciumaFora2023Fragment extends Fragment {

    private FragmentCriciumaForaB2023Binding binding;
    private CriciumaForaB2023Adapter criciumaForaB2023Adapter;
    private CriciumaForaB2023PartidaApi criciumaForaB2023PartidaApi;
    ...
    public CriciumaFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCriciumaForaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        criciumaForaB2023PartidaApi = retrofit.create(CriciumaForaB2023PartidaApi.class);
    }

    private void setupDadosJogos() {

        binding.rvCriciumaFora.setHasFixedSize(true);
        binding.rvCriciumaFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvCriciumaFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        criciumaForaB2023PartidaApi.getCriciumaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    criciumaForaB2023Adapter = new CriciumaForaB2023Adapter(partidas);
                    binding.rvCriciumaFora.setAdapter(criciumaForaB2023Adapter);

                    binding.rvCriciumaFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvCriciumaFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
