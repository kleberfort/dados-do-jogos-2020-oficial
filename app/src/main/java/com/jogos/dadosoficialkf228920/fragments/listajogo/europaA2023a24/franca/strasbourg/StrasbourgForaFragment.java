...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.strasbourg.StrasbourgForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.strasbourg.StrasbourgForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentStrasbourgFora2023a24Binding;
...
public class StrasbourgForaFragment extends Fragment {

    private FragmentStrasbourgFora2023a24Binding binding;
    private StrasbourgForaPartidaApi strasbourgForaPartidaApi;
    private StrasbourgForaAdapter strasbourgForaAdapter;



    public StrasbourgForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentStrasbourgFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        strasbourgForaPartidaApi = retrofit.create(StrasbourgForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        strasbourgForaPartidaApi.getStrasbourgFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    strasbourgForaAdapter = new StrasbourgForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(strasbourgForaAdapter);
