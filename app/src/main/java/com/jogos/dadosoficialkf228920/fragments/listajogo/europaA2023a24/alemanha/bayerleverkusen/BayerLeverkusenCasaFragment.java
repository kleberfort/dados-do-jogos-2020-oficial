package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.bayerleverkusen;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.bayerleverkusen.BayerLeverkusenCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.bayerleverkusen.BayerLeverkusenCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAugsburgCasa2023a24Binding;
import com.jogos.dadosoficialkf228920.databinding.FragmentBayerLeverkusenCasa2023a24Binding;
...
public class BayerLeverkusenCasaFragment extends Fragment {

    private FragmentBayerLeverkusenCasa2023a24Binding binding;
    private BayerLeverkusenCasaPartidaApi bayerLeverkusenCasaPartidaApi;
    private BayerLeverkusenCasaAdapter bayerLeverkusenCasaAdapter;



    public BayerLeverkusenCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBayerLeverkusenCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/alemanha/bayer-leverkusen/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        bayerLeverkusenCasaPartidaApi = retrofit.create(BayerLeverkusenCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        bayerLeverkusenCasaPartidaApi.getBayerLeverkusenCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    bayerLeverkusenCasaAdapter = new BayerLeverkusenCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(bayerLeverkusenCasaAdapter);
