...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.americaMG.AmericaMgForaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.americaMG.AmericaMgForaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAmericaMgForaA2023Binding;
...
public class AmericaMgFora2023Fragment extends Fragment {

    private FragmentAmericaMgForaA2023Binding binding;
    private AmericaMgForaA2023Adapter americaMgForaA2023Adapter;
    private AmericaMgForaA2023PartidaApi americaMgForaA2023PartidaApi;

    public AmericaMgFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAmericaMgForaA2023Binding.inflate(inflater, container, false);
        ...
        americaMgForaA2023PartidaApi.getAmericaMgFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    americaMgForaA2023Adapter = new AmericaMgForaA2023Adapter(partidas);
                    binding.rvAmericaMgFora.setAdapter(americaMgForaA2023Adapter);

                    binding.rvAmericaMgFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvAmericaMgFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
