...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.astonvilla.AstonVillaForaAdapter;
...
import com.jogos.dadosoficialkf228920.databinding.FragmentAstonVillaFora2023a24Binding;
...
public class AstonVillaForaFragment extends Fragment {

    private FragmentAstonVillaFora2023a24Binding binding;
    private AstonVillaForaPartidaApi astonVillaForaPartidaApi;
    private AstonVillaForaAdapter astonVillaForaAdapter;



    public AstonVillaForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAstonVillaFora2023a24Binding.inflate(inflater, container, false);
        ...
        astonVillaForaPartidaApi.getAstonVillaFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    astonVillaForaAdapter = new AstonVillaForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(astonVillaForaAdapter);
