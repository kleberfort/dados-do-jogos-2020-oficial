package com.jogos.dadosoficialkf228920.fragments.francaA2022a23.nantes;
...
import com.jogos.dadosoficialkf228920.adapter.francaA2022a23.nantes.NantesCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.francaA2022a23.nantes.NantesCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentNantesCasa2022a23Binding;
...
public class NantesCasa2022a23Fragment extends Fragment {
    ...
    private void setupHttpClient() {
        ...
        nantesCasaA2022a23PartidaApi = retrofit.create(NantesCasaA2022a23PartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        nantesCasaA2022a23PartidaApi.getNantesCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    nantesCasa2022a23Adapter = new NantesCasa2022a23Adapter(partidas);
                    binding.rvNantesCasa.setAdapter(nantesCasa2022a23Adapter);

                    binding.rvNantesCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvNantesCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
