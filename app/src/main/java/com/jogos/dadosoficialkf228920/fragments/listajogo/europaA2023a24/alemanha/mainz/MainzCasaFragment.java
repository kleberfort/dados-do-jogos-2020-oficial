package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.mainz;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.mainz05.Mainz05CasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.augsburg.AugsburgCasaPartidaApi;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.mainz05.Mainz05CasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAugsburgCasa2023a24Binding;
import com.jogos.dadosoficialkf228920.databinding.FragmentMainz05Casa2023a24Binding;
...
public class MainzCasaFragment extends Fragment {

    private FragmentMainz05Casa2023a24Binding binding;
    private Mainz05CasaPartidaApi mainz05CasaPartidaApi;
    private Mainz05CasaAdapter mainz05CasaAdapter;



    public MainzCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentMainz05Casa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/alemanha/mainz05/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        mainz05CasaPartidaApi = retrofit.create(Mainz05CasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        mainz05CasaPartidaApi.getMainz05Casa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    mainz05CasaAdapter = new Mainz05CasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(mainz05CasaAdapter);
