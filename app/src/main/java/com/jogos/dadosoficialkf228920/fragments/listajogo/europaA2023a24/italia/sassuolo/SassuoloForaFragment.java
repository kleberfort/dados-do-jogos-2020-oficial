...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.sassuolo.SassuoloForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.sassuolo.SassuoloForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentSassuoloFora2023a24Binding;
...
public class SassuoloForaFragment extends Fragment {

    private FragmentSassuoloFora2023a24Binding binding;
    private SassuoloForaPartidaApi sassuoloForaPartidaApi;
    private SassuoloForaAdapter sassuoloForaAdapter;



    public SassuoloForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSassuoloFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        sassuoloForaPartidaApi = retrofit.create(SassuoloForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        sassuoloForaPartidaApi.getSassuoloFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    sassuoloForaAdapter = new SassuoloForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(sassuoloForaAdapter);
