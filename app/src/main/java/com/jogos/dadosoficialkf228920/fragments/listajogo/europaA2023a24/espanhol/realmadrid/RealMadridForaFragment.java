package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.realmadrid;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.realmadrid.RealMadridForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.realmadrid.RealMadridForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentRealMadridFora2023a24Binding;
...
public class RealMadridForaFragment extends Fragment {

    private FragmentRealMadridFora2023a24Binding binding;
    private RealMadridForaPartidaApi realMadridForaPartidaApi;
    private RealMadridForaAdapter realMadridForaAdapter;



    public RealMadridForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentRealMadridFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/espanhol/real-madrid/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        realMadridForaPartidaApi = retrofit.create(RealMadridForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        realMadridForaPartidaApi.getRealMadridFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    realMadridForaAdapter = new RealMadridForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(realMadridForaAdapter);
