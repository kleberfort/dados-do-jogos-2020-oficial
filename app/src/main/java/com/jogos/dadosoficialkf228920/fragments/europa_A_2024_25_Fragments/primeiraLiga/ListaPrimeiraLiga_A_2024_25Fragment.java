...
public class ListaPrimeiraLiga_A_2024_25Fragment extends Fragment implements JogosPrimeiraLiga_A_2024_25_Listener {

    private FragmentListaPrimeiraLigaA202425Binding binding;
    private JogosPrimeiraLiga_A_2024_25 jogosPrimeiraLigaA202425;
    ...
    public interface ListaPrimeiraLiga2025_LongClickInterface{
        void listaPrimeiraLigaLongClick2025metodo();
    }

    //2 etapa criamos uma variavel da interface
    ListaPrimeiraLiga2025_OnClinkInterface listaPrimeiraLigaOnClick = null;//queremos usar o metodo listaBrasilAMetodo(String nome) mas estamos iniciando ela com o valor null
    //ou seuja null é igual a nulo ou nada
    //entende isso ?sim

    //2 etapa criamos uma variavel da interface
    ListaPrimeiraLiga2025_LongClickInterface listaPrimeiraLigaLongClick = null;
    ...
    public void onAttach(@NonNull Context context) {//
        ...
        if(context instanceof ListaPrimeiraLiga2025_OnClinkInterface){
            listaPrimeiraLigaOnClick = (ListaPrimeiraLiga2025_OnClinkInterface) context;//aqui iniciamos a nossa variavel... Esse código voce nao precisa entender, só tem que
            //compreendeu as 3 etapadas ?sim ok
        }

        if(context instanceof ListaPrimeiraLiga2025_LongClickInterface){
            listaPrimeiraLigaLongClick = (ListaPrimeiraLiga2025_LongClickInterface) context;
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentListaPrimeiraLigaA202425Binding.inflate(inflater, container, false);
        View view = binding.getRoot();


        jogosPrimeiraLigaA202425 = new JogosPrimeiraLiga_A_2024_25();
        jogosPrimeiraLigaA202425.setupHttpClient();
        jogosPrimeiraLigaA202425.setupDadosJogos();
        jogosPrimeiraLigaA202425.setListener(this);
        ...
        binding.rvLista.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvLista, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                if (acessos >= 3) {
                    listaPrimeiraLigaOnClick.listaPrimeiraLigaOnClick2025Metodo(name);
            ...
            public void onLongItemClick(View view, int position) {
                listaPrimeiraLigaLongClick.listaPrimeiraLigaLongClick2025metodo();
