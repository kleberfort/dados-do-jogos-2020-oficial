...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.atalanta.AtalantaForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.atalanta.AtalantaForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAtalantaFora2023a24Binding;
...
public class AtalantaForaFragment extends Fragment {

    private FragmentAtalantaFora2023a24Binding binding;
    private AtalantaForaPartidaApi atalantaForaPartidaApi;
    private AtalantaForaAdapter atalantaForaAdapter;



    public AtalantaForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAtalantaFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        atalantaForaPartidaApi = retrofit.create(AtalantaForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        atalantaForaPartidaApi.getAtalantaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    atalantaForaAdapter = new AtalantaForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(atalantaForaAdapter);
