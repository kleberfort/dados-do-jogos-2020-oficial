...
import com.jogos.dadosoficialkf228920.databinding.FragmentNantesCsResultadoBinding;
 ...
 * Use the {@link NantesCsResultadoFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class NantesCsResultadoFragment extends Fragment {

    private FragmentNantesCsResultadoBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentNantesCsResultadoBinding.inflate(inflater, container, false);
    ...
    private void setupDadosJogos() {
        ...
        jogosFrancesCasaFora2023_24Api.getNantesCasa().enqueue(new Callback<List<Partida>>() {
            @Override
