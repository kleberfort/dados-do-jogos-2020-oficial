...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.lehavre.LeHavreCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.lehavre.LeHavreCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentLeHavreCasa2023a24Binding;
...
public class LeHavreCasaFragment extends Fragment {

    private FragmentLeHavreCasa2023a24Binding binding;
    private LeHavreCasaPartidaApi leHavreCasaPartidaApi;
    private LeHavreCasaAdapter leHavreCasaAdapter;



    public LeHavreCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLeHavreCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        leHavreCasaPartidaApi = retrofit.create(LeHavreCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        leHavreCasaPartidaApi.getLeHavreCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    leHavreCasaAdapter = new LeHavreCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(leHavreCasaAdapter);
