...
import com.jogos.dadosoficialkf228920.adapter.italiaA2022a23.monza.MonzaFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.italiaA2022a23.monza.MonzaForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentMonzaFora2022a23Binding;
        ...
        monzaForaA2022a23PartidaApi.getMonzaFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvMonzaFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvMonzaFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
