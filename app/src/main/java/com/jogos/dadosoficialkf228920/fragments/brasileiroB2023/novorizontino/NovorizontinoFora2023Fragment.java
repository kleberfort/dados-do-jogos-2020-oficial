package com.jogos.dadosoficialkf228920.fragments.brasileiroB2023.novorizontino;
...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.novorizontino.NovorizontinoForaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.novorizontino.NovorizontinoForaB2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentNovorizontinoForaB2023Binding;
...
public class NovorizontinoFora2023Fragment extends Fragment {

    private FragmentNovorizontinoForaB2023Binding binding;
    private NovorizontinoForaB2023Adapter novorizontinoForaB2023Adapter;
    private NovorizontinoForaB2023PartidaApi novorizontinoForaB2023PartidaApi;




    public NovorizontinoFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentNovorizontinoForaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/brasileiro-b-2023/novorizontino/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        novorizontinoForaB2023PartidaApi = retrofit.create(NovorizontinoForaB2023PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvNovorizontinoFora.setHasFixedSize(true);
        binding.rvNovorizontinoFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvNovorizontinoFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        novorizontinoForaB2023PartidaApi.getNovorizontinoFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    novorizontinoForaB2023Adapter = new NovorizontinoForaB2023Adapter(partidas);
                    binding.rvNovorizontinoFora.setAdapter(novorizontinoForaB2023Adapter);

                    binding.rvNovorizontinoFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvNovorizontinoFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
