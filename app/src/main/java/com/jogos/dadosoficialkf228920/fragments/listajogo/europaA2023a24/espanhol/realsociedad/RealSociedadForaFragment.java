...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.realsociedad.RealSociedadForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.realsociedad.RealSociedadForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentRealSociedadFora2023a24Binding;
...
public class RealSociedadForaFragment extends Fragment {

    private FragmentRealSociedadFora2023a24Binding binding;
    private RealSociedadForaPartidaApi realSociedadForaPartidaApi;
    private RealSociedadForaAdapter realSociedadForaAdapter;



    public RealSociedadForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentRealSociedadFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        realSociedadForaPartidaApi = retrofit.create(RealSociedadForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        realSociedadForaPartidaApi.getRealSociedadFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    realSociedadForaAdapter = new RealSociedadForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(realSociedadForaAdapter);
