package com.jogos.dadosoficialkf228920.fragments.francaA2022a23.troyes;
...
import com.jogos.dadosoficialkf228920.adapter.francaA2022a23.troyes.TroyesFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.francaA2022a23.troyes.TroyesForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentTroyesFora2022a23Binding;
...
public class TroyesFora2022a23Fragment extends Fragment {
    ...
    private void setupHttpClient() {
        ...
        troyesForaA2022a23PartidaApi = retrofit.create(TroyesForaA2022a23PartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        troyesForaA2022a23PartidaApi.getTroyesFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    troyesFora2022a23Adapter = new TroyesFora2022a23Adapter(partidas);
                    binding.rvTroyesFora.setAdapter(troyesFora2022a23Adapter);

                    binding.rvTroyesFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvTroyesFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
