package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.heidenheim;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.heidenheim.HeidenheimCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.augsburg.AugsburgCasaPartidaApi;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.heidenheim.HeidenheimCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAugsburgCasa2023a24Binding;
import com.jogos.dadosoficialkf228920.databinding.FragmentHeidenheimCasa2023a24Binding;
...
public class HeidenheimCasaFragment extends Fragment {

    private FragmentHeidenheimCasa2023a24Binding binding;
    private HeidenheimCasaPartidaApi heidenheimCasaPartidaApi;
    private HeidenheimCasaAdapter heidenheimCasaAdapter;



    public HeidenheimCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentHeidenheimCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/alemanha/heidenheim/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        heidenheimCasaPartidaApi = retrofit.create(HeidenheimCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        heidenheimCasaPartidaApi.getHeidenheimCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    heidenheimCasaAdapter = new HeidenheimCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(heidenheimCasaAdapter);
