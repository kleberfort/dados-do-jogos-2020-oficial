...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.bochum.BochumCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.augsburg.AugsburgCasaPartidaApi;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.bochum.BochumCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAugsburgCasa2023a24Binding;
import com.jogos.dadosoficialkf228920.databinding.FragmentBochumCasa2023a24Binding;
...
public class BochumCasaFragment extends Fragment {

    private FragmentBochumCasa2023a24Binding binding;
    private BochumCasaPartidaApi bochumCasaPartidaApi;
    private BochumCasaAdapter bochumCasaAdapter;



    public BochumCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBochumCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        bochumCasaPartidaApi = retrofit.create(BochumCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        bochumCasaPartidaApi.getBochumCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    bochumCasaAdapter = new BochumCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(bochumCasaAdapter);
