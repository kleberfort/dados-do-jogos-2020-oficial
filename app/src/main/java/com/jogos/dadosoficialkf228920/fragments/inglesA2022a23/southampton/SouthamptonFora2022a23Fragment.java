package com.jogos.dadosoficialkf228920.fragments.inglesA2022a23.southampton;
...
import com.jogos.dadosoficialkf228920.adapter.inglesA2022a2023.southampton.SouthamptonFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.inglesA2022a23.southampton.SouthamptonForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentSouthamptonFora2022a23Binding;
...
public class SouthamptonFora2022a23Fragment extends Fragment {

    private FragmentSouthamptonFora2022a23Binding binding;
    private SouthamptonForaA2022a23PartidaApi southamptonForaA2022a23PartidaApi;
    private SouthamptonFora2022a23Adapter southamptonFora2022a23Adapter;


    public SouthamptonFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSouthamptonFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        southamptonForaA2022a23PartidaApi = retrofit.create(SouthamptonForaA2022a23PartidaApi.class);

    }

    private void setupDadosJogos() {
        binding.rvSouthamptonFora.setHasFixedSize(true);
        ...
        southamptonForaA2022a23PartidaApi.getSouthamptonFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    southamptonFora2022a23Adapter = new SouthamptonFora2022a23Adapter(partidas);
                    binding.rvSouthamptonFora.setAdapter(southamptonFora2022a23Adapter);

                    binding.rvSouthamptonFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvSouthamptonFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
