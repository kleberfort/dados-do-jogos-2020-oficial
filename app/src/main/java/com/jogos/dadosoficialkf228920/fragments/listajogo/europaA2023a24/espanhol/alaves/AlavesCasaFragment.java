package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.alaves;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.alaves.AlavesCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.alaves.AlavesCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAlavesCasa2023a24Binding;
...
public class AlavesCasaFragment extends Fragment {

    private FragmentAlavesCasa2023a24Binding binding;
    private AlavesCasaPartidaApi alavesCasaPartidaApi;
    private AlavesCasaAdapter alavesCasaAdapter;



    public AlavesCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAlavesCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/espanhol/alaves/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        alavesCasaPartidaApi = retrofit.create(AlavesCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        alavesCasaPartidaApi.getAlavesCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    alavesCasaAdapter = new AlavesCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(alavesCasaAdapter);
