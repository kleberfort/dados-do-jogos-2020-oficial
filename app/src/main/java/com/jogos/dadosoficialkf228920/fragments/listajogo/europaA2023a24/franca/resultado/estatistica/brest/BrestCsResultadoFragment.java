...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.FrancaCptResultadoAdt;
...
public class BrestCsResultadoFragment extends Fragment {

    private FragmentBrestCsResultadoBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBrestCsResultadoBinding.inflate(inflater, container, false);
    ...
    private void setupDadosJogos() {
        ...
        jogosFrancesCasaFora2023_24Api.getBrestCasa().enqueue(new Callback<List<Partida>>() {
            @Override
