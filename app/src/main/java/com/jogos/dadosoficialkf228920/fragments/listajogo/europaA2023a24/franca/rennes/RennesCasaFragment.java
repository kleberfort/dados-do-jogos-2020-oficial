...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.rennes.RennesCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.rennes.RennesCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentRennesCasa2023a24Binding;
...
public class RennesCasaFragment extends Fragment {

    private FragmentRennesCasa2023a24Binding binding;
    private RennesCasaPartidaApi rennesCasaPartidaApi;
    private RennesCasaAdapter rennesCasaAdapter;



    public RennesCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentRennesCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        rennesCasaPartidaApi = retrofit.create(RennesCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        rennesCasaPartidaApi.getRennesCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    rennesCasaAdapter = new RennesCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(rennesCasaAdapter);
