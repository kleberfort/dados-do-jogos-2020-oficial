...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.sampaiocorrea.SampaioCorreaCasaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.sampaiocorrea.SampaioCorreaCasaB2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentSampaiocorreaCasaB2023Binding;
...
public class SampaioCorreaCasa2023Fragment extends Fragment {

    private FragmentSampaiocorreaCasaB2023Binding binding;
    private SampaioCorreaCasaB2023Adapter sampaioCorreaCasaB2023Adapter;
    private SampaioCorreaCasaB2023PartidaApi sampaioCorreaCasaB2023PartidaApi;





    public SampaioCorreaCasa2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSampaiocorreaCasaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        sampaioCorreaCasaB2023PartidaApi = retrofit.create(SampaioCorreaCasaB2023PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvSampaioCorreaCasa.setHasFixedSize(true);
        binding.rvSampaioCorreaCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvSampaioCorreaCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        sampaioCorreaCasaB2023PartidaApi.getSampaioCorreaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    sampaioCorreaCasaB2023Adapter = new SampaioCorreaCasaB2023Adapter(partidas);
                    binding.rvSampaioCorreaCasa.setAdapter(sampaioCorreaCasaB2023Adapter);

                    binding.rvSampaioCorreaCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvSampaioCorreaCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
