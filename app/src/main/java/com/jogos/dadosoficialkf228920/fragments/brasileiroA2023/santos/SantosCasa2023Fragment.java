package com.jogos.dadosoficialkf228920.fragments.brasileiroA2023.santos;
...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.santos.SantosCasaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.santos.SantosCasaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentSantosCasaA2023Binding;
...
public class SantosCasa2023Fragment extends Fragment {

    private FragmentSantosCasaA2023Binding binding;
    private SantosCasaA2023Adapter santosCasaA2023Adapter;
    private SantosCasaA2023PartidaApi santosCasaA2023PartidaApi;


    public SantosCasa2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSantosCasaA2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        santosCasaA2023PartidaApi = retrofit.create(SantosCasaA2023PartidaApi.class);
    }
    ...
    private void setupDadosJogos() {
        ...
        santosCasaA2023PartidaApi.getSantosCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    santosCasaA2023Adapter = new SantosCasaA2023Adapter(partidas);
                    binding.rvSantosCasa.setAdapter(santosCasaA2023Adapter);

                    binding.rvSantosCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvSantosCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
