package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.stuttgart;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.stuttgart.StuttgartForaAdapter;
...
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.stuttgart.StuttgartForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAugsburgFora2023a24Binding;
import com.jogos.dadosoficialkf228920.databinding.FragmentStuttgartFora2023a24Binding;
...
public class StuttgartForaFragment extends Fragment {

    private FragmentStuttgartFora2023a24Binding binding;
    private StuttgartForaPartidaApi stuttgartForaPartidaApi;
    private StuttgartForaAdapter stuttgartForaAdapter;



    public StuttgartForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentStuttgartFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        stuttgartForaPartidaApi = retrofit.create(StuttgartForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        stuttgartForaPartidaApi.getStuttgartFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    stuttgartForaAdapter = new StuttgartForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(stuttgartForaAdapter);
