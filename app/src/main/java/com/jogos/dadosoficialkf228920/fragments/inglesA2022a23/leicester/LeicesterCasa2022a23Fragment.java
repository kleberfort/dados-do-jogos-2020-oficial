...
import com.jogos.dadosoficialkf228920.adapter.inglesA2022a2023.leicester.LeicesterCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.inglesA2022a23.leicester.LeicesterCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentLeicesterCasa2022a23Binding;
        ...
        leicesterCasaA2022a23PartidaApi.getLeicesterCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvLeicesterCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvLeicesterCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
