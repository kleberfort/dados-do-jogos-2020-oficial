...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.guarani.GuaraniCasaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.guarani.GuaraniCasaB2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentGuaraniCasaB2023Binding;
...
public class GuaraniCasa2023Fragment extends Fragment {

    private FragmentGuaraniCasaB2023Binding binding;
    private GuaraniCasaB2023Adapter guaraniCasaB2023Adapter;
    private GuaraniCasaB2023PartidaApi guaraniCasaB2023PartidaApi;



    public GuaraniCasa2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentGuaraniCasaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        guaraniCasaB2023PartidaApi = retrofit.create(GuaraniCasaB2023PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvGuaraniCasa.setHasFixedSize(true);
        binding.rvGuaraniCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvGuaraniCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        guaraniCasaB2023PartidaApi.getGuaraniCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    guaraniCasaB2023Adapter = new GuaraniCasaB2023Adapter(partidas);
                    binding.rvGuaraniCasa.setAdapter(guaraniCasaB2023Adapter);

                    binding.rvGuaraniCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvGuaraniCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
