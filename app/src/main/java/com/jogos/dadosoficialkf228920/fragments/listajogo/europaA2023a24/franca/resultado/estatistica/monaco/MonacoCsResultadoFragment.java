package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.resultado.estatistica.monaco;
...
import com.jogos.dadosoficialkf228920.databinding.FragmentMonacoCsResultadoBinding;
 ...
 * Use the {@link MonacoCsResultadoFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MonacoCsResultadoFragment extends Fragment {

    private FragmentMonacoCsResultadoBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentMonacoCsResultadoBinding.inflate(inflater, container, false);
    ...
    private void setupDadosJogos() {
        ...
        jogosFrancesCasaFora2023_24Api.getMonacoCasa().enqueue(new Callback<List<Partida>>() {
            @Override
