package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.athleticbilbao;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.athleticbilbao.AthleticBilbaoForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.athleticbilbao.AthleticBilbaoForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAthleticBilbaoFora2023a24Binding;
...
public class AthleticBilbaoForaFragment extends Fragment {

    private FragmentAthleticBilbaoFora2023a24Binding binding;
    private AthleticBilbaoForaPartidaApi athleticBilbaoForaPartidaApi;
    private AthleticBilbaoForaAdapter athleticBilbaoForaAdapter;



    public AthleticBilbaoForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAthleticBilbaoFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/espanhol/athletic-bilbao/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        athleticBilbaoForaPartidaApi = retrofit.create(AthleticBilbaoForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        athleticBilbaoForaPartidaApi.getAthleticBilbaoFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    athleticBilbaoForaAdapter = new AthleticBilbaoForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(athleticBilbaoForaAdapter);
