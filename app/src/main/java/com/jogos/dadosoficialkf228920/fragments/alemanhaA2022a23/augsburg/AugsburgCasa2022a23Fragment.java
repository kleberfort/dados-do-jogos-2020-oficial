package com.jogos.dadosoficialkf228920.fragments.alemanhaA2022a23.augsburg;
...
import com.jogos.dadosoficialkf228920.data.alemanhaA2022a23.augsburg.AugsburgCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAugsburgCasa2022a23Binding;
...
public class AugsburgCasa2022a23Fragment extends Fragment {
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/alemanha-a-2022-23/augsburg/")
        ...
        augsburgCasaA2022a23PartidaApi.getAugsburgCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    augsburgCasa2022a23Adapter = new AugsburgCasa2022a23Adapter(partidas);
                    binding.rvAugsburgCasa.setAdapter(augsburgCasa2022a23Adapter);

                    binding.rvAugsburgCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvAugsburgCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
