...
import com.jogos.dadosoficialkf228920.databinding.FragmentWolvesResultadoEstatisticaBinding;
...
public class WolvesResultadoEstatisticaFragment extends Fragment {

    private FragmentWolvesResultadoEstatisticaBinding binding;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        binding = FragmentWolvesResultadoEstatisticaBinding.inflate(inflater, container, false);
        ...
        FragmentPagerItemAdapter adapter = new FragmentPagerItemAdapter(
                ...
                FragmentPagerItems.with(getApplicationContext())
                        .add("Casa 2023-24", WolvesCsResultadoFragment.class)
                        .add("Fora 2023-24", WolvesFrResultadoFragment.class)
