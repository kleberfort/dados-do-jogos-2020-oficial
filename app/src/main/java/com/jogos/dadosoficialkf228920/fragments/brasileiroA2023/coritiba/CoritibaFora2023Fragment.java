...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.coritiba.CoritibaForaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.coritiba.CoritibaForaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentCoritibaForaA2023Binding;
...
public class CoritibaFora2023Fragment extends Fragment {

    private FragmentCoritibaForaA2023Binding binding;
    private CoritibaForaA2023Adapter coritibaForaA2023Adapter;
    private CoritibaForaA2023PartidaApi coritibaForaA2023PartidaApi;



    public CoritibaFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCoritibaForaA2023Binding.inflate(inflater, container, false);
        ...
        coritibaForaA2023PartidaApi.getCoritibaFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    coritibaForaA2023Adapter = new CoritibaForaA2023Adapter(partidas);
                    binding.rvCoritibaFora.setAdapter(coritibaForaA2023Adapter);

                    binding.rvCoritibaFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvCoritibaFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
