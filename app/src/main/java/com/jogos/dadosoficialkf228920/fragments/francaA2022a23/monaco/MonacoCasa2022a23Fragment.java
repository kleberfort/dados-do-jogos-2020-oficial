...
import com.jogos.dadosoficialkf228920.adapter.francaA2022a23.monaco.MonacoCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.francaA2022a23.monaco.MonacoCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentMonacoCasa2022a23Binding;
        ...
        monacoCasaA2022a23PartidaApi.getMonacoCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvMonacoCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvMonacoCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
