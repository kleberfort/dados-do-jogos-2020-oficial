...
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.werderbremen.WerderBremenCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAugsburgCasa2023a24Binding;
import com.jogos.dadosoficialkf228920.databinding.FragmentWerderBremenCasa2023a24Binding;
...
public class WerderBremenCasaFragment extends Fragment {

    private FragmentWerderBremenCasa2023a24Binding binding;
    private WerderBremenCasaPartidaApi werderBremenCasaPartidaApi;
    private WerderBremenCasaAdapter werderBremenCasaAdapter;



    public WerderBremenCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentWerderBremenCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        werderBremenCasaPartidaApi = retrofit.create(WerderBremenCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        werderBremenCasaPartidaApi.getWerderBremenCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    werderBremenCasaAdapter = new WerderBremenCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(werderBremenCasaAdapter);
