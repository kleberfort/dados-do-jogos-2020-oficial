package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.brest;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.brest.BrestForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.brest.BrestForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentBrestFora2023a24Binding;
...
public class BrestForaFragment extends Fragment {

    private FragmentBrestFora2023a24Binding binding;
    private BrestForaPartidaApi brestForaPartidaApi;
    private BrestForaAdapter brestForaAdapter;



    public BrestForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBrestFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/franca/brest/")
        ...
        brestForaPartidaApi.getBrestFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    brestForaAdapter = new BrestForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(brestForaAdapter);
