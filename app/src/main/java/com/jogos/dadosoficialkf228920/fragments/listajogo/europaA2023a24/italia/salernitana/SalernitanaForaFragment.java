...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.salernitana.SalernitanaForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.salernitana.SalernitanaForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentSalernitanaFora2023a24Binding;
...
public class SalernitanaForaFragment extends Fragment {

    private FragmentSalernitanaFora2023a24Binding binding;
    private SalernitanaForaPartidaApi salernitanaForaPartidaApi;
    private SalernitanaForaAdapter salernitanaForaAdapter;



    public SalernitanaForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSalernitanaFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        salernitanaForaPartidaApi = retrofit.create(SalernitanaForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        salernitanaForaPartidaApi.getSalernitanaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    salernitanaForaAdapter = new SalernitanaForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(salernitanaForaAdapter);
