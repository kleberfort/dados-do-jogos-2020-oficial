...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.londrina.LondrinaForaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.londrina.LondrinaForaB2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentLondrinaForaB2023Binding;
...
public class LondrinaFora2023Fragment extends Fragment {

    private FragmentLondrinaForaB2023Binding binding;
    private LondrinaForaB2023Adapter londrinaForaB2023Adapter;
    private LondrinaForaB2023PartidaApi londrinaForaB2023PartidaApi;





    public LondrinaFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLondrinaForaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        londrinaForaB2023PartidaApi = retrofit.create(LondrinaForaB2023PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvLondrinaFora.setHasFixedSize(true);
        binding.rvLondrinaFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvLondrinaFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        londrinaForaB2023PartidaApi.getLondrinaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    londrinaForaB2023Adapter = new LondrinaForaB2023Adapter(partidas);
                    binding.rvLondrinaFora.setAdapter(londrinaForaB2023Adapter);

                    binding.rvLondrinaFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvLondrinaFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
