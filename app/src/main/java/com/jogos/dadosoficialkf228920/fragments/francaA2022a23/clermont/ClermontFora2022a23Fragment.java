package com.jogos.dadosoficialkf228920.fragments.francaA2022a23.clermont;
...
import com.jogos.dadosoficialkf228920.adapter.francaA2022a23.clermont.ClermontFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.francaA2022a23.clermont.ClermontForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentClermontFora2022a23Binding;
...
public class ClermontFora2022a23Fragment extends Fragment {


    private FragmentClermontFora2022a23Binding binding;
    private ClermontForaA2022a23PartidaApi clermontForaA2022a23PartidaApi;
    private ClermontFora2022a23Adapter clermontFora2022a23Adapter;


    public ClermontFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentClermontFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        clermontForaA2022a23PartidaApi = retrofit.create(ClermontForaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvClermontFora.setHasFixedSize(true);
        binding.rvClermontFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvClermontFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        clermontForaA2022a23PartidaApi.getClermontFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    clermontFora2022a23Adapter = new ClermontFora2022a23Adapter(partidas);
                    binding.rvClermontFora.setAdapter(clermontFora2022a23Adapter);

                    binding.rvClermontFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvClermontFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
