...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.fluminense.FluminenseCasaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.fluminense.FluminenseCasaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentFluminenseCasaA2023Binding;
...
public class FluminenseCasa2023Fragment extends Fragment {

   private FragmentFluminenseCasaA2023Binding binding;
   private FluminenseCasaA2023Adapter fluminenseCasaA2023Adapter;
   private FluminenseCasaA2023PartidaApi fluminenseCasaA2023PartidaApi;

    public FluminenseCasa2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFluminenseCasaA2023Binding.inflate(inflater, container, false);
        ...
        fluminenseCasaA2023PartidaApi.getFluminenseCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    fluminenseCasaA2023Adapter = new FluminenseCasaA2023Adapter(partidas);
                    binding.rvFluminenseCasa.setAdapter(fluminenseCasaA2023Adapter);
