package com.jogos.dadosoficialkf228920.fragments.inglesA2022a23.leicester;
...
import com.jogos.dadosoficialkf228920.adapter.inglesA2022a2023.leicester.LeicesterFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.inglesA2022a23.leicester.LeicesterForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentLeicesterFora2022a23Binding;
        ...
        leicesterForaA2022a23PartidaApi.getLeicesterCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvLeicesterFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvLeicesterFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
