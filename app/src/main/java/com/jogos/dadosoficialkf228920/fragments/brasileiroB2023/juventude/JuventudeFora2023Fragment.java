...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.juventude.JuventudeForaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.juventude.JuventudeForaB2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentJuventudeForaB2023Binding;
...
public class JuventudeFora2023Fragment extends Fragment {


    private FragmentJuventudeForaB2023Binding binding;
    private JuventudeForaB2023Adapter juventudeForaB2023Adapter;
    private JuventudeForaB2023PartidaApi juventudeForaB2023PartidaApi;





    public JuventudeFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentJuventudeForaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/brasileiro-b-2023/juventude/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        juventudeForaB2023PartidaApi = retrofit.create(JuventudeForaB2023PartidaApi.class);
    }
    ...
    private void setupDadosJogos() {
        ...
        juventudeForaB2023PartidaApi.getJuventudeFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    juventudeForaB2023Adapter = new JuventudeForaB2023Adapter(partidas);
                    binding.rvJuventudeFora.setAdapter(juventudeForaB2023Adapter);

                    binding.rvJuventudeFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvJuventudeFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
