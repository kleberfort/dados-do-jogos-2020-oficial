...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.wolfsburg.WolfsburgCasaAdapter;
...
import com.jogos.dadosoficialkf228920.databinding.FragmentWolfsburgCasa2023a24Binding;
...
public class WolfsburgCasaFragment extends Fragment {

    private FragmentWolfsburgCasa2023a24Binding binding;
    private WolfsburgCasaPartidaApi wolfsburgCasaPartidaApi;
    private WolfsburgCasaAdapter wolfsburgCasaAdapter;



    public WolfsburgCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentWolfsburgCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        wolfsburgCasaPartidaApi = retrofit.create(WolfsburgCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        wolfsburgCasaPartidaApi.getWolfsburgCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    wolfsburgCasaAdapter = new WolfsburgCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(wolfsburgCasaAdapter);
