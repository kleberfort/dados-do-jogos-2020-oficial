...
public class BotafogoSpCasa2023Fragment extends Fragment {

    private FragmentBotafogoSpCasaB2023Binding binding;
    private BotafogoSpCasaB2023Adapter botafogoSpCasaB2023Adapter;
    private BotafogoSpCasaB2023PartidaApi botafogoSpCasaB2023PartidaApi;




    public BotafogoSpCasa2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBotafogoSpCasaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        botafogoSpCasaB2023PartidaApi = retrofit.create(BotafogoSpCasaB2023PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvBotafogoSpCasa.setHasFixedSize(true);
        binding.rvBotafogoSpCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvBotafogoSpCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        botafogoSpCasaB2023PartidaApi.getBotafogoSpCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    botafogoSpCasaB2023Adapter = new BotafogoSpCasaB2023Adapter(partidas);
                    binding.rvBotafogoSpCasa.setAdapter(botafogoSpCasaB2023Adapter);

                    binding.rvBotafogoSpCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvBotafogoSpCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
