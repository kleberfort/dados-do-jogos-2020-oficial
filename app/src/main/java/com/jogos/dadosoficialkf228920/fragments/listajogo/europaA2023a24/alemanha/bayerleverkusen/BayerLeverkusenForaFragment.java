...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.bayerleverkusen.BayerLeverkusenForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.bayerleverkusen.BayerLeverkusenForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentBayerLeverkusenFora2023a24Binding;
...
public class BayerLeverkusenForaFragment extends Fragment {

    private FragmentBayerLeverkusenFora2023a24Binding binding;
    private BayerLeverkusenForaPartidaApi bayerLeverkusenForaPartidaApi;
    private BayerLeverkusenForaAdapter bayerLeverkusenForaAdapter;



    public BayerLeverkusenForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBayerLeverkusenFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        bayerLeverkusenForaPartidaApi = retrofit.create(BayerLeverkusenForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        bayerLeverkusenForaPartidaApi.getBayerLeverkusenFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    bayerLeverkusenForaAdapter = new BayerLeverkusenForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(bayerLeverkusenForaAdapter);
