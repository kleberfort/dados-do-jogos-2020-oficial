...
import com.jogos.dadosoficialkf228920.databinding.FragmentToulouseCsResultadoBinding;
 ...
 * Use the {@link ToulouseCsResultadoFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ToulouseCsResultadoFragment extends Fragment {

    private FragmentToulouseCsResultadoBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentToulouseCsResultadoBinding.inflate(inflater, container, false);
    ...
    private void setupDadosJogos() {
        ...
        jogosFrancesCasaFora2023_24Api.getToulouseCasa().enqueue(new Callback<List<Partida>>() {
            @Override
