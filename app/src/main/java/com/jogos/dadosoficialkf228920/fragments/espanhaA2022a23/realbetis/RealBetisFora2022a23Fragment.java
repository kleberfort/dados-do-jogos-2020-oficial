package com.jogos.dadosoficialkf228920.fragments.espanhaA2022a23.realbetis;
...
import com.jogos.dadosoficialkf228920.adapter.espanhaA2022a23.realbetis.RealBetisFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.espanhaA2022a23.realbetis.RealBetisForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentRealBetisFora2022a23Binding;
...
public class RealBetisFora2022a23Fragment extends Fragment {


    private FragmentRealBetisFora2022a23Binding binding;
    private RealBetisForaA2022a23PartidaApi realBetisForaA2022a23PartidaApi;
    private RealBetisFora2022a23Adapter realBetisFora2022a23Adapter;


    public RealBetisFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentRealBetisFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        realBetisForaA2022a23PartidaApi = retrofit.create(RealBetisForaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvRealBetisFora.setHasFixedSize(true);
        binding.rvRealBetisFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvRealBetisFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        realBetisForaA2022a23PartidaApi.getRealBetisFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    realBetisFora2022a23Adapter = new RealBetisFora2022a23Adapter(partidas);
                    binding.rvRealBetisFora.setAdapter(realBetisFora2022a23Adapter);

                    binding.rvRealBetisFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvRealBetisFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
