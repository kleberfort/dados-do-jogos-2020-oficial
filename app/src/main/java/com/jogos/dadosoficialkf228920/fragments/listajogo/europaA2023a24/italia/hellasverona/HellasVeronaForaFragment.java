package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.hellasverona;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.hellasverona.HellasVeronaForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.hellasverona.HellasVeronaForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentHellasVeronaFora2023a24Binding;
...
public class HellasVeronaForaFragment extends Fragment {

    private FragmentHellasVeronaFora2023a24Binding binding;
    private HellasVeronaForaPartidaApi hellasVeronaForaPartidaApi;
    private HellasVeronaForaAdapter hellasVeronaForaAdapter;



    public HellasVeronaForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentHellasVeronaFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/italiano/hellas-verona/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        hellasVeronaForaPartidaApi = retrofit.create(HellasVeronaForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        hellasVeronaForaPartidaApi.getHellasVeronaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    hellasVeronaForaAdapter = new HellasVeronaForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(hellasVeronaForaAdapter);
