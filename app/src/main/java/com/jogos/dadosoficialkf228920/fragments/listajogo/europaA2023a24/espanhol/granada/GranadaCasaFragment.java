...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.granada.GranadaCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.granada.GranadaCasaPartidaApi;

import com.jogos.dadosoficialkf228920.databinding.FragmentGranadaCasa2023a24Binding;
...
public class GranadaCasaFragment extends Fragment {

    private FragmentGranadaCasa2023a24Binding binding;
    private GranadaCasaPartidaApi granadaCasaPartidaApi;
    private GranadaCasaAdapter granadaCasaAdapter;



    public GranadaCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentGranadaCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        granadaCasaPartidaApi = retrofit.create(GranadaCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        granadaCasaPartidaApi.getGranadaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    granadaCasaAdapter = new GranadaCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(granadaCasaAdapter);
