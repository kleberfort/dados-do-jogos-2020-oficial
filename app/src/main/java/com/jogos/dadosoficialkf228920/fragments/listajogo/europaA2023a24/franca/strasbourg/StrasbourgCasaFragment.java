package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.strasbourg;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.strasbourg.StrasbourgCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.strasbourg.StrasbourgCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentStrasbourgCasa2023a24Binding;
...
public class StrasbourgCasaFragment extends Fragment {

    private FragmentStrasbourgCasa2023a24Binding binding;
    private StrasbourgCasaPartidaApi strasbourgCasaPartidaApi;
    private StrasbourgCasaAdapter strasbourgCasaAdapter;



    public StrasbourgCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentStrasbourgCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/franca/strasbourg/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        strasbourgCasaPartidaApi = retrofit.create(StrasbourgCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        strasbourgCasaPartidaApi.getStrasbourgCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    strasbourgCasaAdapter = new StrasbourgCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(strasbourgCasaAdapter);
