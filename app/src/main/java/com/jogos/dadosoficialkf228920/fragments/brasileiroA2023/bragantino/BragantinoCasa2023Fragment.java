...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.bragantino.BragantinoCasaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.bragantino.BragantinoCasaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentBragantinoCasaA2023Binding;
...
public class BragantinoCasa2023Fragment extends Fragment {

    private FragmentBragantinoCasaA2023Binding binding;
    private BragantinoCasaA2023Adapter bragantinoCasaA2023Adapter;
    private BragantinoCasaA2023PartidaApi bragantinoCasaA2023PartidaApi;



    public BragantinoCasa2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBragantinoCasaA2023Binding.inflate(inflater, container, false);
        ...
        bragantinoCasaA2023PartidaApi.getBragantinoCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    bragantinoCasaA2023Adapter = new BragantinoCasaA2023Adapter(partidas);
                    binding.rvBragantinoCasa.setAdapter(bragantinoCasaA2023Adapter);

                    binding.rvBragantinoCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvBragantinoCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
