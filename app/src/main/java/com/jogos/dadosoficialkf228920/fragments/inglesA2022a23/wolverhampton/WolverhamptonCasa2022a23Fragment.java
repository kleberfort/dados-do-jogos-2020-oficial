package com.jogos.dadosoficialkf228920.fragments.inglesA2022a23.wolverhampton;
...
import com.jogos.dadosoficialkf228920.adapter.inglesA2022a2023.wolverhampton.WolverhamptonCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.inglesA2022a23.wolverhampton.WolverhamptonCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentWolverhamptonCasa2022a23Binding;
...
public class WolverhamptonCasa2022a23Fragment extends Fragment {

    private FragmentWolverhamptonCasa2022a23Binding binding;
    private WolverhamptonCasaA2022a23PartidaApi wolverhamptonCasaA2022a23PartidaApi;
    private WolverhamptonCasa2022a23Adapter wolverhamptonCasa2022a23Adapter;

    public WolverhamptonCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentWolverhamptonCasa2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/ingles-a-2022-23/wolverhampton/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        wolverhamptonCasaA2022a23PartidaApi = retrofit.create(WolverhamptonCasaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvWolverhamptonCasa.setHasFixedSize(true);
        binding.rvWolverhamptonCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvWolverhamptonCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        wolverhamptonCasaA2022a23PartidaApi.getWolverhamptonCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    wolverhamptonCasa2022a23Adapter = new WolverhamptonCasa2022a23Adapter(partidas);
                    binding.rvWolverhamptonCasa.setAdapter(wolverhamptonCasa2022a23Adapter);

                    binding.rvWolverhamptonCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvWolverhamptonCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
