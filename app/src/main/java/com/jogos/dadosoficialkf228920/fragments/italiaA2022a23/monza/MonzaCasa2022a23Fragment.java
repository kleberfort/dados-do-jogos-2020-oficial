package com.jogos.dadosoficialkf228920.fragments.italiaA2022a23.monza;
...
import com.jogos.dadosoficialkf228920.adapter.italiaA2022a23.monza.MonzaCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.italiaA2022a23.monza.MonzaCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentMonzaCasa2022a23Binding;
...
public class MonzaCasa2022a23Fragment extends Fragment {

    private FragmentMonzaCasa2022a23Binding binding;
    private MonzaCasaA2022a23PartidaApi monzaCasaA2022a23PartidaApi;
    private MonzaCasa2022a23Adapter monzaCasa2022a23Adapter;


    public MonzaCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentMonzaCasa2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        monzaCasaA2022a23PartidaApi = retrofit.create(MonzaCasaA2022a23PartidaApi.class);

    }

    private void setupDadosJogos() {
        binding.rvMonzaCasa.setHasFixedSize(true);
        binding.rvMonzaCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvMonzaCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        monzaCasaA2022a23PartidaApi.getMonzaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    monzaCasa2022a23Adapter = new MonzaCasa2022a23Adapter(partidas);
                    binding.rvMonzaCasa.setAdapter(monzaCasa2022a23Adapter);

                    binding.rvMonzaCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvMonzaCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
