package com.jogos.dadosoficialkf228920.fragments.americadosul.argentina.ligaprofissinal2024.independiente_rivadavia.estatistica.gols;
...
public class ForaGolsSofridoEstatisticaFragment extends Fragment implements JogosLigaProfissional_A_2024_Listener {
        ...
        switch (textViewId) {
            ...
            case 6:
                for (int i = 0; i < partidas.size(); i++) {
                    ...
                    if(partidas.get(i).getHomeEstatisticaJogo().getGolsPrimeiroTempo() < 3)
                        jogos.add(partidas.get(i));
                }
                if (!jogos.isEmpty()) {
                    showPartidasPrimeiroTempo(jogos);
            ...
            case 12:
                for (int i = 0; i < partidas.size(); i++) {
                    ...
                    if(partidas.get(i).getHomeEstatisticaJogo().getGolsSegundoTempo() < 3)
                        jogos.add(partidas.get(i));
                }
                if (!jogos.isEmpty()) {
                    showPartidasSegundoTempo(jogos);
            ...
            case 20:
                for (int i = 0; i < partidas.size(); i++) {
                    ...
                    if(partidas.get(i).getHomeTime().getPlacar() < 4)
                        jogos.add(partidas.get(i));
                }
                if (!jogos.isEmpty()) {
                    showPartidasDialog(jogos);
