...
import com.jogos.dadosoficialkf228920.adapter.francaA2022a23.lorient.LorientFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.francaA2022a23.lorient.LorientForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentLorientFora2022a23Binding;
      ...
      lorientForaA2022a23PartidaApi.getLorientFora().enqueue(new Callback<List<Partida>>() {
          ...
          public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
              if(response.isSuccessful()){
                  ...
                  binding.rvLorientFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvLorientFora, new RecyclerItemClickListener.OnItemClickListener() {
                      @Override
