package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.torino;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.torino.TorinoCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.torino.TorinoCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentTorinoCasa2023a24Binding;
...
public class TorinoCasaFragment extends Fragment {

    private FragmentTorinoCasa2023a24Binding binding;
    private TorinoCasaPartidaApi torinoCasaPartidaApi;
    private TorinoCasaAdapter torinoCasaAdapter;



    public TorinoCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentTorinoCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/italiano/torino/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        torinoCasaPartidaApi = retrofit.create(TorinoCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        torinoCasaPartidaApi.getTorinoCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    torinoCasaAdapter = new TorinoCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(torinoCasaAdapter);
