package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.manchesterunited;
...
import com.jogos.dadosoficialkf228920.databinding.FragmentManchesterUnitedCasa2023a24Binding;
...
public class ManchesterUnitedCasaFragment extends Fragment {

    private FragmentManchesterUnitedCasa2023a24Binding binding;
    private ManchesterUnitedCasaPartidaApi manchesterUnitedCasaPartidaApi;
    private ManchesterUnitedCasaAdapter manchesterUnitedCasaAdapter;



    public ManchesterUnitedCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentManchesterUnitedCasa2023a24Binding.inflate(inflater, container, false);
        ...
        manchesterUnitedCasaPartidaApi.getManchesterUnitedCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    manchesterUnitedCasaAdapter = new ManchesterUnitedCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(manchesterUnitedCasaAdapter);
