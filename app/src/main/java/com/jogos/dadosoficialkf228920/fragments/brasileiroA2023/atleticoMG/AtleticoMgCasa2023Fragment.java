...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.atleticoMG.AtleticoMgCasaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.atleticoMG.AtleticoMgCasaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAtleticoMgCasaA2023Binding;
...
public class AtleticoMgCasa2023Fragment extends Fragment {

    private FragmentAtleticoMgCasaA2023Binding binding;
    private AtleticoMgCasaA2023Adapter atleticoMgCasaA2023Adapter;
    private AtleticoMgCasaA2023PartidaApi atleticoMgCasaA2023PartidaApi;



    public AtleticoMgCasa2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAtleticoMgCasaA2023Binding.inflate(inflater, container, false);
        ...
        atleticoMgCasaA2023PartidaApi.getAtleticoMgCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    atleticoMgCasaA2023Adapter = new AtleticoMgCasaA2023Adapter(partidas);
                    binding.rvAtleticoMgCasa.setAdapter(atleticoMgCasaA2023Adapter);
