package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.everton;
...
import com.jogos.dadosoficialkf228920.databinding.FragmentEvertonCasa2023a24Binding;
...
public class EvertonCasaFragment extends Fragment {

    private FragmentEvertonCasa2023a24Binding binding;
    private EvertonCasaPartidaApi evertonCasaPartidaApi;
    private EvertonCasaAdapter evertonCasaAdapter;



    public EvertonCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentEvertonCasa2023a24Binding.inflate(inflater, container, false);
        ...
        evertonCasaPartidaApi.getEvertonCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    evertonCasaAdapter = new EvertonCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(evertonCasaAdapter);
