package com.jogos.dadosoficialkf228920.fragments.brasileiroB2023.tombense;
...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.tombense.TombenseCasaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.tombense.TombenseCasaB2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentTombenseCasaB2023Binding;
...
public class TombenseCasa2023Fragment extends Fragment {

    private FragmentTombenseCasaB2023Binding binding;
    private TombenseCasaB2023Adapter tombenseCasaB2023Adapter;
    private TombenseCasaB2023PartidaApi tombenseCasaB2023PartidaApi;





    public TombenseCasa2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentTombenseCasaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/brasileiro-b-2023/tombense/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        tombenseCasaB2023PartidaApi = retrofit.create(TombenseCasaB2023PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvTombenseCasa.setHasFixedSize(true);
        binding.rvTombenseCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvTombenseCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        tombenseCasaB2023PartidaApi.getTombenseCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    tombenseCasaB2023Adapter = new TombenseCasaB2023Adapter(partidas);
                    binding.rvTombenseCasa.setAdapter(tombenseCasaB2023Adapter);

                    binding.rvTombenseCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvTombenseCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
