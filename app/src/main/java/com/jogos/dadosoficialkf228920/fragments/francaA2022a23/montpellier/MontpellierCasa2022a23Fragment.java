package com.jogos.dadosoficialkf228920.fragments.francaA2022a23.montpellier;
...
import com.jogos.dadosoficialkf228920.adapter.francaA2022a23.montpellier.MontpellierCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.francaA2022a23.montpellier.MontpellierCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentMontpellierCasa2022a23Binding;
...
public class MontpellierCasa2022a23Fragment extends Fragment {
    ...
    private void setupHttpClient() {
        ...
        montpellierCasaA2022a23PartidaApi = retrofit.create(MontpellierCasaA2022a23PartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        montpellierCasaA2022a23PartidaApi.getMontpellierCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    montpellierCasa2022a23Adapter = new MontpellierCasa2022a23Adapter(partidas);
                    binding.rvMontepellierCasa.setAdapter(montpellierCasa2022a23Adapter);

                    binding.rvMontepellierCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvMontepellierCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
