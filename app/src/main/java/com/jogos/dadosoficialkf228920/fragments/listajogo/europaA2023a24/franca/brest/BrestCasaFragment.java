...
public class BrestCasaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBrestCasa2023a24Binding.inflate(inflater, container, false);
        ...
        brestApi.getBrestCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    brestCasaAdapter = new BrestCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(brestCasaAdapter);
