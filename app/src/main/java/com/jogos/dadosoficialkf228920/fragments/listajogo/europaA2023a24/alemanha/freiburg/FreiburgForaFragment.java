...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.freiburg.FreiburgForaAdapter;
...
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.freiburg.FreiburgForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAugsburgFora2023a24Binding;
import com.jogos.dadosoficialkf228920.databinding.FragmentFreiburgFora2023a24Binding;
...
public class FreiburgForaFragment extends Fragment {

    private FragmentFreiburgFora2023a24Binding binding;
    private FreiburgForaPartidaApi freiburgForaPartidaApi;
    private FreiburgForaAdapter freiburgForaAdapter;



    public FreiburgForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFreiburgFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        freiburgForaPartidaApi = retrofit.create(FreiburgForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        freiburgForaPartidaApi.getFreiburgFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    freiburgForaAdapter = new FreiburgForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(freiburgForaAdapter);
