package com.jogos.dadosoficialkf228920.fragments.espanhaA2022a23.elche;
...
import com.jogos.dadosoficialkf228920.adapter.espanhaA2022a23.elche.ElcheCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.espanhaA2022a23.elche.ElcheCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentElcheCasa2022a23Binding;
...
public class ElcheCasa2022a23Fragment extends Fragment {

    private FragmentElcheCasa2022a23Binding binding;
    private ElcheCasaA2022a23PartidaApi elcheCasaA2022a23PartidaApi;
    private ElcheCasa2022a23Adapter elcheCasa2022a23Adapter;

    public ElcheCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentElcheCasa2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        elcheCasaA2022a23PartidaApi = retrofit.create(ElcheCasaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvElcheCasa.setHasFixedSize(true);
        binding.rvElcheCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvElcheCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        elcheCasaA2022a23PartidaApi.getElcheCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvElcheCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvElcheCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
