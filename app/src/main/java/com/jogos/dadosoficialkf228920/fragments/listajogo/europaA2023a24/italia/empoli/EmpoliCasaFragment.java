...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.empoli.EmpoliCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.empoli.EmpoliCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentEmpoliCasa2023a24Binding;
...
public class EmpoliCasaFragment extends Fragment {

    private FragmentEmpoliCasa2023a24Binding binding;
    private EmpoliCasaPartidaApi empoliCasaPartidaApi;
    private EmpoliCasaAdapter empoliCasaAdapter;



    public EmpoliCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentEmpoliCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        empoliCasaPartidaApi = retrofit.create(EmpoliCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        empoliCasaPartidaApi.getEmpoliCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    empoliCasaAdapter = new EmpoliCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(empoliCasaAdapter);
