...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.coritiba.CoritibaCasaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.coritiba.CoritibaCasaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentCoritibaCasaA2023Binding;
...
public class CoritibaCasa2023Fragment extends Fragment {

    private FragmentCoritibaCasaA2023Binding binding;
    private CoritibaCasaA2023Adapter coritibaCasaA2023Adapter;
    private CoritibaCasaA2023PartidaApi coritibaCasaA2023PartidaApi;



    public CoritibaCasa2023Fragment() {
    ...
    private void setupHttpClient() {
        ...
        coritibaCasaA2023PartidaApi = retrofit.create(CoritibaCasaA2023PartidaApi.class);
    }
    ...
    private void setupDadosJogos() {
        ...
        coritibaCasaA2023PartidaApi.getCoritibaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    coritibaCasaA2023Adapter = new CoritibaCasaA2023Adapter(partidas);
                    binding.rvCoritibaCasa.setAdapter(coritibaCasaA2023Adapter);

                    binding.rvCoritibaCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvCoritibaCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
