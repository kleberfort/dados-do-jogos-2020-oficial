...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.vilanova.VilaNovaForaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.vilanova.VilaNovaForaB2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentVilanovaForaB2023Binding;
...
public class VilaNovaFora2023Fragment extends Fragment {

    private FragmentVilanovaForaB2023Binding binding;
    private VilaNovaForaB2023Adapter vilaNovaForaB2023Adapter;
    private VilaNovaForaB2023PartidaApi vilaNovaForaB2023PartidaApi;
    ...
    public VilaNovaFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentVilanovaForaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        vilaNovaForaB2023PartidaApi = retrofit.create(VilaNovaForaB2023PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvVilaNovaFora.setHasFixedSize(true);
        binding.rvVilaNovaFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvVilaNovaFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        vilaNovaForaB2023PartidaApi.getVilaNovaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    vilaNovaForaB2023Adapter = new VilaNovaForaB2023Adapter(partidas);
                    binding.rvVilaNovaFora.setAdapter(vilaNovaForaB2023Adapter);

                    binding.rvVilaNovaFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvVilaNovaFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
