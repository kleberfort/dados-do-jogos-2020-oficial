...
import com.jogos.dadosoficialkf228920.databinding.FragmentPsgCsResultadoBinding;
 ...
 * Use the {@link PsgCsResultadoFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PsgCsResultadoFragment extends Fragment {

    private FragmentPsgCsResultadoBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentPsgCsResultadoBinding.inflate(inflater, container, false);
    ...
    private void setupDadosJogos() {
        ...
        jogosFrancesCasaFora2023_24Api.getPsgCasa().enqueue(new Callback<List<Partida>>() {
            @Override
