package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.marseille;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.marseille.MarseilleForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.marseille.MarseilleForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentMarseilleFora2023a24Binding;
...
public class MarseilleForaFragment extends Fragment {

    private FragmentMarseilleFora2023a24Binding binding;
    private MarseilleForaPartidaApi marseilleForaPartidaApi;
    private MarseilleForaAdapter marseilleForaAdapter;



    public MarseilleForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentMarseilleFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/franca/marseille/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        marseilleForaPartidaApi = retrofit.create(MarseilleForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        marseilleForaPartidaApi.getMarseilleFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    marseilleForaAdapter = new MarseilleForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(marseilleForaAdapter);
