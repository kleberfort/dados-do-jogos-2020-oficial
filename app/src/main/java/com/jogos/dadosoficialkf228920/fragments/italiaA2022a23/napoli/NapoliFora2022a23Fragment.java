package com.jogos.dadosoficialkf228920.fragments.italiaA2022a23.napoli;
...
import com.jogos.dadosoficialkf228920.adapter.italiaA2022a23.napoli.NapoliFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.italiaA2022a23.napoli.NapoliForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentNapoliFora2022a23Binding;
        ...
        napoliForaA2022a23PartidaApi.getNapoliFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    napoliFora2022a23Adapter = new NapoliFora2022a23Adapter(partidas);
                    binding.rvNapoliFora.setAdapter(napoliFora2022a23Adapter);

                    binding.rvNapoliFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvNapoliFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
