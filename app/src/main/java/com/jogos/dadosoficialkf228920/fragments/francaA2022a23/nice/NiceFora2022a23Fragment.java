package com.jogos.dadosoficialkf228920.fragments.francaA2022a23.nice;
...
import com.jogos.dadosoficialkf228920.adapter.francaA2022a23.nice.NiceFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.francaA2022a23.nice.NiceForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentNiceFora2022a23Binding;
...
public class NiceFora2022a23Fragment extends Fragment {
    ...
    private void setupHttpClient() {
        ...
        niceForaA2022a23PartidaApi = retrofit.create(NiceForaA2022a23PartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        niceForaA2022a23PartidaApi.getNiceFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    niceFora2022a23Adapter = new NiceFora2022a23Adapter(partidas);
                    binding.rvNiceFora.setAdapter(niceFora2022a23Adapter);

                    binding.rvNiceFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvNiceFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
