...
import com.jogos.dadosoficialkf228920.databinding.FragmentNottinghamFora2023a24Binding;
...
public class NottinghamForaFragment extends Fragment {

    private FragmentNottinghamFora2023a24Binding binding;
    private NottinghamForestForaPartidaApi nottinghamForestForaPartidaApi;
    private NottinhamForaAdapter nottinhamForaAdapter;



    public NottinghamForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentNottinghamFora2023a24Binding.inflate(inflater, container, false);
        ...
        nottinghamForestForaPartidaApi.getNottinghamForestFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    nottinhamForaAdapter = new NottinhamForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(nottinhamForaAdapter);
