package com.jogos.dadosoficialkf228920.fragments.espanhaA2022a23.realsociedad;
...
import com.jogos.dadosoficialkf228920.adapter.espanhaA2022a23.realsociedad.RealSociedadCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.espanhaA2022a23.realsociedad.RealSociedadCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentRealSociedadCasa2022a23Binding;
        ...
        realSociedadCasaA2022a23PartidaApi.getRealSociedadCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvRealSociedadCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvRealSociedadCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
