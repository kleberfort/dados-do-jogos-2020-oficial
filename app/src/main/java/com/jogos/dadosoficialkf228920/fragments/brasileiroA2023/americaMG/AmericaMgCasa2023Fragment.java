...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.americaMG.AmericaMgCasaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.americaMG.AmericaMgCasaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAmericaMgCasaA2023Binding;
...
public class AmericaMgCasa2023Fragment extends Fragment {



    private FragmentAmericaMgCasaA2023Binding binding;
    private AmericaMgCasaA2023Adapter americaMgCasaA2023Adapter;
    ...
    private void setupHttpClient() {
        ...
        americaMGCasaA2023PartidaApi = retrofit.create(AmericaMgCasaA2023PartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        americaMGCasaA2023PartidaApi.getAmericaMgCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    americaMgCasaA2023Adapter = new AmericaMgCasaA2023Adapter(partidas);
                    binding.rvAmericaMgCasa.setAdapter(americaMgCasaA2023Adapter);
