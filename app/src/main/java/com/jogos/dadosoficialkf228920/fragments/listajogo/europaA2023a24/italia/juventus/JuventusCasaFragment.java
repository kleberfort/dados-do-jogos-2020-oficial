...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.juventus.JuventusCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.juventus.JuventusCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentJuventusCasa2023a24Binding;
...
public class JuventusCasaFragment extends Fragment {

    private FragmentJuventusCasa2023a24Binding binding;
    private JuventusCasaPartidaApi juventusCasaPartidaApi;
    private JuventusCasaAdapter juventusCasaAdapter;



    public JuventusCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentJuventusCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        juventusCasaPartidaApi = retrofit.create(JuventusCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        juventusCasaPartidaApi.getJuventusCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    juventusCasaAdapter = new JuventusCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(juventusCasaAdapter);
