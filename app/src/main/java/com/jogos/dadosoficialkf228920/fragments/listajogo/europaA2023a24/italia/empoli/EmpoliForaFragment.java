package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.empoli;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.empoli.EmpoliForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.empoli.EmpoliForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentEmpoliFora2023a24Binding;
...
public class EmpoliForaFragment extends Fragment {

    private FragmentEmpoliFora2023a24Binding binding;
    private EmpoliForaPartidaApi empoliForaPartidaApi;
    private EmpoliForaAdapter empoliForaAdapter;



    public EmpoliForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentEmpoliFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/italiano/empoli/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        empoliForaPartidaApi = retrofit.create(EmpoliForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        empoliForaPartidaApi.getEmpoliFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    empoliForaAdapter = new EmpoliForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(empoliForaAdapter);
