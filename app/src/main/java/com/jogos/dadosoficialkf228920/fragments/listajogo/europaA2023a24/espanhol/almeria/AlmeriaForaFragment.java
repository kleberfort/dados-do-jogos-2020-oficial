...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.almeria.AlmeriaForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.almeria.AlmeriaForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAlmeriaFora2023a24Binding;
...
public class AlmeriaForaFragment extends Fragment {

    private FragmentAlmeriaFora2023a24Binding binding;
    private AlmeriaForaPartidaApi almeriaForaPartidaApi;
    private AlmeriaForaAdapter almeriaForaAdapter;



    public AlmeriaForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAlmeriaFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        almeriaForaPartidaApi = retrofit.create(AlmeriaForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        almeriaForaPartidaApi.getAlmeriaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    almeriaForaAdapter = new AlmeriaForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(almeriaForaAdapter);
