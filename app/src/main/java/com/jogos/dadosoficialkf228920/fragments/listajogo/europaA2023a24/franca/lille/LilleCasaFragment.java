package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.lille;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.lille.LilleCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.lille.LilleCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentLilleCasa2023a24Binding;
...
public class LilleCasaFragment extends Fragment {

    private FragmentLilleCasa2023a24Binding binding;
    private LilleCasaPartidaApi lilleCasaPartidaApi;
    private LilleCasaAdapter lilleCasaAdapter;



    public LilleCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLilleCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/franca/lille/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        lilleCasaPartidaApi = retrofit.create(LilleCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        lilleCasaPartidaApi.getLilleCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    lilleCasaAdapter = new LilleCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(lilleCasaAdapter);
