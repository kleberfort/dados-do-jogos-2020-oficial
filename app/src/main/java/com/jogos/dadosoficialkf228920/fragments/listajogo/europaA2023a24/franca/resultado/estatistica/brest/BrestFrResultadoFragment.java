...
public class BrestFrResultadoFragment extends Fragment {

    private FragmentBrestFrResultadoBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBrestFrResultadoBinding.inflate(inflater, container, false);
    ...
    private void setupDadosJogos() {
        ...
        jogosFrancesCasaFora2023_24Api.getBrestFora().enqueue(new Callback<List<Partida>>() {
            @Override
