...
import com.jogos.dadosoficialkf228920.adapter.espanhaA2022a23.realbetis.RealBetisCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.espanhaA2022a23.realbetis.RealBetisCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentRealBetisCasa2022a23Binding;
        ...
        realBetisCasaA2022a23PartidaApi.getRealBetisCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvRealBetisCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvRealBetisCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
