package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.brentford;
...
import com.jogos.dadosoficialkf228920.databinding.FragmentBrentfordFora2023a24Binding;
...
public class BrentfordForaFragment extends Fragment {

    private FragmentBrentfordFora2023a24Binding binding;
    private BrentfordForaPartidaApi brentfordForaPartidaApi;
    private BrentfordForaAdapter brentfordForaAdapter;



    public BrentfordForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBrentfordFora2023a24Binding.inflate(inflater, container, false);
        ...
        brentfordForaPartidaApi.getBrentfordFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    brentfordForaAdapter = new BrentfordForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(brentfordForaAdapter);
