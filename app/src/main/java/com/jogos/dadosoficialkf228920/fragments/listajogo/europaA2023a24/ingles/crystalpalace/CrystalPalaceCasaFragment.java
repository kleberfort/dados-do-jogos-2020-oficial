...
import com.jogos.dadosoficialkf228920.databinding.FragmentCrystalPalaceCasa2023a24Binding;
...
public class CrystalPalaceCasaFragment extends Fragment {

    private FragmentCrystalPalaceCasa2023a24Binding binding;
    private CrystalPalaceCasaPartidaApi crystalPalaceCasaPartidaApi;
    private CrystalPalaceCasaAdapter crystalPalaceCasaAdapter;



    public CrystalPalaceCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCrystalPalaceCasa2023a24Binding.inflate(inflater, container, false);
        ...
        crystalPalaceCasaPartidaApi.getCrystalPalaceCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    crystalPalaceCasaAdapter = new CrystalPalaceCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(crystalPalaceCasaAdapter);
