...
import com.jogos.dadosoficialkf228920.databinding.FragmentSheffieldResultadoEstatisticaBinding;
...
public class SheffieldResultadoEstatisticaFragment extends Fragment {

    private FragmentSheffieldResultadoEstatisticaBinding binding;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        binding = FragmentSheffieldResultadoEstatisticaBinding.inflate(inflater, container, false);
        ...
        FragmentPagerItemAdapter adapter = new FragmentPagerItemAdapter(
                ...
                FragmentPagerItems.with(getApplicationContext())
                        .add("Casa 2023-24", SheffieldCsResultadoFragment.class)
                        .add("Fora 2023-24", SheffieldFrResultadoFragment.class)
