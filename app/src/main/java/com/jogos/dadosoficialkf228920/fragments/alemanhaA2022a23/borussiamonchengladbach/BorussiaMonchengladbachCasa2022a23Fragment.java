package com.jogos.dadosoficialkf228920.fragments.alemanhaA2022a23.borussiamonchengladbach;
...
import com.jogos.dadosoficialkf228920.data.alemanhaA2022a23.borussiamonchengladbach.BorussiaMonchengladbachCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentBorussiaMonchengladbachCasa2022a23Binding;
...
public class BorussiaMonchengladbachCasa2022a23Fragment extends Fragment {
    ...
    private void setupHttpClient() {
        ...
        borussiaMonchengladbachCasaA2022a23PartidaApi = retrofit.create(BorussiaMonchengladbachCasaA2022a23PartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        borussiaMonchengladbachCasaA2022a23PartidaApi.getBorussiaMonchengladbachCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    borussiaMonchengladbachCasa2022a23Adapter = new BorussiaMonchengladbachCasa2022a23Adapter(partidas);
                    binding.rvBorussiaMonchengladbachCasa.setAdapter(borussiaMonchengladbachCasa2022a23Adapter);

                    binding.rvBorussiaMonchengladbachCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvBorussiaMonchengladbachCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
