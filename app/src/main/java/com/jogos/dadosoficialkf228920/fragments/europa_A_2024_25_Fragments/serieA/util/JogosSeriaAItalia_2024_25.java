...
public class JogosSeriaAItalia_2024_25 {
    ...
    private final OkHttpClient dadosEventos = new OkHttpClient();
    ...
    public void setupDadosJogos() {
        ...
        executor.execute(() -> { // Executa a tarefa em uma thread separada
            String roundMain = "2";
            String urlSerieAItalia2024_25 = String.format("https://sportapi7.p.rapidapi.com/api/v1/unique-tournament/23/season/63515/events/round/%s/last/0", roundMain);
    ...
    private static String obterImageData(String time) {
        ...
        switch (time) {
            ...
            case "Verona":
                ...
                break;
            default:
                return imagem = null; // Retorna null para nome e imagem
        }
