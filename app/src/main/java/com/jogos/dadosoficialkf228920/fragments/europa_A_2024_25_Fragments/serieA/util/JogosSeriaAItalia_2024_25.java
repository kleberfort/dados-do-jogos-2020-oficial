...
public class JogosSeriaAItalia_2024_25 {
    ...
    public void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/refs/heads/master/europa-a-2024-2025/serie-a-Italia/")
    ...
    public void setupDadosJogos() {
        jogos_campeonatos_chamada_api.getSerieAItalia2024_25().enqueue(new Callback<List<MatchNewModelDate>>() {
            @Override
            public void onResponse(Call<List<MatchNewModelDate>> call, Response<List<MatchNewModelDate>> response) {
                ...
                if(listener != null){
                    listener.onJogosSerieAItalia_2024_25(partidasPorTime);
                }
