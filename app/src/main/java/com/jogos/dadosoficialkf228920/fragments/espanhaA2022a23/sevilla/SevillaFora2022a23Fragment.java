...
import com.jogos.dadosoficialkf228920.adapter.espanhaA2022a23.sevilla.SevillaFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.espanhaA2022a23.sevilla.SevillaForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentSevillaFora2022a23Binding;
...
public class SevillaFora2022a23Fragment extends Fragment {
    ...
    private void setupHttpClient() {
        ...
        sevillaForaA2022a23PartidaApi = retrofit.create(SevillaForaA2022a23PartidaApi.class);
    }
    ...
    private void setupDadosJogos() {
        ...
        sevillaForaA2022a23PartidaApi.getSevillaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    sevillaFora2022a23Adapter = new SevillaFora2022a23Adapter(partidas);
                    binding.rvSevillaFora.setAdapter(sevillaFora2022a23Adapter);

                    binding.rvSevillaFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvSevillaFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
