package com.jogos.dadosoficialkf228920.fragments.alemanhaA2022a23.hoffenheim;
...
import com.jogos.dadosoficialkf228920.adapter.alemanhaA2022a23.hoffenheim.HoffenheimFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.alemanhaA2022a23.hoffenheim.HoffenheimForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentHoffenheimFora2022a23Binding;
        ...
        hoffenheimForaA2022a23PartidaApi.getHoffenheimFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvHoffenheimFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvHoffenheimFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
