...
import com.jogos.dadosoficialkf228920.adapter.espanhaA2022a23.valencia.ValenciaFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.espanhaA2022a23.valencia.ValenciaForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentValenciaFora2022a23Binding;
...
public class ValenciaFora2022a23Fragment extends Fragment {
    ...
    private void setupHttpClient() {
        ...
        valenciaForaA2022a23PartidaApi = retrofit.create(ValenciaForaA2022a23PartidaApi.class);
    }
    ...
    private void setupDadosJogos() {
        ...
        valenciaForaA2022a23PartidaApi.getValenciaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    valenciaFora2022a23Adapter = new ValenciaFora2022a23Adapter(partidas);
                    binding.rvValenciaFora.setAdapter(valenciaFora2022a23Adapter);

                    binding.rvValenciaFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvValenciaFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
