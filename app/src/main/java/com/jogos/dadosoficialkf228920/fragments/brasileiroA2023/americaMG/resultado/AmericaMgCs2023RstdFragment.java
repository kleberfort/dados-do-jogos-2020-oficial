...
public class AmericaMgCs2023RstdFragment extends Fragment {

    private FragmentAmericaMgCs2023RstdBinding binding;
    private AmericaMgCasaA2023PartidaApi americaMgCasaA2023PartidaApi;
    private AmericaMgCsA2023RstdAdt americaMgCsA2023RstdAdt;



    public AmericaMgCs2023RstdFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
          ...
          binding = FragmentAmericaMgCs2023RstdBinding.inflate(inflater, container, false);
        ...
        americaMgCasaA2023PartidaApi.getAmericaMgCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    americaMgCsA2023RstdAdt = new AmericaMgCsA2023RstdAdt(partidas);
                    binding.rvListaResultado.setAdapter(americaMgCsA2023RstdAdt);
