...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.koln.KolnForaAdapter;
...
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.koln.KolnForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAugsburgFora2023a24Binding;
import com.jogos.dadosoficialkf228920.databinding.FragmentKolnFora2023a24Binding;
...
public class KolnForaFragment extends Fragment {

    private FragmentKolnFora2023a24Binding binding;
    private KolnForaPartidaApi kolnForaPartidaApi;
    private KolnForaAdapter kolnForaAdapter;



    public KolnForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentKolnFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        kolnForaPartidaApi = retrofit.create(KolnForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        kolnForaPartidaApi.getKolnFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    kolnForaAdapter = new KolnForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(kolnForaAdapter);
