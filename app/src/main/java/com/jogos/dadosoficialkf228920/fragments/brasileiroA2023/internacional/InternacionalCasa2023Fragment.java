package com.jogos.dadosoficialkf228920.fragments.brasileiroA2023.internacional;
...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.internacional.InternacionalCasaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.internacional.InternacionalCasaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentInternacionalCasaA2023Binding;
...
public class InternacionalCasa2023Fragment extends Fragment {

    private FragmentInternacionalCasaA2023Binding binding;
    private InternacionalCasaA2023Adapter internacionalCasaA2023Adapter;
    private InternacionalCasaA2023PartidaApi internacionalCasaA2023PartidaApi;





    public InternacionalCasa2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentInternacionalCasaA2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/brasileiro-a-2023/internacional/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        internacionalCasaA2023PartidaApi = retrofit.create(InternacionalCasaA2023PartidaApi.class);
    }
    ...
    private void setupDadosJogos() {
        ...
        internacionalCasaA2023PartidaApi.getInternacionalCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    internacionalCasaA2023Adapter = new InternacionalCasaA2023Adapter(partidas);
                    binding.rvInternacionalCasa.setAdapter(internacionalCasaA2023Adapter);

                    binding.rvInternacionalCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvInternacionalCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
