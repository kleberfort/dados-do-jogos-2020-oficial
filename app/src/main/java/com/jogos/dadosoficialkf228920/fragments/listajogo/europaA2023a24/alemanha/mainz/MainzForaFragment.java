...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.mainz05.Mainz05ForaAdapter;
...
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.mainz05.Mainz05ForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAugsburgFora2023a24Binding;
import com.jogos.dadosoficialkf228920.databinding.FragmentMainz05Fora2023a24Binding;
...
public class MainzForaFragment extends Fragment {

    private FragmentMainz05Fora2023a24Binding binding;
    private Mainz05ForaPartidaApi mainz05ForaPartidaApi;
    private Mainz05ForaAdapter mainz05ForaAdapter;



    public MainzForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentMainz05Fora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        mainz05ForaPartidaApi = retrofit.create(Mainz05ForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        mainz05ForaPartidaApi.getMainz05Fora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    mainz05ForaAdapter = new Mainz05ForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(mainz05ForaAdapter);
