package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.westham;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.westham.WestHamForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.ingles.westham.WestHamForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentWestHamFora2023a24Binding;
...
public class WestHamForaFragment extends Fragment {

    private FragmentWestHamFora2023a24Binding binding;
    private WestHamForaPartidaApi westHamForaPartidaApi;
    private WestHamForaAdapter westHamForaAdapter;



    public WestHamForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentWestHamFora2023a24Binding.inflate(inflater, container, false);
        ...
        westHamForaPartidaApi.getWestHamFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    westHamForaAdapter = new WestHamForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(westHamForaAdapter);
