package com.jogos.dadosoficialkf228920.fragments.alemanhaA2022a23.borussiadortmund;
...
import com.jogos.dadosoficialkf228920.adapter.alemanhaA2022a23.borussiadortmund.BorussiaDortmundFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.alemanhaA2022a23.borussiadortmund.BorussiaDortmundForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentBorussiaDortmundFora2022a23Binding;
...
public class BorussiaDortmundFora2022a23Fragment extends Fragment {
    ...
    private void setupHttpClient() {
        ...
        borussiaDortmundForaA2022a23PartidaApi = retrofit.create(BorussiaDortmundForaA2022a23PartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        borussiaDortmundForaA2022a23PartidaApi.getBorussiaDortmundFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    borussiaDortmundFora2022a23Adapter = new BorussiaDortmundFora2022a23Adapter(partidas);
                    binding.rvBorussiaDortmundFora.setAdapter(borussiaDortmundFora2022a23Adapter);

                    binding.rvBorussiaDortmundFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvBorussiaDortmundFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
