package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.sheffield;
...
import com.jogos.dadosoficialkf228920.databinding.FragmentSheffieldFora2023a24Binding;
...
public class SheffieldForaFragment extends Fragment {

    private FragmentSheffieldFora2023a24Binding binding;
    private SheffieldForaPartidaApi sheffieldForaPartidaApi;
    private SheffieldForaAdapter sheffieldForaAdapter;



    public SheffieldForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSheffieldFora2023a24Binding.inflate(inflater, container, false);
        ...
        sheffieldForaPartidaApi.getSheffieldFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    sheffieldForaAdapter = new SheffieldForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(sheffieldForaAdapter);
