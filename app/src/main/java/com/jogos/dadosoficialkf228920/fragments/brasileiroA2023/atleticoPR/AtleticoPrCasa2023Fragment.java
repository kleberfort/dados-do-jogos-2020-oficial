package com.jogos.dadosoficialkf228920.fragments.brasileiroA2023.atleticoPR;
...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.atheticoPR.AtheticoPrCasaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.atleticoPR.AtleticoPrCasaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAtheticoPrCasaA2023Binding;
...
public class AtleticoPrCasa2023Fragment extends Fragment {

    private FragmentAtheticoPrCasaA2023Binding binding;
    private AtheticoPrCasaA2023Adapter atheticoPrCasaA2023Adapter;
    ...
    public AtleticoPrCasa2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAtheticoPrCasaA2023Binding.inflate(inflater, container, false);
    ...
    private void setupDadosJogos() {
        binding.rvAtheticoPrCasa.setHasFixedSize(true);
        binding.rvAtheticoPrCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvAtheticoPrCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));
        ...
        atheticoPrCasaA2023PartidaApi.getAtleticoPrCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    atheticoPrCasaA2023Adapter = new AtheticoPrCasaA2023Adapter(partidas);
                    binding.rvAtheticoPrCasa.setAdapter(atheticoPrCasaA2023Adapter);

                    binding.rvAtheticoPrCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvAtheticoPrCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
