...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.arsenal.resultado.ArsenalForaResultadoAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.ingles.arsenal.ArsenalForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentArsenalFrResultadoBinding;
...
public class ArsenalFrResultadoFragment extends Fragment {

    private FragmentArsenalFrResultadoBinding binding;

    private ArsenalForaPartidaApi arsenalForaPartidaApi;

    private ArsenalForaResultadoAdapter arsenalForaResultadoAdapter;


    public ArsenalFrResultadoFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentArsenalFrResultadoBinding.inflate(inflater, container, false);
        ...
        arsenalForaPartidaApi.getArsenalFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    arsenalForaResultadoAdapter = new ArsenalForaResultadoAdapter(partidas);
                    binding.rvListaJogos.setAdapter(arsenalForaResultadoAdapter);
