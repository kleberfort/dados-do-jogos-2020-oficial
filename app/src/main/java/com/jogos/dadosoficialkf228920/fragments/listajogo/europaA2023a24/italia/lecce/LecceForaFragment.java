package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.lecce;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.lecce.LecceForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.lecce.LecceForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentLecceFora2023a24Binding;
...
public class LecceForaFragment extends Fragment {

    private FragmentLecceFora2023a24Binding binding;
    private LecceForaPartidaApi lecceForaPartidaApi;
    private LecceForaAdapter lecceForaAdapter;



    public LecceForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLecceFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/italiano/lecce/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        lecceForaPartidaApi = retrofit.create(LecceForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        lecceForaPartidaApi.getLecceFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    lecceForaAdapter = new LecceForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(lecceForaAdapter);
