package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.salernitana;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.salernitana.SalernitanaCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.salernitana.SalernitanaCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentSalernitanaCasa2023a24Binding;
...
public class SalernitanaCasaFragment extends Fragment {

    private FragmentSalernitanaCasa2023a24Binding binding;
    private SalernitanaCasaPartidaApi salernitanaCasaPartidaApi;
    private SalernitanaCasaAdapter salernitanaCasaAdapter;



    public SalernitanaCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSalernitanaCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/italiano/salernitana/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        salernitanaCasaPartidaApi = retrofit.create(SalernitanaCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        salernitanaCasaPartidaApi.getSalernitanaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    salernitanaCasaAdapter = new SalernitanaCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(salernitanaCasaAdapter);
