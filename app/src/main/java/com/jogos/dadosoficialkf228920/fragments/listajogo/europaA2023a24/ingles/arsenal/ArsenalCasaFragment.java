...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.arsenal.ArsenalCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.ingles.arsenal.ArsenalCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentArsenalCasa2023a24Binding;
...
public class ArsenalCasaFragment extends Fragment {

    private FragmentArsenalCasa2023a24Binding binding;
        ...
        arsenalCasaPartidaApi.getArsenalCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    arsenalCasaAdapter = new ArsenalCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(arsenalCasaAdapter);
