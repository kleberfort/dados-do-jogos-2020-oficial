...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.napoli.NapoliForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.napoli.NapoliForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentNapoliFora2023a24Binding;
...
public class NapoliForaFragment extends Fragment {

    private FragmentNapoliFora2023a24Binding binding;
    private NapoliForaPartidaApi napoliForaPartidaApi;
    private NapoliForaAdapter napoliForaAdapter;



    public NapoliForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentNapoliFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        napoliForaPartidaApi = retrofit.create(NapoliForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        napoliForaPartidaApi.getNapoliFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    napoliForaAdapter = new NapoliForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(napoliForaAdapter);
