package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.lehavre;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.lehavre.LeHavreForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.lehavre.LeHavreForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentLeHavreFora2023a24Binding;
...
public class LeHavreForaFragment extends Fragment {

    private FragmentLeHavreFora2023a24Binding binding;
    private LeHavreForaPartidaApi leHavreForaPartidaApi;
    private LeHavreForaAdapter leHavreForaAdapter;



    public LeHavreForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLeHavreFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/franca/le-havre/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        leHavreForaPartidaApi = retrofit.create(LeHavreForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        leHavreForaPartidaApi.getHavreFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    leHavreForaAdapter = new LeHavreForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(leHavreForaAdapter);
