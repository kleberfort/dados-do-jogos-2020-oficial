package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.brighton;
...
import com.jogos.dadosoficialkf228920.databinding.FragmentBrightonCasa2023a24Binding;
...
public class BrightonCasaFragment extends Fragment {

    private FragmentBrightonCasa2023a24Binding binding;
    private BrightonCasaPartidaApi brightonCasaPartidaApi;
    private BrightonCasaAdapter brightonCasaAdapter;



    public BrightonCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBrightonCasa2023a24Binding.inflate(inflater, container, false);
        ...
        brightonCasaPartidaApi.getBrightonCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    brightonCasaAdapter = new BrightonCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(brightonCasaAdapter);
