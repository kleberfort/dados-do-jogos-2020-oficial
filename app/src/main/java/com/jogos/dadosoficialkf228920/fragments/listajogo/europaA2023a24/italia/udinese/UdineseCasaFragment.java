package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.udinese;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.udinese.UdineseCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.udinese.UdineseCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentUdineseCasa2023a24Binding;
...
public class UdineseCasaFragment extends Fragment {

    private FragmentUdineseCasa2023a24Binding binding;
    private UdineseCasaPartidaApi udineseCasaPartidaApi;
    private UdineseCasaAdapter udineseCasaAdapter;



    public UdineseCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentUdineseCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/italiano/udinese/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        udineseCasaPartidaApi = retrofit.create(UdineseCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        udineseCasaPartidaApi.getUdineseCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    udineseCasaAdapter = new UdineseCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(udineseCasaAdapter);
