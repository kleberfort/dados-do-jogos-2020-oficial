package com.jogos.dadosoficialkf228920.fragments.espanhaA2022a23.espanyol;
...
import com.jogos.dadosoficialkf228920.adapter.espanhaA2022a23.espanyol.EspanyolFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.espanhaA2022a23.espanyol.EspanyolForaA2022aa23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentEspanyolFora2022a23Binding;
...
public class EspanyolFora2022a23Fragment extends Fragment {
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/espanhol-a-2022-23/espanyol/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        espanyolForaA2022aa23PartidaApi = retrofit.create(EspanyolForaA2022aa23PartidaApi.class);
    }
    ...
    private void setupDadosJogos() {
        ...
        espanyolForaA2022aa23PartidaApi.getEspanyolFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    espanyolFora2022a23Adapter = new EspanyolFora2022a23Adapter(partidas);
                    binding.rvEspanyolFora.setAdapter(espanyolFora2022a23Adapter);

                    binding.rvEspanyolFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvEspanyolFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
