...
import com.jogos.dadosoficialkf228920.adapter.alemanhaA2022a23.freiburg.FreiburgFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.alemanhaA2022a23.freiburg.FreiburgForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentFreiburgFora2022a23Binding;
        ...
        freiburgForaA2022a23PartidaApi.getFreiburgFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvFreiburgFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvFreiburgFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
