package com.jogos.dadosoficialkf228920.fragments.brasileiroA2023.vasco;
...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.vasco.VascoForaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.vasco.VascoForaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentVascoForaA2023Binding;
...
public class VascoFora2023Fragment extends Fragment {

    private FragmentVascoForaA2023Binding binding;
    private VascoForaA2023Adapter vascoForaA2023Adapter;
    private VascoForaA2023PartidaApi vascoForaA2023PartidaApi;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentVascoForaA2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        vascoForaA2023PartidaApi = retrofit.create(VascoForaA2023PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvVascoFora.setHasFixedSize(true);
        binding.rvVascoFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvVascoFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        vascoForaA2023PartidaApi.getVascoFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    vascoForaA2023Adapter = new VascoForaA2023Adapter(partidas);
                    binding.rvVascoFora.setAdapter(vascoForaA2023Adapter);

                    binding.rvVascoFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvVascoFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
