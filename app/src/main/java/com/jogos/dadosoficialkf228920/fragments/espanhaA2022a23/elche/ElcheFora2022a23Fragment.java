...
import com.jogos.dadosoficialkf228920.adapter.espanhaA2022a23.elche.ElcheFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.espanhaA2022a23.elche.ElcheForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentElcheFora2022a23Binding;
        ...
        elcheForaA2022a23PartidaApi.getElcheFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvElcheFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvElcheFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
