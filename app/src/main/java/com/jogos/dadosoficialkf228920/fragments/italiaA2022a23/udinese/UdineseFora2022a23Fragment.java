package com.jogos.dadosoficialkf228920.fragments.italiaA2022a23.udinese;
...
import com.jogos.dadosoficialkf228920.adapter.italiaA2022a23.udinese.UdineseFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.italiaA2022a23.udinese.UdineseForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentUdineseFora2022a23Binding;
...
public class UdineseFora2022a23Fragment extends Fragment {

    private FragmentUdineseFora2022a23Binding binding;
    private UdineseForaA2022a23PartidaApi udineseForaA2022a23PartidaApi;
    private UdineseFora2022a23Adapter udineseFora2022a23Adapter;



    public UdineseFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentUdineseFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        udineseForaA2022a23PartidaApi = retrofit.create(UdineseForaA2022a23PartidaApi.class);


    }

    private void setupDadosJogos() {
        binding.rvUdineseFora.setHasFixedSize(true);
        binding.rvUdineseFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvUdineseFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        udineseForaA2022a23PartidaApi.getUdineseFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvUdineseFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvUdineseFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
