...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.bayernmunique.BayernMuniqueForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.bayernmunique.BayernMuniqueForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentBayernMuniqueFora2023a24Binding;
...
public class BayernMuniqueForaFragment extends Fragment {

    private FragmentBayernMuniqueFora2023a24Binding binding;
    private BayernMuniqueForaPartidaApi bayernMuniqueForaPartidaApi;
    private BayernMuniqueForaAdapter bayernMuniqueForaAdapter;



    public BayernMuniqueForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBayernMuniqueFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        bayernMuniqueForaPartidaApi = retrofit.create(BayernMuniqueForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        bayernMuniqueForaPartidaApi.getBayernMuniqueFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    bayernMuniqueForaAdapter = new BayernMuniqueForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(bayernMuniqueForaAdapter);
