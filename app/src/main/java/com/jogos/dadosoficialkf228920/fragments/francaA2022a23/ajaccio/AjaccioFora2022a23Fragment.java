package com.jogos.dadosoficialkf228920.fragments.francaA2022a23.ajaccio;
...
import com.jogos.dadosoficialkf228920.adapter.francaA2022a23.ajaccio.AjaccioFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.francaA2022a23.ajaccio.AjaccioForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAjaccioFora2022a23Binding;
...
public class AjaccioFora2022a23Fragment extends Fragment {

    private FragmentAjaccioFora2022a23Binding binding;
    private AjaccioForaA2022a23PartidaApi ajaccioForaA2022a23PartidaApi;
    private AjaccioFora2022a23Adapter ajaccioFora2022a23Adapter;


    public AjaccioFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAjaccioFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupDadosJogos() {
        binding.rvAjaccioFora.setHasFixedSize(true);
        binding.rvAjaccioFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvAjaccioFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));
        ...
        ajaccioForaA2022a23PartidaApi.getAjaccioFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    ajaccioFora2022a23Adapter = new AjaccioFora2022a23Adapter(partidas);
                    binding.rvAjaccioFora.setAdapter(ajaccioFora2022a23Adapter);

                    binding.rvAjaccioFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvAjaccioFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
