package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.frosinone;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.frosinone.FrosinoneForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.frosinone.FrosinoneForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentFrosinoneFora2023a24Binding;
...
public class FrosinoneForaFragment extends Fragment {

    private FragmentFrosinoneFora2023a24Binding binding;
    private FrosinoneForaPartidaApi frosinoneForaPartidaApi;
    private FrosinoneForaAdapter frosinoneForaAdapter;



    public FrosinoneForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFrosinoneFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/italiano/frosinone/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        frosinoneForaPartidaApi = retrofit.create(FrosinoneForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        frosinoneForaPartidaApi.getFrosinoneFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    frosinoneForaAdapter = new FrosinoneForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(frosinoneForaAdapter);
