package com.jogos.dadosoficialkf228920.fragments.francaA2022a23.angers;
...
import com.jogos.dadosoficialkf228920.adapter.francaA2022a23.angers.AngersFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.francaA2022a23.angers.AngersForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAngersFora2022a23Binding;
...
public class AngersFora2022a23Fragment extends Fragment {


    private FragmentAngersFora2022a23Binding binding;
    private AngersForaA2022a23PartidaApi angersForaA2022a23PartidaApi;
    private AngersFora2022a23Adapter angersFora2022a23Adapter;

    public AngersFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAngersFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        angersForaA2022a23PartidaApi = retrofit.create(AngersForaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvAngersFora.setHasFixedSize(true);
        binding.rvAngersFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvAngersFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        angersForaA2022a23PartidaApi.getAngersFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    angersFora2022a23Adapter = new AngersFora2022a23Adapter(partidas);
                    binding.rvAngersFora.setAdapter(angersFora2022a23Adapter);

                    binding.rvAngersFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvAngersFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
