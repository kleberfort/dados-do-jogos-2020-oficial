package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.mallorca;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.mallorca.MallorcaForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.mallorca.MallorcaForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentMallorcaFora2023a24Binding;
...
public class MallorcaForaFragment extends Fragment {

    private FragmentMallorcaFora2023a24Binding binding;
    private MallorcaForaPartidaApi mallorcaForaPartidaApi;
    private MallorcaForaAdapter mallorcaForaAdapter;



    public MallorcaForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentMallorcaFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/espanhol/mallorca/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        mallorcaForaPartidaApi = retrofit.create(MallorcaForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        mallorcaForaPartidaApi.getMallorcaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    mallorcaForaAdapter = new MallorcaForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(mallorcaForaAdapter);
