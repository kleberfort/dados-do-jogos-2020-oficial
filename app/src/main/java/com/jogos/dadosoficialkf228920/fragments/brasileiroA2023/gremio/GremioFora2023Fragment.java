...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.gremio.GremioForaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.gremio.GremioForaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentGremioForaA2023Binding;
...
public class GremioFora2023Fragment extends Fragment {

    private FragmentGremioForaA2023Binding binding;
    private GremioForaA2023Adapter gremioForaA2023Adapter;
    private GremioForaA2023PartidaApi gremioForaA2023PartidaApi;





    public GremioFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentGremioForaA2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        gremioForaA2023PartidaApi = retrofit.create(GremioForaA2023PartidaApi.class);
    ...
    private void setupListaPartidas() {
        ...
        binding.rvGremioFora.setHasFixedSize(true);
        binding.rvGremioFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvGremioFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));


        gremioForaA2023PartidaApi.getGremioFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    gremioForaA2023Adapter = new GremioForaA2023Adapter(partidas);
                    binding.rvGremioFora.setAdapter(gremioForaA2023Adapter);

                    binding.rvGremioFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvGremioFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
