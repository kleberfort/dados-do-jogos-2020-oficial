...
import com.jogos.dadosoficialkf228920.adapter.espanhaA2022a23.mallorca.MallorcaCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.espanhaA2022a23.mallorca.MallorcaCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentMallorcaCasa2022a23Binding;
        ...
        mallorcaCasaA2022a23PartidaApi.getMallorcaCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvMallorcaCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvMallorcaCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
