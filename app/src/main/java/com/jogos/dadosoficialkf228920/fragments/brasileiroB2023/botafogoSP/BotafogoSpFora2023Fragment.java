package com.jogos.dadosoficialkf228920.fragments.brasileiroB2023.botafogoSP;
...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.botafogoSp.BotafogoSpForaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.botafogoSP.BotafogoSpForaB2023PartidaApi;

import com.jogos.dadosoficialkf228920.databinding.FragmentBotafogoSpForaB2023Binding;
...
public class BotafogoSpFora2023Fragment extends Fragment {

    private FragmentBotafogoSpForaB2023Binding binding;
    private BotafogoSpForaB2023Adapter botafogoSpForaB2023Adapter;
    private BotafogoSpForaB2023PartidaApi botafogoSpForaB2023PartidaApi;
    ...
    public BotafogoSpFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBotafogoSpForaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/brasileiro-b-2023/botafogo-sp/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        botafogoSpForaB2023PartidaApi = retrofit.create(BotafogoSpForaB2023PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvBotafogoSpFora.setHasFixedSize(true);
        binding.rvBotafogoSpFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvBotafogoSpFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        botafogoSpForaB2023PartidaApi.getBotafogoSpFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    botafogoSpForaB2023Adapter = new BotafogoSpForaB2023Adapter(partidas);
                    binding.rvBotafogoSpFora.setAdapter(botafogoSpForaB2023Adapter);

                    binding.rvBotafogoSpFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvBotafogoSpFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
