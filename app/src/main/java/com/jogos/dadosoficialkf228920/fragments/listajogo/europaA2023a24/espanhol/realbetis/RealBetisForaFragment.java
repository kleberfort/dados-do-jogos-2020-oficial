...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.realbetis.RealBetisForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.realbetis.RealBetisForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentRealBetisFora2023a24Binding;
...
public class RealBetisForaFragment extends Fragment {

    private FragmentRealBetisFora2023a24Binding binding;
    private RealBetisForaPartidaApi realBetisForaPartidaApi;
    private RealBetisForaAdapter realBetisForaAdapter;



    public RealBetisForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentRealBetisFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        realBetisForaPartidaApi = retrofit.create(RealBetisForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        realBetisForaPartidaApi.getRealBetisFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    realBetisForaAdapter = new RealBetisForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(realBetisForaAdapter);
