...
import com.jogos.dadosoficialkf228920.databinding.FragmentBrightonResultadoEstatisticaBinding;
...
public class BrightonResultadoEstatisticaFragment extends Fragment {

    private FragmentBrightonResultadoEstatisticaBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBrightonResultadoEstatisticaBinding.inflate(inflater, container, false);
        ...
        FragmentPagerItemAdapter adapter = new FragmentPagerItemAdapter(
                ...
                FragmentPagerItems.with(getApplicationContext())
                        .add("Casa 2023-24", BrightonCsResultadoFragment.class)
                        .add("Fora 2023-24", BrightonFrResultadoFragment.class)
