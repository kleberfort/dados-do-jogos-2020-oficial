...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.saopaulo.SaopauloCasaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.saopaulo.SaopauloCasaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentSaopauloCasaA2023Binding;
...
public class SaopauloCasa2023Fragment extends Fragment {

    private FragmentSaopauloCasaA2023Binding binding;
    private SaopauloCasaA2023Adapter saopauloCasaA2023Adapter;
    private SaopauloCasaA2023PartidaApi saopauloCasaA2023PartidaApi;




    public SaopauloCasa2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSaopauloCasaA2023Binding.inflate(inflater, container, false);
        ...
        saopauloCasaA2023PartidaApi.getSaopauloCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    saopauloCasaA2023Adapter = new SaopauloCasaA2023Adapter(partidas);
                    binding.rvSaopauloCasa.setAdapter(saopauloCasaA2023Adapter);
