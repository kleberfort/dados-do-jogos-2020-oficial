package com.jogos.dadosoficialkf228920.fragments.francaA2022a23.monaco;
...
import com.jogos.dadosoficialkf228920.adapter.francaA2022a23.monaco.MonacoFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.francaA2022a23.monaco.MonacoForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentMonacoFora2022a23Binding;
...
public class MonacoFora2022a23Fragment extends Fragment {


    private FragmentMonacoFora2022a23Binding binding;
    private MonacoForaA2022a23PartidaApi monacoForaA2022a23PartidaApi;
    private MonacoFora2022a23Adapter monacoFora2022a23Adapter;

    public MonacoFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentMonacoFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        monacoForaA2022a23PartidaApi = retrofit.create(MonacoForaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvMonacoFora.setHasFixedSize(true);
        binding.rvMonacoFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvMonacoFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        monacoForaA2022a23PartidaApi.getMonacoFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    monacoFora2022a23Adapter = new MonacoFora2022a23Adapter(partidas);
                    binding.rvMonacoFora.setAdapter(monacoFora2022a23Adapter);

                    binding.rvMonacoFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvMonacoFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
