...
import com.jogos.dadosoficialkf228920.adapter.inglesA2022a2023.newcastle.NewcastleFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.inglesA2022a23.newcastle.NewcastleForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentNewcastleFora2022a23Binding;
        ...
        newcastleForaA2022a23PartidaApi.getNewcastleCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvNewcastleFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvNewcastleFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
