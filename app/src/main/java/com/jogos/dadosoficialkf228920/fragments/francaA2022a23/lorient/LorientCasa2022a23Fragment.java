package com.jogos.dadosoficialkf228920.fragments.francaA2022a23.lorient;
...
import com.jogos.dadosoficialkf228920.adapter.francaA2022a23.lorient.LorientCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.francaA2022a23.lorient.LorientCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentLorientCasa2022a23Binding;
...
public class LorientCasa2022a23Fragment extends Fragment {


    private FragmentLorientCasa2022a23Binding binding;
    private LorientCasaA2022a23PartidaApi lorientCasaA2022a23PartidaApi;
    private LorientCasa2022a23Adapter lorientCasa2022a23Adapter;

    public LorientCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLorientCasa2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        lorientCasaA2022a23PartidaApi = retrofit.create(LorientCasaA2022a23PartidaApi.class);

    }

    private void setupDadosJogos() {
        binding.rvLorientCasa.setHasFixedSize(true);
        binding.rvLorientCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvLorientCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        lorientCasaA2022a23PartidaApi.getLorientCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    lorientCasa2022a23Adapter = new LorientCasa2022a23Adapter(partidas);
                    binding.rvLorientCasa.setAdapter(lorientCasa2022a23Adapter);

                    binding.rvLorientCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvLorientCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
