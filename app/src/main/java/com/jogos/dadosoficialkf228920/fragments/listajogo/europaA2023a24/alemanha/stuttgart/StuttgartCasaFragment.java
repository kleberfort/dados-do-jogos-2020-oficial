...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.stuttgart.StuttgartCasaAdapter;
...
import com.jogos.dadosoficialkf228920.databinding.FragmentStuttgartCasa2023a24Binding;
...
public class StuttgartCasaFragment extends Fragment {

    private FragmentStuttgartCasa2023a24Binding binding;
    private StuttgartCasaPartidaApi stuttgartCasaPartidaApi;
    private StuttgartCasaAdapter stuttgartCasaAdapter;



    public StuttgartCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentStuttgartCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        stuttgartCasaPartidaApi = retrofit.create(StuttgartCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        stuttgartCasaPartidaApi.getStuttgartCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    stuttgartCasaAdapter = new StuttgartCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(stuttgartCasaAdapter);
