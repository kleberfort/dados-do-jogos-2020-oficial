package com.jogos.dadosoficialkf228920.fragments.alemanhaA2022a23.bochum;
...
import com.jogos.dadosoficialkf228920.adapter.alemanhaA2022a23.bochum.BochumCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.alemanhaA2022a23.bochum.BochumCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentBochumCasa2022a23Binding;
...
public class BochumCasa2022a23Fragment extends Fragment {


    private FragmentBochumCasa2022a23Binding binding;
    private BochumCasaA2022a23PartidaApi bochumCasaA2022a23PartidaApi;
    private BochumCasa2022a23Adapter bochumCasa2022a23Adapter;

    public BochumCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBochumCasa2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        bochumCasaA2022a23PartidaApi = retrofit.create(BochumCasaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvBochumCasa.setHasFixedSize(true);
        binding.rvBochumCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvBochumCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));
