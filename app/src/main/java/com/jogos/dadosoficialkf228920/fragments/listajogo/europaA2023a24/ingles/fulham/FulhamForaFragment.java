...
import com.jogos.dadosoficialkf228920.databinding.FragmentFulhamFora2023a24Binding;
...
public class FulhamForaFragment extends Fragment {

    private FragmentFulhamFora2023a24Binding binding;
    private FulhamForaPartidaApi fulhamForaPartidaApi;
    private FulhamForaAdapter fulhamForaAdapter;



    public FulhamForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFulhamFora2023a24Binding.inflate(inflater, container, false);
        ...
        fulhamForaPartidaApi.getFulhamFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    fulhamForaAdapter = new FulhamForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(fulhamForaAdapter);
