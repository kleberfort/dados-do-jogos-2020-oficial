package com.jogos.dadosoficialkf228920.fragments.francaA2022a23.auxerre;
...
import com.jogos.dadosoficialkf228920.adapter.francaA2022a23.auxerre.AuxerreCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.francaA2022a23.auxerre.AuxerreCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAuxerreCasa2022a23Binding;
...
public class AuxerreCasa2022a23Fragment extends Fragment {

    private FragmentAuxerreCasa2022a23Binding binding;
    private AuxerreCasaA2022a23PartidaApi auxerreCasaA2022a23PartidaApi;
    private AuxerreCasa2022a23Adapter auxerreCasa2022a23Adapter;


    public AuxerreCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAuxerreCasa2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        auxerreCasaA2022a23PartidaApi = retrofit.create(AuxerreCasaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvAuxerreCasa.setHasFixedSize(true);
        binding.rvAuxerreCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvAuxerreCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        auxerreCasaA2022a23PartidaApi.getAuxerreCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    auxerreCasa2022a23Adapter = new AuxerreCasa2022a23Adapter(partidas);
                    binding.rvAuxerreCasa.setAdapter(auxerreCasa2022a23Adapter);

                    binding.rvAuxerreCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvAuxerreCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
