...
import com.jogos.dadosoficialkf228920.databinding.FragmentSheffieldCasa2023a24Binding;
...
public class SheffieldCasaFragment extends Fragment {

    private FragmentSheffieldCasa2023a24Binding binding;
    private SheffieldCasaPartidaApi sheffieldCasaPartidaApi;
    private SheffieldCasaAdapter sheffieldCasaAdapter;



    public SheffieldCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSheffieldCasa2023a24Binding.inflate(inflater, container, false);
        ...
        sheffieldCasaPartidaApi.getSheffieldCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    sheffieldCasaAdapter = new SheffieldCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(sheffieldCasaAdapter);
