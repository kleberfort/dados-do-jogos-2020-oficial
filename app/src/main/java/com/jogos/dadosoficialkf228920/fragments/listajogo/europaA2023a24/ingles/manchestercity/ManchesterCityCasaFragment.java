...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.manchestercity.ManchesterCityCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.ingles.manchestercity.ManchesterCityCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentManchesterCityCasa2023a24Binding;
...
public class ManchesterCityCasaFragment extends Fragment {

    private FragmentManchesterCityCasa2023a24Binding binding;
    private ManchesterCityCasaPartidaApi manchesterCityCasaPartidaApi;
    private ManchesterCityCasaAdapter manchesterCityCasaAdapter;



    public ManchesterCityCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentManchesterCityCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        manchesterCityCasaPartidaApi = retrofit.create(ManchesterCityCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        manchesterCityCasaPartidaApi.getManchesterCityCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    manchesterCityCasaAdapter = new ManchesterCityCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(manchesterCityCasaAdapter);
