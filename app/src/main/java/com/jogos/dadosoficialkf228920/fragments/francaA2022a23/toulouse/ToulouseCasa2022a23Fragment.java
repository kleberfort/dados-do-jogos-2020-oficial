package com.jogos.dadosoficialkf228920.fragments.francaA2022a23.toulouse;
...
import com.jogos.dadosoficialkf228920.adapter.francaA2022a23.toulouse.ToulouseCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.francaA2022a23.toulouse.ToulouseCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentToulouseCasa2022a23Binding;
...
public class ToulouseCasa2022a23Fragment extends Fragment {
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/franca-a-2022-23/toulouse/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        toulouseCasaA2022a23PartidaApi = retrofit.create(ToulouseCasaA2022a23PartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        toulouseCasaA2022a23PartidaApi.getToulouseCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    toulouseCasa2022a23Adapter = new ToulouseCasa2022a23Adapter(partidas);
                    binding.rvToulouseCasa.setAdapter(toulouseCasa2022a23Adapter);

                    binding.rvToulouseCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvToulouseCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
