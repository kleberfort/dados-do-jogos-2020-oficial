package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.barcelona;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.barcelona.BarcelonaForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.barcelona.BarcelonaForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentBarcelonaFora2023a24Binding;
...
public class BarcelonaForaFragment extends Fragment {

    private FragmentBarcelonaFora2023a24Binding binding;
    private BarcelonaForaPartidaApi barcelonaForaPartidaApi;
    private BarcelonaForaAdapter barcelonaForaAdapter;



    public BarcelonaForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBarcelonaFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        barcelonaForaPartidaApi = retrofit.create(BarcelonaForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        barcelonaForaPartidaApi.getBarcelonaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    barcelonaForaAdapter = new BarcelonaForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(barcelonaForaAdapter);
