package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.cagliari;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.cagliari.CagliariCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.cagliari.CagliariCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentCagliariCasa2023a24Binding;
...
public class CagliariCasaFragment extends Fragment {

    private FragmentCagliariCasa2023a24Binding binding;
    private CagliariCasaPartidaApi cagliariCasaPartidaApi;
    private CagliariCasaAdapter cagliariCasaAdapter;



    public CagliariCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCagliariCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/italiano/cagliari/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        cagliariCasaPartidaApi = retrofit.create(CagliariCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        cagliariCasaPartidaApi.getCagliariCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    cagliariCasaAdapter = new CagliariCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(cagliariCasaAdapter);
