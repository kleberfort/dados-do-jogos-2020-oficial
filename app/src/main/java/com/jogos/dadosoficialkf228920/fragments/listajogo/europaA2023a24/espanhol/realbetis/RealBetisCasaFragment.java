package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.realbetis;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.realbetis.RealBetisCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.realbetis.RealBetisCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentRealBetisCasa2023a24Binding;
...
public class RealBetisCasaFragment extends Fragment {

    private FragmentRealBetisCasa2023a24Binding binding;
    private RealBetisCasaPartidaApi realBetisCasaPartidaApi;
    private RealBetisCasaAdapter realBetisCasaAdapter;



    public RealBetisCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentRealBetisCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/espanhol/real-betis/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        realBetisCasaPartidaApi = retrofit.create(RealBetisCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        realBetisCasaPartidaApi.getRealBetisCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    realBetisCasaAdapter = new RealBetisCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(realBetisCasaAdapter);
