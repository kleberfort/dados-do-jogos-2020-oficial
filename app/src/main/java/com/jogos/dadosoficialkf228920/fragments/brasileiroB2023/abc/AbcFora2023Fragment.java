...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.abc.AbcForaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.abc.AbcForaB2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAbcForaB2023Binding;
...
public class AbcFora2023Fragment extends Fragment {


    private FragmentAbcForaB2023Binding binding;
    private AbcForaB2023Adapter abcForaB2023Adapter;
    private AbcForaB2023PartidaApi abcForaB2023PartidaApi;




    public AbcFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAbcForaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        abcForaB2023PartidaApi = retrofit.create(AbcForaB2023PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvAbcFora.setHasFixedSize(true);
        binding.rvAbcFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvAbcFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        abcForaB2023PartidaApi.getAbcFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    abcForaB2023Adapter = new AbcForaB2023Adapter(partidas);
                    binding.rvAbcFora.setAdapter(abcForaB2023Adapter);

                    binding.rvAbcFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvAbcFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
