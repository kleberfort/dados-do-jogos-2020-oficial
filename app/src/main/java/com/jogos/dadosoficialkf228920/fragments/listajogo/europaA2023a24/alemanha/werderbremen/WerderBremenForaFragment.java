package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.werderbremen;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.werderbremen.WerderBremenCasaAdapter;
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.werderbremen.WerderBremenForaAdapter;
...
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.werderbremen.WerderBremenForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAugsburgFora2023a24Binding;
import com.jogos.dadosoficialkf228920.databinding.FragmentWerderBremenFora2023a24Binding;
...
public class WerderBremenForaFragment extends Fragment {

    private FragmentWerderBremenFora2023a24Binding binding;
    private WerderBremenForaPartidaApi werderBremenForaPartidaApi;
    private WerderBremenForaAdapter werderBremenForaAdapter;



    public WerderBremenForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentWerderBremenFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        werderBremenForaPartidaApi = retrofit.create(WerderBremenForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        werderBremenForaPartidaApi.getWerderBremenora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    werderBremenForaAdapter = new WerderBremenForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(werderBremenForaAdapter);
