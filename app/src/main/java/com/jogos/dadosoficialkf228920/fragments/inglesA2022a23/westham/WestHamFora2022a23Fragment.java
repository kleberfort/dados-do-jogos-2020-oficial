...
import com.jogos.dadosoficialkf228920.adapter.inglesA2022a2023.westham.WesthamFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.inglesA2022a23.westham.WestHamForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentWestHamFora2022a23Binding;
...
public class WestHamFora2022a23Fragment extends Fragment {
    ...
    private void setupHttpClient() {
        ...
        westHamForaA2022a23PartidaApi = retrofit.create(WestHamForaA2022a23PartidaApi.class);
    }
        ...
        westHamForaA2022a23PartidaApi.getWestHamFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvWesthamFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvWesthamFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
