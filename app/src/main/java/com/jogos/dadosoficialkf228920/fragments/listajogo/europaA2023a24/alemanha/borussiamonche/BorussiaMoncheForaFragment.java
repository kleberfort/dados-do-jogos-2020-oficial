package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.borussiamonche;
...
import com.jogos.dadosoficialkf228920.adapter.alemanhaA2022a23.borussiamonchengladbach.BorussiaMonchengladbachFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.borussiamonchengladbach.BorussiaMoncheForaAdapter;
...
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.borussiamonchengladbach.BorussiaMonchengladbachCasaPartidaApi;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.borussiamonchengladbach.BorussiaMonchengladbachForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAugsburgFora2023a24Binding;
import com.jogos.dadosoficialkf228920.databinding.FragmentBorussiaMonchegladbachFora2023a24Binding;
...
public class BorussiaMoncheForaFragment extends Fragment {

    private FragmentBorussiaMonchegladbachFora2023a24Binding binding;
    private BorussiaMonchengladbachForaPartidaApi borussiaMonchengladbachForaPartidaApi;
    private BorussiaMoncheForaAdapter borussiaMoncheForaAdapter;



    public BorussiaMoncheForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBorussiaMonchegladbachFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/alemanha/borussia-monchengladbach/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        borussiaMonchengladbachForaPartidaApi = retrofit.create(BorussiaMonchengladbachForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        borussiaMonchengladbachForaPartidaApi.getBorussiaMonchengladbachFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    borussiaMoncheForaAdapter = new BorussiaMoncheForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(borussiaMoncheForaAdapter);
