...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.pontepreta.PontePretaCasaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.pontepreta.PontePretaCasaB2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentPontepretaCasaB2023Binding;
...
public class PontePretaCasa2023Fragment extends Fragment {

    private FragmentPontepretaCasaB2023Binding binding;
    private PontePretaCasaB2023Adapter pontePretaCasaB2023Adapter;
    private PontePretaCasaB2023PartidaApi pontePretaCasaB2023PartidaApi;





    public PontePretaCasa2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentPontepretaCasaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        pontePretaCasaB2023PartidaApi = retrofit.create(PontePretaCasaB2023PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvPontePretaCasa.setHasFixedSize(true);
        binding.rvPontePretaCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvPontePretaCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        pontePretaCasaB2023PartidaApi.getPontePretaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    pontePretaCasaB2023Adapter = new PontePretaCasaB2023Adapter(partidas);
                    binding.rvPontePretaCasa.setAdapter(pontePretaCasaB2023Adapter);

                    binding.rvPontePretaCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvPontePretaCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
