...
import com.jogos.dadosoficialkf228920.adapter.francaA2022a23.nantes.NantesFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.francaA2022a23.nantes.NantesForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentNantesFora2022a23Binding;
        ...
        nantesForaA2022a23PartidaApi.getNantesFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvNantesFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvNantesFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
