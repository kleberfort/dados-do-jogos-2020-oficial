...
import com.jogos.dadosoficialkf228920.adapter.francaA2022a23.nice.NiceCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.francaA2022a23.nice.NiceCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentNiceCasa2022a2Binding;
        ...
        niceCasaA2022a23PartidaApi.getNiceCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvNiceCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvNiceCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
