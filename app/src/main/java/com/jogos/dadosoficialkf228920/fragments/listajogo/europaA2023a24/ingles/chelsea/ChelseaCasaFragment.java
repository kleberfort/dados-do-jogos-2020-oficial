...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.chelsea.ChelseaCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.ingles.chelsea.ChelseaCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentChelseaCasa2023a24Binding;
...
public class ChelseaCasaFragment extends Fragment {

    private FragmentChelseaCasa2023a24Binding binding;
    private ChelseaCasaPartidaApi chelseaCasaPartidaApi;
    private ChelseaCasaAdapter chelseaCasaAdapter;



    public ChelseaCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentChelseaCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        chelseaCasaPartidaApi = retrofit.create(ChelseaCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        chelseaCasaPartidaApi.getChelseaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    chelseaCasaAdapter = new ChelseaCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(chelseaCasaAdapter);
