...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.metz.MetzCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.metz.MetzCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentMetzCasa2023a24Binding;
...
public class MetzCasaFragment extends Fragment {

    private FragmentMetzCasa2023a24Binding binding;
    private MetzCasaPartidaApi metzCasaPartidaApi;
    private MetzCasaAdapter metzCasaAdapter;



    public MetzCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentMetzCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        metzCasaPartidaApi = retrofit.create(MetzCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        metzCasaPartidaApi.getMetzCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    metzCasaAdapter = new MetzCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(metzCasaAdapter);
