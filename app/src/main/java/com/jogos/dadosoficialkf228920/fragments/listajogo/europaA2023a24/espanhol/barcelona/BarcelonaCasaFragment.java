...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.barcelona.BarcelonaCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.barcelona.BarcelonaCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentBarcelonaCasa2023a24Binding;
...
public class BarcelonaCasaFragment extends Fragment {

    private FragmentBarcelonaCasa2023a24Binding binding;
    private BarcelonaCasaPartidaApi barcelonaCasaPartidaApi;
    private BarcelonaCasaAdapter barcelonaCasaAdapter;



    public BarcelonaCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBarcelonaCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        barcelonaCasaPartidaApi = retrofit.create(BarcelonaCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        barcelonaCasaPartidaApi.getBarcelonaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    barcelonaCasaAdapter = new BarcelonaCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(barcelonaCasaAdapter);
