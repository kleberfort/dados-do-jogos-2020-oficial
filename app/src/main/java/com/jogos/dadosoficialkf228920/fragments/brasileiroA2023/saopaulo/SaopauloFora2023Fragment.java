package com.jogos.dadosoficialkf228920.fragments.brasileiroA2023.saopaulo;
...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.saopaulo.SaopauloForaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.saopaulo.SaopauloForaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentSaopauloForaA2023Binding;
...
public class SaopauloFora2023Fragment extends Fragment {

    private FragmentSaopauloForaA2023Binding binding;
    private SaopauloForaA2023Adapter saopauloForaA2023Adapter;
    private SaopauloForaA2023PartidaApi saopauloForaA2023PartidaApi;


    public SaopauloFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSaopauloForaA2023Binding.inflate(inflater, container, false);
        ...
        saopauloForaA2023PartidaApi.getSaopauloFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    saopauloForaA2023Adapter = new SaopauloForaA2023Adapter(partidas);
                    binding.rvSaopauloFora.setAdapter(saopauloForaA2023Adapter);
