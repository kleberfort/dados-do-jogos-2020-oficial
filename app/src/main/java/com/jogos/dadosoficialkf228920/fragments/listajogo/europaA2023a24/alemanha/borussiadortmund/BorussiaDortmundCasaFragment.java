...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.borussiadortmund.BorussiaDortmundCasaAdapter;
...
import com.jogos.dadosoficialkf228920.databinding.FragmentBorussiaDortmundCasa2023a24Binding;
...
public class BorussiaDortmundCasaFragment extends Fragment {

    private FragmentBorussiaDortmundCasa2023a24Binding binding;
    private BorussiaDortmundCasaPartidaApi borussiaDortmundCasaPartidaApi;
    private BorussiaDortmundCasaAdapter borussiaDortmundCasaAdapter;



    public BorussiaDortmundCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBorussiaDortmundCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        borussiaDortmundCasaPartidaApi = retrofit.create(BorussiaDortmundCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        borussiaDortmundCasaPartidaApi.getBorussiaDortmundCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    borussiaDortmundCasaAdapter = new BorussiaDortmundCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(borussiaDortmundCasaAdapter);
