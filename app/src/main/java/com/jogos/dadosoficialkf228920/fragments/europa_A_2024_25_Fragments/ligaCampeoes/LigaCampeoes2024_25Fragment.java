...
import com.jogos.dadosoficialkf228920.databinding.FragmentLigaCampeoes202425Binding;
...
public class LigaCampeoes2024_25Fragment extends Fragment implements JogosLigaCampeoes2024_25_Listener {

    private FragmentLigaCampeoes202425Binding binding;

    private JogosLigaCampeoes2024_25 jogosLigaCampeoes202425;
...
//    public interface ListaLigaCampeoes2025_OnClinkInterface{//esse é o codigo de criar a interface // entede essa primeira parte ? ele basicamente
//        void listaLigaCampeoesOnClick2025Metodo(String nome);//viu que é uma string ?sim
//    }
//
//    public interface ListaLigaCampeoes2025_LongClickInterface{
//        void listaLigaCampeoesLongClick2025metodo();
//    }
//
//    //2 etapa criamos uma variavel da interface
//    ListaLigaCampeoes2025_OnClinkInterface listaLigaCampeoesOnClick = null;//queremos usar o metodo listaBrasilAMetodo(String nome) mas estamos iniciando ela com o valor null
//    //ou seuja null é igual a nulo ou nada
//    //entende isso ?sim
//
//    //2 etapa criamos uma variavel da interface
//    ListaLigaCampeoes2025_LongClickInterface listaLigaCampeoesLongClick = null;
//
...
//
//        if(context instanceof ListaLigaCampeoes2025_OnClinkInterface){
//            listaLigaCampeoesOnClick = (ListaLigaCampeoes2025_OnClinkInterface) context;//aqui iniciamos a nossa variavel... Esse código voce nao precisa entender, só tem que
//            //compreendeu as 3 etapadas ?sim ok
//        }
//
//        if(context instanceof ListaLaLiga_A_2024_25Fragment.ListaLaLiga2025_LongClickInterface){
//            listaLigaCampeoesLongClick = (ListaLigaCampeoes2025_LongClickInterface) context;
//        }
//
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLigaCampeoes202425Binding.inflate(inflater, container, false);
        View view = binding.getRoot();

        jogosLigaCampeoes202425 = new JogosLigaCampeoes2024_25();
        jogosLigaCampeoes202425.setupHttpClient();
        jogosLigaCampeoes202425.setupDadosJogos();
        jogosLigaCampeoes202425.setListener(this);// Registra o fragmento como listener
        ...
        binding.rvLista.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvLista, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                if (acessos >= 3) {
                  //  listaLaLigaOnClick.listaLaLigaOnClick2025Metodo(name);
            ...
            public void onLongItemClick(View view, int position) {
              //  listaLaLigaLongClick.listaLaLigaLongClick2025metodo();
