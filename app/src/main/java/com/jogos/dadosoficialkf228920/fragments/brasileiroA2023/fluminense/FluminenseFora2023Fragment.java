package com.jogos.dadosoficialkf228920.fragments.brasileiroA2023.fluminense;
...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.fluminense.FluminenseForaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.fluminense.FluminenseForaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentFluminenseForaA2023Binding;
...
public class FluminenseFora2023Fragment extends Fragment {

    private FragmentFluminenseForaA2023Binding binding;
    private FluminenseForaA2023Adapter fluminenseForaA2023Adapter;
    private FluminenseForaA2023PartidaApi fluminenseForaA2023PartidaApi;


    public FluminenseFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFluminenseForaA2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/brasileiro-a-2023/fluminense/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        fluminenseForaA2023PartidaApi = retrofit.create(FluminenseForaA2023PartidaApi.class);
    }
    ...
    private void setupDadosJogos() {
        ...
        fluminenseForaA2023PartidaApi.getFluminenseFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    fluminenseForaA2023Adapter = new FluminenseForaA2023Adapter(partidas);
                    binding.rvFluminenseFora.setAdapter(fluminenseForaA2023Adapter);

                    binding.rvFluminenseFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvFluminenseFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
