package com.jogos.dadosoficialkf228920.fragments.alemanhaA2022a23.mainz05;
...
import com.jogos.dadosoficialkf228920.adapter.alemanhaA2022a23.mainz05.Mainz05Fora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.alemanhaA2022a23.mainz05.Mainz05ForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentMainz05Fora2022a23Binding;
        ...
        mainz05ForaA2022a23PartidaApi.getMainz05Fora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    mainz05Fora2022a23Adapter = new Mainz05Fora2022a23Adapter(partidas);
                    binding.rvMainz05Fora.setAdapter(mainz05Fora2022a23Adapter);

                    binding.rvMainz05Fora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvMainz05Fora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
