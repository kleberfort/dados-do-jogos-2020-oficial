package com.jogos.dadosoficialkf228920.fragments.espanhaA2022a23.osasuna;
...
import com.jogos.dadosoficialkf228920.adapter.espanhaA2022a23.osasuna.OsasunaFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.espanhaA2022a23.osasuna.OsasunaForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentOsasunaFora2022a23Binding;
...
public class OsasunaFora2022a23Fragment extends Fragment {

    private FragmentOsasunaFora2022a23Binding binding;
    private OsasunaForaA2022a23PartidaApi osasunaForaA2022a23PartidaApi;
    private OsasunaFora2022a23Adapter osasunaFora2022a23Adapter;


    public OsasunaFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentOsasunaFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/espanhol-a-2022-23/osasuna/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        osasunaForaA2022a23PartidaApi = retrofit.create(OsasunaForaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvOsasunaFora.setHasFixedSize(true);
        binding.rvOsasunaFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvOsasunaFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        osasunaForaA2022a23PartidaApi.getOsasunaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    osasunaFora2022a23Adapter = new OsasunaFora2022a23Adapter(partidas);
                    binding.rvOsasunaFora.setAdapter(osasunaFora2022a23Adapter);

                    binding.rvOsasunaFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvOsasunaFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
