...
import com.jogos.dadosoficialkf228920.adapter.inglesA2022a2023.fulham.FulhamFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.inglesA2022a23.fulham.FulhamForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentFulhamFora2022a23Binding;
        ...
        fulhamForaA2022a23PartidaApi.getFulhamCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvFulhamFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvFulhamFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
