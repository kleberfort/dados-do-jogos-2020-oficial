package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.astonvilla;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.astonvilla.AstonVillaCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.ingles.astonvilla.AstonVillaCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAstonVillaCasa2023a24Binding;
...
public class AstonVillaCasaFragment extends Fragment {

    private FragmentAstonVillaCasa2023a24Binding binding;
    private AstonVillaCasaPartidaApi astonVillaCasaPartidaApi;
    private AstonVillaCasaAdapter astonVillaCasaAdapter;



    public AstonVillaCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAstonVillaCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        astonVillaCasaPartidaApi = retrofit.create(AstonVillaCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        astonVillaCasaPartidaApi.getAstonVillaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    astonVillaCasaAdapter = new AstonVillaCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(astonVillaCasaAdapter);
