...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.osasuna.OsasunaCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.osasuna.OsasunaCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentOsasunaCasa2023a24Binding;
...
public class OsasunaCasaFragment extends Fragment {

    private FragmentOsasunaCasa2023a24Binding binding;
    private OsasunaCasaPartidaApi osasunaCasaPartidaApi;
    private OsasunaCasaAdapter osasunaCasaAdapter;



    public OsasunaCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentOsasunaCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        osasunaCasaPartidaApi = retrofit.create(OsasunaCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        osasunaCasaPartidaApi.getOsasunaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    osasunaCasaAdapter = new OsasunaCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(osasunaCasaAdapter);
