package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.unionberlin;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.unionberlin.UnionBerlinCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.augsburg.AugsburgCasaPartidaApi;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.stuttgart.StuttgartCasaPartidaApi;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.unionberlin.UnionBerlinCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAugsburgCasa2023a24Binding;
import com.jogos.dadosoficialkf228920.databinding.FragmentUnionBerlinCasa2023a24Binding;
...
public class UnionBerlinCasaFragment extends Fragment {

    private FragmentUnionBerlinCasa2023a24Binding binding;
    private UnionBerlinCasaPartidaApi unionBerlinCasaPartidaApi;
    private UnionBerlinCasaAdapter unionBerlinCasaAdapter;



    public UnionBerlinCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentUnionBerlinCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/alemanha/union-berlin/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        unionBerlinCasaPartidaApi = retrofit.create(UnionBerlinCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        unionBerlinCasaPartidaApi.getUnionBerlinCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    unionBerlinCasaAdapter = new UnionBerlinCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(unionBerlinCasaAdapter);
