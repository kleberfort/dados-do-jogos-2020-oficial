package com.jogos.dadosoficialkf228920.fragments.brasileiroB2023.criciuma;
...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.criciuma.CriciumaCasaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.criciuma.CriciumaCasaB2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentCriciumaCasaB2023Binding;
...
public class CriciumaCasa2023Fragment extends Fragment {

    private FragmentCriciumaCasaB2023Binding binding;
    private CriciumaCasaB2023Adapter criciumaCasaB2023Adapter;
    private CriciumaCasaB2023PartidaApi criciumaCasaB2023PartidaApi;




    public CriciumaCasa2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCriciumaCasaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/brasileiro-b-2023/criciuma/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        criciumaCasaB2023PartidaApi = retrofit.create(CriciumaCasaB2023PartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        binding.rvCriciumaCasa.setHasFixedSize(true);
        binding.rvCriciumaCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvCriciumaCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        criciumaCasaB2023PartidaApi.getCriciumaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if (response.isSuccessful()) {
                    List<Partida> partidas = response.body();
                    criciumaCasaB2023Adapter = new CriciumaCasaB2023Adapter(partidas);
                    binding.rvCriciumaCasa.setAdapter(criciumaCasaB2023Adapter);

                    binding.rvCriciumaCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvCriciumaCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
