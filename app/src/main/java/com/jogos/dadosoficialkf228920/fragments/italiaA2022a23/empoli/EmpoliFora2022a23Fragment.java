...
import com.jogos.dadosoficialkf228920.adapter.italiaA2022a23.empoli.EmpoliFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.italiaA2022a23.empoli.EmpoliForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentEmpoliFora2022a23Binding;
        ...
        empoliForaA2022a23PartidaApi.getEmpoliFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvEmpoliFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvEmpoliFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
