...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.atleticoGo.AtleticoGoForaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.atleticoGO.AtleticoGoForaB2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAtleticoGoForaB2023Binding;
...
public class AtleticoGoFora2023Fragment extends Fragment {

    private FragmentAtleticoGoForaB2023Binding binding;
    private AtleticoGoForaB2023Adapter atleticoGoForaB2023Adapter;
    private AtleticoGoForaB2023PartidaApi atleticoGoForaB2023PartidaApi;




    public AtleticoGoFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAtleticoGoForaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        atleticoGoForaB2023PartidaApi = retrofit.create(AtleticoGoForaB2023PartidaApi.class);
    }
    ...
    private void setupDadosJogos() {
        ...
        atleticoGoForaB2023PartidaApi.getAtleticoGoFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    atleticoGoForaB2023Adapter = new AtleticoGoForaB2023Adapter(partidas);
                    binding.rvAtleticoGoFora.setAdapter(atleticoGoForaB2023Adapter);

                    binding.rvAtleticoGoFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvAtleticoGoFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
