package com.jogos.dadosoficialkf228920.fragments.alemanhaA2022a23.unionberlin;
...
import com.jogos.dadosoficialkf228920.adapter.alemanhaA2022a23.unionberlin.UnionBerlinCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.alemanhaA2022a23.unionberlin.UnionBerlinCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentUnionBerlinCasa2022a23Binding;
...
public class UnionBerlinCasa2022a23Fragment extends Fragment {


    private FragmentUnionBerlinCasa2022a23Binding binding;
    private UnionBerlinCasaA2022a23PartidaApi unionBerlinCasaA2022a23PartidaApi;
    private UnionBerlinCasa2022a23Adapter unionBerlinCasa2022a23Adapter;

    public UnionBerlinCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentUnionBerlinCasa2022a23Binding.inflate(inflater, container, false);
        ...
        unionBerlinCasaA2022a23PartidaApi.getUnionBerlinCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    unionBerlinCasa2022a23Adapter = new UnionBerlinCasa2022a23Adapter(partidas);
                    binding.rvUnionBerlinCasa.setAdapter(unionBerlinCasa2022a23Adapter);

                    binding.rvUnionBerlinCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvUnionBerlinCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
