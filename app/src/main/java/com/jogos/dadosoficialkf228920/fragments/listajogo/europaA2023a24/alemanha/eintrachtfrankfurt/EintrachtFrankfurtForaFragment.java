...
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.eintrachtfrankfurt.EintrachtFrankfurtForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAugsburgFora2023a24Binding;
import com.jogos.dadosoficialkf228920.databinding.FragmentEintrachtFrankfurtFora2023a24Binding;
...
public class EintrachtFrankfurtForaFragment extends Fragment {

    private FragmentEintrachtFrankfurtFora2023a24Binding binding;
    private EintrachtFrankfurtForaPartidaApi eintrachtFrankfurtForaPartidaApi;
    private EintrachtFrankfurtCasaAdapter eintrachtFrankfurtCasaAdapter;



    public EintrachtFrankfurtForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentEintrachtFrankfurtFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        eintrachtFrankfurtForaPartidaApi = retrofit.create(EintrachtFrankfurtForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        eintrachtFrankfurtForaPartidaApi.getEintrachtFrankfurtFora().enqueue(new Callback<List<Partida>>() {
            @Override
