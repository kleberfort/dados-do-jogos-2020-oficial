package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.reims;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.reims.ReimsCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.reims.ReimsCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentReimsCasa2023a24Binding;
...
public class ReimsCasaFragment extends Fragment {

    private FragmentReimsCasa2023a24Binding binding;
    private ReimsCasaPartidaApi reimsCasaPartidaApi;
    private ReimsCasaAdapter reimsCasaAdapter;



    public ReimsCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentReimsCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/franca/reims/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        reimsCasaPartidaApi = retrofit.create(ReimsCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        reimsCasaPartidaApi.getReimsCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    reimsCasaAdapter = new ReimsCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(reimsCasaAdapter);
