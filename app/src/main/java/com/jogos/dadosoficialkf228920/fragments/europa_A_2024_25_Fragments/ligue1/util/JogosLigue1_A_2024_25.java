...
public class JogosLigue1_A_2024_25 {

    private JogosLigue1_A_2024_25_Listener listener;
    ...
    public void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/refs/heads/master/europa-a-2024-2025/ligue-1-franca/")
    ...
    public void setupDadosJogos() {
        jogos_campeonatos_chamada_api.getLigue1Franca2024_25().enqueue(new Callback<List<MatchNewModelDate>>() {
            ...
            public void onResponse(Call<List<MatchNewModelDate>> call, Response<List<MatchNewModelDate>> response) {
                ...
                if(listener != null){
                    listener.onJogosLigue1_A_franca(partidasPorTime);
                }
