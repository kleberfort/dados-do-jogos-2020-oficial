...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.genoa.GenoaCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.genoa.GenoaCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentGenoaCasa2023a24Binding;
...
public class GenoaCasaFragment extends Fragment {

    private FragmentGenoaCasa2023a24Binding binding;
    private GenoaCasaPartidaApi genoaCasaPartidaApi;
    private GenoaCasaAdapter genoaCasaAdapter;



    public GenoaCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentGenoaCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        genoaCasaPartidaApi = retrofit.create(GenoaCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        genoaCasaPartidaApi.getGenoaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    genoaCasaAdapter = new GenoaCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(genoaCasaAdapter);
