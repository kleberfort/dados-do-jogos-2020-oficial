package com.jogos.dadosoficialkf228920.fragments.italiaA2022a23.salernitana;
...
import com.jogos.dadosoficialkf228920.adapter.italiaA2022a23.salernitana.SalernitanaCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.italiaA2022a23.salernitana.SalernitanaCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentSalernitanaCasa2022a23Binding;
...
public class SalernitanaCasa2022a23Fragment extends Fragment {

    private FragmentSalernitanaCasa2022a23Binding binding;
    private SalernitanaCasaA2022a23PartidaApi salernitanaCasaA2022a23PartidaApi;
    private SalernitanaCasa2022a23Adapter salernitanaCasa2022a23Adapter;

    public SalernitanaCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSalernitanaCasa2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/italia-a-2022-23/salernitana/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        salernitanaCasaA2022a23PartidaApi = retrofit.create(SalernitanaCasaA2022a23PartidaApi.class);

    }

    private void setupDadosJogos() {
        binding.rvSalernitanaCasa.setHasFixedSize(true);
        binding.rvSalernitanaCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvSalernitanaCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        salernitanaCasaA2022a23PartidaApi.getSalernitanaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    salernitanaCasa2022a23Adapter = new SalernitanaCasa2022a23Adapter(partidas);
                    binding.rvSalernitanaCasa.setAdapter(salernitanaCasa2022a23Adapter);

                    binding.rvSalernitanaCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvSalernitanaCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
