package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.franca.lyon;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.lyon.LyonForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.lyon.LyonForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentLyonFora2023a24Binding;
...
public class LyonForaFragment extends Fragment {

    private FragmentLyonFora2023a24Binding binding;
    private LyonForaPartidaApi lyonForaPartidaApi;
    private LyonForaAdapter lyonForaAdapter;



    public LyonForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLyonFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/franca/lyon/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        lyonForaPartidaApi = retrofit.create(LyonForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        lyonForaPartidaApi.getLyonFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    lyonForaAdapter = new LyonForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(lyonForaAdapter);
