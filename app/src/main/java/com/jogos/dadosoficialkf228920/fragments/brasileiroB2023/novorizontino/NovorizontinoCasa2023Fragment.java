...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.novorizontino.NovorizontinoCasaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.novorizontino.NovorizontinoCasaB2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentNovorizontinoCasaB2023Binding;
...
public class NovorizontinoCasa2023Fragment extends Fragment {

    private FragmentNovorizontinoCasaB2023Binding binding;
    private NovorizontinoCasaB2023Adapter novorizontinoCasaB2023Adapter;
    private NovorizontinoCasaB2023PartidaApi novorizontinoCasaB2023PartidaApi;





    public NovorizontinoCasa2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentNovorizontinoCasaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        novorizontinoCasaB2023PartidaApi = retrofit.create(NovorizontinoCasaB2023PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvNovorizontinoCasa.setHasFixedSize(true);
        binding.rvNovorizontinoCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvNovorizontinoCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        novorizontinoCasaB2023PartidaApi.getNovorizontinoCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    novorizontinoCasaB2023Adapter = new NovorizontinoCasaB2023Adapter(partidas);
                    binding.rvNovorizontinoCasa.setAdapter(novorizontinoCasaB2023Adapter);

                    binding.rvNovorizontinoCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvNovorizontinoCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
