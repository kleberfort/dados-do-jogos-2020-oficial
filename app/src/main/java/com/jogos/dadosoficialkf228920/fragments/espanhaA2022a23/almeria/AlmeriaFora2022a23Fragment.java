package com.jogos.dadosoficialkf228920.fragments.espanhaA2022a23.almeria;
...
import com.jogos.dadosoficialkf228920.adapter.espanhaA2022a23.almeria.AlmeriaFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.espanhaA2022a23.almeria.AlmeriaForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAlmeriaFora2022a23Binding;
        ...
        almeriaForaA2022a23PartidaApi.getAlmeriaFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    almeriaFora2022a23Adapter = new AlmeriaFora2022a23Adapter(partidas);
                    binding.rvAlmeriaFora.setAdapter(almeriaFora2022a23Adapter);

                    binding.rvAlmeriaFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvAlmeriaFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
