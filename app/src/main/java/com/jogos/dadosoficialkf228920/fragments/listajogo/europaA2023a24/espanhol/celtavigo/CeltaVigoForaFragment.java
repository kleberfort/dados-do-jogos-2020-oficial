...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.celtavigo.CeltaVigoForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.celtavigo.CeltaVigoForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentCeltaVigoFora2023a24Binding;
...
public class CeltaVigoForaFragment extends Fragment {

    private FragmentCeltaVigoFora2023a24Binding binding;
    private CeltaVigoForaPartidaApi celtaVigoForaPartidaApi;
    private CeltaVigoForaAdapter celtaVigoForaAdapter;



    public CeltaVigoForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCeltaVigoFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        celtaVigoForaPartidaApi = retrofit.create(CeltaVigoForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        celtaVigoForaPartidaApi.getCeltaVigoFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    celtaVigoForaAdapter = new CeltaVigoForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(celtaVigoForaAdapter);
