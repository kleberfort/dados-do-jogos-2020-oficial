package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.wolverhampton;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.wolverhampton.WolvesCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.ingles.wolverhampton.WolverhamptonCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentWolvesCasa2023a24Binding;
...
public class WolvesCasaFragment extends Fragment {

    private FragmentWolvesCasa2023a24Binding binding;
    private WolverhamptonCasaPartidaApi wolverhamptonCasaPartidaApi;
    private WolvesCasaAdapter wolvesCasaAdapter;



    public WolvesCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentWolvesCasa2023a24Binding.inflate(inflater, container, false);
        ...
        wolverhamptonCasaPartidaApi.getWolverhamptonCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    wolvesCasaAdapter = new WolvesCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(wolvesCasaAdapter);
