package com.jogos.dadosoficialkf228920.fragments.inglesA2022a23.newcastle;
...
import com.jogos.dadosoficialkf228920.adapter.inglesA2022a2023.newcastle.NewcastleCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.inglesA2022a23.newcastle.NewcastleCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentNewcastleCasa2022a23Binding;
        ...
        newcastleCasaA2022a23PartidaApi.getNewcastleCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvNewcastleCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvNewcastleCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
