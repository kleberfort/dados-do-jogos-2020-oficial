package com.jogos.dadosoficialkf228920.fragments.brasileiroB2023.pontepreta;
...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.pontepreta.PontePretaForaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.pontepreta.PontePretaForaB2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentPontepretaForaB2023Binding;
...
public class PontePretaFora2023Fragment extends Fragment {

    private FragmentPontepretaForaB2023Binding binding;
    private PontePretaForaB2023Adapter pontePretaForaB2023Adapter;
    private PontePretaForaB2023PartidaApi pontePretaForaB2023PartidaApi;





    public PontePretaFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentPontepretaForaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/brasileiro-b-2023/pontepreta/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        pontePretaForaB2023PartidaApi = retrofit.create(PontePretaForaB2023PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvPontePretaFora.setHasFixedSize(true);
        binding.rvPontePretaFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvPontePretaFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        pontePretaForaB2023PartidaApi.getPontePretaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    pontePretaForaB2023Adapter = new PontePretaForaB2023Adapter(partidas);
                    binding.rvPontePretaFora.setAdapter(pontePretaForaB2023Adapter);

                    binding.rvPontePretaFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvPontePretaFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
