package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.realsociedad;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.realsociedad.RealSociedadCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.realsociedad.RealSociedadCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentRealSociedadCasa2023a24Binding;
...
public class RealSociedadCasaFragment extends Fragment {

    private FragmentRealSociedadCasa2023a24Binding binding;
    private RealSociedadCasaPartidaApi realSociedadCasaPartidaApi;
    private RealSociedadCasaAdapter realSociedadCasaAdapter;



    public RealSociedadCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentRealSociedadCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/espanhol/real-sociedad/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        realSociedadCasaPartidaApi = retrofit.create(RealSociedadCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        realSociedadCasaPartidaApi.getRealSociedadCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    realSociedadCasaAdapter = new RealSociedadCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(realSociedadCasaAdapter);
    ...
    private void errorBuscarDados() {
        Snackbar.make(binding.getRoot(), "erro ao buscar Lista de jogos, Verifique a conexão de Internet, ", Snackbar.LENGTH_LONG).show();
    }
}
