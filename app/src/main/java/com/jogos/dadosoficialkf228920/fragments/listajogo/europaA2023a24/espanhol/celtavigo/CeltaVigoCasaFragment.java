package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.espanhol.celtavigo;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.espanhol.celtavigo.CeltaVigoCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.espanhol.celtavigo.CeltaVigoCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentCeltaVigoCasa2023a24Binding;
...
public class CeltaVigoCasaFragment extends Fragment {

    private FragmentCeltaVigoCasa2023a24Binding binding;
    private CeltaVigoCasaPartidaApi celtaVigoCasaPartidaApi;
    private CeltaVigoCasaAdapter celtaVigoCasaAdapter;



    public CeltaVigoCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCeltaVigoCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/espanhol/celta-vigo/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        celtaVigoCasaPartidaApi = retrofit.create(CeltaVigoCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        celtaVigoCasaPartidaApi.getCeltaVigoCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    celtaVigoCasaAdapter = new CeltaVigoCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(celtaVigoCasaAdapter);
