...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.lyon.LyonCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.lyon.LyonCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentLyonCasa2023a24Binding;
...
public class LyonCasaFragment extends Fragment {

    private FragmentLyonCasa2023a24Binding binding;
    private LyonCasaPartidaApi lyonCasaPartidaApi;
    private LyonCasaAdapter lyonCasaAdapter;



    public LyonCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLyonCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        lyonCasaPartidaApi = retrofit.create(LyonCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        lyonCasaPartidaApi.getLyonCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    lyonCasaAdapter = new LyonCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(lyonCasaAdapter);
