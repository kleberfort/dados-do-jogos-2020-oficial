...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.franca.nantes.NantesForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.franca.nantes.NantesForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentNantesFora2023a24Binding;
...
public class NantesForaFragment extends Fragment {

    private FragmentNantesFora2023a24Binding binding;
    private NantesForaPartidaApi nantesForaPartidaApi;
    private NantesForaAdapter nantesForaAdapter;



    public NantesForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentNantesFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        nantesForaPartidaApi = retrofit.create(NantesForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        nantesForaPartidaApi.getNantesFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    nantesForaAdapter = new NantesForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(nantesForaAdapter);
