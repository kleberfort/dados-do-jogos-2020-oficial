...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.lazio.LazioForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.lazio.LazioForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentLazioFora2023a24Binding;
...
public class LazioForaFragment extends Fragment {

    private FragmentLazioFora2023a24Binding binding;
    private LazioForaPartidaApi lazioForaPartidaApi;
    private LazioForaAdapter lazioForaAdapter;



    public LazioForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLazioFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        lazioForaPartidaApi = retrofit.create(LazioForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        lazioForaPartidaApi.getLazioFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    lazioForaAdapter = new LazioForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(lazioForaAdapter);
