...
import com.jogos.dadosoficialkf228920.databinding.FragmentNewcastleCasa2023a24Binding;
...
public class NewcastleCasaFragment extends Fragment {

    private FragmentNewcastleCasa2023a24Binding binding;
    private NewcastleCasaPartidaApi newcastleCasaPartidaApi;
    private NewcastleCasaAdapter newcastleCasaAdapter;



    public NewcastleCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentNewcastleCasa2023a24Binding.inflate(inflater, container, false);
        ...
        newcastleCasaPartidaApi.getNewcastleCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    newcastleCasaAdapter = new NewcastleCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(newcastleCasaAdapter);
