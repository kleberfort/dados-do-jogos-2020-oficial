...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.milan.MilanForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.milan.MilanForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentMilanFora2023a24Binding;
...
public class MilanForaFragment extends Fragment {

    private FragmentMilanFora2023a24Binding binding;
    private MilanForaPartidaApi milanForaPartidaApi;
    private MilanForaAdapter milanForaAdapter;



    public MilanForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentMilanFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        milanForaPartidaApi = retrofit.create(MilanForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        milanForaPartidaApi.getMilanFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    milanForaAdapter = new MilanForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(milanForaAdapter);
