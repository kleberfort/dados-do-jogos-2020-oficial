package com.jogos.dadosoficialkf228920.fragments.francaA2022a23.lille;
...
import com.jogos.dadosoficialkf228920.adapter.francaA2022a23.lille.LilleCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.francaA2022a23.lille.LilleCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentLilleCasa2022a23Binding;
...
public class LilleCasa2022a23Fragment extends Fragment {


    private FragmentLilleCasa2022a23Binding binding;
    private LilleCasaA2022a23PartidaApi lilleCasaA2022a23PartidaApi;
    private LilleCasa2022a23Adapter lilleCasa2022a23Adapter;

    public LilleCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLilleCasa2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        lilleCasaA2022a23PartidaApi = retrofit.create(LilleCasaA2022a23PartidaApi.class);

    }

    private void setupDadosJogos() {
        binding.rvLilleCasa.setHasFixedSize(true);
        binding.rvLilleCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvLilleCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        lilleCasaA2022a23PartidaApi.getLilleCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    lilleCasa2022a23Adapter = new LilleCasa2022a23Adapter(partidas);
                    binding.rvLilleCasa.setAdapter(lilleCasa2022a23Adapter);

                    binding.rvLilleCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvLilleCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
