package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.bayernmunique;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.bayernmunique.BayernMuniqueCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.bayernmunique.BayernMuniqueCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentBayernMuniqueCasa2023a24Binding;
...
public class BayernMuniqueCasaFragment extends Fragment {

    private FragmentBayernMuniqueCasa2023a24Binding binding;
    private BayernMuniqueCasaPartidaApi bayernMuniqueCasaPartidaApi;
    private BayernMuniqueCasaAdapter bayernMuniqueCasaAdapter;



    public BayernMuniqueCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBayernMuniqueCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/alemanha/bayern-munique/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        bayernMuniqueCasaPartidaApi = retrofit.create(BayernMuniqueCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        bayernMuniqueCasaPartidaApi.getBayernMuniqueCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    bayernMuniqueCasaAdapter = new BayernMuniqueCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(bayernMuniqueCasaAdapter);
