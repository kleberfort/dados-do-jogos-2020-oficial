package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.burnley;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.burnley.BurnleyCasaAdapter;
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.burnley.BurnleyForaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.ingles.burnley.BurnleyCasaPartidaApi;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.ingles.burnley.BurnleyForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentBurnleyFora2023a24Binding;
...
public class BurnleyForaFragment extends Fragment {

    private FragmentBurnleyFora2023a24Binding binding;
    private BurnleyForaPartidaApi burnleyForaPartidaApi;
    private BurnleyForaAdapter burnleyForaAdapter;



    public BurnleyForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBurnleyFora2023a24Binding.inflate(inflater, container, false);
        ...
        burnleyForaPartidaApi.getBurnleyFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    burnleyForaAdapter = new BurnleyForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(burnleyForaAdapter);
