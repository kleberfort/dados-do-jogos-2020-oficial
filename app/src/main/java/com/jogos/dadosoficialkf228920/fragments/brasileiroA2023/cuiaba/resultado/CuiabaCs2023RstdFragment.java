...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.cuiaba.resultado.CuiabaCsA2023RstdAdt;
...
import com.jogos.dadosoficialkf228920.databinding.FragmentCuiabaCs2023RstdBinding;
...
public class CuiabaCs2023RstdFragment extends Fragment {

    private FragmentCuiabaCs2023RstdBinding binding;
    private CuiabaCasaA2023PartidaApi cuiabaCasaA2023PartidaApi;
    private CuiabaCsA2023RstdAdt cuiabaCsA2023RstdAdt;

    public CuiabaCs2023RstdFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCuiabaCs2023RstdBinding.inflate(inflater, container, false);
        ...
        cuiabaCasaA2023PartidaApi.getCuiabaCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    cuiabaCsA2023RstdAdt = new CuiabaCsA2023RstdAdt(partidas);
                    binding.rvListaResultado.setAdapter(cuiabaCsA2023RstdAdt);
