...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.ingles.bournemouth.BournemouthCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.ingles.bournemouth.BournemouthCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentBournemouthCasa2023a24Binding;
...
public class BournemouthCasaFragment extends Fragment {

    private FragmentBournemouthCasa2023a24Binding binding;
    private BournemouthCasaPartidaApi bournemouthCasaPartidaApi;
    private BournemouthCasaAdapter bournemouthCasaAdapter;



    public BournemouthCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBournemouthCasa2023a24Binding.inflate(inflater, container, false);
        ...
        bournemouthCasaPartidaApi.getBournemouthCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    bournemouthCasaAdapter = new BournemouthCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(bournemouthCasaAdapter);
