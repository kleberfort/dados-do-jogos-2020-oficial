package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.wolfsburg;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.wolfsburg.WolfsburgForaAdapter;
...
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.wolfsburg.WolfsburgCasaPartidaApi;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.wolfsburg.WolfsburgForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAugsburgFora2023a24Binding;
import com.jogos.dadosoficialkf228920.databinding.FragmentWolfsburgFora2023a24Binding;
...
public class WolfsburgForaFragment extends Fragment {

    private FragmentWolfsburgFora2023a24Binding binding;
    private WolfsburgForaPartidaApi wolfsburgForaPartidaApi;
    private WolfsburgForaAdapter wolfsburgForaAdapter;



    public WolfsburgForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentWolfsburgFora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        wolfsburgForaPartidaApi = retrofit.create(WolfsburgForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        wolfsburgForaPartidaApi.getWolfsburgFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    wolfsburgForaAdapter = new WolfsburgForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(wolfsburgForaAdapter);
