...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.corinthians.CorinthiansForaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.corinthians.CorinthiansForaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentCorinthiansForaA2023Binding;
...
public class CorinthiansFora2023Fragment extends Fragment {

    private FragmentCorinthiansForaA2023Binding binding;
    private CorinthiansForaA2023Adapter corinthiansForaA2023Adapter;
    private CorinthiansForaA2023PartidaApi corinthiansForaA2023PartidaApi;


    public CorinthiansFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCorinthiansForaA2023Binding.inflate(inflater, container, false);
        ...
        corinthiansForaA2023PartidaApi.getCorinthiansFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    corinthiansForaA2023Adapter = new CorinthiansForaA2023Adapter(partidas);
                    binding.rvCorinthiansFora.setAdapter(corinthiansForaA2023Adapter);
