package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.newcastle;
...
import com.jogos.dadosoficialkf228920.databinding.FragmentNewcastleFora2023a24Binding;
...
public class NewcastleForaFragment extends Fragment {

    private FragmentNewcastleFora2023a24Binding binding;
    private NewcastleForaPartidaApi newcastleForaPartidaApi;
    private NewcastleForaAdapter newcastleForaAdapter;



    public NewcastleForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentNewcastleFora2023a24Binding.inflate(inflater, container, false);
        ...
        newcastleForaPartidaApi.getNewcastleFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    newcastleForaAdapter = new NewcastleForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(newcastleForaAdapter);
