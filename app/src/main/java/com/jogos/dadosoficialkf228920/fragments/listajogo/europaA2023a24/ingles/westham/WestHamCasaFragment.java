...
import com.jogos.dadosoficialkf228920.databinding.FragmentWestHamCasa2023a24Binding;
...
public class WestHamCasaFragment extends Fragment {

    private FragmentWestHamCasa2023a24Binding binding;
    private WestHamCasaPartidaApi westHamCasaPartidaApi;
    private WestHamCasaAdapter westHamCasaAdapter;



    public WestHamCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentWestHamCasa2023a24Binding.inflate(inflater, container, false);
        ...
        westHamCasaPartidaApi.getWestHamCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    westHamCasaAdapter = new WestHamCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(westHamCasaAdapter);
