...
import com.jogos.dadosoficialkf228920.databinding.FragmentLensCsResultadoBinding;
 ...
 * Use the {@link LensCsResultadoFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class LensCsResultadoFragment extends Fragment {

    private FragmentLensCsResultadoBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLensCsResultadoBinding.inflate(inflater, container, false);
    ...
    private void setupDadosJogos() {
        ...
        jogosFrancesCasaFora2023_24Api.getLensCasa().enqueue(new Callback<List<Partida>>() {
            @Override
