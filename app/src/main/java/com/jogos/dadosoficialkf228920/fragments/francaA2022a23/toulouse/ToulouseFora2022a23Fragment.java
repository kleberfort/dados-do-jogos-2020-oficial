...
import com.jogos.dadosoficialkf228920.adapter.francaA2022a23.toulouse.ToulouseFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.francaA2022a23.toulouse.ToulouseForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentToulouseFora2022a23Binding;
        ...
        toulouseForaA2022a23PartidaApi.getToulouseFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    toulouseFora2022a23Adapter = new ToulouseFora2022a23Adapter(partidas);
                    binding.rvToulouseFora.setAdapter(toulouseFora2022a23Adapter);

                    binding.rvToulouseFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvToulouseFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
