...
import com.jogos.dadosoficialkf228920.adapter.italiaA2022a23.atalanta.AtalantaCasa2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.italiaA2022a23.atalanta.AtalantaCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAtalantaCasa2022a23Binding;
        ...
        atalantaCasaA2022a23PartidaApi.getAtalantaCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvAtalantaCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvAtalantaCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
