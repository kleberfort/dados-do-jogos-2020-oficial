...
import com.jogos.dadosoficialkf228920.adapter.brasileriroB2023.tombense.TombenseForaB2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroB2023.tombense.TombenseForaB2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentTombenseForaB2023Binding;
...
public class TombenseFora2023Fragment extends Fragment {

    private FragmentTombenseForaB2023Binding binding;
    private TombenseForaB2023Adapter tombenseForaB2023Adapter;
    private TombenseForaB2023PartidaApi tombenseForaB2023PartidaApi;





    public TombenseFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentTombenseForaB2023Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        tombenseForaB2023PartidaApi = retrofit.create(TombenseForaB2023PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvTombenseFora.setHasFixedSize(true);
        binding.rvTombenseFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvTombenseFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        tombenseForaB2023PartidaApi.getTombenseFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    tombenseForaB2023Adapter = new TombenseForaB2023Adapter(partidas);
                    binding.rvTombenseFora.setAdapter(tombenseForaB2023Adapter);

                    binding.rvTombenseFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvTombenseFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
