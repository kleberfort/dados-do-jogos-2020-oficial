package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.napoli;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.napoli.NapoliCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.napoli.NapoliCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentNapoliCasa2023a24Binding;
...
public class NapoliCasaFragment extends Fragment {

    private FragmentNapoliCasa2023a24Binding binding;
    private NapoliCasaPartidaApi napoliCasaPartidaApi;
    private NapoliCasaAdapter napoliCasaAdapter;



    public NapoliCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentNapoliCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/italiano/napoli/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        napoliCasaPartidaApi = retrofit.create(NapoliCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        napoliCasaPartidaApi.getNapoliCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    napoliCasaAdapter = new NapoliCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(napoliCasaAdapter);
