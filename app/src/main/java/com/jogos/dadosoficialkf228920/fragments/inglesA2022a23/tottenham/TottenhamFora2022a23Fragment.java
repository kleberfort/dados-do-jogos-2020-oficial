package com.jogos.dadosoficialkf228920.fragments.inglesA2022a23.tottenham;
...
import com.jogos.dadosoficialkf228920.adapter.inglesA2022a2023.tottenham.TottenhamFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.inglesA2022a23.tottenham.TottenhamForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentTottenhamFora2022a23Binding;
...
public class TottenhamFora2022a23Fragment extends Fragment {

    private FragmentTottenhamFora2022a23Binding binding;
    private TottenhamForaA2022a23PartidaApi tottenhamForaA2022a23PartidaApi;
    private TottenhamFora2022a23Adapter tottenhamFora2022a23Adapter;


    public TottenhamFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentTottenhamFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        tottenhamForaA2022a23PartidaApi = retrofit.create(TottenhamForaA2022a23PartidaApi.class);

    }

    private void setupDadosJogos() {
        binding.rvTottenhamFora.setHasFixedSize(true);
        ...
        tottenhamForaA2022a23PartidaApi.getTottenhamFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    tottenhamFora2022a23Adapter = new TottenhamFora2022a23Adapter(partidas);
                    binding.rvTottenhamFora.setAdapter(tottenhamFora2022a23Adapter);

                    binding.rvTottenhamFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvTottenhamFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
