package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.darmstadt;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.darmstadt98.Darmstadt98ForaAdapter;
...
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.darmstadt98.Darmstadt98CasaPartidaApi;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.darmstadt98.Darmstadt98ForaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAugsburgFora2023a24Binding;
import com.jogos.dadosoficialkf228920.databinding.FragmentDarmstadt98Fora2023a24Binding;
...
public class DarmstadtForaFragment extends Fragment {

    private FragmentDarmstadt98Fora2023a24Binding binding;
    private Darmstadt98ForaPartidaApi darmstadt98ForaPartidaApi;
    private Darmstadt98ForaAdapter darmstadt98ForaAdapter;



    public DarmstadtForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentDarmstadt98Fora2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/alemanha/darmstadt98/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        darmstadt98ForaPartidaApi = retrofit.create(Darmstadt98ForaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        darmstadt98ForaPartidaApi.getDarmstradt98Fora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    darmstadt98ForaAdapter = new Darmstadt98ForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(darmstadt98ForaAdapter);
