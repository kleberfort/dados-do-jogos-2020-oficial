package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.intermilao;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.intermilao.InterMilaoCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.intermilao.InterMilaoCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentInterMilaoCasa2023a24Binding;
...
public class InterMilaoCasaFragment extends Fragment {

    private FragmentInterMilaoCasa2023a24Binding binding;
    private InterMilaoCasaPartidaApi interMilaoCasaPartidaApi;
    private InterMilaoCasaAdapter interMilaoCasaAdapter;



    public InterMilaoCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentInterMilaoCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/italiano/inter-milao/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        interMilaoCasaPartidaApi = retrofit.create(InterMilaoCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        interMilaoCasaPartidaApi.getInterMilaoCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    interMilaoCasaAdapter = new InterMilaoCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(interMilaoCasaAdapter);
