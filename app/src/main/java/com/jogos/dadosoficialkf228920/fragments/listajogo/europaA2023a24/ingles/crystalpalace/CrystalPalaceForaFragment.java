package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.crystalpalace;
...
import com.jogos.dadosoficialkf228920.databinding.FragmentCrystalPalaceFora2023a24Binding;
...
public class CrystalPalaceForaFragment extends Fragment {

    private FragmentCrystalPalaceFora2023a24Binding binding;
    private CrystalPalaceForaPartidaApi crystalPalaceForaPartidaApi;
    private CrystalPalaceForaAdapter crystalPalaceForaAdapter;



    public CrystalPalaceForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCrystalPalaceFora2023a24Binding.inflate(inflater, container, false);
        ...
        crystalPalaceForaPartidaApi.getCrystalPalaceFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    crystalPalaceForaAdapter = new CrystalPalaceForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(crystalPalaceForaAdapter);
