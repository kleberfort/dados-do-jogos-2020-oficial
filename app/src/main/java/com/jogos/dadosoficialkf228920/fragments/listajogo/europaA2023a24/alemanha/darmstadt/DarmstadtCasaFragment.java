...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.darmstadt98.Darmstadt98CasaAdapter;
...
import com.jogos.dadosoficialkf228920.databinding.FragmentDarmstadt98Casa2023a24Binding;
...
public class DarmstadtCasaFragment extends Fragment {

    private FragmentDarmstadt98Casa2023a24Binding binding;
    private Darmstadt98CasaPartidaApi darmstadt98CasaPartidaApi;
    private Darmstadt98CasaAdapter darmstadt98CasaAdapter;



    public DarmstadtCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentDarmstadt98Casa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        darmstadt98CasaPartidaApi = retrofit.create(Darmstadt98CasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        darmstadt98CasaPartidaApi.getDarmstradt98Casa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    darmstadt98CasaAdapter = new Darmstadt98CasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(darmstadt98CasaAdapter);
