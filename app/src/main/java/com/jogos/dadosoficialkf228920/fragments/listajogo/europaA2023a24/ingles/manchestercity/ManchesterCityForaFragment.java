package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.ingles.manchestercity;
...
import com.jogos.dadosoficialkf228920.databinding.FragmentManchesterCityFora2023a24Binding;
...
public class ManchesterCityForaFragment extends Fragment {

    private FragmentManchesterCityFora2023a24Binding binding;
    private ManchesterCityForaPartidaApi manchesterCityForaPartidaApi;
    private ManchesterCityForaAdapter manchesterCityForaAdapter;



    public ManchesterCityForaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentManchesterCityFora2023a24Binding.inflate(inflater, container, false);
        ...
        manchesterCityForaPartidaApi.getManchesterCityFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    manchesterCityForaAdapter = new ManchesterCityForaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(manchesterCityForaAdapter);
