package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.alemanha.freiburg;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.alemanha.freiburg.FreiburgCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.augsburg.AugsburgCasaPartidaApi;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.alemanha.freiburg.FreiburgCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentAugsburgCasa2023a24Binding;
import com.jogos.dadosoficialkf228920.databinding.FragmentFreiburgCasa2023a24Binding;
...
public class FreiburgCasaFragment extends Fragment {

    private FragmentFreiburgCasa2023a24Binding binding;
    private FreiburgCasaPartidaApi freiburgCasaPartidaApi;
    private FreiburgCasaAdapter freiburgCasaAdapter;



    public FreiburgCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFreiburgCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/alemanha/freiburg/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        freiburgCasaPartidaApi = retrofit.create(FreiburgCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        freiburgCasaPartidaApi.getFreiburgCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    freiburgCasaAdapter = new FreiburgCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(freiburgCasaAdapter);
