...
import com.jogos.dadosoficialkf228920.adapter.italiaA2022a23.juventus.JuventusFora2022a23Adapter;
import com.jogos.dadosoficialkf228920.data.italiaA2022a23.juventus.JuventusForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentJuventusFora2022a23Binding;
        ...
        juventusForaA2022a23PartidaApi.getJuventusFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvJuventusFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvJuventusFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
