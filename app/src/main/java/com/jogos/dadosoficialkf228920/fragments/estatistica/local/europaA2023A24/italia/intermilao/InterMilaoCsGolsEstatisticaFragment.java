...
public class InterMilaoCsGolsEstatisticaFragment extends Fragment {
...
//                        GOLS ACIMA -----------------------------------------------------------------------------
                    ...
                    binding.tvTitulo.setText("ESTATÍSTICA DE GOLS " + partidas.get(0).getHomeTime().getName().toUpperCase());                    binding.tvTitulo.setText("ESTATÍSTICA DE GOLS " + partidas.get(0).getHomeTime().getName().toUpperCase() + " CASA");
