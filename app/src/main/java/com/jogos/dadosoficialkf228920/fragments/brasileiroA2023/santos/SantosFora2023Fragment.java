...
import com.jogos.dadosoficialkf228920.adapter.brasileiroA2023.santos.SantosForaA2023Adapter;
import com.jogos.dadosoficialkf228920.data.brasileiroA2023.santos.SantosForaA2023PartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentSantosForaA2023Binding;
...
public class SantosFora2023Fragment extends Fragment {

    private FragmentSantosForaA2023Binding binding;
    private SantosForaA2023Adapter santosForaA2023Adapter;
    private SantosForaA2023PartidaApi santosForaA2023PartidaApi;




    public SantosFora2023Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSantosForaA2023Binding.inflate(inflater, container, false);
        ...
        santosForaA2023PartidaApi.getSantosFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    santosForaA2023Adapter = new SantosForaA2023Adapter(partidas);
                    binding.rvSantosFora.setAdapter(santosForaA2023Adapter);
