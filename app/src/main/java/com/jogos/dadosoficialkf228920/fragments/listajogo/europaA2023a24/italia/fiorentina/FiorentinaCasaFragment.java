package com.jogos.dadosoficialkf228920.fragments.listajogo.europaA2023a24.italia.fiorentina;
...
import com.jogos.dadosoficialkf228920.adapter.europa2023a24.italia.fiorentina.FiorentinaCasaAdapter;
import com.jogos.dadosoficialkf228920.data.europaA2023a24.italia.fiorentina.FiorentinaCasaPartidaApi;
import com.jogos.dadosoficialkf228920.databinding.FragmentFiorentinaCasa2023a24Binding;
...
public class FiorentinaCasaFragment extends Fragment {

    private FragmentFiorentinaCasa2023a24Binding binding;
    private FiorentinaCasaPartidaApi fiorentinaCasaPartidaApi;
    private FiorentinaCasaAdapter fiorentinaCasaAdapter;



    public FiorentinaCasaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFiorentinaCasa2023a24Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/europa-a-2023-24/italiano/fiorentina/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        fiorentinaCasaPartidaApi = retrofit.create(FiorentinaCasaPartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        fiorentinaCasaPartidaApi.getFiorentinaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {

                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    fiorentinaCasaAdapter = new FiorentinaCasaAdapter(partidas);
                    binding.rvListaJogos.setAdapter(fiorentinaCasaAdapter);
