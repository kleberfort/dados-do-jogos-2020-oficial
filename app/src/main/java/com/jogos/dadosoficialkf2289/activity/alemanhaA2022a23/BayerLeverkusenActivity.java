...
import com.jogos.dadosoficialkf2289.fragments.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenCasa2022a23Fragment;
import com.jogos.dadosoficialkf2289.fragments.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenFora2022a23Fragment;
...
public class BayerLeverkusenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.avBayerLeverkusen.loadAd(adRequest);

        //configurar o adapter para abas
        FragmentPagerItemAdapter adapter = new FragmentPagerItemAdapter(
                getSupportFragmentManager(),
                FragmentPagerItems.with(getApplicationContext())
                        .add("Casa 2022-23", BayerLeverkusenCasa2022a23Fragment.class)
                        .add("Fora 2022-23", BayerLeverkusenFora2022a23Fragment.class)
                        .create()
        );
