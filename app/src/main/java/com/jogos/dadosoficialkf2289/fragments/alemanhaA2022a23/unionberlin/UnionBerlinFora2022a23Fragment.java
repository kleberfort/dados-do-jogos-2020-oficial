package com.jogos.dadosoficialkf2289.fragments.alemanhaA2022a23.unionberlin;
...
import com.jogos.dadosoficialkf2289.adapter.alemanhaA2022a23.unionberlin.UnionBerlinFora2022a23Adapter;
import com.jogos.dadosoficialkf2289.data.alemanhaA2022a23.unionberlin.UnionBerlinForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf2289.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.jogos.dadosoficialkf2289.databinding.FragmentStuttgartFora2022a23Binding;
import com.jogos.dadosoficialkf2289.databinding.FragmentUnionBerlinFora2022a23Binding;
...
public class UnionBerlinFora2022a23Fragment extends Fragment {


    private FragmentUnionBerlinFora2022a23Binding binding;
    private UnionBerlinForaA2022a23PartidaApi unionBerlinForaA2022a23PartidaApi;
    private UnionBerlinFora2022a23Adapter unionBerlinFora2022a23Adapter;

    public UnionBerlinFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentUnionBerlinFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/alemanha-a-2022-23/union-berlin/")
        ...
        unionBerlinForaA2022a23PartidaApi.getUnionBerlinFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    unionBerlinFora2022a23Adapter = new UnionBerlinFora2022a23Adapter(partidas);
                    binding.rvUnionBerlinFora.setAdapter(unionBerlinFora2022a23Adapter);

                    binding.rvUnionBerlinFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvUnionBerlinFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
