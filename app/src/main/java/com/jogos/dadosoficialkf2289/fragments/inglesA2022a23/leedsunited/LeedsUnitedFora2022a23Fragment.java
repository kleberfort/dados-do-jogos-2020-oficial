package com.jogos.dadosoficialkf2289.fragments.inglesA2022a23.leedsunited;
...
import com.jogos.dadosoficialkf2289.adapter.inglesA2022a2023.leedsunited.LeedsUnitedFora2022a23Adapter;
...
import com.jogos.dadosoficialkf2289.databinding.FragmentLeedsUnitedFora2022a23Binding;
        ...
        leedsUnitedForaA2022a23PartidaApi.getLeedsUnitedCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvLeedsUnitedFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvLeedsUnitedFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
