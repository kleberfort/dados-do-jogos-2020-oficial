...
import com.jogos.dadosoficialkf2289.adapter.brasileiroA2022.atleticoGO.AtleticoGoCasaA2022Adapter;
import com.jogos.dadosoficialkf2289.data.brasileiroSerieA2022.atleticoGO.AtleticoGoCasaA2022PartidaApi;
import com.jogos.dadosoficialkf2289.databinding.FragmentAmericaMgFora2022Binding;
        ...
        atleticoGoCasaA2022PartidaApi.getAtleticoGoCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvAlteticoGoCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvAlteticoGoCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
