package com.jogos.dadosoficialkf2289.fragments.alemanhaA2022a23.herthaberlin;
...
import com.jogos.dadosoficialkf2289.adapter.alemanhaA2022a23.herthaberlin.HerthaBerlinCasa2022a23Adapter;
import com.jogos.dadosoficialkf2289.data.alemanhaA2022a23.herthaberlin.HerthaBerlinCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf2289.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.jogos.dadosoficialkf2289.databinding.FragmentHerthaBerlinCasa2022a23Binding;
        ...
        herthaBerlinCasaA2022a23PartidaApi.getHerthaBerlinCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvHerthaBerlinCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvHerthaBerlinCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
