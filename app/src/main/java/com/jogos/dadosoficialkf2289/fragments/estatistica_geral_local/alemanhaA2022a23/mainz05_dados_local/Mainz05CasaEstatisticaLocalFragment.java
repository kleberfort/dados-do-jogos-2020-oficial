package com.jogos.dadosoficialkf2289.fragments.estatistica_geral_local.espanhaA2022a23.almeria_dados_geral.almeria_dados_local;
...
import com.jogos.dadosoficialkf2289.data.espanhaA2022a23.almeria.AlmeriaCasaA2022a23PartidaApi;
...
public class AlmeriaCasaEstatisticaLocalFragment extends Fragment {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()) {
                    ...
                    for (int i = 0; i < partidas.size(); i++) {
                        ...
                        //GOLS ACIMA 0.5
                        if(partidas.get(i).getHomeEstatisticaJogo().getGolsPrimeiroTempo() > 0  || partidas.get(i).getHomeEstatisticaJogo().getGolsSegundoTempo() > 0 )
                            golsTotalZeroCincoMarcados += 1;

                        //GOLS ACIMA 1.5
                        if((partidas.get(i).getHomeEstatisticaJogo().getGolsPrimeiroTempo()) + (partidas.get(i).getHomeEstatisticaJogo().getGolsSegundoTempo()) > 1)
                                golsTotalUmCincoMarcados += 1;


                        //GOLS ACIMA 2.5
                        if((partidas.get(i).getHomeEstatisticaJogo().getGolsPrimeiroTempo()) + (partidas.get(i).getHomeEstatisticaJogo().getGolsSegundoTempo()) > 2)
                            golsTotalDoisCincoMarcados += 1;

                        //AMBAS MARCAM 1° TEMPO
                        if(((partidas.get(i).getHomeEstatisticaJogo().getGolsPrimeiroTempo()) > 0) && ((partidas.get(i).getAwayEstatisticaJogo().getGolsPrimeiroTempo() > 0)))
                            totalAmbasMarcadosPrimeiroTempo += 1;

                        //AMBAS MARCAM 2° TEMPO
                        if(((partidas.get(i).getHomeEstatisticaJogo().getGolsSegundoTempo()) > 0) && ((partidas.get(i).getAwayEstatisticaJogo().getGolsSegundoTempo() > 0)))
                        ...
                        //ESCANTEIOS TOTAL >=6
                        if((partidas.get(i).getHomeEstatisticaJogo().getEscanteiosPrimeiroTempo() + partidas.get(i).getHomeEstatisticaJogo().getEscanteioSegundoTempo() >= 6))
                            escanteiosTotalMaiorIgualSeisMarcados += 1;

                        //ESCANTEIOS TOTAL >=7
                        if((partidas.get(i).getHomeEstatisticaJogo().getEscanteiosPrimeiroTempo() + partidas.get(i).getHomeEstatisticaJogo().getEscanteioSegundoTempo() >= 7))
                    ...
                    binding.tvEstatisticaJogos.setText("ESTATÍSTICA DO " + ( partidas.get(0).getHomeTime().getNome().toUpperCase()) + " CASA");
