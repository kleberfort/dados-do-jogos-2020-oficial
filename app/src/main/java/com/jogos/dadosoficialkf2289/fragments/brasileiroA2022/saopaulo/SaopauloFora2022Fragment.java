package com.jogos.dadosoficialkf2289.fragments.brasileiroA2022.saopaulo;
...
import com.jogos.dadosoficialkf2289.adapter.brasileiroA2022.saopaulo.SaopauloForaA2022Adapter;
import com.jogos.dadosoficialkf2289.data.brasileiroSerieA2022.saopaulo.SaopauloForaA2022PartidaApi;
import com.jogos.dadosoficialkf2289.databinding.FragmentAtleticoPRFora2022Binding;
import com.jogos.dadosoficialkf2289.databinding.FragmentSaopauloFora2022Binding;
...
public class SaopauloFora2022Fragment extends Fragment {

    private FragmentSaopauloFora2022Binding binding;
    private SaopauloForaA2022Adapter saopauloForaA2022Adapter;
    private SaopauloForaA2022PartidaApi saopauloForaA2022PartidaApi;


    public SaopauloFora2022Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSaopauloFora2022Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        saopauloForaA2022PartidaApi = retrofit.create(SaopauloForaA2022PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvSaopauloFora.setHasFixedSize(true);
        binding.rvSaopauloFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvSaopauloFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        saopauloForaA2022PartidaApi.getSaopauloFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    saopauloForaA2022Adapter = new SaopauloForaA2022Adapter(partidas);
                    binding.rvSaopauloFora.setAdapter(saopauloForaA2022Adapter);

                    binding.rvSaopauloFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvSaopauloFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
