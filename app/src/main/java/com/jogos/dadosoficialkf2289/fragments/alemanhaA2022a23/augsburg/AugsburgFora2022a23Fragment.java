...
import com.jogos.dadosoficialkf2289.adapter.alemanhaA2022a23.augsburg.AugsburgFora2022a23Adapter;
import com.jogos.dadosoficialkf2289.data.alemanhaA2022a23.augsburg.AugsburgForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf2289.databinding.FragmentAugsburgFora2022a23Binding;
        ...
        augsburgForaA2022a23PartidaApi.getAugsburgFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    augsburgFora2022a23Adapter = new AugsburgFora2022a23Adapter(partidas);
                    binding.rvAugsburgFora.setAdapter(augsburgFora2022a23Adapter);

                    binding.rvAugsburgFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvAugsburgFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
