...
import com.jogos.dadosoficialkf2289.adapter.brasileiroA2022.atleticoPR.AtleticoPrCasaA2022Adapter;
import com.jogos.dadosoficialkf2289.data.brasileiroSerieA2022.atleticoPR.AtleticoPrCasaA2022PartidaApi;
        ...
        atleticoPrCasaA2022PartidaApi.getAtleticoPrCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvAtleticoPrCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvAtleticoPrCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
