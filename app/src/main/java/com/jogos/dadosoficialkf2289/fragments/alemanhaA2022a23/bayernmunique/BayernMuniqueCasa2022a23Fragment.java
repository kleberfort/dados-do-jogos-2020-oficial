...
import com.jogos.dadosoficialkf2289.adapter.alemanhaA2022a23.bayernmunique.BayernMuniqueCasa2022a23Adapter;
import com.jogos.dadosoficialkf2289.data.alemanhaA2022a23.bayernmunique.BayernMuniqueCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf2289.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.jogos.dadosoficialkf2289.databinding.FragmentBayernMuniqueCasa2022a23Binding;
        ...
        bayernMuniqueCasaA2022a23PartidaApi.getBayernMuniqueCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvBayernMuniqueCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvBayernMuniqueCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
