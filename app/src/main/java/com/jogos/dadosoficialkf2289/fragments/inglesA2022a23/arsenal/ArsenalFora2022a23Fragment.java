package com.jogos.dadosoficialkf2289.fragments.inglesA2022a23.arsenal;
...
import com.jogos.dadosoficialkf2289.adapter.inglesA2022a2023.arsenal.ArsenalFora2022a23Adapter;
import com.jogos.dadosoficialkf2289.data.inglesA2022a23.arsenal.ArsenalForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf2289.databinding.FragmentArsenalCasa2022a23Binding;
import com.jogos.dadosoficialkf2289.databinding.FragmentArsenalFora2022a23Binding;
        ...
        arsenalForaA2022a23PartidaApi.getArsenalFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvArsenalFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvArsenalFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
