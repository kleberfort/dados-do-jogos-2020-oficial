package com.jogos.dadosoficialkf2289.fragments.espanhaA2022a23.athleticbilbao;
...
import com.jogos.dadosoficialkf2289.adapter.espanhaA2022a23.athleticbilbao.AthleticBilbaoFora2022a23Adapter;
import com.jogos.dadosoficialkf2289.data.espanhaA2022a23.athleticbilbao.AthleticBilbaoForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf2289.databinding.FragmentAthleticBilbaoFora2022a23Binding;
...
public class AthleticBilbaoFora2022a23Fragment extends Fragment {


    private FragmentAthleticBilbaoFora2022a23Binding binding;
    private AthleticBilbaoForaA2022a23PartidaApi athleticBilbaoForaA2022a23PartidaApi;
    private AthleticBilbaoFora2022a23Adapter athleticBilbaoFora2022a23Adapter;

    public AthleticBilbaoFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAthleticBilbaoFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        athleticBilbaoForaA2022a23PartidaApi = retrofit.create(AthleticBilbaoForaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvAthleticBilbaoFora.setHasFixedSize(true);
        binding.rvAthleticBilbaoFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvAthleticBilbaoFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        athleticBilbaoForaA2022a23PartidaApi.getAthleticBilbaoFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    athleticBilbaoFora2022a23Adapter = new AthleticBilbaoFora2022a23Adapter(partidas);
                    binding.rvAthleticBilbaoFora.setAdapter(athleticBilbaoFora2022a23Adapter);

                    binding.rvAthleticBilbaoFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvAthleticBilbaoFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
