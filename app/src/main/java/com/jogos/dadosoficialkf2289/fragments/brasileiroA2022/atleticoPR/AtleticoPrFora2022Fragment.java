package com.jogos.dadosoficialkf2289.fragments.brasileiroA2022.atleticoPR;
...
import com.jogos.dadosoficialkf2289.adapter.brasileiroA2022.atleticoPR.AtleticoPrForaA2022Adapter;
import com.jogos.dadosoficialkf2289.data.brasileiroSerieA2022.atleticoPR.AtleticoPrForaA2022PartidaApi;
import com.jogos.dadosoficialkf2289.databinding.FragmentAtleticoMgFora2022Binding;
import com.jogos.dadosoficialkf2289.databinding.FragmentAtleticoPRCasa2022Binding;
        ...
        atleticoPrForaA2022PartidaApi.getAtleticoPrFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvAtleticoPrFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvAtleticoPrFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
