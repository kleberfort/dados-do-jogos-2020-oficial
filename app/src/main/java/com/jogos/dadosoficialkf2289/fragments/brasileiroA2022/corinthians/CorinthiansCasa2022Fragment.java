package com.jogos.dadosoficialkf2289.fragments.brasileiroA2022.corinthians;
...
import com.jogos.dadosoficialkf2289.adapter.brasileiroA2022.corinthians.CorinthiansCasaA2022Adapter;
import com.jogos.dadosoficialkf2289.data.brasileiroSerieA2022.corinthians.CorinthiansCasaA2022PartidaApi;
import com.jogos.dadosoficialkf2289.databinding.FragmentAtleticoPRFora2022Binding;
import com.jogos.dadosoficialkf2289.databinding.FragmentCorinthiansCasa2022Binding;
...
public class CorinthiansCasa2022Fragment extends Fragment {
    ...
    private FragmentCorinthiansCasa2022Binding binding;
    private CorinthiansCasaA2022Adapter corinthiansCasaA2022Adapter;
    private CorinthiansCasaA2022PartidaApi corinthiansCasaA2022PartidaApi;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentCorinthiansCasa2022Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        corinthiansCasaA2022PartidaApi = retrofit.create(CorinthiansCasaA2022PartidaApi.class);
    }
    ...
    private void setupDadosJogos() {
        ...
        corinthiansCasaA2022PartidaApi.getCorinthiansCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    corinthiansCasaA2022Adapter = new CorinthiansCasaA2022Adapter(partidas);
                    binding.rvCorinthiansCasa.setAdapter(corinthiansCasaA2022Adapter);
