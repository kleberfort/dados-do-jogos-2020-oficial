package com.jogos.dadosoficialkf2289.fragments.alemanhaA2022a23.wolfsburg;
...
import com.jogos.dadosoficialkf2289.adapter.alemanhaA2022a23.wolfsburg.WolfburgFora2022a23Adapter;
import com.jogos.dadosoficialkf2289.data.alemanhaA2022a23.wolfsburg.WolfsburgForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf2289.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.jogos.dadosoficialkf2289.databinding.FragmentWolfsburgFora2022a23Binding;
...
public class WolfsburgFora2022a23Fragment extends Fragment {
    ...
    private WolfsburgForaA2022a23PartidaApi wolfsburgForaA2022a23PartidaApi;
    private WolfburgFora2022a23Adapter wolfburgFora2022a23Adapter;
    ...
    private void setupHttpClient() {
        ...
        wolfsburgForaA2022a23PartidaApi = retrofit.create(WolfsburgForaA2022a23PartidaApi.class);
    ...
    private void setupDadosJogos() {
        ...
        wolfsburgForaA2022a23PartidaApi.getWolfsburgFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    wolfburgFora2022a23Adapter = new WolfburgFora2022a23Adapter(partidas);
                    binding.rvWolfsburgFora.setAdapter(wolfburgFora2022a23Adapter);

                    binding.rvWolfsburgFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvWolfsburgFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
