package com.jogos.dadosoficialkf2289.fragments.brasileiroA2022.bragantino;
...
import com.jogos.dadosoficialkf2289.adapter.brasileiroA2022.bragantino.BragantinoForaA2022Adapter;
import com.jogos.dadosoficialkf2289.data.brasileiroSerieA2022.bragantino.BragantinoForaA2022PartidaApi;
import com.jogos.dadosoficialkf2289.databinding.FragmentAtleticoPRFora2022Binding;
import com.jogos.dadosoficialkf2289.databinding.FragmentBragantinoFora2022Binding;
...
public class BragantinoFora2022Fragment extends Fragment {

    private FragmentBragantinoFora2022Binding binding;
    private BragantinoForaA2022Adapter bragantinoForaA2022Adapter;
    private BragantinoForaA2022PartidaApi bragantinoForaA2022PartidaApi;



    public BragantinoFora2022Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBragantinoFora2022Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        bragantinoForaA2022PartidaApi = retrofit.create(BragantinoForaA2022PartidaApi.class);
    }
    ...
    private void setupDadosJogos() {
        ...
        bragantinoForaA2022PartidaApi.getBragantinoFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    bragantinoForaA2022Adapter = new BragantinoForaA2022Adapter(partidas);
                    binding.rvBragantinoFora.setAdapter(bragantinoForaA2022Adapter);
