package com.jogos.dadosoficialkf2289.fragments.italiaA2022a23.fiorentina;
...
import com.jogos.dadosoficialkf2289.adapter.italiaA2022a23.fiorentina.FiorentinaFora2022a23Adapter;
import com.jogos.dadosoficialkf2289.data.italiaA2022a23.fiorentina.FiorentinaForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf2289.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.jogos.dadosoficialkf2289.databinding.FragmentFiorentinaFora2022a23Binding;
        ...
        fiorentinaForaA2022a23PartidaApi.getFiorentinaFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvFiorentiaFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvFiorentiaFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
