package com.jogos.dadosoficialkf2289.fragments.alemanhaA2022a23.stuttgart;
...
import com.jogos.dadosoficialkf2289.adapter.alemanhaA2022a23.stuttgart.StuttgartFora2022a23Adapter;
import com.jogos.dadosoficialkf2289.data.alemanhaA2022a23.stuttgart.StuttgartForaA2022a23PartidaApi;
        ...
        stuttgartForaA2022a23PartidaApi.getStuttgartFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvStuttgartFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvStuttgartFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
