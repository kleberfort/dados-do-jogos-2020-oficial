...
import com.jogos.dadosoficialkf2289.adapter.inglesA2022a2023.wolverhampton.WolverhamptonFora2022a23Adapter;
import com.jogos.dadosoficialkf2289.data.inglesA2022a23.wolverhampton.WolverhamptonForaA2022a23PartidaApi;
...
import com.jogos.dadosoficialkf2289.databinding.FragmentWolverhamptonFora2022a23Binding;
...
public class WolverhamptonFora2022a23Fragment extends Fragment {

    private FragmentWolverhamptonFora2022a23Binding binding;
    private WolverhamptonForaA2022a23PartidaApi wolverhamptonForaA2022a23PartidaApi;
    private WolverhamptonFora2022a23Adapter wolverhamptonFora2022a23Adapter;


    public WolverhamptonFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentWolverhamptonFora2022a23Binding.inflate(inflater, container, false);
        ...
        wolverhamptonForaA2022a23PartidaApi.getWolverhamptonFora().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    wolverhamptonFora2022a23Adapter = new WolverhamptonFora2022a23Adapter(partidas);
                    binding.rvWolverhamptonFora.setAdapter(wolverhamptonFora2022a23Adapter);

                    binding.rvWolverhamptonFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvWolverhamptonFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
