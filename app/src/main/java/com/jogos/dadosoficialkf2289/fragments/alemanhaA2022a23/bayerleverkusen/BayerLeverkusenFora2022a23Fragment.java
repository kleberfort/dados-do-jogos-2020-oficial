package com.jogos.dadosoficialkf2289.fragments.alemanhaA2022a23.bayerleverkusen;
...
import com.jogos.dadosoficialkf2289.adapter.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenFora2022a23Adapter;
import com.jogos.dadosoficialkf2289.data.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf2289.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.jogos.dadosoficialkf2289.databinding.FragmentBayerLeverkusenFora2022a23Binding;
...
public class BayerLeverkusenFora2022a23Fragment extends Fragment {



    private FragmentBayerLeverkusenFora2022a23Binding binding;
    private BayerLeverkusenForaA2022a23PartidaApi bayerLeverkusenForaA2022a23PartidaApi;
    private BayerLeverkusenFora2022a23Adapter bayerLeverkusenFora2022a23Adapter;

    public BayerLeverkusenFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBayerLeverkusenFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        bayerLeverkusenForaA2022a23PartidaApi = retrofit.create(BayerLeverkusenForaA2022a23PartidaApi.class);

    }

    private void setupDadosJogos() {
        binding.rvBayerLeverkusenFora.setHasFixedSize(true);
        binding.rvBayerLeverkusenFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvBayerLeverkusenFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        bayerLeverkusenForaA2022a23PartidaApi.getBayerLeverkusenFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    bayerLeverkusenFora2022a23Adapter = new BayerLeverkusenFora2022a23Adapter(partidas);
                    binding.rvBayerLeverkusenFora.setAdapter(bayerLeverkusenFora2022a23Adapter);

                    binding.rvBayerLeverkusenFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvBayerLeverkusenFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
