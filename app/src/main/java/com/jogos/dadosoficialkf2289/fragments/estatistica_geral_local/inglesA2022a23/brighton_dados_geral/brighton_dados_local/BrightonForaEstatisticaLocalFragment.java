package com.jogos.dadosoficialkf2289.fragments.estatistica_geral_local.inglesA2022a23.brighton_dados_geral.brighton_dados_local;
...
public class BrightonForaEstatisticaLocalFragment extends Fragment {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()) {
                    ...
                    for (int i = 0; i < partidas.size(); i++) {
                        ...
                        //GOLS ACIMA 1.5
                        if(
                                (partidas.get(i).getAwayEstatisticaJogo().getGolsPrimeiroTempo()) + (partidas.get(i).getAwayEstatisticaJogo().getGolsSegundoTempo()) > 1){
                        ...
                        //GOLS ACIMA 2.5
                        if(
                                (partidas.get(i).getAwayEstatisticaJogo().getGolsPrimeiroTempo()) + (partidas.get(i).getAwayEstatisticaJogo().getGolsSegundoTempo()) > 2
                        ){
                        ...
                        if(((partidas.get(i).getAwayEstatisticaJogo().getGolsPrimeiroTempo()) > 0) &&
                                ((partidas.get(i).getHomeEstatisticaJogo().getGolsPrimeiroTempo() > 0))){
                        ...
                        //ESCANTEIOS TOTAL >=7
                        if((partidas.get(i).getAwayEstatisticaJogo().getEscanteiosPrimeiroTempo() +
                                partidas.get(i).getAwayEstatisticaJogo().getEscanteioSegundoTempo() >= 7)
