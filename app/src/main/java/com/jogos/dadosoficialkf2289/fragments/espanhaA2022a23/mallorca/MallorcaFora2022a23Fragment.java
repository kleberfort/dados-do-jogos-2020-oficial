package com.jogos.dadosoficialkf2289.fragments.espanhaA2022a23.mallorca;
...
import com.jogos.dadosoficialkf2289.adapter.espanhaA2022a23.mallorca.MallorcaFora2022a23Adapter;
import com.jogos.dadosoficialkf2289.data.espanhaA2022a23.mallorca.MallorcaForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf2289.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.jogos.dadosoficialkf2289.databinding.FragmentMallorcaCasa2022a23Binding;
import com.jogos.dadosoficialkf2289.databinding.FragmentMallorcaFora2022a23Binding;
...
public class MallorcaFora2022a23Fragment extends Fragment {
    ...
    private void setupHttpClient() {
        ...
        mallorcaForaA2022a23PartidaApi = retrofit.create(MallorcaForaA2022a23PartidaApi.class);
    }
    ...
    private void setupDadosJogos() {
        ...
        mallorcaForaA2022a23PartidaApi.getMallorcaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    mallorcaFora2022a23Adapter = new MallorcaFora2022a23Adapter(partidas);
                    binding.rvMallorcaFora.setAdapter(mallorcaFora2022a23Adapter);

                    binding.rvMallorcaFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvMallorcaFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
