package com.jogos.dadosoficialkf2289.fragments.italiaA2022a23.bologna;
...
import com.jogos.dadosoficialkf2289.adapter.italiaA2022a23.bologna.BolognaFora2022a23Adapter;
import com.jogos.dadosoficialkf2289.data.italiaA2022a23.bologna.BolognaForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf2289.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.jogos.dadosoficialkf2289.databinding.FragmentBolognaFora2022a23Binding;
...
public class BolognaFora2022a23Fragment extends Fragment {

    private FragmentBolognaFora2022a23Binding binding;
    private BolognaForaA2022a23PartidaApi bolognaForaA2022a23PartidaApi;
    private BolognaFora2022a23Adapter bolognaFora2022a23Adapter;

    public BolognaFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBolognaFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        bolognaForaA2022a23PartidaApi = retrofit.create(BolognaForaA2022a23PartidaApi.class);

    }

    private void setupDadosJogos() {
        binding.rvBolognaFora.setHasFixedSize(true);
        binding.rvBolognaFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvBolognaFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        bolognaForaA2022a23PartidaApi.getBolognaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    bolognaFora2022a23Adapter = new BolognaFora2022a23Adapter(partidas);
                    binding.rvBolognaFora.setAdapter(bolognaFora2022a23Adapter);

                    binding.rvBolognaFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvBolognaFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
