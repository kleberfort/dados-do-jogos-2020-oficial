package com.jogos.dadosoficialkf2289.fragments.italiaA2022a23.milan;
...
import com.jogos.dadosoficialkf2289.adapter.italiaA2022a23.milan.MilanFora2022a23Adapter;
import com.jogos.dadosoficialkf2289.data.italiaA2022a23.milan.MilanForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf2289.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.jogos.dadosoficialkf2289.databinding.FragmentInterMilaoFora2022a23Binding;
import com.jogos.dadosoficialkf2289.databinding.FragmentMilanFora2022a23Binding;
...
public class MilanFora2022a23Fragment extends Fragment {

    private FragmentMilanFora2022a23Binding binding;
    private MilanForaA2022a23PartidaApi milanForaA2022a23PartidaApi;
    private MilanFora2022a23Adapter milanFora2022a23Adapter;


    public MilanFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentMilanFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/italia-a-2022-23/milan/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        milanForaA2022a23PartidaApi = retrofit.create(MilanForaA2022a23PartidaApi.class);

    }

    private void setupDadosJogos() {
        binding.rvMilanFora.setHasFixedSize(true);
        binding.rvMilanFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvMilanFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        milanForaA2022a23PartidaApi.getMilanFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    milanFora2022a23Adapter = new MilanFora2022a23Adapter(partidas);
                    binding.rvMilanFora.setAdapter(milanFora2022a23Adapter);

                    binding.rvMilanFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvMilanFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
