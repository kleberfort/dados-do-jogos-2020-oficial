package com.jogos.dadosoficialkf2289.fragments.espanhaA2022a23.cadiz;
...
import com.jogos.dadosoficialkf2289.adapter.espanhaA2022a23.cadiz.CadizCasa2022a23Adapter;
import com.jogos.dadosoficialkf2289.data.espanhaA2022a23.cadiz.CadizCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf2289.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.jogos.dadosoficialkf2289.databinding.FragmentCadizCasa2022a23Binding;
        ...
        cadizCasaA2022a23PartidaApi.getCadizCasa().enqueue(new Callback<List<Partida>>() {
            ...
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    ...
                    binding.rvCadizCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvCadizCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
