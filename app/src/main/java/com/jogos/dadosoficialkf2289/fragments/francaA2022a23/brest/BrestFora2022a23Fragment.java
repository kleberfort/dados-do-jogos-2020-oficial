package com.jogos.dadosoficialkf2289.fragments.francaA2022a23.brest_dados_geral;
...
import com.jogos.dadosoficialkf2289.adapter.francaA2022a23.brest.BrestFora2022a23Adapter;
import com.jogos.dadosoficialkf2289.data.francaA2022a23.brest.BrestForaA2022a23PartidaApi;
import com.jogos.dadosoficialkf2289.databinding.FragmentBrestFora2022a23Binding;
...
public class BrestFora2022a23Fragment extends Fragment {

    private FragmentBrestFora2022a23Binding binding;
    private BrestForaA2022a23PartidaApi brestForaA2022a23PartidaApi;
    private BrestFora2022a23Adapter brestFora2022a23Adapter;


    public BrestFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBrestFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        brestForaA2022a23PartidaApi = retrofit.create(BrestForaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvBrestFora.setHasFixedSize(true);
        binding.rvBrestFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvBrestFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        brestForaA2022a23PartidaApi.getBrestFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    brestFora2022a23Adapter = new BrestFora2022a23Adapter(partidas);
                    binding.rvBrestFora.setAdapter(brestFora2022a23Adapter);

                    binding.rvBrestFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvBrestFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
