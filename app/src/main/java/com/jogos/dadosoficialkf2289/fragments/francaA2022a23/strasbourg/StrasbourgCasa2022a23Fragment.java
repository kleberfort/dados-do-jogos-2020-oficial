package com.jogos.dadosoficialkf2289.fragments.francaA2022a23.strasbourg;
...
import com.jogos.dadosoficialkf2289.adapter.francaA2022a23.strasbourg.StrasbourgCasa2022a23Adapter;
import com.jogos.dadosoficialkf2289.data.francaA2022a23.strasbourg.StrasbourgCasaA2022a23PartidaApi;
import com.jogos.dadosoficialkf2289.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.jogos.dadosoficialkf2289.databinding.FragmentStrasbourgCasa2022a23Binding;
import com.jogos.dadosoficialkf2289.databinding.FragmentStrasbourgFora2022a23Binding;
...
public class StrasbourgCasa2022a23Fragment extends Fragment {

    private FragmentStrasbourgCasa2022a23Binding binding;
    private StrasbourgCasaA2022a23PartidaApi strasbourgCasaA2022a23PartidaApi;
    private StrasbourgCasa2022a23Adapter strasbourgCasa2022a23Adapter;


    public StrasbourgCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentStrasbourgCasa2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        strasbourgCasaA2022a23PartidaApi = retrofit.create(StrasbourgCasaA2022a23PartidaApi.class);


    }

    private void setupDadosJogos() {
        binding.rvStrasbourgCasa.setHasFixedSize(true);
        binding.rvStrasbourgCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvStrasbourgCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        strasbourgCasaA2022a23PartidaApi.getStrasbourgCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    strasbourgCasa2022a23Adapter = new StrasbourgCasa2022a23Adapter(partidas);
                    binding.rvStrasbourgCasa.setAdapter(strasbourgCasa2022a23Adapter);

                    binding.rvStrasbourgCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvStrasbourgCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
