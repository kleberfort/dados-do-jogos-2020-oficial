...
import com.example.dadosdosjogos2020oficial.fragments.francaA2022a23.nice.NiceCasa2022a23Fragment;
import com.example.dadosdosjogos2020oficial.fragments.francaA2022a23.nice.NiceFora2022a23Fragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FragmentPagerItemAdapter adapter = new FragmentPagerItemAdapter(
                ...
                FragmentPagerItems.with(getApplicationContext())
                        .add("Casa 2022", NiceCasa2022a23Fragment.class)
                        .add("Fora 2022", NiceFora2022a23Fragment.class)
                        .create()
        );
