...
import com.example.dadosdosjogos2020oficial.fragments.espanhaA2022a23.mallorca.MallorcaCasa2022a23Fragment;
import com.example.dadosdosjogos2020oficial.fragments.espanhaA2022a23.mallorca.MallorcaFora2022a23Fragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FragmentPagerItemAdapter adapter = new FragmentPagerItemAdapter(
                ...
                FragmentPagerItems.with(getApplicationContext())
                        .add("Casa 2022", MallorcaCasa2022a23Fragment.class)
                        .add("Fora 2022", MallorcaFora2022a23Fragment.class)
                        .create()
        );
