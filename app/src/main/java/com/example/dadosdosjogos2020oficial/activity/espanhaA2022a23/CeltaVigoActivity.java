...
import com.example.dadosdosjogos2020oficial.fragments.espanhaA2022a23.celtavigo.CeltaVigoCasa2022a23Fragment;
import com.example.dadosdosjogos2020oficial.fragments.espanhaA2022a23.celtavigo.CeltaVigoFora2022a23Fragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FragmentPagerItemAdapter adapter = new FragmentPagerItemAdapter(
                ...
                FragmentPagerItems.with(getApplicationContext())
                        .add("Casa 2022", CeltaVigoCasa2022a23Fragment.class)
                        .add("Fora 2022", CeltaVigoFora2022a23Fragment.class)
                        .create()
        );
