...
import com.example.dadosdosjogos2020oficial.fragments.alemanhaA2022a23.bayernmunique.BayernMuniqueCasa2022a23Fragment;
import com.example.dadosdosjogos2020oficial.fragments.alemanhaA2022a23.bayernmunique.BayernMuniqueFora2022a23Fragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FragmentPagerItemAdapter adapter = new FragmentPagerItemAdapter(
                ...
                FragmentPagerItems.with(getApplicationContext())
                        .add("Casa 2022", BayernMuniqueCasa2022a23Fragment.class)
                        .add("Fora 2022", BayernMuniqueFora2022a23Fragment.class)
                        .create()
        );
