...
import com.example.dadosdosjogos2020oficial.fragments.alemanhaA2022a23.freiburg.FreiburgCasa2022a23Fragment;
import com.example.dadosdosjogos2020oficial.fragments.alemanhaA2022a23.freiburg.FreiburgFora2022a23Fragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FragmentPagerItemAdapter adapter = new FragmentPagerItemAdapter(
                ...
                FragmentPagerItems.with(getApplicationContext())
                        .add("Casa 2022", FreiburgCasa2022a23Fragment.class)
                        .add("Fora 2022", FreiburgFora2022a23Fragment.class)
                        .create()
        );
