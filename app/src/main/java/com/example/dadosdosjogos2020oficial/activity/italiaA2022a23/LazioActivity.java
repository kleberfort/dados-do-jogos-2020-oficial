...
import com.example.dadosdosjogos2020oficial.fragments.italiaA2022a23.lazio.LazioCasa2022a23Fragment;
import com.example.dadosdosjogos2020oficial.fragments.italiaA2022a23.lazio.LazioFora2022a23Fragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FragmentPagerItemAdapter adapter = new FragmentPagerItemAdapter(
                ...
                FragmentPagerItems.with(getApplicationContext())
                        .add("Casa 2022", LazioCasa2022a23Fragment.class)
                        .add("Fora 2022", LazioFora2022a23Fragment.class)
                        .create()
        );
