package com.example.dadosdosjogos2020oficial.fragments.espanhaA2022a23.girona;
...
import com.example.dadosdosjogos2020oficial.adapter.espanhaA2022a23.girona.GironaCasa2022a23Adapter;
import com.example.dadosdosjogos2020oficial.data.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.data.espanhaA2022a23.girona.GironaCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.example.dadosdosjogos2020oficial.databinding.FragmentGironaCasa2022a23Binding;
...
public class GironaCasa2022a23Fragment extends Fragment {

    private FragmentGironaCasa2022a23Binding binding;
    private GironaCasaA2022a23PartidaApi gironaCasaA2022a23PartidaApi;
    private GironaCasa2022a23Adapter gironaCasa2022a23Adapter;

    public GironaCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentGironaCasa2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/espanhol-a-2022-23/girona/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        gironaCasaA2022a23PartidaApi = retrofit.create(GironaCasaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvGironaCasa.setHasFixedSize(true);
        binding.rvGironaCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvGironaCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        gironaCasaA2022a23PartidaApi.getGironaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    gironaCasa2022a23Adapter = new GironaCasa2022a23Adapter(partidas);
                    binding.rvGironaCasa.setAdapter(gironaCasa2022a23Adapter);

                    binding.rvGironaCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvGironaCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
