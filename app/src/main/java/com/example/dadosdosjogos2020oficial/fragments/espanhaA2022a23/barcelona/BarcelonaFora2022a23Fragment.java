package com.example.dadosdosjogos2020oficial.fragments.espanhaA2022a23.barcelona;
...
import com.example.dadosdosjogos2020oficial.adapter.espanhaA2022a23.barcelona.BarcelonaFora2022a23Adapter;
import com.example.dadosdosjogos2020oficial.data.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.data.espanhaA2022a23.barcelona.BarcelonaForaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.databinding.FragmentBarcelonaCasa2022a23Binding;
import com.example.dadosdosjogos2020oficial.databinding.FragmentBarcelonaFora2022a23Binding;
...
public class BarcelonaFora2022a23Fragment extends Fragment {


    private FragmentBarcelonaFora2022a23Binding binding;
    private BarcelonaForaA2022a23PartidaApi barcelonaForaA2022a23PartidaApi;
    private BarcelonaFora2022a23Adapter barcelonaFora2022a23Adapter;


    public BarcelonaFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBarcelonaFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        barcelonaForaA2022a23PartidaApi = retrofit.create(BarcelonaForaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvBarcelonaFora.setHasFixedSize(true);
        binding.rvBarcelonaFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvBarcelonaFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        barcelonaForaA2022a23PartidaApi.getBarcelonaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    barcelonaFora2022a23Adapter = new BarcelonaFora2022a23Adapter(partidas);
                    binding.rvBarcelonaFora.setAdapter(barcelonaFora2022a23Adapter);

                    binding.rvBarcelonaFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvBarcelonaFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
