...
import com.example.dadosdosjogos2020oficial.adapter.espanhaA2022a23.girona.GironaFora2022a23Adapter;
import com.example.dadosdosjogos2020oficial.data.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.data.espanhaA2022a23.girona.GironaForaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.example.dadosdosjogos2020oficial.databinding.FragmentGironaFora2022a23Binding;
...
public class GironaFora2022a23Fragment extends Fragment {


    private FragmentGironaFora2022a23Binding binding;
    private GironaForaA2022a23PartidaApi gironaForaA2022a23PartidaApi;
    private GironaFora2022a23Adapter gironaFora2022a23Adapter;


    public GironaFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentGironaFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        gironaForaA2022a23PartidaApi = retrofit.create(GironaForaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvGironaFora.setHasFixedSize(true);
        binding.rvGironaFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvGironaFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        gironaForaA2022a23PartidaApi.getGironaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    gironaFora2022a23Adapter = new GironaFora2022a23Adapter(partidas);
                    binding.rvGironaFora.setAdapter(gironaFora2022a23Adapter);

                    binding.rvGironaFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvGironaFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
