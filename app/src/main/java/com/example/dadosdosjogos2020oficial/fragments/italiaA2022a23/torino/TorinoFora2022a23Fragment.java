...
import com.example.dadosdosjogos2020oficial.adapter.italiaA2022a23.torino.TorinoFora2022a23Adapter;
import com.example.dadosdosjogos2020oficial.data.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.data.italiaA2022a23.torino.TorinoForaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.example.dadosdosjogos2020oficial.databinding.FragmentTorinoFora2022a23Binding;
...
public class TorinoFora2022a23Fragment extends Fragment {

    private FragmentTorinoFora2022a23Binding binding;
    private TorinoForaA2022a23PartidaApi torinoForaA2022a23PartidaApi;
    private TorinoFora2022a23Adapter torinoFora2022a23Adapter;


    public TorinoFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentTorinoFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        torinoForaA2022a23PartidaApi = retrofit.create(TorinoForaA2022a23PartidaApi.class);

    }

    private void setupDadosJogos() {
        binding.rvTorinoFora.setHasFixedSize(true);
        binding.rvTorinoFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvTorinoFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        torinoForaA2022a23PartidaApi.getTorinoFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    torinoFora2022a23Adapter = new TorinoFora2022a23Adapter(partidas);
                    binding.rvTorinoFora.setAdapter(torinoFora2022a23Adapter);

                    binding.rvTorinoFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvTorinoFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
