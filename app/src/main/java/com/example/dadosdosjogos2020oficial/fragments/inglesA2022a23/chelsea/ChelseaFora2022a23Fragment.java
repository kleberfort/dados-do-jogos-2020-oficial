...
import com.example.dadosdosjogos2020oficial.adapter.inglesA2022a2023.chelsea.ChelseaFora2022a23Adapter;
import com.example.dadosdosjogos2020oficial.data.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.data.inglesA2022a23.chelsea.ChelseaForaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.example.dadosdosjogos2020oficial.databinding.FragmentChelseaFora2022a23Binding;
...
public class ChelseaFora2022a23Fragment extends Fragment {

    private FragmentChelseaFora2022a23Binding binding;
    private ChelseaForaA2022a23PartidaApi chelseaForaA2022a23PartidaApi;
    private ChelseaFora2022a23Adapter chelseaFora2022a23Adapter;

    public ChelseaFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentChelseaFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        chelseaForaA2022a23PartidaApi = retrofit.create(ChelseaForaA2022a23PartidaApi.class);


    }

    private void setupDadosJogos() {
        binding.rvChelseaFora.setHasFixedSize(true);
        binding.rvChelseaFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvChelseaFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        chelseaForaA2022a23PartidaApi.getChelseaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    chelseaFora2022a23Adapter = new ChelseaFora2022a23Adapter(partidas);
                    binding.rvChelseaFora.setAdapter(chelseaFora2022a23Adapter);

                    binding.rvChelseaFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvChelseaFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
