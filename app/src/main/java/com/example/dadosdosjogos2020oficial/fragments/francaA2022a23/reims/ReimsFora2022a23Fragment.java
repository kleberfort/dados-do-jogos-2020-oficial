package com.example.dadosdosjogos2020oficial.fragments.francaA2022a23.reims;
...
import com.example.dadosdosjogos2020oficial.adapter.francaA2022a23.reims.ReimsFora2022a23Adapter;
import com.example.dadosdosjogos2020oficial.data.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.data.francaA2022a23.reims.ReimsForaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.example.dadosdosjogos2020oficial.databinding.FragmentReimsFora2022a23Binding;
...
public class ReimsFora2022a23Fragment extends Fragment {

    private FragmentReimsFora2022a23Binding binding;
    private ReimsForaA2022a23PartidaApi reimsForaA2022a23PartidaApi;
    private ReimsFora2022a23Adapter reimsFora2022a23Adapter;



    public ReimsFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentReimsFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/franca-a-2022-23/reims/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        reimsForaA2022a23PartidaApi = retrofit.create(ReimsForaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvReimsFora.setHasFixedSize(true);
        binding.rvReimsFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvReimsFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        reimsForaA2022a23PartidaApi.getReimsFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    reimsFora2022a23Adapter = new ReimsFora2022a23Adapter(partidas);
                    binding.rvReimsFora.setAdapter(reimsFora2022a23Adapter);

                    binding.rvReimsFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvReimsFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
