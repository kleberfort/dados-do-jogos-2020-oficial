...
import com.example.dadosdosjogos2020oficial.adapter.espanhaA2022a23.villarreal.VillarrealFora2022a23Adapter;
import com.example.dadosdosjogos2020oficial.data.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.data.espanhaA2022a23.villarreal.VillarrealForaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.example.dadosdosjogos2020oficial.databinding.FragmentVillarrealFora2022a23Binding;
...
public class VillarrealFora2022a23Fragment extends Fragment {

    private FragmentVillarrealFora2022a23Binding binding;
    private VillarrealForaA2022a23PartidaApi villarrealForaA2022a23PartidaApi;
    private VillarrealFora2022a23Adapter villarrealFora2022a23Adapter;

    public VillarrealFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentVillarrealFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        villarrealForaA2022a23PartidaApi = retrofit.create(VillarrealForaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvVillarrealFora.setHasFixedSize(true);
        binding.rvVillarrealFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvVillarrealFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        villarrealForaA2022a23PartidaApi.getVillarrealFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    villarrealFora2022a23Adapter = new VillarrealFora2022a23Adapter(partidas);
                    binding.rvVillarrealFora.setAdapter(villarrealFora2022a23Adapter);

                    binding.rvVillarrealFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvVillarrealFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
