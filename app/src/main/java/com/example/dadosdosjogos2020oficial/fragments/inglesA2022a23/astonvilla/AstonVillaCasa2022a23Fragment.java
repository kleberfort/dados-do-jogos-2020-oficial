package com.example.dadosdosjogos2020oficial.fragments.inglesA2022a23.astonvilla;
...
import com.example.dadosdosjogos2020oficial.adapter.inglesA2022a2023.astonvilla.AstonVillaCasa2022a23Adapter;
import com.example.dadosdosjogos2020oficial.data.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.data.inglesA2022a23.astonvilla.AstonVillaCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.databinding.FragmentAstonVillaCasa2022a23Binding;
...
public class AstonVillaCasa2022a23Fragment extends Fragment {

    private FragmentAstonVillaCasa2022a23Binding binding;
    private AstonVillaCasaA2022a23PartidaApi astonVillaCasaA2022a23PartidaApi;
    private AstonVillaCasa2022a23Adapter astonVillaCasa2022a23Adapter;

    public AstonVillaCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAstonVillaCasa2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/ingles-a-2022-23/aston-villa/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        astonVillaCasaA2022a23PartidaApi = retrofit.create(AstonVillaCasaA2022a23PartidaApi.class);


    }

    private void setupDadosJogos() {
        binding.rvAstonVillaCasa.setHasFixedSize(true);
        binding.rvAstonVillaCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvAstonVillaCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        astonVillaCasaA2022a23PartidaApi.getAstonVillaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    astonVillaCasa2022a23Adapter = new AstonVillaCasa2022a23Adapter(partidas);
                    binding.rvAstonVillaCasa.setAdapter(astonVillaCasa2022a23Adapter);

                    binding.rvAstonVillaCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvAstonVillaCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
