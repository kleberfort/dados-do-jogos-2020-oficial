package com.example.dadosdosjogos2020oficial.fragments.espanhaA2022a23.realmadrid;
...
import com.example.dadosdosjogos2020oficial.adapter.espanhaA2022a23.realmadrid.RealMadridCasa2022a23Adapter;
import com.example.dadosdosjogos2020oficial.data.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.data.espanhaA2022a23.realmadrid.RealMadridCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.example.dadosdosjogos2020oficial.databinding.FragmentRealMadridCasa2022a23Binding;
...
public class RealMadridCasa2022a23Fragment extends Fragment {


    private FragmentRealMadridCasa2022a23Binding binding;
    private RealMadridCasaA2022a23PartidaApi realMadridCasaA2022a23PartidaApi;
    private RealMadridCasa2022a23Adapter realMadridCasa2022a23Adapter;


    public RealMadridCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentRealMadridCasa2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/espanhol-a-2022-23/real-madrid/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        realMadridCasaA2022a23PartidaApi = retrofit.create(RealMadridCasaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvRealMadridCasa.setHasFixedSize(true);
        binding.rvRealMadridCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvRealMadridCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        realMadridCasaA2022a23PartidaApi.getRealMadridCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    realMadridCasa2022a23Adapter = new RealMadridCasa2022a23Adapter(partidas);
                    binding.rvRealMadridCasa.setAdapter(realMadridCasa2022a23Adapter);

                    binding.rvRealMadridCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvRealMadridCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
