package com.example.dadosdosjogos2020oficial.fragments.espanhaA2022a23.villarreal;
...
import com.example.dadosdosjogos2020oficial.adapter.espanhaA2022a23.villarreal.VillarrealCasa2022a23Adapter;
import com.example.dadosdosjogos2020oficial.data.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.data.espanhaA2022a23.villarreal.VillarrealCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.example.dadosdosjogos2020oficial.databinding.FragmentVillarrealCasa2022a23Binding;
...
public class VillarrealCasa2022a23Fragment extends Fragment {


    private FragmentVillarrealCasa2022a23Binding binding;
    private VillarrealCasaA2022a23PartidaApi villarrealCasaA2022a23PartidaApi;
    private VillarrealCasa2022a23Adapter villarrealCasa2022a23Adapter;


    public VillarrealCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentVillarrealCasa2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/espanhol-a-2022-23/villarreal/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        villarrealCasaA2022a23PartidaApi = retrofit.create(VillarrealCasaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvVillarrealCasa.setHasFixedSize(true);
        binding.rvVillarrealCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvVillarrealCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        villarrealCasaA2022a23PartidaApi.getVillarrealCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    villarrealCasa2022a23Adapter = new VillarrealCasa2022a23Adapter(partidas);
                    binding.rvVillarrealCasa.setAdapter(villarrealCasa2022a23Adapter);

                    binding.rvVillarrealCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvVillarrealCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
