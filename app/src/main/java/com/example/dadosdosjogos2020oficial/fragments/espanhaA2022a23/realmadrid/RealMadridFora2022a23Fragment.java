...
import com.example.dadosdosjogos2020oficial.adapter.espanhaA2022a23.realmadrid.RealMadridFora2022a23Adapter;
import com.example.dadosdosjogos2020oficial.data.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.data.espanhaA2022a23.realmadrid.RealMadridForaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.example.dadosdosjogos2020oficial.databinding.FragmentRealMadridFora2022a23Binding;
...
public class RealMadridFora2022a23Fragment extends Fragment {

    private FragmentRealMadridFora2022a23Binding binding;
    private RealMadridForaA2022a23PartidaApi realMadridForaA2022a23PartidaApi;
    private RealMadridFora2022a23Adapter realMadridFora2022a23Adapter;


    public RealMadridFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentRealMadridFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        realMadridForaA2022a23PartidaApi = retrofit.create(RealMadridForaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvRealMadridFora.setHasFixedSize(true);
        binding.rvRealMadridFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvRealMadridFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        realMadridForaA2022a23PartidaApi.getRealMadridFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    realMadridFora2022a23Adapter = new RealMadridFora2022a23Adapter(partidas);
                    binding.rvRealMadridFora.setAdapter(realMadridFora2022a23Adapter);

                    binding.rvRealMadridFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvRealMadridFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
