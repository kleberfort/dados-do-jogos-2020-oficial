package com.example.dadosdosjogos2020oficial.fragments.italiaA2022a23.torino;
...
import com.example.dadosdosjogos2020oficial.adapter.italiaA2022a23.torino.TorinoCasa2022a23Adapter;
import com.example.dadosdosjogos2020oficial.data.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.data.italiaA2022a23.torino.TorinoCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.example.dadosdosjogos2020oficial.databinding.FragmentTorinoCasa2022a23Binding;
...
public class TorinoCasa2022a23Fragment extends Fragment {

    private FragmentTorinoCasa2022a23Binding binding;
    private TorinoCasaA2022a23PartidaApi torinoCasaA2022a23PartidaApi;
    private TorinoCasa2022a23Adapter torinoCasa2022a23Adapter;



    public TorinoCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentTorinoCasa2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/italia-a-2022-23/torino/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        torinoCasaA2022a23PartidaApi = retrofit.create(TorinoCasaA2022a23PartidaApi.class);


    }

    private void setupDadosJogos() {
        binding.rvTorinoCasa.setHasFixedSize(true);
        binding.rvTorinoCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvTorinoCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        torinoCasaA2022a23PartidaApi.getTorinoCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    torinoCasa2022a23Adapter = new TorinoCasa2022a23Adapter(partidas);
                    binding.rvTorinoCasa.setAdapter(torinoCasa2022a23Adapter);

                    binding.rvTorinoCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvTorinoCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
