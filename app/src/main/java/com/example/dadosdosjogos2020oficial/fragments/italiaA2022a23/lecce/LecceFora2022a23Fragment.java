package com.example.dadosdosjogos2020oficial.fragments.italiaA2022a23.lecce;
...
import com.example.dadosdosjogos2020oficial.adapter.italiaA2022a23.lecce.LecceFora2022a23Adapter;
import com.example.dadosdosjogos2020oficial.data.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.data.italiaA2022a23.lecce.LecceForaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.example.dadosdosjogos2020oficial.databinding.FragmentLecceFora2022a23Binding;
...
public class LecceFora2022a23Fragment extends Fragment {

    private FragmentLecceFora2022a23Binding binding;
    private LecceForaA2022a23PartidaApi lecceForaA2022a23PartidaApi;
    private LecceFora2022a23Adapter lecceFora2022a23Adapter;

    public LecceFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLecceFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/italia-a-2022-23/lecce/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        lecceForaA2022a23PartidaApi = retrofit.create(LecceForaA2022a23PartidaApi.class);

    }

    private void setupDadosJogos() {
        binding.rvLecceFora.setHasFixedSize(true);
        binding.rvLecceFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvLecceFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        lecceForaA2022a23PartidaApi.getLecceFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    lecceFora2022a23Adapter = new LecceFora2022a23Adapter(partidas);
                    binding.rvLecceFora.setAdapter(lecceFora2022a23Adapter);

                    binding.rvLecceFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvLecceFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
