package com.example.dadosdosjogos2020oficial.fragments.francaA2022a23.lens;
...
import com.example.dadosdosjogos2020oficial.adapter.francaA2022a23.lens.LensFora2022a23Adapter;
import com.example.dadosdosjogos2020oficial.data.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.data.francaA2022a23.lens.LensForaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.example.dadosdosjogos2020oficial.databinding.FragmentLensFora2022a23Binding;
import com.example.dadosdosjogos2020oficial.databinding.FragmentLilleCasa2022a23Binding;
...
public class LensFora2022a23Fragment extends Fragment {

    private FragmentLensFora2022a23Binding binding;
    private LensForaA2022a23PartidaApi lensForaA2022a23PartidaApi;
    private LensFora2022a23Adapter lensFora2022a23Adapter;


    public LensFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLensFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/franca-a-2022-23/lens/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        lensForaA2022a23PartidaApi = retrofit.create(LensForaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvLensFora.setHasFixedSize(true);
        binding.rvLensFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvLensFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        lensForaA2022a23PartidaApi.getLensFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    lensFora2022a23Adapter = new LensFora2022a23Adapter(partidas);
                    binding.rvLensFora.setAdapter(lensFora2022a23Adapter);

                    binding.rvLensFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvLensFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
