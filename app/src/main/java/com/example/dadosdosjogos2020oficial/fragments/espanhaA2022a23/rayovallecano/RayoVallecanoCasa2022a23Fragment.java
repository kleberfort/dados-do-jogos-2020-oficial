package com.example.dadosdosjogos2020oficial.fragments.espanhaA2022a23.rayovallecano;
...
import com.example.dadosdosjogos2020oficial.adapter.espanhaA2022a23.rayovallecano.RayoVallecanoCasa2022a23Adapter;
import com.example.dadosdosjogos2020oficial.data.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.data.espanhaA2022a23.rayovallecano.RayoVallecanoCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.example.dadosdosjogos2020oficial.databinding.FragmentRayoVallecanoCasa2022a23Binding;
...
public class RayoVallecanoCasa2022a23Fragment extends Fragment {

    private FragmentRayoVallecanoCasa2022a23Binding binding;
    private RayoVallecanoCasaA2022a23PartidaApi rayoVallecanoCasaA2022a23PartidaApi;
    private RayoVallecanoCasa2022a23Adapter rayoVallecanoCasa2022a23Adapter;


    public RayoVallecanoCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentRayoVallecanoCasa2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/espanhol-a-2022-23/rayo-vallecano/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        rayoVallecanoCasaA2022a23PartidaApi = retrofit.create(RayoVallecanoCasaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvRayoVallecanoCasa.setHasFixedSize(true);
        binding.rvRayoVallecanoCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvRayoVallecanoCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        rayoVallecanoCasaA2022a23PartidaApi.getRayoVallecanoCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    rayoVallecanoCasa2022a23Adapter = new RayoVallecanoCasa2022a23Adapter(partidas);
                    binding.rvRayoVallecanoCasa.setAdapter(rayoVallecanoCasa2022a23Adapter);

                    binding.rvRayoVallecanoCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvRayoVallecanoCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
