...
import com.example.dadosdosjogos2020oficial.adapter.espanhaA2022a23.rayovallecano.RayoVallecanoFora2022a23Adapter;
import com.example.dadosdosjogos2020oficial.data.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.data.espanhaA2022a23.rayovallecano.RayoVallecanoForaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.example.dadosdosjogos2020oficial.databinding.FragmentRayoVallecanoFora2022a23Binding;
...
public class RayoVallecanoFora2022a23Fragment extends Fragment {


    private FragmentRayoVallecanoFora2022a23Binding binding;
    private RayoVallecanoForaA2022a23PartidaApi rayoVallecanoForaA2022a23PartidaApi;
    private RayoVallecanoFora2022a23Adapter rayoVallecanoFora2022a23Adapter;

    public RayoVallecanoFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentRayoVallecanoFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        rayoVallecanoForaA2022a23PartidaApi = retrofit.create(RayoVallecanoForaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvRayoVallecanoFora.setHasFixedSize(true);
        binding.rvRayoVallecanoFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvRayoVallecanoFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        rayoVallecanoForaA2022a23PartidaApi.getRayoVallecanoFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    rayoVallecanoFora2022a23Adapter = new RayoVallecanoFora2022a23Adapter(partidas);
                    binding.rvRayoVallecanoFora.setAdapter(rayoVallecanoFora2022a23Adapter);

                    binding.rvRayoVallecanoFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvRayoVallecanoFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
