package com.example.dadosdosjogos2020oficial.fragments.inglesA2022a23.chelsea;
...
import com.example.dadosdosjogos2020oficial.adapter.inglesA2022a2023.chelsea.ChelseaCasa2022a23Adapter;
import com.example.dadosdosjogos2020oficial.data.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.data.inglesA2022a23.chelsea.ChelseaCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.example.dadosdosjogos2020oficial.databinding.FragmentChelseaCasa2022a23Binding;
...
public class ChelseaCasa2022a23Fragment extends Fragment {

    private FragmentChelseaCasa2022a23Binding binding;
    private ChelseaCasaA2022a23PartidaApi chelseaCasaA2022a23PartidaApi;
    private ChelseaCasa2022a23Adapter chelseaCasa2022a23Adapter;

    public ChelseaCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentChelseaCasa2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/ingles-a-2022-23/chelsea/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        chelseaCasaA2022a23PartidaApi = retrofit.create(ChelseaCasaA2022a23PartidaApi.class);


    }

    private void setupDadosJogos() {
        binding.rvChelseaCasa.setHasFixedSize(true);
        binding.rvChelseaCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvChelseaCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        chelseaCasaA2022a23PartidaApi.getChelseaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    chelseaCasa2022a23Adapter = new ChelseaCasa2022a23Adapter(partidas);
                    binding.rvChelseaCasa.setAdapter(chelseaCasa2022a23Adapter);

                    binding.rvChelseaCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvChelseaCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
