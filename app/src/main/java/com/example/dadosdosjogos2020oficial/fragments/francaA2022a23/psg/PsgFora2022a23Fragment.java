...
import com.example.dadosdosjogos2020oficial.adapter.francaA2022a23.psg.PsgFora2022a23Adapter;
import com.example.dadosdosjogos2020oficial.data.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.data.francaA2022a23.psg.PsgForaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.example.dadosdosjogos2020oficial.databinding.FragmentPsgFora2022a23Binding;
...
public class PsgFora2022a23Fragment extends Fragment {

    private FragmentPsgFora2022a23Binding binding;
    private PsgForaA2022a23PartidaApi psgForaA2022a23PartidaApi;
    private PsgFora2022a23Adapter psgFora2022a23Adapter;



    public PsgFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentPsgFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        psgForaA2022a23PartidaApi = retrofit.create(PsgForaA2022a23PartidaApi.class);


    }

    private void setupDadosJogos() {
        binding.rvPsgFora.setHasFixedSize(true);
        binding.rvPsgFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvPsgFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        psgForaA2022a23PartidaApi.getPsgFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    psgFora2022a23Adapter = new PsgFora2022a23Adapter(partidas);
                    binding.rvPsgFora.setAdapter(psgFora2022a23Adapter);

                    binding.rvPsgFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvPsgFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
