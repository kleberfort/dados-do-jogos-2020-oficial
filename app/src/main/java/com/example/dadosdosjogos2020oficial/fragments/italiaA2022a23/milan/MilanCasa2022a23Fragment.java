package com.example.dadosdosjogos2020oficial.fragments.italiaA2022a23.milan;
...
import com.example.dadosdosjogos2020oficial.adapter.italiaA2022a23.milan.MilanCasa2022a23Adapter;
import com.example.dadosdosjogos2020oficial.data.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.data.italiaA2022a23.milan.MilanCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.example.dadosdosjogos2020oficial.databinding.FragmentMilanCasa2022a23Binding;
...
public class MilanCasa2022a23Fragment extends Fragment {

    private FragmentMilanCasa2022a23Binding binding;
    private MilanCasaA2022a23PartidaApi milanCasaA2022a23PartidaApi;
    private MilanCasa2022a23Adapter milanCasa2022a23Adapter;

    public MilanCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentMilanCasa2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        milanCasaA2022a23PartidaApi = retrofit.create(MilanCasaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvMilanCasa.setHasFixedSize(true);
        binding.rvMilanCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvMilanCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        milanCasaA2022a23PartidaApi.getMilanCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    milanCasa2022a23Adapter = new MilanCasa2022a23Adapter(partidas);
                    binding.rvMilanCasa.setAdapter(milanCasa2022a23Adapter);

                    binding.rvMilanCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvMilanCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
