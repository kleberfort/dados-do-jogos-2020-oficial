...
import com.example.dadosdosjogos2020oficial.adapter.italiaA2022a23.sampdoria.SampdoriaFora2022a23Adapter;
import com.example.dadosdosjogos2020oficial.data.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.data.italiaA2022a23.sampdoria.SampdoriaForaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.example.dadosdosjogos2020oficial.databinding.FragmentSampdoriaFora2022a23Binding;
...
public class SampdoriaFora2022a23Fragment extends Fragment {

    private FragmentSampdoriaFora2022a23Binding binding;
    private SampdoriaForaA2022a23PartidaApi sampdoriaForaA2022a23PartidaApi;
    private SampdoriaFora2022a23Adapter sampdoriaFora2022a23Adapter;


    public SampdoriaFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSampdoriaFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        sampdoriaForaA2022a23PartidaApi = retrofit.create(SampdoriaForaA2022a23PartidaApi.class);

    }

    private void setupDadosJogos() {
        binding.rvSampdoriaFora.setHasFixedSize(true);
        binding.rvSampdoriaFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvSampdoriaFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        sampdoriaForaA2022a23PartidaApi.getSampdoriaFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    sampdoriaFora2022a23Adapter = new SampdoriaFora2022a23Adapter(partidas);
                    binding.rvSampdoriaFora.setAdapter(sampdoriaFora2022a23Adapter);

                    binding.rvSampdoriaFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvSampdoriaFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
