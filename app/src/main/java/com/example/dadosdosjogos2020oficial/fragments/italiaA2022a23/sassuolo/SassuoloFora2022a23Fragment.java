...
import com.example.dadosdosjogos2020oficial.adapter.italiaA2022a23.sassuolo.SassuoloFora2022a23Adapter;
import com.example.dadosdosjogos2020oficial.data.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.data.italiaA2022a23.sassuolo.SassuoloForaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.example.dadosdosjogos2020oficial.databinding.FragmentSassuoloFora2022a23Binding;
...
public class SassuoloFora2022a23Fragment extends Fragment {


    private FragmentSassuoloFora2022a23Binding binding;
    private SassuoloForaA2022a23PartidaApi sassuoloForaA2022a23PartidaApi;
    private SassuoloFora2022a23Adapter sassuoloFora2022a23Adapter;


    public SassuoloFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSassuoloFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        sassuoloForaA2022a23PartidaApi = retrofit.create(SassuoloForaA2022a23PartidaApi.class);

    }

    private void setupDadosJogos() {
        binding.rvSassuoloFora.setHasFixedSize(true);
        binding.rvSassuoloFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvSassuoloFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        sassuoloForaA2022a23PartidaApi.getSassuoloFora().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    sassuoloFora2022a23Adapter = new SassuoloFora2022a23Adapter(partidas);
                    binding.rvSassuoloFora.setAdapter(sassuoloFora2022a23Adapter);

                    binding.rvSassuoloFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvSassuoloFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
