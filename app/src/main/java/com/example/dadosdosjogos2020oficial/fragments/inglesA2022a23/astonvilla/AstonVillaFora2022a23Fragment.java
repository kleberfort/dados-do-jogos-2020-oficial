...
import com.example.dadosdosjogos2020oficial.adapter.inglesA2022a2023.astonvilla.AstonVillaFora2022a23Adapter;
import com.example.dadosdosjogos2020oficial.data.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.data.inglesA2022a23.astonvilla.AstonVillaForaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.databinding.FragmentAstonVillaFora2022a23Binding;
...
public class AstonVillaFora2022a23Fragment extends Fragment {

    private FragmentAstonVillaFora2022a23Binding binding;
    private AstonVillaForaA2022a23PartidaApi astonVillaForaA2022a23PartidaApi;
    private AstonVillaFora2022a23Adapter astonVillaFora2022a23Adapter;


    public AstonVillaFora2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAstonVillaFora2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        astonVillaForaA2022a23PartidaApi = retrofit.create(AstonVillaForaA2022a23PartidaApi.class);


    }

    private void setupDadosJogos() {
        binding.rvAstonVillaFora.setHasFixedSize(true);
        binding.rvAstonVillaFora.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvAstonVillaFora.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        astonVillaForaA2022a23PartidaApi.getAstonVillaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    astonVillaFora2022a23Adapter = new AstonVillaFora2022a23Adapter(partidas);
                    binding.rvAstonVillaFora.setAdapter(astonVillaFora2022a23Adapter);

                    binding.rvAstonVillaFora.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvAstonVillaFora, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
