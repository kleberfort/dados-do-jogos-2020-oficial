package com.example.dadosdosjogos2020oficial.fragments.francaA2022a23.psg;
...
import com.example.dadosdosjogos2020oficial.adapter.francaA2022a23.psg.PsgCasa2022a23Adapter;
import com.example.dadosdosjogos2020oficial.data.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.data.francaA2022a23.psg.PsgCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.example.dadosdosjogos2020oficial.databinding.FragmentPsgCasa2022a23Binding;
...
public class PsgCasa2022a23Fragment extends Fragment {

    private FragmentPsgCasa2022a23Binding binding;
    private PsgCasaA2022a23PartidaApi psgCasaA2022a23PartidaApi;
    private PsgCasa2022a23Adapter psgCasa2022a23Adapter;

    public PsgCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentPsgCasa2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/franca-a-2022-23/psg/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        psgCasaA2022a23PartidaApi = retrofit.create(PsgCasaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvPsgCasa.setHasFixedSize(true);
        binding.rvPsgCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvPsgCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        psgCasaA2022a23PartidaApi.getPsgCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    psgCasa2022a23Adapter = new PsgCasa2022a23Adapter(partidas);
                    binding.rvPsgCasa.setAdapter(psgCasa2022a23Adapter);

                    binding.rvPsgCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvPsgCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
