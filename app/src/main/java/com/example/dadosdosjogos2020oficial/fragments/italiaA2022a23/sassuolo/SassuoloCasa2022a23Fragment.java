package com.example.dadosdosjogos2020oficial.fragments.italiaA2022a23.sassuolo;
...
import com.example.dadosdosjogos2020oficial.adapter.italiaA2022a23.sassuolo.SassuoloCasa2022a23Adapter;
import com.example.dadosdosjogos2020oficial.data.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.data.italiaA2022a23.sassuolo.SassuoloCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.example.dadosdosjogos2020oficial.databinding.FragmentSassuoloCasa2022a23Binding;
...
public class SassuoloCasa2022a23Fragment extends Fragment {

    private FragmentSassuoloCasa2022a23Binding binding;
    private SassuoloCasaA2022a23PartidaApi sassuoloCasaA2022a23PartidaApi;
    private SassuoloCasa2022a23Adapter sassuoloCasa2022a23Adapter;

    public SassuoloCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSassuoloCasa2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/italia-a-2022-23/sassuolo/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        sassuoloCasaA2022a23PartidaApi = retrofit.create(SassuoloCasaA2022a23PartidaApi.class);


    }

    private void setupDadosJogos() {
        binding.rvSassuoloCasa.setHasFixedSize(true);
        binding.rvSassuoloCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvSassuoloCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        sassuoloCasaA2022a23PartidaApi.getSassuoloCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    sassuoloCasa2022a23Adapter = new SassuoloCasa2022a23Adapter(partidas);
                    binding.rvSassuoloCasa.setAdapter(sassuoloCasa2022a23Adapter);

                    binding.rvSassuoloCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvSassuoloCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
