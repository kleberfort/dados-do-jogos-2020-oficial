package com.example.dadosdosjogos2020oficial.fragments.italiaA2022a23.sampdoria;
...
import com.example.dadosdosjogos2020oficial.adapter.italiaA2022a23.sampdoria.SampdoriaCasa2022a23Adapter;
import com.example.dadosdosjogos2020oficial.data.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.data.italiaA2022a23.sampdoria.SampdoriaCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.example.dadosdosjogos2020oficial.databinding.FragmentSampdoriaCasa2022a23Binding;
...
public class SampdoriaCasa2022a23Fragment extends Fragment {

    private FragmentSampdoriaCasa2022a23Binding binding;
    private SampdoriaCasaA2022a23PartidaApi sampdoriaCasaA2022a23PartidaApi;
    private SampdoriaCasa2022a23Adapter sampdoriaCasa2022a23Adapter;

    public SampdoriaCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSampdoriaCasa2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://raw.githubusercontent.com/kleberfort/dados-jogos-partidas-oficial-2022-api/master/italia-a-2022-23/sampdoria/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        sampdoriaCasaA2022a23PartidaApi = retrofit.create(SampdoriaCasaA2022a23PartidaApi.class);
    }

    private void setupDadosJogos() {
        binding.rvSampdoriaCasa.setHasFixedSize(true);
        binding.rvSampdoriaCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvSampdoriaCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        sampdoriaCasaA2022a23PartidaApi.getSampdoriaCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    sampdoriaCasa2022a23Adapter = new SampdoriaCasa2022a23Adapter(partidas);
                    binding.rvSampdoriaCasa.setAdapter(sampdoriaCasa2022a23Adapter);

                    binding.rvSampdoriaCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvSampdoriaCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
