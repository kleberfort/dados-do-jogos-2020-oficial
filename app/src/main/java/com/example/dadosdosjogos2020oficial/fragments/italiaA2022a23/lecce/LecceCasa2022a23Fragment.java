...
import com.example.dadosdosjogos2020oficial.adapter.italiaA2022a23.lecce.LecceCasa2022a23Adapter;
import com.example.dadosdosjogos2020oficial.data.alemanhaA2022a23.bayerleverkusen.BayerLeverkusenCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.data.italiaA2022a23.lecce.LecceCasaA2022a23PartidaApi;
import com.example.dadosdosjogos2020oficial.databinding.FragmentBayerLeverkusenCasa2022a23Binding;
import com.example.dadosdosjogos2020oficial.databinding.FragmentLecceCasa2022a23Binding;
...
public class LecceCasa2022a23Fragment extends Fragment {

    private FragmentLecceCasa2022a23Binding binding;
    private LecceCasaA2022a23PartidaApi lecceCasaA2022a23PartidaApi;
    private LecceCasa2022a23Adapter lecceCasa2022a23Adapter;


    public LecceCasa2022a23Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLecceCasa2022a23Binding.inflate(inflater, container, false);
    ...
    private void setupHttpClient() {
        ...
        lecceCasaA2022a23PartidaApi = retrofit.create(LecceCasaA2022a23PartidaApi.class);

    }

    private void setupDadosJogos() {
        binding.rvLecceCasa.setHasFixedSize(true);
        binding.rvLecceCasa.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.rvLecceCasa.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayout.VERTICAL));

        lecceCasaA2022a23PartidaApi.getLecceCasa().enqueue(new Callback<List<Partida>>() {
            @Override
            public void onResponse(Call<List<Partida>> call, Response<List<Partida>> response) {
                if(response.isSuccessful()){
                    List<Partida> partidas = response.body();
                    lecceCasa2022a23Adapter = new LecceCasa2022a23Adapter(partidas);
                    binding.rvLecceCasa.setAdapter(lecceCasa2022a23Adapter);

                    binding.rvLecceCasa.addOnItemTouchListener(new RecyclerItemClickListener(getContext(), binding.rvLecceCasa, new RecyclerItemClickListener.OnItemClickListener() {
                        @Override
